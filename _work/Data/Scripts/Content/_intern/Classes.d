...
CLASS C_Item 
{
	...
	// Benцtigte Attribute zum Benutzen des Items
	VAR INT		cond_atr		[3]				;
	VAR INT		cond_value		[3]				;

	// Attribute, die bei anlegen des Items verдndert werden
	...
	// Verдnderung des NSC-Meshes beim Anlegen dieses Gegenstandes
...
{															
	...
	VAR FLOAT	npc_elevdo, npc_elevup			;		//	Elevation	( Hцhenwinkel  )
	VAR INT		npc_prio						;		//	Prioritдt
															
	/// fьr ITEMs											
	VAR FLOAT	item_range1, item_range2		;		//	Reichweite 
	VAR FLOAT	item_azi						;		//	Azimuth		( Seitenwinkel )
	VAR FLOAT	item_elevdo, item_elevup		;		//	Elevation	( Hцhenwinkel  )
	VAR INT		item_prio						;		//	Prioritдt
															
	/// fьr MOBs											
	VAR FLOAT	mob_range1, mob_range2			;		//	Reichweite 
	VAR FLOAT	mob_azi							;		//	Azimuth		( Seitenwinkel )
	VAR FLOAT	mob_elevdo, mob_elevup			;		//	Elevation	( Hцhenwinkel  )
	VAR INT		mob_prio						;		//	Prioritдt
};
