...
// ZS_MM_ThreatenEnemy
// -------------------
// geht davon aus, daЯ Feind INNERHALB der DrohRange
// Monster bedrohen Feind n Sekunden (einstellbar)
// dann greifen sie an, es sei denn der Feind hat sich verkrьmelt
// **************************************************************
...
func void ZS_MM_ThreatenEnemy ()
{
	...
	// ------ Warn senden ------
	Npc_SendPassivePerc	(self, PERC_ASSESSWARN, other, self); // Opfer, Tдter - ruft PACKHUNTER der selben Gilde herbei --> drohen dann mit
};
