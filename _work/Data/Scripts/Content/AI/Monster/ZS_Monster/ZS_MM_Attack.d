...
{												
	...
	// ------ Hilfe anfordern ------
	Npc_SendPassivePerc	(self, PERC_ASSESSWARN,	other, self); //Opfer,Tдter	
	...
	self.aivar[AIV_TAPOSITION] = 0; //fьr Regeneration
};
...
func int ZS_MM_Attack_Loop ()
{
	...
	else 										// NPC_GetTarget(self) == FALSE, also tot - other hier automatisch gelцscht
	{
