...
// Beutetiere nehmen Jдger ьber PERC_ASSESSWARN wahr
// --------------------------------------------------
...
func void B_MM_AssessEnemy ()
{
	...
	// ------- OVERRIDE fьr menschliche Enemies ------
	...
	// ------- OVERRIDE fьr menschliche Enemies ------
	if (self.aivar[AIV_EnemyOverride] == TRUE)	//Joly: fьr Inubis, Skelette in der Krypta und д.
	...
	// ------- Monster sollen sich zu Tode stьrzen, etc. ------
	...
	// ------ Monster kцnnen nach HINTEN nicht so weit riechen ------
	// --------------------------------------------------------------
	...
	// ------ Jдger greift Beute immer direkt an ------
	...
	// ------ Beute flieht vor Jдger (wenn in Droh-Reichweite (Abfrage s.o.) ------
