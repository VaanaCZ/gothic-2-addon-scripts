...
// die die Atitьde zum SC auf FRIENDLY gesetzt bekommen
// ****************************************************
...
func void B_MM_AssessOthersDamage ()
{
	...
	// ------ wenn ich zu weit weg bin ------	//wichtig fьr Aufruf ьber FIGHTSOUND aus ZS_MM_Rtn_Summoned
	...
	if (self.aivar[AIV_PARTYMEMBER] == TRUE)
	{
		...
		&& (!Npc_IsDead (victim)) //Funktion wird auch ьber AssessMurder angesprungen
		{
			Npc_ClearAIQueue	(self);
			B_ClearPerceptions	(self);
