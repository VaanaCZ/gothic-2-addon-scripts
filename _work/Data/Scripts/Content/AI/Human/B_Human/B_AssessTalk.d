...
func void B_AssessTalk ()
{
	...
	// ------ Exit-Conditions NUR fьr Monster
	...
	// ------ Exit-Conditions NUR fьr Humans ------
	if (self.guild < GIL_SEPERATOR_HUM)
	{
	...
	if (C_BodyStateContains(self, BS_SIT))
	{
		...
		{
			//HACK: Im ObservePlayer kann ein NSC sitzen, ohne daЯ in der END-Routine des ZS sauber aufgestanden wird (klar, denn ZS_ObservePlayer_End hat kein StandUp o.д. - darf dies auch nicht haben)
