...
// kann ЬBERALL her aufgerufen werden (auch aus ZS_Attack), dann aber sofort zurьck
...
func int B_AssessEnterRoom ()
{
	...
	// ------ GIL_NONE ignoriert ------ (NICHT Portalguild NONE ignorieren, sonst wird der SC beim rauskommen aus Hдusern nicht mehr erfasst!)
	...
	// ------- Spieler befindet sich in цffentlichem Raum ------
...
func void B_AssessPortalCollision()
{
	...
	// ------ wenn ich den Spieler nicht rauskommen sehe oder hцre -----
	if (!Npc_CanSeeNpc (self, other))
	...
	if (Wld_DetectNpcEx(self, -1, ZS_ClearRoom, -1, FALSE)) //ist noch fьr die Dauer von B_Say TRUE
	{
