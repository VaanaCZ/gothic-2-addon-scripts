...
func int B_AssessEnemy()
{
	...
	// ------- OVERRIDE fьr Enemies, die noch vorher quatschen sollen ------
	...
	// ------- Sicherheitsabfrage (B_AssessEnemy wird auch von anderen Funktionen aufgerufen, nicht nur ьber Wahrnehmung) ------
	...
	{
		// ------ ABER ich bin temp_hostile (d.h. hab gerade gegen den Spieler gekдmpft) ------
		if (Npc_GetAttitude (self, other) == ATT_HOSTILE)
		// -------------------------
		...
		// ------ Kampf nur fortsetzen, wenn Spieler nдher als 10m ------
