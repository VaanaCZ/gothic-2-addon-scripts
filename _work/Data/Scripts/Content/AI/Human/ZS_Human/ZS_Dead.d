...
// ZS_Dead
// -------
// wird auch nach jedem Load Game ausgefьhrt
// wird auch vom Spieler ausgefьhrt
// *****************************************
...
{	
	...
	if (Npc_IsPlayer(other))
	{
		...
		//------Addon Garaz Minecrawler Hцhle------egal wer tцtet----
	...
	// ------ weil sonst Hдndler bevor man zum ersten Mal TRADE gewдhlt hat nix haben ------
	B_GiveTradeInv(self);//Joly:	STEHEN LASSEN!!!!!!!!!!!!!!!

	// ------ Monster-Inventory abhдngig vom Spieler-Talent ------
	B_GiveDeathInv(self);
	...
	// ------ Equippte Waffen kцnnen nicht genommen werden! ------
