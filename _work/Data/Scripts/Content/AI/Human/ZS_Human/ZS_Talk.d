...
FUNC void ZS_Talk ()
{
	...
	{
		B_Say (self,other,"$ABS_COMMANDER"); //Ich hцrte, du warst beim Kommandanten und hast die Sache wieder in Ordnung gebracht.
		B_Say (self,other,"$ABS_MONASTERY"); //Ich hцrte, du warst bei Vater Parlan und hast BuЯe getan..
		B_Say (self,other,"$ABS_FARM");	//Ich hцrte, du warst bei Lee und und hast die Sache wieder in Ordnung gebracht.
...
func INT ZS_Talk_Loop ()
{
   	...
   	&& (zsTalkBugfix == TRUE)			//verhindert, daЯ InfoManager_HasFinished im ERSTEN FRAME der Loop abgefragt wird --> fьhrt sonst bei MOB-SITZENDEN NSCs (kein Scheiss) zu Abbruch der Loop im ERSTEN FRAME! 
...
{
	// ------ damit nicht nach Dialog+Losgehen gegrьЯt wird ------
