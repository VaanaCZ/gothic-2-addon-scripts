...
INSTANCE Focus_Melee (C_Focus)
{
	...
	npc_range1	= 0.0;				
	npc_range2	= 500.0;
	npc_azi		= 50.0;			//    - geдndert von 30 auf 45 (Gothic 1) auf 50 (Gothic II) -- Mike
	npc_elevup	= 90.0;
	npc_elevdo	= -60.0;
...
// ACHTUNG!!!!!!!: Der Magie Fokus sollte nicht verдndert werden. Alle spezifischen Focus Modes sind PRO SPELL in der Spell_Params.d einstellbar.
// Diese Magie Focus Instanz trifft die Vorentscheidung, welche Vobs ьberhaupt in Frage kommen. Der eigentlich Test findet in den einzelnen Spells statt!
...
/*	npc_range1	= 0.0;				
	...
	npc_elevup	= 90.0;
	npc_elevdo	= -85.0;
	npc_prio	= 1;				// MH: NUR NSCs werden berьcksichtigt
	// ITEMs
	item_range1	= 0.0;				
	item_range2	= 3000.0;
	item_azi	= 45.0;				
