...
//	PrintDebugNpc
//	-------------
//	Gibt eine Debug-Meldung im zSpy aus. Dabei muЯ in 'type' ein
//	Debug-Channel und in 'text' der eigentliche Meldungstext ьbergeben
//	werden.
...
//	PrintAttitudes
//	--------------
//	Gibt die Attitьden von 'self' auf dem zSpy aus
//////////////////////////////////////////////////////////////////////////
func void PrintAttitudes (var int channel)
{
	...
	// Check Block auf temporдre Attitьde des Nscґs
