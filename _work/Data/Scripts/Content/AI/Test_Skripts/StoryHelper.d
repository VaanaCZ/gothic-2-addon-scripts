...
func VOID StoryHelper_INFO1_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO1, "Początek rozdziału"			                			, StoryHelper_KAPITEL1ANFANG);
	Info_AddChoice		( StoryHelper_INFO1, "DODATEK: Gotowy na pierwsze spotkanie z Saturasem (zignoruj Laresa)"			                	, StoryHelper_SATURAS);
	Info_AddChoice		( StoryHelper_INFO1, "DODATEK: Błąd Cavalorna"			                	, StoryHelper_Cavalorn);
};
...
func VOID StoryHelper_INFO2_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO2, "Początek rozdziału"			                			, StoryHelper_KAPITEL2ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID StoryHelper_INFO3_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO3, "Początek rozdziału"			                			, StoryHelper_KAPITEL3ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID StoryHelper_INFO4_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO4, "Początek rozdziału"			                			, StoryHelper_KAPITEL4ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID StoryHelper_INFO5_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO5, "Początek rozdziału"			                			, StoryHelper_KAPITEL5ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID StoryHelper_INFO6_Info()
{
	...
	Info_AddChoice		( StoryHelper_INFO6, "Początek rozdziału"			                			, StoryHelper_KAPITEL6ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
