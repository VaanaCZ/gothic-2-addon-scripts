...
func void B_SetHeroExp() 
{
    ...
    Attributes = "Postoupil jsi na novou úroveò! Vìdomostní body: ";
...
FUNC VOID  CH_Geben_Info()
{
	//B_GiveInvItems (self, other, Itmi_Nugget, 2);
		 ...
		 AI_PrintScreen ("Pøedat med",	 -1, 34, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Pøedat chléb",	 -1, 37, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Pøedat víno",     -1, 40, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Pøedat klobásu",  	 -1, 43, FONT_ScreenSmall, 2);
};
//***************************************************************************
//	Rahmen-Infos
// 	Ende
...
func VOID CH_Language_Info()
{
	...
	Info_AddChoice	(CH_Language, "Jazyk knìží (3)", CH_Language_Priest );
...
INSTANCE CH_Level_Start (C_INFO)
{
	...
	description		= "Úroveò, vìdomostní body a cech"; 
	permanent		=  TRUE;
};
...
func VOID CH_Lernpunkte_Info()
{
	...
	Info_AddChoice (CH_Lernpunkte,"Vìdomostní body + 50",CH_Lernpunkte_50);
	Info_AddChoice (CH_Lernpunkte,"Vìdomostní body + 25",CH_Lernpunkte_25);
	Info_AddChoice (CH_Lernpunkte,"Vìdomostní body + 10",CH_Lernpunkte_10);
	Info_AddChoice (CH_Lernpunkte,"Vìdomostní body + 5 ",CH_Lernpunkte_5);
};
...
FUNC VOID CH_Lernpunkte_50 ()
{
	...
	hero.LP = (hero.LP + 50);
	PrintScreen  ("+ 50 vìdomostních bodù", -1,-1,FONT_Screen,3);
	Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_25 ()
{
	...
	hero.LP = (hero.LP + 25);
	PrintScreen  ("+ 25 vìdomostních bodù", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_10 ()
{
	...
	hero.LP = (hero.LP + 10);
	PrintScreen  ("+ 10 vìdomostních bodù", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_5 ()
{
	...
	hero.LP = (hero.LP + 5);
	PrintScreen  ("+ 5 vìdomostních bodù", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
//***************************************************************************
//	Levelwahl 1- 25
...
func VOID CH_Level_niedrig_Info()
{
	...
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 21 - 25" , CH_Level21);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 16 - 20" , CH_Level16);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 11 - 15" , CH_Level11);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò  6 - 10" , CH_Level6);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò  1 -  5" , CH_Level1);
...
func VOID CH_Level_hoch_Info()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Úroveò 46 - 50" , CH_Level46);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 41 - 45" , CH_Level41);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 36 - 40" , CH_Level36);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 31 - 35" , CH_Level31);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 26 - 30" , CH_Level26);
};
//***************************************************************************
//	Level Funcs
//***************************************************************************
func void CH_Level46()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 50" , CH_Level_50);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 49" , CH_Level_49);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 48" , CH_Level_48);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 47" , CH_Level_47);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 46" , CH_Level_46);
};
func void CH_Level41()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 45" , CH_Level_45);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 44" , CH_Level_44);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 43" , CH_Level_43);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 42" , CH_Level_42);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 41" , CH_Level_41);
};
func void CH_Level36()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 40" , CH_Level_40);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 39" , CH_Level_39);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 38" , CH_Level_38);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 37" , CH_Level_37);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 36" , CH_Level_36);
};
func void CH_Level31()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 35" , CH_Level_35);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 34" , CH_Level_34);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 33" , CH_Level_33);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 32" , CH_Level_32);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 31" , CH_Level_31);
};
...
func void CH_Level26()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 30" , CH_Level_30);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 29" , CH_Level_29);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 28" , CH_Level_28);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 27" , CH_Level_27);
	Info_AddChoice		(CH_Level_hoch, "Úroveò 26" , CH_Level_26);
};  
func void CH_Level21()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 25" , CH_Level_25);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 24" , CH_Level_24);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 23" , CH_Level_23);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 22" , CH_Level_22);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 21" , CH_Level_21);
...
func void CH_Level16()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 20" , CH_Level_20);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 19" , CH_Level_19);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 18" , CH_Level_18);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 17" , CH_Level_17);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 16" , CH_Level_16);
};
...
func void CH_Level11()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 15" , CH_Level_15);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 14" , CH_Level_14);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 13" , CH_Level_13);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 12" , CH_Level_12);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 11" , CH_Level_11);
};
func void CH_Level6()
{
	Info_ClearChoices	(CH_Level_niedrig);
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK	    , CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 10" , CH_Level_10);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò  9" , CH_Level_9);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò  8" , CH_Level_8);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò  7" , CH_Level_7);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò  6" , CH_Level_6);
};
...
func void CH_Level1()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 5" 	, CH_Level_5);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 4" 	, CH_Level_4);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 3" 	, CH_Level_3);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 2" 	, CH_Level_2);
	Info_AddChoice		(CH_Level_niedrig, "Úroveò 1" 	, CH_Level_1);
};
...
FUNC VOID DIA_CH_KREISE_Info()
{
	...
	Info_AddChoice 	  (DIA_CH_KREISE,"Tøetí kruh", CH_KREISE_3);
...
FUNC VOID DIA_CH_Kampf_Einhand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranì + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*20)		,CH_Training_Combat_1H_20);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranì + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*10)		,CH_Training_Combat_1H_10);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranì + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*5)		,CH_Training_Combat_1H_5);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranì + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1))		,CH_Training_Combat_1H_1);
};
...
FUNC VOID DIA_CH_Kampf_Zweihand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranì + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*20)			,CH_Training_Combat_2H_20);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranì + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*10)			,CH_Training_Combat_2H_10);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranì + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*5)				,CH_Training_Combat_2H_5);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranì + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1))				,CH_Training_Combat_2H_1);
};
...
INSTANCE DIA_CH_Dieb_Alle (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Všechny zlodìjské dovednosti nauèeny";
};                       
...
FUNC VOID DIA_CH_Dieb_Alle_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Alle , B_BuildLearnString("Všechny zlodìjské dovednosti", kosten_alle), CH_Training_Thief_Alle);
};
//***************************************************************************
...
INSTANCE DIA_CH_Misc_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Ostatní (nápoje, trofeje, kováøské øemeslo, paladinské runy, øeèi)";
};                       
...
INSTANCE DIA_CH_Misc_Alchemie (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Alchymie - umìní míchat lektvary";
};                       
