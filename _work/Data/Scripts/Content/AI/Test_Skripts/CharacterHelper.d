...
func void UseMobsiBrief ()
{
		...
		nDocID =	Doc_Create		();
					...
					Doc_PrintLines	(nDocID,  0, "Teraz znowu wszystko będzie w porządku."						);
...
{	
	name 				=	"W sakwie jest pełno nowych broni!";
	...
	description			= 	name;
	TEXT[2]				= 	"Wiele różnych broni";		
	
};

	FUNC VOID Use_Sack()
	{
		Print("Znalazłem stos nowej broni!");
...
func void B_SetHeroExp() 
{
    ...
    Attributes = ConcatStrings(Attributes, " Punkty trafień:");
...
instance  CH_kriegen (C_INFO)
{
	...
	permanent	=  TRUE;
	description = "Daj 1 kawałek rudy";
};                       
...
instance  CH_RESET (C_INFO)
{
	...
	permanent 	=  TRUE;
	description = "Całkowity reset postaci";
};                       
...
FUNC VOID  CH_RESET_Info()
{
	...
	PrintScreen ("PC_Hero - postać wyzerowana", - 1, - 1, FONT_Screen, 2);   
...
func VOID CH_Language_Info()
{
	...
	Info_AddChoice	(CH_Language, "Język kapłanów (3)", CH_Language_Priest );
	Info_AddChoice	(CH_Language, "Język wojowników (2)", CH_Language_Warrior );
	Info_AddChoice	(CH_Language, "Język farmerów (1)", CH_Language_Peasant );
};
...
func VOID CH_Guild_Info()
{
    ...
    Info_AddChoice	(CH_Guild, "Łowca smoków"       , CH_DJG);
    Info_AddChoice	(CH_Guild, "Strażnik"       	, CH_MIL);    
...
FUNC VOID DIA_CH_Strength_Info()
{
	...
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Siła + 20"		, B_GetLearnCostAttribute(other, ATR_STRENGTH)*20)		,DIA_CH_Strength_20);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Siła + 10"		, B_GetLearnCostAttribute(other, ATR_STRENGTH)*10)		,DIA_CH_Strength_10);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Siła + 5"			, B_GetLearnCostAttribute(other, ATR_STRENGTH)*5)		,DIA_CH_Strength_5);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Siła + 1"			, B_GetLearnCostAttribute(other, ATR_STRENGTH))			,DIA_CH_Strength_1);
...
INSTANCE DIA_CH_Dex (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zwiększanie zręczności";
};                       
...
FUNC VOID DIA_CH_Dex_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Zręczność + 20"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*20)		,DIA_CH_DEX_20);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Zręczność + 10"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*10)		,DIA_CH_DEX_10);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Zręczność + 5"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*5)		,DIA_CH_DEX_5);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Zręczność + 1"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY))		,DIA_CH_DEX_1);
};
...
INSTANCE DIA_CH_MAGIE (C_INFO)
{
	...
	permanent	= TRUE;
	description = "MAGIA: mana, runy, kręgi";
};                       
...
FUNC VOID DIA_CH_KREISE_Info()
{
	...
	Info_AddChoice 	  (DIA_CH_KREISE,"Szósty krąg",CH_KREISE_6);
	Info_AddChoice 	  (DIA_CH_KREISE,"Piąty krąg", CH_KREISE_5);
	Info_AddChoice 	  (DIA_CH_KREISE,"Czwarty krąg", CH_KREISE_4);
	Info_AddChoice 	  (DIA_CH_KREISE,"Trzeci krąg", CH_KREISE_3);
	Info_AddChoice 	  (DIA_CH_KREISE,"Drugi krąg", CH_KREISE_2);
	Info_AddChoice 	  (DIA_CH_KREISE,"Pierwszy krąg",  CH_KREISE_1);  
...
FUNC VOID DIA_CH_Runen_Info()
{
	...
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("Szósty krąg magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 6))			,DIA_CH_Runen_6);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 4)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("Piąty krąg magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 5))			,DIA_CH_Runen_5);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 3)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("Czwarty krąg magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 4))			,DIA_CH_Runen_4);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 2)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("Trzeci krąg magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 3))			,DIA_CH_Runen_3);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 1)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("Drugi krąg magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 2))			,DIA_CH_Runen_2);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) < 1)
	{ 
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("Pierwszy krąg magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 1))			,DIA_CH_Runen_1);
	};
};
//**********************************************************
// BACK
...
INSTANCE DIA_CH_Kampf_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Umiejętności bojowe";
};                       
...
INSTANCE DIA_CH_Kampf_Einhand (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Bronie jednoręczne";
};                       
...
FUNC VOID DIA_CH_Kampf_Einhand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bronie jednoręczne + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*20)		,CH_Training_Combat_1H_20);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bronie jednoręczne + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*10)		,CH_Training_Combat_1H_10);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bronie jednoręczne + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*5)		,CH_Training_Combat_1H_5);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Bronie jednoręczne + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1))		,CH_Training_Combat_1H_1);
};
...
FUNC VOID DIA_CH_Kampf_Zweihand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bronie dwuręczne + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*20)			,CH_Training_Combat_2H_20);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bronie dwuręczne + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*10)			,CH_Training_Combat_2H_10);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bronie dwuręczne + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*5)				,CH_Training_Combat_2H_5);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Bronie dwuręczne + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1))				,CH_Training_Combat_2H_1);
};
...
FUNC VOID DIA_CH_Kampf_Bogen_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Łuki + 20", 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1)*20)			,CH_Training_Combat_BOW_20);
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Łuki + 10", 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1)*10)			,CH_Training_Combat_BOW_10);
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Łuki + 5"	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1)*5)			,CH_Training_Combat_BOW_5);
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Łuki + 1"	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,CH_Training_Combat_BOW_1);
...
INSTANCE DIA_CH_Dieb_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Umiejętności złodziejskie";
};                       
...
FUNC VOID DIA_CH_Dieb_Steal_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Steal, B_BuildLearnString("Kradzież kiesz."	, B_GetLearnCostTalent(other, NPC_TALENT_PICKPOCKET, 1))		,CH_Training_Thief_Pickpocket);
};
//*********************************************
//Dieb Schleichen
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Schleichen_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Schleichen, B_BuildLearnString("Skradanie się"	, B_GetLearnCostTalent(other, NPC_TALENT_SNEAK, 1))		,CH_Training_Thief_Sneak);
};
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Picklock_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Picklock , B_BuildLearnString("Włamywanie się"	, B_GetLearnCostTalent(other, NPC_TALENT_PICKLOCK, 1))		,CH_Training_Thief_Picklock);
};
//*********************************************
...
INSTANCE DIA_CH_Dieb_Alle (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Nauka wszystkich umiejętności złodziejskich";
};                       
...
FUNC VOID DIA_CH_Dieb_Alle_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Alle , B_BuildLearnString("Wszystkie umiejętności złodziejskie", kosten_alle), CH_Training_Thief_Alle);
};
//***************************************************************************
...
INSTANCE DIA_CH_Misc_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Inne (Mikstury, Trofea, Kowalstwo, Runy Paladyna, Języki)";
};                       
...
FUNC VOID DIA_CH_Misc_Special_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Naładowanie Oka", 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, CHARGE_Innoseye)), CH_Training_Alchemy_Charge_InnosEye);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Speed] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Mikstura szybkości"	, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Speed)), CH_Training_Alchemy_POTION_Speed);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Perm_STR] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Eliksir siły"		, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_STR)), CH_Training_Alchemy_POTION_Perm_STR);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Perm_DEX] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Mikstura zręczności"		, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_DEX)), CH_Training_Alchemy_POTION_Perm_DEX);
	};
...
INSTANCE DIA_CH_Misc_Animal_allg (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zęby, skóra, pazury, serca";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_allg_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("Zęby",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Teeth)),  CH_Training_TROPHYS_Teeth);
	};
...
INSTANCE DIA_CH_Misc_Animal_Speziell (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Skrzydło, żądło, żuwaczki, płyty";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_Speziell_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Żądło krwiopijcy",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFSting)),  CH_Training_TROPHYS_BFSting);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_BFWing] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Skrzydło krwiopijcy",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWing)),  CH_Training_TROPHYS_BFWing);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_CrawlerPlate] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Płyty z pancerza pełzacza",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CrawlerPlate)),  CH_Training_TROPHYS_CrawlerPlate	);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Mandibles] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Żuwaczki",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Mandibles)),  CH_Training_TROPHYS_Mandibles	);
	};
};
//--------------------------------------------
...
INSTANCE DIA_CH_Misc_Animal_other (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Krew, łuski, rogi, język";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_other_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Język ognistego jaszczura",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FireTongue)),  CH_Training_TROPHYS_FireTongue);
	};
	
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_DrgSnapperHorn] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Róg smoczego zębacza",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_DrgSnapperHorn)),  CH_Training_TROPHYS_DrgSnapperHorn);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_DragonScale] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Smocze łuski",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_DragonScale)),  CH_Training_TROPHYS_DragonScale);
	};
...
INSTANCE DIA_CH_Misc_PalHeal (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Światło i leczenie";
};                       
