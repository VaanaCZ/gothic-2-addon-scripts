...
{	
	...
	description			= 	name;
	TEXT[2]				= 	"Velká spousta různých zbraní!";		
...
func void B_SetHeroExp() 
{
    ...
    Attributes = "Postoupil jsi na novou úroveň! Vědomostní body: ";
...
FUNC VOID  CH_Geben_Info()
{
	//B_GiveInvItems (self, other, Itmi_Nugget, 2);
		 ...
		 AI_PrintScreen ("Předat med",	 -1, 34, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Předat chléb",	 -1, 37, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Předat víno",     -1, 40, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Předat klobásu",  	 -1, 43, FONT_ScreenSmall, 2);
};
//***************************************************************************
//	Rahmen-Infos
// 	Ende
...
func VOID CH_Language_Info()
{
	...
	Info_AddChoice	(CH_Language, "Jazyk kněží (3)", CH_Language_Priest );
	Info_AddChoice	(CH_Language, "Jazyk válečníků (2)", CH_Language_Warrior );
	Info_AddChoice	(CH_Language, "Jazyk stavitelů (1)", CH_Language_Peasant );
};
...
INSTANCE CH_Level_Start (C_INFO)
{
	...
	description		= "Úroveň, vědomostní body a cech"; 
	permanent		=  TRUE;
};
...
func VOID CH_Lernpunkte_Info()
{
	...
	Info_AddChoice (CH_Lernpunkte,"Vědomostní body + 50",CH_Lernpunkte_50);
	Info_AddChoice (CH_Lernpunkte,"Vědomostní body + 25",CH_Lernpunkte_25);
	Info_AddChoice (CH_Lernpunkte,"Vědomostní body + 10",CH_Lernpunkte_10);
	Info_AddChoice (CH_Lernpunkte,"Vědomostní body + 5 ",CH_Lernpunkte_5);
};
...
FUNC VOID CH_Lernpunkte_50 ()
{
	...
	hero.LP = (hero.LP + 50);
	PrintScreen  ("+ 50 vědomostních bodů", -1,-1,FONT_Screen,3);
	Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_25 ()
{
	...
	hero.LP = (hero.LP + 25);
	PrintScreen  ("+ 25 vědomostních bodů", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_10 ()
{
	...
	hero.LP = (hero.LP + 10);
	PrintScreen  ("+ 10 vědomostních bodů", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_5 ()
{
	...
	hero.LP = (hero.LP + 5);
	PrintScreen  ("+ 5 vědomostních bodů", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
//***************************************************************************
//	Levelwahl 1- 25
...
func VOID CH_Level_niedrig_Info()
{
	...
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 21 - 25" , CH_Level21);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 16 - 20" , CH_Level16);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 11 - 15" , CH_Level11);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň  6 - 10" , CH_Level6);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň  1 -  5" , CH_Level1);
...
func VOID CH_Level_hoch_Info()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Úroveň 46 - 50" , CH_Level46);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 41 - 45" , CH_Level41);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 36 - 40" , CH_Level36);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 31 - 35" , CH_Level31);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 26 - 30" , CH_Level26);
};
//***************************************************************************
//	Level Funcs
//***************************************************************************
func void CH_Level46()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 50" , CH_Level_50);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 49" , CH_Level_49);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 48" , CH_Level_48);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 47" , CH_Level_47);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 46" , CH_Level_46);
};
func void CH_Level41()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 45" , CH_Level_45);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 44" , CH_Level_44);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 43" , CH_Level_43);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 42" , CH_Level_42);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 41" , CH_Level_41);
};
func void CH_Level36()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 40" , CH_Level_40);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 39" , CH_Level_39);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 38" , CH_Level_38);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 37" , CH_Level_37);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 36" , CH_Level_36);
};
func void CH_Level31()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 35" , CH_Level_35);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 34" , CH_Level_34);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 33" , CH_Level_33);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 32" , CH_Level_32);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 31" , CH_Level_31);
};
...
func void CH_Level26()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 30" , CH_Level_30);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 29" , CH_Level_29);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 28" , CH_Level_28);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 27" , CH_Level_27);
	Info_AddChoice		(CH_Level_hoch, "Úroveň 26" , CH_Level_26);
};  
func void CH_Level21()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 25" , CH_Level_25);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 24" , CH_Level_24);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 23" , CH_Level_23);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 22" , CH_Level_22);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 21" , CH_Level_21);
...
func void CH_Level16()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 20" , CH_Level_20);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 19" , CH_Level_19);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 18" , CH_Level_18);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 17" , CH_Level_17);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 16" , CH_Level_16);
};
...
func void CH_Level11()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 15" , CH_Level_15);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 14" , CH_Level_14);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 13" , CH_Level_13);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 12" , CH_Level_12);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 11" , CH_Level_11);
};
func void CH_Level6()
{
	Info_ClearChoices	(CH_Level_niedrig);
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK	    , CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 10" , CH_Level_10);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň  9" , CH_Level_9);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň  8" , CH_Level_8);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň  7" , CH_Level_7);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň  6" , CH_Level_6);
};
...
func void CH_Level1()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 5" 	, CH_Level_5);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 4" 	, CH_Level_4);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 3" 	, CH_Level_3);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 2" 	, CH_Level_2);
	Info_AddChoice		(CH_Level_niedrig, "Úroveň 1" 	, CH_Level_1);
};
...
FUNC VOID DIA_CH_KREISE_Info()
{
	...
	Info_AddChoice 	  (DIA_CH_KREISE,"Čtvrtý kruh", CH_KREISE_4);
	Info_AddChoice 	  (DIA_CH_KREISE,"Třetí kruh", CH_KREISE_3);
...
FUNC VOID DIA_CH_Kampf_Einhand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruční zbraně + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*20)		,CH_Training_Combat_1H_20);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruční zbraně + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*10)		,CH_Training_Combat_1H_10);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruční zbraně + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*5)		,CH_Training_Combat_1H_5);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruční zbraně + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1))		,CH_Training_Combat_1H_1);
};
...
FUNC VOID DIA_CH_Kampf_Zweihand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruční zbraně + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*20)			,CH_Training_Combat_2H_20);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruční zbraně + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*10)			,CH_Training_Combat_2H_10);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruční zbraně + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*5)				,CH_Training_Combat_2H_5);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruční zbraně + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1))				,CH_Training_Combat_2H_1);
};
...
INSTANCE DIA_CH_Dieb_Alle (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Všechny zlodějské dovednosti naučeny";
};                       
...
FUNC VOID DIA_CH_Dieb_Alle_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Alle , B_BuildLearnString("Všechny zlodějské dovednosti", kosten_alle), CH_Training_Thief_Alle);
};
//***************************************************************************
...
INSTANCE DIA_CH_Misc_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Ostatní (nápoje, trofeje, kovářské řemeslo, paladinské runy, řeči)";
};                       
...
INSTANCE DIA_CH_Misc_Alchemie (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Alchymie - umění míchat lektvary";
};                       
...
INSTANCE DIA_CH_Misc_Health (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Léčivé lektvary celkem";
};                       
