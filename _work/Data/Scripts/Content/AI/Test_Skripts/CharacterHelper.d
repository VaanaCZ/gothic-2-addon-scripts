...
{	
	name 				=	"Vak je plný nových zbraní!";
	...
	description			= 	name;
	TEXT[2]				= 	"Velká spousta rùzných zbraní!";		
	
};

	FUNC VOID Use_Sack()
	{
		Print("Našel jsi hromadu nových zbraní!");
...
func void B_SetHeroExp() 
{
    ...
    Attributes = "Postoupil jsi na novou úroveà! Vêdomostní body: ";
    Attributes = ConcatStrings(Attributes, IntToString(hero.LP));
    Attributes = ConcatStrings(Attributes, "  Životy:");
...
FUNC VOID  CH_Geben_Info()
{
	//B_GiveInvItems (self, other, Itmi_Nugget, 2);
		 ...
		 AI_PrintScreen ("Pâedat med",	 -1, 34, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Pâedat chléb",	 -1, 37, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Pâedat víno",     -1, 40, FONT_ScreenSmall, 2);
		 AI_PrintScreen ("Pâedat klobásu",  	 -1, 43, FONT_ScreenSmall, 2);
};
//***************************************************************************
//	Rahmen-Infos
// 	Ende
...
func VOID CH_Language_Info()
{
	...
	Info_AddChoice	(CH_Language, "Jazyk knêží (3)", CH_Language_Priest );
	Info_AddChoice	(CH_Language, "Jazyk váleèníkù (2)", CH_Language_Warrior );
	Info_AddChoice	(CH_Language, "Jazyk stavitelù (1)", CH_Language_Peasant );
};
...
func VOID CH_Guild_Info()
{
    ...
    Info_AddChoice	(CH_Guild, "Voják"   		, CH_SLD);
    ...
    Info_AddChoice 	(CH_Guild, "Falešný bandita"        , CH_FakeBandit);	    
};
...
INSTANCE CH_Level_Start (C_INFO)
{
	...
	description		= "Úroveà, vêdomostní body a cech"; 
	permanent		=  TRUE;
};
...
func VOID CH_Lernpunkte_Info()
{
	...
	Info_AddChoice (CH_Lernpunkte,"Vêdomostní body + 50",CH_Lernpunkte_50);
	Info_AddChoice (CH_Lernpunkte,"Vêdomostní body + 25",CH_Lernpunkte_25);
	Info_AddChoice (CH_Lernpunkte,"Vêdomostní body + 10",CH_Lernpunkte_10);
	Info_AddChoice (CH_Lernpunkte,"Vêdomostní body + 5 ",CH_Lernpunkte_5);
};
...
FUNC VOID CH_Lernpunkte_50 ()
{
	...
	hero.LP = (hero.LP + 50);
	PrintScreen  ("+ 50 vêdomostních bodù", -1,-1,FONT_Screen,3);
	Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_25 ()
{
	...
	hero.LP = (hero.LP + 25);
	PrintScreen  ("+ 25 vêdomostních bodù", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_10 ()
{
	...
	hero.LP = (hero.LP + 10);
	PrintScreen  ("+ 10 vêdomostních bodù", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
FUNC VOID CH_Lernpunkte_5 ()
{
	...
	hero.LP = (hero.LP + 5);
	PrintScreen  ("+ 5 vêdomostních bodù", -1,-1,FONT_Screen,3);
	 Snd_Play ("LEVELUP");    
};
//***************************************************************************
//	Levelwahl 1- 25
...
func VOID CH_Level_niedrig_Info()
{
	...
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 21 - 25" , CH_Level21);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 16 - 20" , CH_Level16);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 11 - 15" , CH_Level11);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà  6 - 10" , CH_Level6);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà  1 -  5" , CH_Level1);
...
func VOID CH_Level_hoch_Info()
{
	...
	Info_AddChoice		(CH_Level_hoch, "Úroveà 46 - 50" , CH_Level46);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 41 - 45" , CH_Level41);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 36 - 40" , CH_Level36);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 31 - 35" , CH_Level31);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 26 - 30" , CH_Level26);
};
//***************************************************************************
//	Level Funcs
//***************************************************************************
func void CH_Level46()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 50" , CH_Level_50);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 49" , CH_Level_49);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 48" , CH_Level_48);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 47" , CH_Level_47);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 46" , CH_Level_46);
};
func void CH_Level41()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 45" , CH_Level_45);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 44" , CH_Level_44);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 43" , CH_Level_43);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 42" , CH_Level_42);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 41" , CH_Level_41);
};
func void CH_Level36()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 40" , CH_Level_40);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 39" , CH_Level_39);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 38" , CH_Level_38);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 37" , CH_Level_37);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 36" , CH_Level_36);
};
func void CH_Level31()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 35" , CH_Level_35);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 34" , CH_Level_34);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 33" , CH_Level_33);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 32" , CH_Level_32);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 31" , CH_Level_31);
};
...
func void CH_Level26()
{
	...
	Info_AddChoice		(CH_Level_hoch,DIALOG_BACK	, CH_Level_hoch_BACK);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 30" , CH_Level_30);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 29" , CH_Level_29);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 28" , CH_Level_28);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 27" , CH_Level_27);
	Info_AddChoice		(CH_Level_hoch, "Úroveà 26" , CH_Level_26);
};  
func void CH_Level21()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 25" , CH_Level_25);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 24" , CH_Level_24);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 23" , CH_Level_23);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 22" , CH_Level_22);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 21" , CH_Level_21);
...
func void CH_Level16()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 20" , CH_Level_20);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 19" , CH_Level_19);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 18" , CH_Level_18);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 17" , CH_Level_17);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 16" , CH_Level_16);
};
...
func void CH_Level11()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 15" , CH_Level_15);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 14" , CH_Level_14);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 13" , CH_Level_13);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 12" , CH_Level_12);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 11" , CH_Level_11);
};
func void CH_Level6()
{
	Info_ClearChoices	(CH_Level_niedrig);
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK	    , CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 10" , CH_Level_10);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà  9" , CH_Level_9);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà  8" , CH_Level_8);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà  7" , CH_Level_7);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà  6" , CH_Level_6);
};
...
func void CH_Level1()
{
	...
	Info_AddChoice		(CH_Level_niedrig, DIALOG_BACK		, CH_Level_niedrig_BACK);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 5" 	, CH_Level_5);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 4" 	, CH_Level_4);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 3" 	, CH_Level_3);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 2" 	, CH_Level_2);
	Info_AddChoice		(CH_Level_niedrig, "Úroveà 1" 	, CH_Level_1);
};
...
FUNC VOID DIA_CH_Strength_Info()
{
	...
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Síla + 20"		, B_GetLearnCostAttribute(other, ATR_STRENGTH)*20)		,DIA_CH_Strength_20);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Síla + 10"		, B_GetLearnCostAttribute(other, ATR_STRENGTH)*10)		,DIA_CH_Strength_10);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Síla + 5"			, B_GetLearnCostAttribute(other, ATR_STRENGTH)*5)		,DIA_CH_Strength_5);
	Info_AddChoice	  (DIA_CH_Strength, B_BuildLearnString("Síla + 1"			, B_GetLearnCostAttribute(other, ATR_STRENGTH))			,DIA_CH_Strength_1);
...
FUNC VOID DIA_CH_Dex_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Obratnost + 20"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*20)		,DIA_CH_DEX_20);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Obratnost + 10"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*10)		,DIA_CH_DEX_10);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Obratnost + 5"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY)*5)		,DIA_CH_DEX_5);
	Info_AddChoice		(DIA_CH_Dex, B_BuildLearnString("Obratnost + 1"			, B_GetLearnCostAttribute(other, ATR_DEXTERITY))		,DIA_CH_DEX_1);
};
...
FUNC VOID DIA_CH_KREISE_Info()
{
	...
	Info_AddChoice 	  (DIA_CH_KREISE,"Šestý kruh",CH_KREISE_6);
	Info_AddChoice 	  (DIA_CH_KREISE,"Pátý kruh", CH_KREISE_5);
	Info_AddChoice 	  (DIA_CH_KREISE,"Ètvrtý kruh", CH_KREISE_4);
	Info_AddChoice 	  (DIA_CH_KREISE,"Tâetí kruh", CH_KREISE_3);
	Info_AddChoice 	  (DIA_CH_KREISE,"Druhý kruh", CH_KREISE_2);
	Info_AddChoice 	  (DIA_CH_KREISE,"První kruh",  CH_KREISE_1);  
...
FUNC VOID DIA_CH_Runen_Info()
{
	...
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("6. kruh magie"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 6))			,DIA_CH_Runen_6);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 4)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("5. kruh magie"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 5))			,DIA_CH_Runen_5);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 3)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("4. kruh magie"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 4))			,DIA_CH_Runen_4);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 2)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("3. kruh magie"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 3))			,DIA_CH_Runen_3);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 1)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("2. kruh magie"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 2))			,DIA_CH_Runen_2);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) < 1)
	{ 
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("1. kruh magie"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 1))			,DIA_CH_Runen_1);
	};
};
//**********************************************************
// BACK
...
INSTANCE DIA_CH_Kampf_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Bojové dovednosti (boj zblízka a z dálky)";
};                       
...
FUNC VOID DIA_CH_Kampf_Einhand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranê + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*20)		,CH_Training_Combat_1H_20);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranê + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*10)		,CH_Training_Combat_1H_10);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranê + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*5)		,CH_Training_Combat_1H_5);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Jednoruèní zbranê + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1))		,CH_Training_Combat_1H_1);
};
...
FUNC VOID DIA_CH_Kampf_Zweihand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranê + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*20)			,CH_Training_Combat_2H_20);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranê + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*10)			,CH_Training_Combat_2H_10);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranê + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*5)				,CH_Training_Combat_2H_5);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Obouruèní zbranê + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1))				,CH_Training_Combat_2H_1);
};
...
FUNC VOID DIA_CH_Kampf_Bogen_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Luk + 20", 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1)*20)			,CH_Training_Combat_BOW_20);
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Luk + 10", 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1)*10)			,CH_Training_Combat_BOW_10);
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Luk + 5"	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1)*5)			,CH_Training_Combat_BOW_5);
	Info_AddChoice		(DIA_CH_Kampf_Bogen, B_BuildLearnString("Luk + 1"	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,CH_Training_Combat_BOW_1);
...
FUNC VOID DIA_CH_Kampf_Armbrust_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Kuše + 20", 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1)*20)			,CH_Training_Combat_CROSSBOW_20);
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Kuše + 10", 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1)*10)			,CH_Training_Combat_CROSSBOW_10);
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Kuše + 5"	, 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1)*5)			,CH_Training_Combat_CROSSBOW_5);
	Info_AddChoice		(DIA_CH_Kampf_Armbrust, B_BuildLearnString("Kuše + 1"	, 			B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1))				,CH_Training_Combat_CROSSBOW_1);
};
...
FUNC VOID DIA_CH_Dieb_Schleichen_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Schleichen, B_BuildLearnString("Plížení"	, B_GetLearnCostTalent(other, NPC_TALENT_SNEAK, 1))		,CH_Training_Thief_Sneak);
};
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Picklock_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Picklock , B_BuildLearnString("Vykrádání"	, B_GetLearnCostTalent(other, NPC_TALENT_PICKLOCK, 1))		,CH_Training_Thief_Picklock);
};
//*********************************************
...
INSTANCE DIA_CH_Dieb_Alle (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Všechny zlodêjské dovednosti nauèeny";
};                       
...
FUNC VOID DIA_CH_Dieb_Alle_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Alle , B_BuildLearnString("Všechny zlodêjské dovednosti", kosten_alle), CH_Training_Thief_Alle);
};
//***************************************************************************
...
INSTANCE DIA_CH_Misc_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Ostatní (nápoje, trofeje, kováâské âemeslo, paladinské runy, âeèi)";
};                       
...
INSTANCE DIA_CH_Misc_Alchemie (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Alchymie - umêní míchat lektvary";
};                       
...
INSTANCE DIA_CH_Misc_Health (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Léèivé lektvary celkem";
};                       
...
FUNC VOID DIA_CH_Misc_Health_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Esence hojivé síly", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Health_01)), CH_Training_Alchemy_POTION_Health_01);	  
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Health_02] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Extrakt hojivé síly", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Health_02)), CH_Training_Alchemy_POTION_Health_02);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Health_03] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Elixír hojivé síly", B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Health_03)), CH_Training_Alchemy_POTION_Health_03);
	};
	if ( PLAYER_TALENT_ALCHEMY[POTION_Perm_Health] == FALSE)
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Trvalá hojivá síla", 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_Health)), CH_Training_Alchemy_POTION_Perm_Health);
	};
};
...
INSTANCE DIA_CH_Misc_Mana (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Lektvary many celkem";
};                       
...
FUNC VOID DIA_CH_Misc_Special_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Elixier der Síla"		, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_STR)), CH_Training_Alchemy_POTION_Perm_STR);
	};
