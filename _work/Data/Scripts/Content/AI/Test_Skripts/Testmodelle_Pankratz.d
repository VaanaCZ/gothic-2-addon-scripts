...
{	
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle síně živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle síně živý neopustíš.
	AI_Output			(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //Neuděláš takového větru. Nech nás přejít k věci.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle síně živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle síně živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle síně živý neopustíš.
	AI_Output			(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //Neuděláš takového větru. Nech nás přejít k věci.
