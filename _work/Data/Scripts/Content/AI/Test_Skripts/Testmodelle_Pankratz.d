...
{   
//************************************************************
//			Befehle fьrs JOLY_Storyhelpletter
//************************************************************
...
//**************************************
//Storyhelper light fьr die Oldworld //Joly: steht wegen verwechslungsgefahr!
//**************************************
...
FUNC VOID SH_Oldworld_KAPITEL5ANFANG()
{
	...
	B_Kapitelwechsel		(4, OLDWORLD_ZEN );
	//-------- was neu geschieht --------
	CreateInvItems (hero,ItAt_IcedragonHeart,1);			//damit man eins fьr die DI hat!!
...
INSTANCE Dragon_Testmodell	(Mst_Default_Dragon_Fire)  //Joly: Testdrachen fьr den Talk!
{
