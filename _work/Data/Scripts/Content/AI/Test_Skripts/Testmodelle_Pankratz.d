INSTANCE J1 (C_Item)
{	
	name 				=	"Wypełnia potworami obszar dodatku";
...
func VOID SH_Oldworld_INFO1_Info()
{
	...
	Info_AddChoice		( SH_Oldworld_INFO1, "Początek rozdziału"			                			, SH_Oldworld_KAPITEL1ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID SH_Oldworld_INFO2_Info()
{
	...
	Info_AddChoice		( SH_Oldworld_INFO2, "Początek rozdziału"			                			, SH_Oldworld_KAPITEL2ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID SH_Oldworld_INFO3_Info()
{
	...
	Info_AddChoice		( SH_Oldworld_INFO3, "Początek rozdziału"			                			, SH_Oldworld_KAPITEL3ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID SH_Oldworld_INFO4_Info()
{
	...
	Info_AddChoice		( SH_Oldworld_INFO4, "Początek rozdziału"			                			, SH_Oldworld_KAPITEL4ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID SH_Oldworld_INFO5_Info()
{
	...
	Info_AddChoice		( SH_Oldworld_INFO5, "Początek rozdziału"			                			, SH_Oldworld_KAPITEL5ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
...
func VOID SH_Oldworld_INFO6_Info()
{
	...
	Info_AddChoice		( SH_Oldworld_INFO6, "Początek rozdziału"			                			, SH_Oldworld_KAPITEL6ANFANG);
};
//---------------------------------------------------------------------
//	BACK
//---------------------------------------------------------------------
