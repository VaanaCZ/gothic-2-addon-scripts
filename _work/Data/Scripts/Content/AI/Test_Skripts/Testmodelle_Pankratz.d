...
{	
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle sínę živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle sínę živý neopustíš.
	AI_Output			(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //Neudęláš takového vętru. Nech nás pâejít k vęci.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle sínę živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle sínę živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, človíčku, ale tyhle sínę živý neopustíš.
	AI_Output			(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //Neudęláš takového vętru. Nech nás pâejít k vęci.
