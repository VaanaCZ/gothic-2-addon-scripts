...
{	
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, èlovíèku, ale tyhle sínì živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, èlovíèku, ale tyhle sínì živý neopustíš.
	AI_Output			(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //Neudìláš takového vìtru. Nech nás pøejít k vìci.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, èlovíèku, ale tyhle sínì živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, èlovíèku, ale tyhle sínì živý neopustíš.
	AI_Output			(self, other, "DIA_Dragon_Testmodell_Hello_20_00"); //Dostal ses daleko, èlovíèku, ale tyhle sínì živý neopustíš.
	AI_Output			(other, self, "DIA_Dragon_Testmodell_Hello_15_00"); //Neudìláš takového vìtru. Nech nás pøejít k vìci.
