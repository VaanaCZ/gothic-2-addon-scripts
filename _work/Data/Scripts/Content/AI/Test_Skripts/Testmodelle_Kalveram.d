...
INSTANCE Info_TA_Testmodell_GuideEnd (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zakoñcz Guide_Player!";
};                       
...
{
	CreateInvItems (self,ItMi_Gold,1000);	
	PrintScreen	("Otrzyma³eœ 1000 szt. z³ota", -1, 45, FONT_Screen, 2);
	Snd_Play ("Geldbeutel");
	PrintScreen	("Kara za oszustwo: doœwiadczenie -100 ", -1, 55, FONT_Screen, 2);
	if hero.exp >= 100
	{
...
{	
	name 				=	"Wejœcie do obozu bandytów";
