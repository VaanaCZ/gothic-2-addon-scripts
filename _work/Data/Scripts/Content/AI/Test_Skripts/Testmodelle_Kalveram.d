...
INSTANCE Info_TA_Testmodell_GuideStart (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Pokaż Guide_Player!";
};                       
...
INSTANCE Info_TA_Testmodell_GuideEnd (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zakończ Guide_Player!";
};                       
...
{
	CreateInvItems (self,ItMi_Gold,1000);	
	PrintScreen	("Otrzymałeś 1000 szt. złota", -1, 45, FONT_Screen, 2);
	Snd_Play ("Geldbeutel");
	PrintScreen	("Kara za oszustwo: doświadczenie -100 ", -1, 55, FONT_Screen, 2);
	if hero.exp >= 100
	{
...
{	
	...
	on_state[0]			=   UseHosh1;
	scemeName			=	"MAP";
	description			=   "Daje wszystkie runy z dodatku";
};
func void UseHosh1 ()
{   
	CreateInvItems (self,ItRu_Waterfist,1);
...
{	
	name 				=	"Wejście do obozu bandytów";
	...
	on_state[0]			=   UseHosh2;
	scemeName			=	"MAP";
	description			=   "Ustawia Player_HasTalkedToBanditCamp";
};
func void UseHosh2 ()
{   
