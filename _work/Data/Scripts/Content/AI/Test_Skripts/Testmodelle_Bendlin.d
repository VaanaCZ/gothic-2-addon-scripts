...
instance DIA_Aya_WarteHier(C_Info)
{
	...
	permanent	= TRUE;
	description	= "Obawiam się, że teraz musimy się rozstać.";
};
...
{
	AI_Output(other, self, "DIA_Biff_GELDEINTREIBEN_zuTeuer_trennen_15_00");  //Obawiam się, że teraz musimy się rozstać.
