...
// Spells, die gecastet werden solange man die Tasten gedrьckt hдlt

// Auf Programm-Seite ist das Aufrechterhalten des Spells aber die INVEST-Phase!! 
// Das bedeutet, daЯ die Damage_per_Level Angabe in der Spells_Params.d erst beim stoppen (eigentlich CASTEN) 
// des Spells aufgerufen wird! Der Abzug von Schaden beim Opfer muЯ also im zs_"Victim"-Script des Opfers erfolgen...
...
SPL_DONTINVEST 			// Es kцnnen keine weiteren Manapunkte investiert werden. Erst durch CTRL loslassen geht der Spell ab
SPL_RECEIVEINVEST		// Wirkung durchgefьhrt, es kцnnen weitere Invest kommen, zB.bei Heal nach jedem Pцppel
SPL_SENDCAST			// Starte den Zauber-Effekt (wie CTRL loslassen), automatischer Abbruch
SPL_SENDSTOP			// Beende Zauber ohne Effekt
SPL_NEXTLEVEL			// setze den Spruch auf den nдchsten Level
