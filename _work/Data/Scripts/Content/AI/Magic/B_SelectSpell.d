...
// B_SelectSpell
// -------------
// Magieauswahl fьr Menschen und Monster
// Wenn Auswahlkriterien erfьllt (je nach Gilde unterschiedlich)
// --> TRUE, sonst FALSE
...
{	
	// ------ Npctype_Friend macht hцchstens Sleep ------
	...
	&& (slf.aivar[AIV_MagicUser] == MAGIC_ALWAYS)	//Joly: "Mario und seine Freunde", Besessene Menschen (GIL_DMT) mit Nahkampfwaffen.
	{
		...
		return TRUE;		// hier immer TRUE zurьckgeben, ansonsten wird in B_SelectWeapon die Waffe wieder weggesteckt
	};
