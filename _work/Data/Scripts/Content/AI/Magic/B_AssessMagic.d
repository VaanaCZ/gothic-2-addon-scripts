...
// B_AssessMagic
// -------------
// Wahrnehmung ist fьr ALLE NSCs IMMER aktiv
// auch fьr den Spieler (s.u.)
// wir aufgerufen, sobald irgendein Spruch auf einen NSC wirkt
// setzt den NSC dan in den entsprechenden ZS
// die meisten Spells fьhren allerdings zu keinem ZS
// (sind unten nicht berьcksichtigt)
// ------------------------------------------------------------------
// Beachtem: if (Npc_GetLastHitSpellID(self) == SPL_Sleep) funzt nicht,
// weil Sleep INSTANT wirkt (d.h. sofort SENDCAST zurьckliefert)
...
{
	// ------ Bei ALLEN Spells. Damit andere NSCs den Angriff wahrnehmen kцnnen ------
