...
//-------- Addon Missionen ---------
const string TOPIC_Addon_RatHunt		= 	"Caccia al ratto";
const string TOPIC_Addon_BringMeat		=	"Carne per Morgan";
const string TOPIC_Addon_BanditsTower 	=	"La torre";
const string TOPIC_Addon_HolOwen		= 	"Legna per la palizzata";
const string TOPIC_Addon_Kompass		=	"La bussola di Garett";
const string TOPIC_Addon_RoastGrog		=	"Grog per il cuoco";
...
//-------- Addon Lehrer ------------
const string Topic_Addon_PIR_Teacher = "Imparare dai pirati";
...
const string Log_Text_Addon_TalentRune_Geyser		="Ingredienti per la runa 'Geyser': 1 acquamarina";
const string Log_Text_Addon_TalentRune_Waterfist	="Runa 'Pugno d'acqua': 1 acquamarina e 1 quarzo di montagna";
const string Log_Text_Addon_TalentRune_Thunderstorm	="Per la runa 'Tempesta': 1 quarzo di montagna e 1 ala";
