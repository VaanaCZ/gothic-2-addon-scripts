...
// Die Funktionen mьssen so heissen wie die zen-files
// *******************************************************************
...
func void STARTUP_ADDON_PART_GOLDMINE_01 ()
{
	...
	//------------ Monster ANZAHL (10) WICHTIG fьr Garaz (FIXME_FILLER) ----------------------------
...
func void STARTUP_ADDON_PART_ENTRANCE_01 ()
{
	...
	Wld_InsertNpc (VLK_4304_Addon_William,"ADW_ENTRANCE"); 			//Unterhalpb des Hьgels, auf der PIR Seite
...
FUNC VOID STARTUP_ADDON_PART_BANDITSCAMP_01()
{
	...
	Wld_InsertNpc (BDT_1077_Addon_Bandit,"BANDIT");//EX Hдndler
	...
	Wld_InsertNpc (BDT_1097_Addon_Fisk,"BANDIT");//Hдndler
...
{
	//--------- Piraten --------------------------
	Wld_InsertNpc (PIR_1350_Addon_Francis,"STRAND");		//Vor Gregs Hьtte -->SitBench
	Wld_InsertNpc (PIR_1351_Addon_Samuel,"STRAND");			//In der Hцhle    
	Wld_InsertNpc (PIR_1353_Addon_Morgan,"STRAND");			//Vor Sams Hцhle
	...
	Wld_InsertNpc (PIR_1367_Addon_Owen,"STRAND");			//Holzfдlelrlager
	Wld_InsertNpc (PIR_1368_Addon_Malcom,"STRAND");			//tot ind er geheimen Hцhle
	...
	Wld_InsertItem (ItAm_Addon_STR,"FP_ITEMSPAWN_LONEBEACH_02");	//-->Feuerwaranstrand in der Hцhle
/*
	...
	Wld_InsertItem (XXX,"FP_ITEMSPAWN_SECRETCAVE_01");	//-->In der unterirdische Stunthцhle
	...
	Wld_InsertItem (XXX,"FP_ITEMSPAWN_BEACH_02");		//-->Piratenstrand, hinter der ersten Hьtte
	...
	Wld_InsertItem (XXX,"FP_ITEMSPAWN_LURKERBEACH_03");	//-->Lurkerstrand Hцhle
...
func void STARTUP_OLDCAMP ()
{
	...
	func void INIT_SUB_OLDCAMP()
	{
		...
		// ------ PORTAL-RДUME ------		//GroЯ- und Kleinschreibung beachten!
		...
		//Brutus
		Wld_AssignRoomToGuild("tu1", GIL_NONE); //wegen Mission besser gil_none (lдuft raus)
		
		//Wehrgдnge
		Wld_AssignRoomToGuild("he3", GIL_NONE); //einzelner Raum ьber Knast
		...
		Wld_AssignRoomToGuild("hh3",	GIL_PUBLIC); //Kьche
...
//*******************************************************
	...
	//-------------Jдger Camp im Lager ьber ehem. Cavalorns Hьtte---------------------------
	...
	//-------------Hцhle von Cavalorns Hьtte---------------------------
	Wld_InsertNpc		(PAL_217_Marcos,"OC1");
	
	//-------------Entflohene Strдflinge im spдteren DJG Vorposten Camp---------------------------------------------------------
	...
	Wld_InsertNpc		(VLK_4110_Jergan,"OC1"); //Spдher		
...
//*******************************************************
	...
	Wld_InsertItem		(ItSe_DiegosTreasure_Mis,"WP_INTRO_WI15"); 
		...
		// hinter der Brьcke gegenьber der verlassenen Mine
	...
	Wld_InsertNpc		(Snapper,"OW_PATH_1_5_A"); 
		...
		// zwischen ehem. Ratford und Brьcke zum OC
	...
	// entschдfter alternativ Weg zur Newmine
...
//--------------------------------------------------------------------------	
	...
	*/
	...
	//------------------Mine 2 zu Banditenlager  Die Brьcken--------------------------
	...
	//ehem. Neks Hцhle, Gothic2 Gorns Versteck----------------
	...
	//Hцhle unter Wasserfall nahe Iceregion
	...
	// umgestьrtzter Demonenbeschwцrer Turm im Wasser
	...
	//------------------------------------------------------------
		...
		// Hцhle auf Bergweg vor Milten Nдhe Stonehenge
	...
	// Gebiet um Stonehenge
   	...
   	Wld_InsertNpc		(SkeletonMage_Angar,"OW_UNDEAD_DUNGEON_03"); //Joly: in der Hцhle
    ...
    //-------------------------FELSENFESTUNG: RockDragon------------------------
 	// Berggebiet vor Brьcke (ehemaliges Bloodhound-gebiet)
	...
	// --------ITEMS in den vergessenen Hцhlen/Locations -----------------
...
FUNC VOID INIT_OLDWORLD ()
{
	...
	if (MIS_ReadyForChapter4  == TRUE )	//Joly: muЯ hier in der INIT ganz zum schluss stehen, nachdem alle NSCs fьrs Kapitel insertet wurden!!!
...
func void STARTUP_NewWorld_Part_City_01()
{
	...
	Wld_InsertNpc (VLK_499_Buerger		, "NW_CITY_ENTRANCE_01");	//OV-Bьrger. IЯt an Stand, Smalltalk im OV, pennt iv ??? (OV)
	Wld_InsertNpc (VLK_416_Matteo		, "NW_CITY_ENTRANCE_01");	//Ausrьstungs-Hдndler, pennt in NW_City_Bed_Matteo
	...
	Wld_InsertNpc (VLK_426_Buergerin	, "NW_CITY_ENTRANCE_01");	//Zuhцrerin, nachts vor Stadtkneipe
	Wld_InsertNpc (VLK_428_Buergerin	, "NW_CITY_ENTRANCE_01");	//Zuhцrerin, nachts Smalltalk Bierstand
	Wld_InsertNpc (VLK_450_Buerger		, "NW_CITY_ENTRANCE_01");	//Zuhцrer, nachts vor Stadtkneipe
	Wld_InsertNpc (VLK_454_Buerger		, "NW_CITY_ENTRANCE_01");	//Zuhцrer, nachts an Blubber
	Wld_InsertNpc (VLK_455_Buerger		, "NW_CITY_ENTRANCE_01");	//Zuhцrer, nachts Smalltalk Bierstand
	Wld_InsertNpc (VLK_421_Valentino	, "NW_CITY_ENTRANCE_01"); 	//OV-Bьrger, 
	//------------------------------	
	...
	Wld_InsertNpc (VLK_456_Abuyin		, "NW_CITY_ENTRANCE_01");	//Wasserpfeifen-Hдndler, pennt in Hotel
	...
	//---Marktplatz--------------------
	Wld_InsertNpc (VLK_407_Hakon		, "NW_CITY_ENTRANCE_01");	//Waffenhдndler, nachts in Hotel
	Wld_InsertNpc (VLK_408_Jora			, "NW_CITY_ENTRANCE_01");	//Krдmer, nachts in Hotel
	Wld_InsertNpc (VLK_409_Zuris		, "NW_CITY_ENTRANCE_01");	//Trankhдndler, nachts in Zuris Haus
	Wld_InsertNpc (VLK_410_Baltram		, "NW_CITY_ENTRANCE_01");	//Lebensmittelhдndler, nachts in Hotel
	Wld_InsertNpc (VLK_470_Sarah		, "NW_CITY_ENTRANCE_01");	//Waffenhдndlerin (Canthars Opfer), nachts in Hotel
	...
	Wld_InsertNpc (VLK_415_Meldor		, "NW_CITY_ENTRANCE_01"); 	//Einer von Lehmars Schlдgern, pennt in hafen03
	...
	Wld_InsertNpc (VLK_479_Lucy	, "NW_CITY_ENTRANCE_01"); 	//Alwins Frau, Gдrtnerin, NW_City_Pick_02, pennt in hafen02
	...
	Wld_InsertNpc (VLK_453_Buerger		, "NW_CITY_ENTRANCE_01");	//Sдgt, pennt in hafen06
	Wld_InsertNpc (VLK_430_Buergerin	, "NW_CITY_ENTRANCE_01"); 	//Frau vom Sдger, pennt in hafen 06
	
	//---Forscher----------
	Wld_InsertNpc (VLK_498_Ignaz		, "NW_CITY_ENTRANCE_01"); 	//verrьckter Forscher, hafen09, lebt und pennt da
	
	//---Platz E----------- (Edda)
	Wld_InsertNpc (VLK_471_Edda			, "NW_CITY_ENTRANCE_01"); 	//Kocht fьr die Armen, pennt in hafen08 - NW_City_Habour_Poor_Area_Hut_06_Bed_02
	//Bett frei (Bed_01)

	//---Platz F----------- (Fellan)
	Wld_InsertNpc (VLK_480_Fellan		, "NW_CITY_ENTRANCE_01"); 	//irrer Hдmmerer, pennt in FELLAN - NW_City_Habour_Hut_05_Bed_01
	Wld_InsertNpc (VLK_478_Buergerin	, "NW_CITY_ENTRANCE_01"); 	//Fellans Frau, Gдrtnerin, NW_City_Pick_01, pennt in FELLAN
	...
	Wld_InsertNpc (VLK_444_Jack			, "NW_CITY_ENTRANCE_01");	//am Kai, wartet, daЯ der Leuchtturm frei wird
	...
	Wld_InsertNpc (VLK_434_Borka	 	, "NW_CITY_ENTRANCE_01");	//Tьrsteher Puff 24h
	...
	Wld_InsertNpc (VLK_476_Fenia	   	, "NW_CITY_ENTRANCE_01"); 	//Halvors Frau, Hдndlerin auf Hafenstrasse, pennt in FISCH
	...
	Wld_InsertItem			(ItMi_Moleratlubric_MIS,"FP_ITEM_SHIP_07");	//zur Sicherheit fьr Vinos Brennerei!
	...
	Wld_InsertNpc (Mil_313_Boltan		, "NW_CITY_ENTRANCE_01");	//Gefдngniswдrter
	...
	//Wld_InsertNpc		(VLK_463_Buerger	, "NW_CITY_ENTRANCE_01"); // SMALLTALK  GEMЬSE
	//Wld_InsertNpc		(VLK_464_Buerger	, "NW_CITY_ENTRANCE_01"); // SMALLTALK  GEMЬSE
	//Wld_InsertNpc		(VLK_465_Buerger	, "NW_CITY_ENTRANCE_01"); // DRINKING 	GEMЬSE
	
	//Wld_InsertNpc		(VLK_483_Buergerin	, "NW_CITY_ENTRANCE_01"); // SMALLTALK  GEMЬSE
	//Wld_InsertNpc		(VLK_490_Buergerin	, "NW_CITY_ENTRANCE_01"); // SMALLTALK  GEMЬSE

	//Wld_InsertNpc		(VLK_4200_Buergerin	, "NW_CITY_ENTRANCE_01"); //Smalltalk

	//ADDON>
	//Piratenlager an der Kьste
	...
	//---oberes Viertel-------------------
	//------------------------------------
	Wld_InsertNpc		(Mil_304_Torwache	, "NW_CITY_ENTRANCE_01");	//Torwache Bьrgerviertel 24h
	Wld_InsertNpc		(Mil_305_Torwache	, "NW_CITY_ENTRANCE_01");	//Torwache Bьrgerviertel Important 24h
	//------------------------------------
...
FUNC VOID STARTUP_NewWorld_Part_Monastery_01 ()
{
	...
	Wld_InsertNpc 	(NOV_601_Igaraz, 	"NW_MONASTERY_ENTRY_01");	//Erwдhlter im Smalltalk im Hof
	Wld_InsertNpc 	(NOV_603_Agon, 		"NW_MONASTERY_ENTRY_01");	//Krдutergarten
	Wld_InsertNpc 	(NOV_604_Dyrian, 	"NW_MONASTERY_ENTRY_01");	//
	Wld_InsertNpc 	(NOV_605_Opolos, 	"NW_MONASTERY_ENTRY_01");	//Hьtet Schafe
	...
	FUNC VOID INIT_SUB_NewWorld_Part_Monastery_01()
	{
		...
		Wld_AssignRoomToGuild ("kloster02",GIL_PUBLIC); //Bьcherei
...
FUNC VOID STARTUP_NewWorld_Part_GreatPeasant_01 ()
{
	...
	//3 rausgenommen, wegen Fester-> werden spдter insertet
...
//Jдgerlager
	...
	FUNC VOID INIT_SUB_NewWorld_Part_GreatPeasant_01()
	{
		...
		Wld_AssignRoomToGuild ("grpwaldhuette02",	GIL_PUBLIC); //Banditenhьtte
	};
...
{	
	...
	CurrentLevel = ADDONWORLD_ZEN;	 
	Wld_SetTime	(60,00);//Joly: KDW sind schon 2 Tag da. SC hat ein biosschen lдnger gebraucht.
};
