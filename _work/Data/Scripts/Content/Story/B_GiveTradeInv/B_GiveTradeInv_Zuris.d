...
FUNC VOID B_GiveTradeInv_Zuris (var C_NPC slf)
{
	...
	&& (Zuris_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		CreateInvItems (slf,ItMi_ApfelTabak	,2); //fьr Abuyin
		CreateInvItems (slf,ItWr_Astronomy_Mis,1);	//Fьr  Mission HygalsBringBook
		CreateInvItems (slf,ItFo_Addon_Pfeffer_01,1);//FЬR Mission fortuno
