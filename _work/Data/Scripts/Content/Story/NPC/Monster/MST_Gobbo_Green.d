...
prototype Mst_Default_Gobbo_Green (C_NPC)			
{
	...
	// ------ Damage Types ------						//entweder EIN damagetype oder mehrere damage[x], die dann addiert werden und getrennten Rьstungsabzug bekommen
	damagetype 						=	DAM_EDGE;
...
INSTANCE Gobbo_Green (Mst_Default_Gobbo_Green)
{
	...
	Npc_SetToFightMode (self, ItMw_1h_Bau_Mace); //Waffe ist nur Optik - Schaden wird NUR ьber STR bestimmt (Gobbo ist als Monster im Fistmode)
};
