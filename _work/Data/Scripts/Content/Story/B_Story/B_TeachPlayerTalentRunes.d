...
func int B_TeachPlayerTalentRunes (var C_NPC slf, var C_NPC oth, var int spell)
{
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'světlo': 1 zlaťák.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'ledový šíp': 1 křemen z ledovce");};		
	if (spell == SPL_LightHeal)				{	PLAYER_TALENT_RUNES[SPL_LightHeal] 				= TRUE;	CreateInvItems (ScrollTrader, ItSc_LightHeal, 1);				
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'léčba lehkých zranění': 1 léčivá rostlina.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'vytvoření gobliního kostlivce': 1 gobliní kost.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'větrná pěst': 1 uhlík.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'léčba středně těžkých zranění': 1 léčivá bylina.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'blesk': 1 kamenný krystal a 1 křemen z ledovce.");	};	
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'vytvoření kostlivce': 1 kost z kostlivce.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'ledový blok': 1 křemen z ledovce a 1 akvamarín.");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'zničení nemrtvých': 1 svěcená voda.");	};		
	if (spell == SPL_Pyrokinesis)			{	PLAYER_TALENT_RUNES[SPL_Pyrokinesis] 			= TRUE;	CreateInvItems (ScrollTrader, ItSc_Pyrokinesis, 1);				
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'velká ohnivá bouře': 1 síra a 1 jazyk ohnivého ještěra.");	};		
	if (spell == SPL_Firestorm)				{	PLAYER_TALENT_RUNES[SPL_Firestorm] 				= TRUE;	CreateInvItems (ScrollTrader, ItSc_Firestorm, 1);				
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'malá ohnivá bouře': 1 síra a 1 smola.");	};		
	if (spell == SPL_IceWave)				{	PLAYER_TALENT_RUNES[SPL_IceWave] 				= TRUE;	CreateInvItems (ScrollTrader, ItSc_IceWave, 1);					
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'ledová vlna': 1 křemen z ledovce a 1 akvamarín");	};		
	...
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'léčba těžkých zranění': 1 léčivý kořen");	};	
	if (spell == SPL_Firerain)				{	PLAYER_TALENT_RUNES[SPL_Firerain] 				= TRUE;	CreateInvItems (ScrollTrader, ItSc_Firerain, 1);				
	B_LogEntry (TOPIC_TalentRunes,"Ingredience pro runu 'ohnivý déšť': 1 smola a 1 jazyk ohnivého ještěra.");	};		
