// ******************************************************************************************************
//  			B_NPC_IsAliveCheck			(fьr NPCs die eine Levelchange vollziehen)
// ******************************************************************************************************
var int SLD_Bullco_is_alive;	//Check, ob die SLD noch leben und zum Drachenjдger gemacht werden kцnnen.
...
// ***********************************************************
	if (Zen == NEWWORLD_ZEN )
	{
		...
		{
			// 	Drachenjдger	(Check, ob die SLD noch leben und zum Drachenjдger gemacht werden kцnnen.)
			// ***********************************************************
...
// ***********************************************************
	...
	if (Zen == OLDWORLD_ZEN )
	{
		...
		if (Kapitel >= 4)
		{
			// 	Drachenjдger	(Check, wer nach der Drachenjagd in die NEWWORLD geht.)
			// ***********************************************************
