...
FUNC VOID B_ENTER_OLDWORLD_Kapitel_4 ()
{
	if (EnterOW_Kapitel4 == FALSE)	// Inserten der Drachenjäger wenn Drachenjagd eröffnet
		...
		if ((Npc_IsDead(Engrom)) == FALSE)
			{
			B_StartOtherRoutine (Engrom,"Posedlý");
		...
		// ------ TAs ändern ------
		Npc_ExchangeRoutine	(Brutus,"Žravé štênice");  
	...
	// Kapitel2 Canyon "Gilbert´s Höhle"
		...
		B_LogEntry (TOPIC_Dragonhunter,"Zaèal velký lov na draky, který do Hornického údolí pâilákal spoustu rádoby dobrodruhù. Mohu jen doufat, že se mi nepâipletou do cesty."); 
