...
func int B_TeachPlayerTalentTakeAnimalTrophy (var C_NPC slf, var C_NPC oth, var int trophy)
{
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...získat zuby rùzných zvíâat.");};
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...vyjmout jazyk ohnivým ještêrùm.");};
	if (trophy == TROPHY_BFWing) 			{	PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_BFWing] 			= TRUE;	
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...oddêlit krvavým mouchám kâídla.");};
	...
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...získat krunýâe dùlních èervù.");};
	if (trophy == TROPHY_DrgSnapperHorn)	{	PLAYER_TALENT_TAKEANIMALTROPHY[TROPHY_DrgSnapperHorn] 	= TRUE;	
	B_LogEntry (TOPIC_TalentAnimalTrophy,"...vyjmout rohy draèím chàapavcùm.");};
	if (trophy == TROPHY_DragonScale) 		{	
												...
												B_LogEntry (TOPIC_TalentAnimalTrophy,"...získat šupiny z têl mrtvých drakù.");	
											};
