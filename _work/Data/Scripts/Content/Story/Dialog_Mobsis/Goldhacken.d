...
INSTANCE PC_Goldhacken_Addon_Hour (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Dai solo un colpetto."; 
};
	...
	if (B_GoldMob_Bestimmung() == TRUE)
	{
		if (CurrentChance <= Hero_HackChance)
		{
			...
			&& (MultiNugget >= 8)
			{
				...
				PrintScreen ("3 pepite d'oro estratte!", -1, -1, FONT_ScreenSmall, 2);	
				Truemmer_Count = 0;
			...
			&& (MultiNugget >= 5)
			{
				...
				PrintScreen ("2 pepite d'oro estratte!", -1, -1, FONT_ScreenSmall, 2);	
				Truemmer_Count = 0;
			...
			else
			{
				...
				PrintScreen ("1 pepita d'oro estratta!", -1, -1, FONT_ScreenSmall, 2);	
				Truemmer_Count = 0;
				GoldCounter = (GoldCounter +1);
			};
		}
...
INSTANCE PC_Goldhacken_Addon_TSchlag (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vibra un colpo deciso."; 
};
