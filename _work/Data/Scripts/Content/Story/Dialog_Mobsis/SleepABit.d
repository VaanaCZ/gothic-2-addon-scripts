...
INSTANCE PC_SleepTime_Morning (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir hasta la mañana siguiente";
};
...
INSTANCE PC_SleepTime_Noon (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir hasta el mediodía";
};
...
INSTANCE PC_SleepTime_Evening (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir hasta el siguiente atardecer";
};
...
instance PC_SleepTime_Midnight (C_INFO)
{
	...
	important		= 0;
	permanent		= 1;
	description		= "Dormir hasta medianoche";
};
