...
INSTANCE PC_PrayShrine_Paladine (C_Info)
{
	...
	permanent		= FALSE;
	description		= "Zmów modlitwę za paladynów."; 
};
...
FUNC VOID PC_PrayShrine_Pray_Info()
{
	if (ShrineIsObsessed == TRUE)
		...
		{		
			...
			Info_AddChoice (PC_PrayShrine_Pray,"Chcę się pomodlić.",PC_PrayShrine_Pray_NoPay);
			
			if (Npc_HasItems (hero,ItMi_Gold) >=10)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"Chcę się pomodlić i złożyć ofiarę 10 sztuk złota.",PC_PrayShrine_Pray_SmallPay);
			};
			if (Npc_HasItems (hero,ItMi_Gold) >=50)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"Chcę się pomodlić i złożyć ofiarę 50 sztuk złota.",PC_PrayShrine_Pray_MediumPay);
			};
			if (Npc_HasItems (hero,ItMi_Gold) >=100)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"Chcę się pomodlić i złożyć ofiarę 100 sztuk złota.",PC_PrayShrine_Pray_BigPay);
			};
		};
}; 
