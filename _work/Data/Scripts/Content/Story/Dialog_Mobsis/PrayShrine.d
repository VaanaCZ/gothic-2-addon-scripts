...
INSTANCE PC_PrayShrine_Paladine (C_Info)
{
	...
	permanent		= FALSE;
	description		= "ѕомолитьс€ за паладинов."; 
};
...
FUNC VOID PC_PrayShrine_Pray_Info()
{
	if (ShrineIsObsessed == TRUE)
		...
		{		
			...
			Info_AddChoice (PC_PrayShrine_Pray,"я хочу помолитьс€ и пожертвовать 0 золотых монет.",PC_PrayShrine_Pray_NoPay);
			
			if (Npc_HasItems (hero,ItMi_Gold) >=10)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"я хочу помолитьс€ и пожертвовать 10 золотых монет.",PC_PrayShrine_Pray_SmallPay);
			};
			if (Npc_HasItems (hero,ItMi_Gold) >=50)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"я хочу помолитьс€ и пожертвовать 50 золотых монет.",PC_PrayShrine_Pray_MediumPay);
			};
			if (Npc_HasItems (hero,ItMi_Gold) >=100)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"я хочу помолитьс€ и пожертвовать 100 золотых монет.",PC_PrayShrine_Pray_BigPay);
			};
		};
}; 
