...
INSTANCE PC_PrayShrine_HEALSHRINE (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Purifier sanctuaire"; 
};
...
INSTANCE PC_PrayShrine_Paladine (C_Info)
{
	...
	permanent		= FALSE;
	description		= "Dire une prière pour les paladins."; 
};
...
FUNC VOID PC_PrayShrine_Pray_Info()
{
	if (ShrineIsObsessed == TRUE)
		...
		{		
			...
			Info_AddChoice (PC_PrayShrine_Pray,"Je veux prier et donner 0 pièce d'or.",PC_PrayShrine_Pray_NoPay);
			
			if (Npc_HasItems (hero,ItMi_Gold) >=10)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"Je veux prier et donner 10 pièces d'or.",PC_PrayShrine_Pray_SmallPay);
			};
			if (Npc_HasItems (hero,ItMi_Gold) >=50)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"Je veux prier et donner 50 pièces d'or.",PC_PrayShrine_Pray_MediumPay);
			};
			if (Npc_HasItems (hero,ItMi_Gold) >=100)
			{
				Info_AddChoice (PC_PrayShrine_Pray,"Je veux prier et donner 100 pièces d'or.",PC_PrayShrine_Pray_BigPay);
			};
		};
}; 
