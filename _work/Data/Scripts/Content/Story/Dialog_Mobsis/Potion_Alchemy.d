...
INSTANCE PC_Booze_Schlaf (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Il Martello di Lou con il doppio di rum"; 
};
...
INSTANCE PC_Booze_SchnellerHering (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Prepara un'Aringa furiosa"; 
};
...
INSTANCE PC_Mana_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Prepara pozioni del mana"; 
};
...
INSTANCE PC_ItPo_Mana_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Essenza di mana (2 ortiche del fuoco, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_ItPo_Mana_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Estratto di mana (2 erbe del fuoco, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_ItPo_Mana_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elisir di mana (2 radici del fuoco, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_ItPo_Mana_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pozione del mana (3 essenze di mana, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_Health_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Prepara pozioni curative"; 
};
...
INSTANCE PC_ItPo_Health_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Essenza curativa (2 piante curative, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_ItPo_Health_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Estratto curativo (2 erbe curative, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_ItPo_Health_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elisir curativo (2 radici curative, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_ItPo_Health_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pozioni curative (3 essenze di mana, 1 groviglio della prateria)"; 
};
...
INSTANCE PC_Special_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Prepara pozioni speciali"; 
};
...
INSTANCE PC_ItPo_Addon_Geist (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elisir di alterazione mentale"; 
};
...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elisir della vita (1 radice curativa, 1 acetosella del re)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elisir dello spirito (1 radice del fuoco, 1 acetosella del re)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pozione della destrezza (1 bacca del goblin, 1 acetosella del re)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pozione della forza (1 radice del drago, 1 acetosella del re)"; 
};
...
INSTANCE PC_Tabak_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Mescola il tabacco e arrotola sigari"; 
};
...
INSTANCE PC_ItMi_Addon_Joint_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Prepara un novizio verde (1 sigaro)"; 
};
...
INSTANCE PC_ItMi_Tabak (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Mescola il tabacco..."; 
};
...
FUNC VOID PC_ItMi_Tabak_Info ()
{
	...
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...con il miele",PC_ItMi_Tabak_Honey);
	};
	if (Npc_HasItems (hero, ItPl_SwampHerb) >=1)
	{
	...
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...con il fungo velenoso",PC_ItMi_Tabak_Mushroom_01);
	};
...
INSTANCE PC_ItPo_MegaDrink (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pozione di uova di drago (10 uova di drago, 1 perla nera, 1 zolfo)"; 
};
