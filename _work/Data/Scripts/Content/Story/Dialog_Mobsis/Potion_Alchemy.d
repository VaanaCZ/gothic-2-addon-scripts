...
INSTANCE PC_Booze_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Destilovat koøalku"; 
};
...
INSTANCE PC_ItPo_Mana_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Esence many (2 ohnivé kopøivy, 1 luèní pohanka)"; 
};
...
INSTANCE PC_ItPo_Mana_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Extrakt many (2 ohnivé býlí, 1 luèní pohanka)"; 
};
...
INSTANCE PC_ItPo_Mana_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír many (2 ohnivé koøeny, 1 luèní pohanka)"; 
};
...
INSTANCE PC_ItPo_Health_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír hojivé síly (2 léèivé koøeny, 1 luèní pohanka)"; 
};
...
INSTANCE PC_ItPo_Health_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar èisté životní energie (3 esence hojivé síly, 1 luèní pohanka)"; 
};
...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír života (1 léèivý koøen, 1 královský šovík)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír ducha (1 ohnivý koøen, 1 královský šovík)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar obratnosti (1 gobliní bobule, 1 královský šovík)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar síly (1 draèí koøen, 1 královský šovík)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar rychlosti (1 chòapavèí býlí, 1 luèní pohanka)"; 
};
