...
INSTANCE PC_Booze_Schlaf (C_Info)
{
	...
	permanent		= TRUE;
	description		= "El martillo de Lou con doble de ron"; 
};
...
INSTANCE PC_Booze_SchnellerHering (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Preparar un arenque veloz"; 
};
...
INSTANCE PC_Charge_InnosEye (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Recargar el Ojo de Innos."; 
};
...
INSTANCE PC_Special_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Prepara pociones especiales"; 
};
...
INSTANCE PC_ItMi_Addon_Joint_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Haz un novicio verde (1 cigarro)"; 
};
...
FUNC VOID PC_ItMi_Tabak_Info ()
{
	...
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"... con miel",PC_ItMi_Tabak_Honey);
	};
	if (Npc_HasItems (hero, ItPl_SwampHerb) >=1)
	{
	...
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"... con setas tenebrosas",PC_ItMi_Tabak_Mushroom_01);
	};
