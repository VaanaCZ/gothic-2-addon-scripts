...
INSTANCE PC_Booze_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Destilovat kořalku"; 
};
...
INSTANCE PC_Booze_Lou (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vyzkoušej Louův cloumák..."; 
};
...
INSTANCE PC_Booze_Schlaf (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Louův cloumák s dvojitou dávkou rumu."; 
};
...
INSTANCE PC_ItPo_Mana_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Esence many (2 ohnivé kopřivy, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Mana_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír many (2 ohnivé kořeny, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Mana_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Mana potion (3 esence many, 1 luční pohanka)"; 
};
...
INSTANCE PC_Health_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Namíchat léčivé lektvary"; 
};
...
INSTANCE PC_ItPo_Health_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír hojivé síly (2 léčivé kořeny, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Health_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar čisté životní energie (3 esence hojivé síly, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItPo_Addon_Geist (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar pozměněné mysli"; 
};
...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír života (1 léčivý kořen, 1 královský šťovík)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír ducha (1 ohnivý kořen, 1 královský šťovík)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar obratnosti (1 gobliní bobule, 1 královský šťovík)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar síly (1 dračí kořen, 1 královský šťovík)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar rychlosti (1 chňapavčí býlí, 1 luční pohanka)"; 
};
...
INSTANCE PC_ItMi_Joint (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Ubalit trávu z bažin (1 špek)"; 
};
