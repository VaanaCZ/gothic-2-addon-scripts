...
INSTANCE PC_Booze_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Brûler de l'alcool"; 
};
...
INSTANCE PC_Booze_Lou (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Essayer le Marteau de Lou..."; 
};
...
INSTANCE PC_Booze_Schlaf (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Le Marteau de Lou avec une double dose de rhum."; 
};
...
INSTANCE PC_Booze_SchnellerHering (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Mélanger un Hareng pressé"; 
};
...
INSTANCE PC_Charge_InnosEye (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Recharger l'Œil d'Innos"; 
};
...
INSTANCE PC_Mana_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Brasser des potions de mana"; 
};
...
INSTANCE PC_ItPo_Mana_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Essence de mana (2 orties de feu, 1 nœud de prairie)"; 
};
...
INSTANCE PC_ItPo_Mana_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Extrait de mana (2 herbes de feu, 1 nœud de prairie)"; 
};
...
INSTANCE PC_ItPo_Mana_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir de mana (2 racines de feu, 1 nœud de prairie)"; 
};
...
INSTANCE PC_ItPo_Mana_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Potion de mana (3 essences de mana, 1 nœud de prairie)"; 
};
...
INSTANCE PC_Health_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Brasser des potions de soins"; 
};
...
INSTANCE PC_ItPo_Health_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Essence médicinale (2 plantes médicinales, 1 nœud de prairie)"; 
};
...
INSTANCE PC_ItPo_Health_02 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Extrait médicinal (2 herbes médicinales, 1 nœud de prairie)"; 
};
...
INSTANCE PC_ItPo_Health_03 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir médicinal (2 racines médicinales, 1 nœud de prairie)"; 
};
...
INSTANCE PC_ItPo_Health_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "potion de soins (3 essences de soin, 1 nœud de prairie)"; 
};
...
INSTANCE PC_Special_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Brasser des potions spéciales"; 
};
...
INSTANCE PC_ItPo_Addon_Geist (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir d'altération mentale"; 
};
...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir de vie (1 racine médicinale, 1 oseille royale)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir de l'esprit (1 racine de feu, 1 oseille royale)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Potion de dextérité (1 baie gobeline, 1 oseille royale)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Potion de force (1 racine de dragon, 1 oseille royale)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Potion de rapidité (1 herbe faucheuse, 1 nœud de prairie)"; 
};
...
INSTANCE PC_Tabak_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Mélanger du tabac et rouler un joint"; 
};
...
INSTANCE PC_ItMi_Joint (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Préparer l'herbe des marais (1 joint)"; 
};
...
INSTANCE PC_ItMi_Addon_Joint_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Rouler un novice vert (1 joint)"; 
};
...
FUNC VOID PC_ItMi_Tabak_Info ()
{
	...
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...avec du miel",PC_ItMi_Tabak_Honey);
	};
	if (Npc_HasItems (hero, ItPl_SwampHerb) >=1)
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...avec de l'herbe des marais",PC_ItMi_Tabak_Swampherb);
	};
	if (Npc_HasItems (hero, ItPl_Mushroom_01) >=1)
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...avec du champignon noir",PC_ItMi_Tabak_Mushroom_01);
	};
...
INSTANCE PC_ItPo_MegaDrink (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Potion d'œufs de dragon (10 œufs de dragon, 1 perle noire, 1 dose de souffre)"; 
};
