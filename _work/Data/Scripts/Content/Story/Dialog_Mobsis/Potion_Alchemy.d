...
INSTANCE PC_Booze_Lou (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Spróbuj przygotować Młot Lou..."; 
};
...
INSTANCE PC_Booze_Schlaf (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Młot Lou z podwójną zawartością rumu."; 
};
...
INSTANCE PC_Booze_SchnellerHering (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Zmieszaj Szybkiego śledzia."; 
};
...
INSTANCE PC_Charge_InnosEye (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Ponowne naładuj Oko Innosa"; 
};
...
INSTANCE PC_ItPo_Mana_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pełnia many (3 esencje many, 1 rdest polny)"; 
};
...
INSTANCE PC_ItPo_Health_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Esencja lecznicza (2 rośliny lecznicze, 1 rdest polny)"; 
};
...
INSTANCE PC_ItPo_Health_04 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Pełnia życia (3 esencje lecznicze, 1 rdest polny)"; 
};
...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Eliksir życia (1 korzeń leczniczy, 1 szczaw królewski)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Eliksir ducha (1 ognisty korzeń, 1 szczaw królewski)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Mikstura zręczności (1 porcja goblinich jagód, 1 szczaw królewski)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Mikstura siły (1 smoczy korzeń, 1 szczaw królewski)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Mikstura szybkości (1 zębate ziele, 1 rdest polny)"; 
};
...
INSTANCE PC_Tabak_Start (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Zmieszaj tytoń i zwiń łodygi"; 
};
...
INSTANCE PC_ItMi_Joint (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Przekształcenie bagiennego ziela (1 łodyga)"; 
};
...
INSTANCE PC_ItMi_Addon_Joint_01 (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Zrób zielonego nowicjusza (1 łodyga)"; 
};
...
FUNC VOID PC_ItMi_Tabak_Info ()
{
	...
	{
		Info_AddChoice 	(PC_ItMi_Tabak,"...z mułowym grzybem",PC_ItMi_Tabak_Mushroom_01);
	};
...
INSTANCE PC_ItPo_MegaDrink (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Mikstura ze smoczych jaj (10 smoczych jaj, 1 czarna perła, 1 porcja siarki)"; 
};
