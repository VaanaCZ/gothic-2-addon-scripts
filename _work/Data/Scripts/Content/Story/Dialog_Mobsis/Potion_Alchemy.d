...
INSTANCE PC_ItPo_Perm_Health (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír života (1 léèivý koâen, 1 královský šãovík)"; 
};
...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixír ducha (1 ohnivý koâen, 1 královský šãovík)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar obratnosti (1 gobliní bobule, 1 královský šãovík)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar síly (1 draèí koâen, 1 královský šãovík)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Lektvar rychlosti (1 chàapavèí býlí, 1 luèní pohanka)"; 
};
