...
INSTANCE PC_Circle_01 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit runy 1. kruhu"; 
};
...
INSTANCE PC_Circle_02 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit runy 2. kruhu"; 
};
...
INSTANCE PC_Circle_03 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit runy 3. kruhu"; 
};
...
INSTANCE PC_Circle_04 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit runy 4. kruhu"; 
};
...
INSTANCE PC_Circle_05 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit runy 5. kruhu"; 
};
...
INSTANCE PC_Circle_06 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit runy 6. kruhu"; 
};
...
INSTANCE PC_SPL_MasterOfDisaster (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Tajná místnost v knihovnì!"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_MasterOfDisaster,"Tajná místnost v knihovnì!",PC_SPL_MasterOfDisaster_Create);
	};
...
INSTANCE PC_SPL_PalTeleportSecret (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoøit teleportaèní runu"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_PalTeleportSecret,"Tajná místnost v knihovnì!",PC_SPL_PalTeleportSecret_Create);
	};
