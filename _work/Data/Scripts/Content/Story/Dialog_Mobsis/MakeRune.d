...
INSTANCE PC_Circle_01 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea le rune del Primo Circolo"; 
};
...
INSTANCE PC_Circle_02 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea le rune del Secondo Circolo"; 
};
...
INSTANCE PC_Circle_03 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea le rune del Terzo Circolo"; 
};
...
INSTANCE PC_Circle_04 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea le rune del Quarto Circolo"; 
};
...
INSTANCE PC_Circle_05 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea le rune del Quinto Circolo"; 
};
...
INSTANCE PC_Circle_06 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea le rune del Sesto Circolo"; 
};
...
INSTANCE PC_SPL_MasterOfDisaster (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Il segreto della libreria!"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_MasterOfDisaster,"Il segreto della libreria!",PC_SPL_MasterOfDisaster_Create);
	};
...
INSTANCE PC_SPL_PalTeleportSecret (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Crea la runa del teletrasporto"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_PalTeleportSecret,"Il segreto della libreria!",PC_SPL_PalTeleportSecret_Create);
	};
