...
INSTANCE PC_Circle_02 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Twórz runy drugiego kręgu"; 
};
...
INSTANCE PC_Circle_03 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Twórz runy trzeciego kręgu"; 
};
...
INSTANCE PC_Circle_04 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Twórz runy czwartego kręgu"; 
};
...
INSTANCE PC_Circle_05 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Twórz runy piątego kręgu"; 
};
...
INSTANCE PC_Circle_06 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Twórz runy szóstego kręgu"; 
};
...
INSTANCE PC_SPL_PalTeleportSecret (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Twórz runę teleportacyjną"; 
};
