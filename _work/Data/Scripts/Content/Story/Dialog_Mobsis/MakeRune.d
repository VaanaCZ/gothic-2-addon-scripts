...
INSTANCE PC_SPL_MasterOfDisaster (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Tajná místnost v knihovnê!"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_MasterOfDisaster,"Tajná místnost v knihovnê!",PC_SPL_MasterOfDisaster_Create);
	};
...
INSTANCE PC_SPL_PalTeleportSecret (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit teleportaèní runu"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_PalTeleportSecret,"Tajná místnost v knihovnê!",PC_SPL_PalTeleportSecret_Create);
	};
