...
INSTANCE PC_Circle_01 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit runy 1. kruhu"; 
};
...
INSTANCE PC_Circle_02 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit runy 2. kruhu"; 
};
...
INSTANCE PC_Circle_03 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit runy 3. kruhu"; 
};
...
INSTANCE PC_Circle_04 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit runy 4. kruhu"; 
};
...
INSTANCE PC_Circle_05 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit runy 5. kruhu"; 
};
...
INSTANCE PC_Circle_06 (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit runy 6. kruhu"; 
};
...
INSTANCE PC_SPL_MasterOfDisaster (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Tajná místnost v knihovnę!"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_MasterOfDisaster,"Tajná místnost v knihovnę!",PC_SPL_MasterOfDisaster_Create);
	};
...
INSTANCE PC_SPL_PalTeleportSecret (C_Info)
{
	...
	permanent		= TRUE;
	description		= "Vytvoâit teleportační runu"; 
};
...

{
	...
	{
		Info_AddChoice 	  (PC_SPL_PalTeleportSecret,"Tajná místnost v knihovnę!",PC_SPL_PalTeleportSecret_Create);
	};
