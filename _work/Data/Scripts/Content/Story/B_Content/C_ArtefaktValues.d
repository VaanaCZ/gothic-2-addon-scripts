/*
	...
	C_STR_ArtefaktValue (Stдrke)
	
*/	
//------------------------------------------------------------------------------------------	
//Check fьr Artefakt Set der Heiler (Bonus Berechnung)
//------------------------------------------------------------------------------------------	
...
{	                                                    	
	...
	//fьr Diagnose Print(IntToString(HP_Artefakt_Value) );
	
	return HP_Artefakt_Value;
};
//------------------------------------------------------------------------------------------	
//Check fьr Artefakt Set der Priester (Bonus Berechnung)
//------------------------------------------------------------------------------------------	
...
{	                                                    	
	...
	//fьr Diagnose Print(IntToString(MA_Artefakt_Value) );
	
	return MA_Artefakt_Value;
};
//------------------------------------------------------------------------------------------	
//Check fьr Artefakt Set der Krieger (Bonus Berechnung)
//------------------------------------------------------------------------------------------	
