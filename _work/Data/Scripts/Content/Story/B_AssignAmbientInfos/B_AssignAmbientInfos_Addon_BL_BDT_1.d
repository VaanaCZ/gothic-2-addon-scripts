...
{	
	...
	if (RavenIsDead == TRUE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_BL_BDT_1_Chef_01_01");//Tady poøád odcházejí a pøicházejí noví velitelé, takže za chvíli ztratíš pøehled.
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_BL_BDT_1_Chef_01_02");//Ale myslím, že teï je naším šéfem Thorus.
		};
	}
	else 
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_1_Chef_01_03");//Náš velitel je Havran. Dovedl nás sem a vystavìl tábor.
...
{	
	AI_Output (other, self, "DIA_Addon_BL_BDT_1_Lager_15_00");//Co víš o táboøe?
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager_01_01");//Když se provalilo, že je tu zlatej dùl, zaèalo to v týhle bandì flákaèù poøádnì vøít.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager_01_02");//Ty nejhorší Havran pozabíjel a zbytek poslal do dolu.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager_01_03");//Od tý doby sem nahoru nikdo nesmí. V dole musí kopat dokonce i všichni vìzni.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager2_01_01");//Jestli nìkoho z nich napadneš, sesypou se na tebe VŠICHNI.
...
{	
	...
	if (RavenIsDead == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_1_News_01_01");//Havran je mrtvý, co si teï poèneme?
	};
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_News_01_02");//Piráti nás na pevninu nepøevezou, protože jsme jim za to už párkrát nezaplatili.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_News_01_03");//Mìli bysme jich pár zapíchnout. Ostatní by snad potom dostali rozum a radši nás pøevezli.
};
// *************************************************************************
// 									Sklaven
// *************************************************************************
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Sklaven_01_01");//Havran chce nìco vykopat. Napøed to nechal dìlat bandity, ale až moc jich pøitom zaøvalo.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Sklaven_01_02");//Takže sem pøived vìznì - u tìch na úmrtnosti tolik nezáleží.
	
	if (BDT_1_Ausbuddeln == FALSE)
	{
		AI_Output (other, self, "DIA_Addon_BL_BDT_1_Sklaven_15_03");//Co chce Havran vykopat?
		AI_Output (self, other, "DIA_Addon_BL_BDT_1_Sklaven_01_04");//Nemám páru, ale urèitì je to nìco víc než zlato.
