...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_1_Chef_01_03");//Náš velitel je Havran. Dovedl nás sem a vystavęl tábor.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager_01_01");//Když se provalilo, že je tu zlatej důl, začalo to v týhle bandę flákačů poâádnę vâít.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager_01_02");//Ty nejhorší Havran pozabíjel a zbytek poslal do dolu.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager_01_03");//Od tý doby sem nahoru nikdo nesmí. V dole musí kopat dokonce i všichni vęzni.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Lager2_01_01");//Jestli nękoho z nich napadneš, sesypou se na tebe VŠICHNI.
...
{	
	...
	if (RavenIsDead == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_1_News_01_01");//Havran je mrtvý, co si teë počneme?
	};
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_News_01_03");//Męli bysme jich pár zapíchnout. Ostatní by snad potom dostali rozum a radši nás pâevezli.
};
// *************************************************************************
// 									Sklaven
// *************************************************************************
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Sklaven_01_01");//Havran chce nęco vykopat. Napâed to nechal dęlat bandity, ale až moc jich pâitom zaâvalo.
	AI_Output (self, other, "DIA_Addon_BL_BDT_1_Sklaven_01_02");//Takže sem pâived vęznę - u tęch na úmrtnosti tolik nezáleží.
	
	if (BDT_1_Ausbuddeln == FALSE)
	{
		AI_Output (other, self, "DIA_Addon_BL_BDT_1_Sklaven_15_03");//Co chce Havran vykopat?
		AI_Output (self, other, "DIA_Addon_BL_BDT_1_Sklaven_01_04");//Nemám páru, ale určitę je to nęco víc než zlato.
