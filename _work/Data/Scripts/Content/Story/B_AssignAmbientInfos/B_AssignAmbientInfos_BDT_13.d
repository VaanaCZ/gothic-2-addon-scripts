...
{
	AI_Output (self,other,"DIA_BDT_13_STANDARD_13_01"); //Sparisci!
};
...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_BDT_13_STANDARD_13_00"); //Perché mi fissi con quell'aria da idiota?
	};
	if (randy == 1)
	{
	...
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_BDT_13_STANDARD_13_02"); //Lasciami in pace, fannullone.
	};
