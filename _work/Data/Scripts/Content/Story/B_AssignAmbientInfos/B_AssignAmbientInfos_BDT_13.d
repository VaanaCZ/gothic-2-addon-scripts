...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_BDT_13_STANDARD_13_00"); //Na co się gapisz, kretynie!
	};
	if (randy == 1)
	{
	...
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_BDT_13_STANDARD_13_02"); //Zostaw mnie w spokoju, przybłędo.
	};
