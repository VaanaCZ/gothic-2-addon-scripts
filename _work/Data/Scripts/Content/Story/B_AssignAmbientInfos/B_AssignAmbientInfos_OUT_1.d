...
{	
	...
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_OUT_1_STANDARD_01_01"); //Na domobranu není žádný spoleh. Musíme se umìt bránit sami.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_OUT_1_STANDARD_01_02"); //Nenechám se nikým využívat. Ani králem, ani Onarem. Co dìlám, dìlám jen kvùli sobì.
	};
