...
func void B_AddCityGuideChoices()
{
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Do dolní èásti mêsta.", DIA_CITYGUIDE_UNTERSTADT);
	};
	if (!C_IsQuarterNearest(self, Q_OBERSTADT))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Do horní ètvrti.", DIA_CITYGUIDE_OBERSTADT);
	};
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Na tržištê.", DIA_CITYGUIDE_MARKT);
	};
	if (!C_IsQuarterNearest(self, Q_GALGEN))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Na šibenièní námêstí.", DIA_CITYGUIDE_GALGEN);
	};
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Do pâístavní ètvrti.", DIA_CITYGUIDE_HAFEN);
	};
	
	Info_AddChoice (DIA_CITYGUIDE, "Díky - to je vše, co jsem chtêl vêdêt!", DIA_CITYGUIDE_BACK);
};
...
{	
	AI_Output (other, self, "DIA_CITYGUIDE_15_00"); //Co mi mùžeš âíct o tomhle místê?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_BACK_15_00"); //Díky - to je vše, co jsem chtêl vêdêt!
	Info_ClearChoices (DIA_CITYGUIDE);
};
	
func void DIA_CITYGUIDE_UNTERSTADT()	
{
	AI_Output (other, self, "DIA_CITYGUIDE_UNTERSTADT_15_00"); //Jak se dostanu do dolní èásti mêsta?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_OBERSTADT_15_00"); //Jak se dostanu do horní èásti mêsta?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_MARKT_15_00"); //Kde je tržištê?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_GALGEN_15_00"); //Jak se dostanu na šibenièní námêstí?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_HAFEN_15_00"); //Kde je pâístavní ètvrã?
