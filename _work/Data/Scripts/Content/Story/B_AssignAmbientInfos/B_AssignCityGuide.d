...
func void B_AddCityGuideChoices()
{
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Do dolní části města.", DIA_CITYGUIDE_UNTERSTADT);
	};
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Na tržiště.", DIA_CITYGUIDE_MARKT);
	};
	if (!C_IsQuarterNearest(self, Q_GALGEN))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Na šibeniční náměstí.", DIA_CITYGUIDE_GALGEN);
	};
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Do přístavní čtvrti.", DIA_CITYGUIDE_HAFEN);
	};
	
	Info_AddChoice (DIA_CITYGUIDE, "Díky - to je vše, co jsem chtěl vědět!", DIA_CITYGUIDE_BACK);
};
...
{	
	AI_Output (other, self, "DIA_CITYGUIDE_15_00"); //Co mi můžeš říct o tomhle místě?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_BACK_15_00"); //Díky - to je vše, co jsem chtěl vědět!
	Info_ClearChoices (DIA_CITYGUIDE);
};
	
func void DIA_CITYGUIDE_UNTERSTADT()	
{
	AI_Output (other, self, "DIA_CITYGUIDE_UNTERSTADT_15_00"); //Jak se dostanu do dolní části města?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_OBERSTADT_15_00"); //Jak se dostanu do horní části města?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_MARKT_15_00"); //Kde je tržiště?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_GALGEN_15_00"); //Jak se dostanu na šibeniční náměstí?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_HAFEN_15_00"); //Kde je přístavní čtvrť?
