...
func void B_AddCityGuideChoices()
{
	...
	{
		Info_AddChoice (DIA_CITYGUIDE, "Â íèæíþþ ÷àñòü ãîðîäà.", DIA_CITYGUIDE_UNTERSTADT);
	};
	if (!C_IsQuarterNearest(self, Q_OBERSTADT))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Â âåðõíèé êâàðòàë.", DIA_CITYGUIDE_OBERSTADT);
	};
	if (!C_IsQuarterNearest(self, Q_TEMPEL))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Ê õðàìó Àäàíîñà.", DIA_CITYGUIDE_TEMPEL);
	};
	if (!C_IsQuarterNearest(self, Q_MARKT))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Íà ðûíî÷íóþ ïëîùàäü.", DIA_CITYGUIDE_MARKT);
	};
	if (!C_IsQuarterNearest(self, Q_GALGEN))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Íà ïëîùàäü ïðàâîñóäèÿ.", DIA_CITYGUIDE_GALGEN);
	};
	if (!C_IsQuarterNearest(self, Q_KASERNE))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Ê êàçàðìàì.", DIA_CITYGUIDE_KASERNE);
	};
	if (!C_IsQuarterNearest(self, Q_HAFEN))
	{
		Info_AddChoice (DIA_CITYGUIDE, "Â ïîðòîâûé êâàðòàë.", DIA_CITYGUIDE_HAFEN);
	};
	
	Info_AddChoice (DIA_CITYGUIDE, "Ñïàñèáî. Èìåííî ýòî ÿ è õîòåë óçíàòü!", DIA_CITYGUIDE_BACK);
};
...
INSTANCE DIA_CITYGUIDE (C_INFO)
{
	...
	permanent	= TRUE;
	description = "×òî òû ìîæåøü ðàññêàçàòü ìíå îá ýòîì êâàðòàëå?";
};                       
...
{	
	AI_Output (other, self, "DIA_CITYGUIDE_15_00"); //×òî òû ìîæåøü ðàññêàçàòü ìíå îá ýòîì êâàðòàëå?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_BACK_15_00"); //Ñïàñèáî. Èìåííî ýòî ÿ è õîòåë óçíàòü!
	Info_ClearChoices (DIA_CITYGUIDE);
};
	
func void DIA_CITYGUIDE_UNTERSTADT()	
{
	AI_Output (other, self, "DIA_CITYGUIDE_UNTERSTADT_15_00"); //Êàê ìíå ïîïàñòü â íèæíþþ ÷àñòü ãîðîäà?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_OBERSTADT_15_00"); //Êàê ìíå ïîïàñòü â âåðõíèé êâàðòàë?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_TEMPEL_15_00"); //ß èùó õðàì.
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_MARKT_15_00"); //Ãäå íàõîäèòñÿ ðûíî÷íàÿ ïëîùàäü?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_GALGEN_15_00"); //Êàê ìíå ïîïàñòü íà ïëîùàäü Ïðàâîñóäèÿ?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_KASERNE_15_00"); //Ãäå íàõîäÿòñÿ êàçàðìû?
...
{
	AI_Output (other, self, "DIA_CITYGUIDE_HAFEN_15_00"); //Ãäå íàõîäèòñÿ ïîðòîâûé êâàðòàë?
