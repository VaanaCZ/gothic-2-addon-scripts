...
{	
	AI_Output (other, self,"DIA_Liesel_Hallo_15_00"); //Salve... (si schiarisce la voce) ...pecore.
	B_LieselMaeh ();
};
// ************************************************************
// 			  			Komm mit
...
{	
	AI_Output (other, self,"DIA_Liesel_KommMit_15_00");	//Vieni con me!
	B_LieselMaeh ();
...
{	
	AI_Output (other, self,"DIA_Liesel_WarteHier_15_00");	//Aspetta qui!
	B_LieselMaeh ();
