...
{	
	AI_Output (other, self,"DIA_Liesel_Hallo_15_00"); //Hola... (carraspea) ...oveja.
	B_LieselMaeh ();
};
// ************************************************************
// 			  			Komm mit
...
{	
	AI_Output (other, self,"DIA_Liesel_KommMit_15_00");	//¡Ven conmigo!
	B_LieselMaeh ();
...
{	
	AI_Output (other, self,"DIA_Liesel_WarteHier_15_00");	//¡Espera aquí!
	B_LieselMaeh ();
