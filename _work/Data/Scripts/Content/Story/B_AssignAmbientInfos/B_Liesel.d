...
{	
	AI_Output (other, self,"DIA_Liesel_Hallo_15_00"); //Bonjour... (en s'éclaircissant la voix)... mouton.
	B_LieselMaeh ();
};
// ************************************************************
// 			  			Komm mit
...
{	
	AI_Output (other, self,"DIA_Liesel_KommMit_15_00");	//Venez avec moi !
	B_LieselMaeh ();
...
{	
	AI_Output (other, self,"DIA_Liesel_WarteHier_15_00");	//Attendez ici !
	B_LieselMaeh ();
