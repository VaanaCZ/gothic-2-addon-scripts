...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_Hi_13_02");//Questa palude sarà la nostra tomba...
};
// *************************************************************************
// 							Tal
// *************************************************************************
...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_Tal_13_01");//Qui c'è un mucchio di roba vecchia. Raven ci ha ordinato di raccogliere tutto.
...
{	
	AI_Output (other, self, "DIA_Addon_TAL_BDT_13_News_15_00");//Ci sono novità?
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_News_13_01");//Li abbiamo davvero imbrogliati quei pirati.
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_News_13_02");//Ci hanno fornito i prigionieri, ma non hanno mai visto un soldo in cambio. È ovvio che siano arrabbiati.
	
	if (BDT_13_einmal == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_TAL_BDT_13_News_13_03");//E cosa possono fare? Attaccare il campo? (ride) AH AH AH.
		BDT_13_einmal = TRUE;
	};
};
