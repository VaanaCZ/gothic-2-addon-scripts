...
func void B_Preach_Vatras(var int satz)
{
	...
	if (satz == 17)
	{		
		AI_Output (self, self, "DIA_Vatras_PREACH_05_17"); //Et Innos, dans sa grande sagesse, accepta.
	};
	if (satz == 18)
	{		
	...
	if (satz == 20)
	{		
		AI_Output (self, self, "DIA_Vatras_PREACH_05_20"); //Et Innos, dans sa grande sagesse, accepta.
	};
};
