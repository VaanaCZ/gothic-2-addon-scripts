...
{	
	AI_Output			(self, other, "DIA_Dragon_Fire_Hello_20_00"); //Prostê nemùžu uvêâit, že opravdu ještê existují lidé, kteâí jsou ochotni obêtovat svùj život jen proto, aby na vlastní oèi vidêli draka.
	if (Mis_KilledDragons == 0)
	{	
		AI_Output			(other, self, "DIA_Dragon_Fire_Hello_15_01"); //Jsi docela výâeèný - na takovou neskladnou obludu.
	};
	...
	AI_Output			(other, self, "DIA_Dragon_Fire_Hello_15_05"); //Ne tak rychle, pâíteli. Mám u sebe Innosovo oko. Nemùžeš odolat mé moci. Odpovêz na mé otázky, nebo okusíš nesnesitelná muka.
	AI_Output			(self, other, "DIA_Dragon_Fire_Hello_20_06"); //(âve) Arrgh. Tak se pochlub têmi tvými otázkami, dokud mùžeš. Tvá moc nebude mít dlouhého trvání.
...
func void DIA_Dragon_Fire_WerBistDu_Info ()
{
	...
	AI_Output			(self, other, "DIA_Dragon_Fire_WerBistDu_20_02"); //Jakmile uniknu úèinkùm kouzla Oka, užiješ si žáru poâádného plamene.
...
func void DIA_Dragon_Fire_HORT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Dragon_Fire_HORT_20_02"); //Vzal jsem svùj poklad nahoru na žhavé útesy, které lze nazvat všelijak, jenom ne pâístupnými neokâídlenému èlovíèkovi, jako jsi ty.
