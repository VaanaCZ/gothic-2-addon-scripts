...
{	
	...
	if (RavenIsDead == TRUE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_BL_BDT_13_Chef_13_01");//Nasz wspaniały przywódca Thorus. Dzięki niemu wszyscy będziemy bogaci.
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_BL_BDT_13_Chef_13_02");//Nasz wspaniały przywódca.... Eee... Nie mam pojęcia...
		};
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Chef_13_03");//Nasz wspaniały przywódca, Kruk. Dzięki niemu wszyscy będziemy bogaci.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BL_BDT_13_Lager_13_01");//Porozmawiaj ze Snafem, jeśli chcesz się czegoś dowiedzieć. Ten spasiony kucharz sporo wie.
	AI_Output (self, other, "DIA_Addon_BL_BDT_13_Lager_13_02");//Jeśli chcesz coś kupić, poszukaj Fiska. On może załatwić niemal wszystko...
};
// *************************************************************************
// 								News
// *************************************************************************
...
{	
	...
	if (RavenIsDead == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_News_13_01");//Kruk nie żyje. Teraz NIGDY nie wydostaniemy się z tej wyspy.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_News_13_02");//Piraci postawili żagle i zwiali.
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_News_13_03");//Na plaży zostało tylko paru idiotów, którzy nie mają nawet porządnego statku.
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_News_13_04");//Nawet Beliar nie wie, jak można się wydostać z tej wyspy.
	};
};
// *************************************************************************
// 									Gold
...
instance DIA_Addon_BL_BDT_13_Gold(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Jak można się szybko wzbogacić?";
};                       
...
{	
	...
	if (BDT_13_Nerver <= 2)
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Gold_13_01");//Dobre pytanie. Czyż nie po to wszyscy tu jesteśmy?
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Gold_13_02");//Zdobądź czerwony kamień i daj go Thorusowi, a będziesz mógł wejść do kopalni.
	}
	else if (BDT_13_Kill == FALSE)
	{
		BDT_13_Nerver = 0;
		BDT_13_Kill = TRUE;
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Gold_13_03");//Żarty sobie stroisz? Spadaj!
		AI_StopProcessInfos (self);
	}
	else 
	{
		BDT_13_Nerver = 0;
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Gold_13_04");//Koniec z uprzejmościami!
		AI_StopProcessInfos (self);
