...
{	
	...
	if (RavenIsDead == TRUE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_BL_BDT_13_Chef_13_01");//(nadšenę) Náš slavnej velitel Thorus. Udęlá z nás ze všech boháče!
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_BL_BDT_13_Chef_13_02");//Náš slavnej velitel... no, vlastnę nevím.
		};
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Chef_13_03");//(nadšenę) Náš slavnej velitel Havran. Udęlá z nás ze všech boháče!
...
{	
	...
	else
	{
		...
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_News_13_03");//Na pláži zůstalo sedęt jen pár debilů, kteâí ani nemaj poâádnou loë.
...
instance DIA_Addon_BL_BDT_13_Gold(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Jak bych si rychle vydęlal peníze?";
};                       
...
{	
	...
	if (BDT_13_Nerver <= 2)
	{
		...
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Gold_13_02");//Prostę si u Thoruse vyzvedni červenej kámen a pak už můžeš jít do dolu.
	}
	else if (BDT_13_Kill == FALSE)
	{
		BDT_13_Nerver = 0;
		BDT_13_Kill = TRUE;
		AI_Output (self, other, "DIA_Addon_BL_BDT_13_Gold_13_03");//Si dęláš kozy, ne? Jdi do prdele!
		AI_StopProcessInfos (self);
	}
	else 
	{
