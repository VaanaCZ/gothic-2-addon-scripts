...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_BDT_1_STANDARD_01_00"); //Zejdź mi z oczu!
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_BDT_1_STANDARD_01_01"); //Szukasz kłopotów?
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_BDT_1_STANDARD_01_02"); //Odejdź, póki możesz!
	};
