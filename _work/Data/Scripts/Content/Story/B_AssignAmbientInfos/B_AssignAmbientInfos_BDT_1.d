...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_BDT_1_STANDARD_01_00"); //Hors de ma vue !
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_BDT_1_STANDARD_01_01"); //Vous cherchez les ennuis ?
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_BDT_1_STANDARD_01_02"); //Partez tant que vous le pouvez !
	};
