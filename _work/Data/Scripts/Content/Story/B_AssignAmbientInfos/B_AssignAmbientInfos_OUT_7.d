...
{	
	...
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_OUT_7_STANDARD_07_01"); //Musíme mêstu zaplatit danê. Když to neudêláme, budeme mít poâádné problémy s paladiny.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_OUT_7_STANDARD_07_02"); //Onarova vzpoura bude mít vážné následky. Radêji bych se do toho nepletl.
	};
