...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_00"); //Innos to honor, a honor jest mym życiem!
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_01"); //Będziemy się bronić, póki chroni nas jaśniejąca łaska Innosa!
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_02"); //Z pomocą Innosa uda się nam odpędzić pomiot zła!
	};
