...
{	
	...
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_01"); //Vydržíme tu tak dlouho, dokud nad námi bude bdít Innosovo světlo.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_02"); //S Innosovou pomocí musíme odsud ta stvoření zla vyhnat.
	};
