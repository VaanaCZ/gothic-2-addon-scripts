...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_00"); //Innos es mi honor y mi honor es mi vida.
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_01"); //Permaneceremos firmes mientras Innos nos ilumine.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_OWPAL_4_STANDARD_04_02"); //Con la ayuda de Innos mantendremos a raya a las criaturas malignas.
	};
