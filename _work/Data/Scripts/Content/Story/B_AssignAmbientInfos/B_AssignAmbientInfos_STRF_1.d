...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_STRF_1_STANDARD_01_00"); //Gdybym odszedł, kiedy miałem na to szansę, dziś nie musiałbym harować dla tych świń!
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_STRF_1_STANDARD_01_01"); //Wszystko przez rudę! Ciągle to samo. Wszystkim zależy tylko na tej cholernej rudzie.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_STRF_1_STANDARD_01_02"); //Gdybyś choć raz spróbował żarcia, które nam dają, sam zacząłbyś myśleć o buncie.
	};
