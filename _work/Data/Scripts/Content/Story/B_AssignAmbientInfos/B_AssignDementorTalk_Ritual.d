...
{	
	...
	{
		AI_Output			(self ,other, "DIA_RitualDementor_19_00"); //Pâišel jsi pâíliš pozdê.
		AI_Output			(self ,other, "DIA_RitualDementor_19_01"); //Znièili jsme Innosovo oko, takže už nemùže nikdy znovu nabýt své pùvodní moci.
		AI_Output			(self ,other, "DIA_RitualDementor_19_02"); //Teë ti ukážeme pošetilost tvých snah postavit se našemu Pánu.

		MIS_SCKnowsInnosEyeIsBroken  = TRUE;
		B_LogEntry (TOPIC_INNOSEYE, "Ti hrozní chlapi mi pêknê hrají na nervy - znièili Innosovo oko a já teë netuším, jak je spravit.");
 		B_LogEntry (TOPIC_TraitorPedro, "Našel jsem Innosovo oko, ale po Pedrovi nebylo nikde ani vidu, ani slechu. Dal se do spolku s têmi èernými mágy.");
	...
	else
	{
		...
		if (randy == 3)
		{
			AI_Output			(self ,other, "DIA_RitualDementor_19_06"); //Zabijeme tê.
		};
	};
