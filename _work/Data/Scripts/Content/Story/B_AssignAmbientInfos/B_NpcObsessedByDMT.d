...
func void B_DMTWurm ()
{
		AI_Output	(self, other, "DIA_NoName_ObsessedByDMT_19_00"); //Widzimy cię, robaku. Nie uciekniesz nam.
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (NpcObsessedByDMT == FALSE)
		{
			...
			if (Hlp_GetInstanceID(medium) == Hlp_GetInstanceID(Brutus))
			{
				if (MIS_OCGateOpen == TRUE)
					{
						AI_Output	(self, other, "DIA_Brutus_ObsessedByDMT_19_00"); //Otwarcie wrót to wielka przysługa dla naszego Mistrza, marny śmiertelniku. Na twym grobie postawimy kaplicę ku jego chwale.
					}
					else
					{
							B_DMTWurm ();
			...
			{
				AI_Output	(self, other, "DIA_Engrom_ObsessedByDMT_19_00"); //Zawróć. Póki jeszcze możesz.
			...
			{
				AI_Output	(self, other, "DIA_Vino_ObsessedByDMT_19_00"); //Wkrótce wszyscy będą naszymi sługami. Twoje magiczne sztuczki na nic się nie zdadzą.
			...
			{
				AI_Output	(self, other, "DIA_Malak_ObsessedByDMT_19_00"); //Nigdy nie zdołasz ocalić tej duszy, magu.
			...
			{
				AI_Output	(self, other, "DIA_Sekob_ObsessedByDMT_19_00"); //Poddaj się, magu, nie możesz nas pokonać.
			...
			{
				AI_Output	(self, other, "DIA_Randolph_ObsessedByDMT_19_00"); //Nie zawracaj sobie głowy słabeuszami. Zniewolimy ich wszystkich.
