...
func void B_DMTWurm ()
{
		AI_Output	(self, other, "DIA_NoName_ObsessedByDMT_19_00"); //Ti vediamo, verme. Non puoi sfuggirci.
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (NpcObsessedByDMT == FALSE)
		{
			...
			if (Hlp_GetInstanceID(medium) == Hlp_GetInstanceID(Brutus))
			{
				if (MIS_OCGateOpen == TRUE)
					{
						AI_Output	(self, other, "DIA_Brutus_ObsessedByDMT_19_00"); //Aprendo il cancello hai reso un grande servizio al nostro Padrone, umile mortale. Erigeremo un tempio in suo onore sulla tua tomba.
					}
					else
					{
							B_DMTWurm ();
			...
			{
				AI_Output	(self, other, "DIA_Engrom_ObsessedByDMT_19_00"); //Torna indietro, prima che sia troppo tardi per te.
			...
			{
				AI_Output	(self, other, "DIA_Vino_ObsessedByDMT_19_00"); //Presto li comanderemo tutti. Tu e le tue patetiche arti magiche non potete fare niente contro di noi.
			...
			{
				AI_Output	(self, other, "DIA_Malak_ObsessedByDMT_19_00"); //Non riuscirai a salvare la sua anima, mago. Non tornerà mai più com'era prima.
			...
			{
				AI_Output	(self, other, "DIA_Sekob_ObsessedByDMT_19_00"); //Arrenditi mago. Non puoi farcela.
			...
			{
				AI_Output	(self, other, "DIA_Randolph_ObsessedByDMT_19_00"); //Non preocuparti dei deboli. Li renderemo tutti schiavi.
