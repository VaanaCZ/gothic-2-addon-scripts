...
func void B_DMTWurm ()
{
		AI_Output	(self, other, "DIA_NoName_ObsessedByDMT_19_00"); //My tê vidêt, èerve. Ty nemoct utéct.
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (NpcObsessedByDMT == FALSE)
		{
			...
			if (Hlp_GetInstanceID(medium) == Hlp_GetInstanceID(Brutus))
			{
				if (MIS_OCGateOpen == TRUE)
					{
						AI_Output	(self, other, "DIA_Brutus_ObsessedByDMT_19_00"); //Otevâení brány pâedstavovat velká služba našemu Pán, malý smrtelník. My postavit svatyni na jeho poèest na tvùj hrob.
					}
					else
					{
							B_DMTWurm ();
			...
			{
				AI_Output	(self, other, "DIA_Engrom_ObsessedByDMT_19_00"); //Obraã sebe, dokud pro tebe nebýt pâíliš pozdê.
			...
			{
				AI_Output	(self, other, "DIA_Vino_ObsessedByDMT_19_00"); //Už brzo jim budeme všem velet. Ty pro nás se svými žalostnými magickými schopnostmi nepâedstavuješ žádné nebezpeèí.
			...
			{
				AI_Output	(self, other, "DIA_Malak_ObsessedByDMT_19_00"); //Nemùžeš tuhle duši nijak zachránit, mágu. Nikdy se nevrátí do svého têla.
			...
			{
				AI_Output	(self, other, "DIA_Sekob_ObsessedByDMT_19_00"); //Vzdej to, mágu. Nemùžeš vyhrát.
