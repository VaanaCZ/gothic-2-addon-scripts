...
func void B_DMTWurm ()
{
		AI_Output	(self, other, "DIA_NoName_ObsessedByDMT_19_00"); //Te vemos, gusano. No te vas a librar de nosotros.
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (NpcObsessedByDMT == FALSE)
		{
			...
			if (Hlp_GetInstanceID(medium) == Hlp_GetInstanceID(Brutus))
			{
				if (MIS_OCGateOpen == TRUE)
					{
						AI_Output	(self, other, "DIA_Brutus_ObsessedByDMT_19_00"); //Abrir la puerta fue un gran servicio para nuestro amo, débil mortal. Erigiremos un altar en su honor sobre tu tumba.
					}
					else
					{
							B_DMTWurm ();
			...
			{
				AI_Output	(self, other, "DIA_Engrom_ObsessedByDMT_19_00"); //Date la vuelta antes de que sea demasiado tarde.
			...
			{
				AI_Output	(self, other, "DIA_Vino_ObsessedByDMT_19_00"); //Dentro de poco los controlaremos a todos. Tu triste capacidad mágica y tú no suponéis ninguna amenaza para nosotros.
			...
			{
				AI_Output	(self, other, "DIA_Malak_ObsessedByDMT_19_00"); //No vas a poder salvar su alma, mago. Jamás volverá a ser el mismo.
			...
			{
				AI_Output	(self, other, "DIA_Sekob_ObsessedByDMT_19_00"); //Ríndete, mago. No puedes vencer.
			...
			{
				AI_Output	(self, other, "DIA_Randolph_ObsessedByDMT_19_00"); //No te preocupes por los débiles. Los esclavizaremos a todos.
