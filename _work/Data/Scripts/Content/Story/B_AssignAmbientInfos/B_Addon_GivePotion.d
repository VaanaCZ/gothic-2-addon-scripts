...
instance DIA_Addon_GivePotion(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(donner une potion de soins)";
};                       
...
{	
	...
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(donner un extrait de soin)",DIA_Addon_GivePotion_ItPo_Health_02);
	};
	if (Npc_HasItems (other,ItPo_Health_01) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(donner une essence de soin)",DIA_Addon_GivePotion_ItPo_Health_01);
	};
};
// ------------------------------------------------------------
