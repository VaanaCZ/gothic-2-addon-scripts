...
instance DIA_Addon_GivePotion(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(dát léèivý lektvar)";
};                       
...
{	
	...
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(dát léèivý elixír)",DIA_Addon_GivePotion_ItPo_Health_03);
	};
...
{
	AI_Output (other,self ,"DIA_Addon_Brandon_GivePotion_15_00"); //Na, tady máš léèivý lektvar.
