...
instance DIA_Addon_GivePotion(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(consegna pozione curativa)";
};                       
...
{	
	...
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(consegna elisir curativo)",DIA_Addon_GivePotion_ItPo_Health_03);
	};
	if (Npc_HasItems (other,ItPo_Health_02) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(consegna estratto curativo)",DIA_Addon_GivePotion_ItPo_Health_02);
	};
	if (Npc_HasItems (other,ItPo_Health_01) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(consegna essenza curativa)",DIA_Addon_GivePotion_ItPo_Health_01);
	};
};
// ------------------------------------------------------------
func void B_Addon_DrinkPotion ()
{
	AI_Output (other,self ,"DIA_Addon_Brandon_GivePotion_15_00"); //Ecco, tieni la pozione curativa.
