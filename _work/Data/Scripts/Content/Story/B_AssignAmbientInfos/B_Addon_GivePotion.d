...
instance DIA_Addon_GivePotion(C_INFO)
{
	...
	permanent	= TRUE;
	description = "(dar poción de curación)";
};                       
...
{	
	...
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(dar elixir de curación)",DIA_Addon_GivePotion_ItPo_Health_03);
	};
	if (Npc_HasItems (other,ItPo_Health_02) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(dar extracto de curación)",DIA_Addon_GivePotion_ItPo_Health_02);
	};
	if (Npc_HasItems (other,ItPo_Health_01) >= 1)
	{
		Info_AddChoice (DIA_Addon_GivePotion,"(dar esencia de curación)",DIA_Addon_GivePotion_ItPo_Health_01);
	};
};
// ------------------------------------------------------------
func void B_Addon_DrinkPotion ()
{
	AI_Output (other,self ,"DIA_Addon_Brandon_GivePotion_15_00"); //Ten, tómate la poción de curación.
