...
{
	AI_Output			(self, other, "DIA_B_DIA_BDT_10XX_Fluechtling_07_00"); //Nie ma mowy! Nie wrócę do więzienia!
};

FUNC VOID B_DIA_BDT_10XX_Fluechtling_Stimme6 ()
{
	AI_Output			(self, other, "DIA_B_DIA_BDT_10XX_Fluechtling_06_00"); //Nie przyszedłeś chyba po to, żeby zabrać nas z powrotem do więzienia, co?
};
...
{
	AI_Output			(self, other, "DIA_BDT_1031_Fluechtling_Tip1_07_00"); //Trzymaj się ode mnie z daleka, chyba że chcesz wylądować w więzieniu.
	B_GivePlayerXP (XP_AmbientKap3);
	
	if (SCFoundMorgahard == FALSE)
	{
		Info_ClearChoices	(DIA_BDT_1031_Fluechtling_Tip1);
		Info_AddChoice	(DIA_BDT_1031_Fluechtling_Tip1, "Nie bój się, nie chcę cię wydać.", DIA_BDT_1031_Fluechtling_Tip1_frei );
		Info_AddChoice	(DIA_BDT_1031_Fluechtling_Tip1, "Przybywam, by cię aresztować.", DIA_BDT_1031_Fluechtling_Tip1_Knast );
...
func void DIA_BDT_1031_Fluechtling_Tip1_Morgahard ()
{
	...
	AI_Output			(self, other, "DIA_BDT_1031_Fluechtling_Tip1_Morgahard_07_01"); //Rozdzieliliśmy się, żeby trudniej nas było złapać. Nie mam pojęcia, gdzie są pozostali.
	
	Info_AddChoice	(DIA_BDT_1031_Fluechtling_Tip1, "Szkoda, w takim razie będę chyba musiał powiadomić sędziego.", DIA_BDT_1031_Fluechtling_Tip1_Morgahard_drohen );

};
func void DIA_BDT_1031_Fluechtling_Tip1_Morgahard_drohen ()
{
	AI_Output			(other, self, "DIA_BDT_1031_Fluechtling_Tip1_Morgahard_drohen_15_00"); //Szkoda, w takim razie będę chyba musiał powiadomić sędziego.
	AI_Output			(self, other, "DIA_BDT_1031_Fluechtling_Tip1_Morgahard_drohen_07_01"); //Dobra już, dobra. Wydaje mi się, że niektórzy schronili się w tawernie. Ale pamiętaj, nie wiesz tego ode mnie!
	AI_StopProcessInfos (self);
};

func void DIA_BDT_1031_Fluechtling_Tip1_Knast ()
{
	AI_Output			(other, self, "DIA_BDT_1031_Fluechtling_Tip1_Knast_15_00"); //Przyszedłem tu, by cię aresztować.
...
{
	AI_Output			(other, self, "DIA_BDT_1031_Fluechtling_Tip1_frei_15_00"); //Nie bój się, nie chcę cię wydać.
	AI_Output			(self, other, "DIA_BDT_1031_Fluechtling_Tip1_frei_07_01"); //Jeśli przysyła cię sędzia, to powiedz mu, że może się pocałować.
	
	Info_AddChoice	(DIA_BDT_1031_Fluechtling_Tip1, "Co takiego zrobiłeś?", DIA_BDT_1031_Fluechtling_Tip1_frei_verbrechen );
};
func void DIA_BDT_1031_Fluechtling_Tip1_frei_verbrechen ()
{
	AI_Output			(other, self, "DIA_BDT_1031_Fluechtling_Tip1_frei_verbrechen_15_00"); //Co takiego zrobiłeś?
...
func void DIA_BDT_1033_Fluechtling_Tip2_Info ()
{
	...
	if (SCFoundMorgahard == FALSE)
	{
		...
		Info_AddChoice	(DIA_BDT_1033_Fluechtling_Tip2, "Uspokój się. Chcę tylko porozmawiać.", DIA_BDT_1033_Fluechtling_Tip2_frei );
		Info_AddChoice	(DIA_BDT_1033_Fluechtling_Tip2, "Przysłał mnie sędzia. Mam cię do niego zaprowadzić.", DIA_BDT_1033_Fluechtling_Tip2_Knast );
...
func void DIA_BDT_1033_Fluechtling_Tip2_Morgahard ()
{
	...
	AI_Output			(self, other, "DIA_BDT_1033_Fluechtling_Tip2_Morgahard_07_01"); //Nie chcę żadnych kłopotów. Idź do zarządcy. Wiem, że chciał się ukryć wśród najemników. A teraz zostaw mnie w spokoju.
	AI_StopProcessInfos (self);
};

func void DIA_BDT_1033_Fluechtling_Tip2_Knast ()
{
	AI_Output			(other, self, "DIA_BDT_1033_Fluechtling_Tip2_Knast_15_00"); //Przysłał mnie sędzia. Mam cię do niego zaprowadzić.
...
{
	AI_Output			(other, self, "DIA_BDT_1033_Fluechtling_Tip2_frei_15_00"); //Uspokój się. Chcę tylko porozmawiać.
	AI_Output			(self, other, "DIA_BDT_1033_Fluechtling_Tip2_frei_07_01"); //Ale ja nie chcę rozmawiać z tobą. Odwal się.
	
	Info_AddChoice	(DIA_BDT_1033_Fluechtling_Tip2, "Narobiłeś w portki ze strachu?", DIA_BDT_1033_Fluechtling_Tip2_frei_verbrechen );
};
func void DIA_BDT_1033_Fluechtling_Tip2_frei_verbrechen ()
{
	AI_Output			(other, self, "DIA_BDT_1033_Fluechtling_Tip2_frei_verbrechen_15_00"); //Narobiłeś w portki ze strachu?
