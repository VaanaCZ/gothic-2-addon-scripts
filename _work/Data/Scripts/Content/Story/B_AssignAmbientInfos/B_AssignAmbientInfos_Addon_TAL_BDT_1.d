...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_1_Hi_01_01");//Čekám, až budou chtít nękoho novýho. Jsem na âadę.
	if (!Npc_IsDead(Franco))
	{
		AI_Output (self, other, "DIA_Addon_TAL_BDT_1_Hi_01_02");//Ze všech lidí, co tu jsou, může dovnitâ jenom Franco.
	}
	else
	{
...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_1_Lager_01_01");//Buë furt ve stâehu a s nikým se nezaplejtej! Když se bezdůvodnę pustíš do boje, všichni se na tebe okamžitę sesypou!
	AI_Output (self, other, "DIA_Addon_TAL_BDT_1_Lager_01_02");//Vętšina lidí se stejnę furt bojí o svý zlato a chlapi se sledujou navzájem.
};
// *************************************************************************
// 							News
// *************************************************************************
...
{	
	AI_Output (other, self, "DIA_Addon_TAL_BDT_1_Raven_15_00");//Co bys mi povędęl o Havranovi?
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_1_Raven_01_03");//Jednou potâebovali pęt novejch chlapů, protože se vzteknul a vodkrouhnul vlastní lidi.
};
