...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_STRF_13_STANDARD_13_00"); //Zostaw mnie w spokoju, człowieku!
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_STRF_13_STANDARD_13_01"); //Czego chcesz? Nie czepiaj się mnie!
	};
	if (randy == 2)
	{
