...
{	
	...
	if (randy == 0)
	{
		AI_Output (self,other,"DIA_STRF_13_STANDARD_13_00"); //Laissez-moi tranquille !
	};
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_STRF_13_STANDARD_13_01"); //Qu'est-ce que vous me voulez ? Laissez-moi tranquille !
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_STRF_13_STANDARD_13_02"); //On va tous mourir ici !
	};
