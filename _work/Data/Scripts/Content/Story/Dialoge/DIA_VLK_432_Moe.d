...
FUNC VOID DIA_Moe_Hallo_Zahlen()
{
	...
	{
		AI_Output (self ,other,"DIA_Moe_Hallo_Zahlen_01_01"); //Výbornę. A když jsme to tak hezky vyâešili, můžeš mi dát i to ostatní, co máš u sebe.
...
{	
	...
	Info_AddChoice		(DIA_Moe_Harbor,"Jaké lodę sem pâiplouvají?",DIA_Moe_Harbor_Ship);
...
{
	AI_Output (other,self ,"DIA_Moe_Harbor_Ship_15_00"); //Jak často sem pâiplouvají nové lodę?
	AI_Output (self ,other,"DIA_Moe_Harbor_Ship_01_01"); //Jediná loë, která sem v poslední dobę pâiplula, je ta paladinská galeona.
...
FUNC VOID DIA_Moe_Harbor_Rumors ()
{
	...
	else if (Kapitel == 3)
	{
		...
		else
		{
			...
			AI_Output (self ,other,"DIA_Moe_Harbor_Rumors_01_14"); //Myslím, že se bojí, aby jim nikdo nerozbil držku. Mnę osobnę by to vůbec nevadilo.
		};
	}
	else if (Kapitel == 4)
	{
	...
	{
		AI_Output (self ,other,"DIA_Moe_Harbor_Rumors_01_16"); //Konečnę ti nabubâelí paladinové vypadli z pâístavu. Bylo načase.
	};
};
