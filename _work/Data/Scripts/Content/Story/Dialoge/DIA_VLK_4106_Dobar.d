...
func void DIA_Dobar_Schmiede_Info ()
{
	...
	AI_Output (self, other, "DIA_Dobar_Schmiede_08_01"); //Teë zrovna nevím, kam dâív skoèit, jenom bychom si tu pâekáželi. Poèkej, až se setmí.
...
{
	AI_Output (other, self, "DIA_Dobar_beibringen_15_00"); //Mùžeš mê nêèemu nauèit?
	AI_Output (self, other, "DIA_Dobar_beibringen_08_01"); //Základy už máš. Mùžu ti teda ukázat, jak svou práci ještê vylepšit.
...
func void DIA_Dobar_Teach_Info ()
{
	...
	{	
		AI_Output (self, other, "DIA_Dobar_Teach_08_01"); //Pokud má daná zbraà za nêco stát, musíš nejdâív peèlivê a stejnomêrnê rozžhavit ocel.
		AI_Output (self, other, "DIA_Dobar_Teach_08_02"); //Když to budeš mít na pamêti, èepele, které vykováš, budou tvrdší a ostâejší.
		AI_Output (self, other, "DIA_Dobar_Teach_08_03"); //Víc už vêdêt nepotâebuješ. Jestli chceš tady na hradê nêkde sehnat ocel, promluv si s Engorem.
	};
};
///////////////////////////////////////////////////////////////////////
//	Info Waffe
...
func void DIA_Dobar_NEWS_Info ()
{
	...
	if (Dobar_einmalig == FALSE)
	{
		...
		AI_Output (self, other, "DIA_Dobar_NEWS_08_02"); //A taky že je to zapotâebí. Ukážeme têm zatraceným skâetùm, jak ostré jsou naše bâity!
	...
	{
		AI_Output (self, other, "DIA_Dobar_NEWS_08_04"); //Mohlo by to být lepší. Kdybys mê furt nerušil, urèitê bych už mêl hotovo aspoà nêco.
	};
};
