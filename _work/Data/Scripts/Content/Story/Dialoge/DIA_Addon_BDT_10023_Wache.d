...
FUNC VOID DIA_Addon_10023_Wache_Hi_Info()
{
	...
	AI_Output (other, self, "DIA_Addon_10023_Wache_Hi_15_01");//No jasnê, proè ne?
	AI_Output (self, other, "DIA_Addon_10023_Wache_Hi_11_02");//Tam vzadu jsou ještê další otroci. Pro mê za mê si tam klidnê zalez, ale moc je nemlaã, aã ještê mùžou makat.
	AI_Output (self, other, "DIA_Addon_10023_Wache_Hi_11_03");//Stejnê nechcem, aby tu jen tak posedávali. Maj dolovat zlato.
...
FUNC VOID DIA_Addon_10023_Wache_go_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_10023_Wache_go_11_01");//Hele, tady to âídí Bloodwyn. Otroci patâej jemu, takže propustit je mùže jenom on.
...
FUNC VOID DIA_Addon_10023_Wache_go_WER()
{
	...
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_WER_11_01");//Dêláš Estebanovu práci, takže tady nemáš co kecat ABSOLUTNÊ do nièeho. Odprejskni.
	Info_ClearChoices 	(DIA_Addon_10023_Wache_go);
};
//----------------------------------------
...
FUNC VOID DIA_Addon_10023_Wache_go_Blood()
{
	...
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Blood_11_01");//(blééé) Dej to pryè, NIC TAKOVÝHO nechci vidêt.
	AI_Output (other, self, "DIA_Addon_10023_Wache_go_Blood_15_02");//Bylo by lepší, kdybys ty otroky propustil. HNED.
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Blood_11_03");//Poèkej pâece. Bloodwyn není jedinej, kdo tu má àáký slovo. Dokud nedostanu rozkaz vod Thoruse, nikoho nepropustím.
	...
	else
	{
		...
		{
			AI_Output (other, self, "DIA_Addon_10023_Wache_go_Blood_15_04");//Ale právê jsi âíkal, že otroci patâí Bloodwynovi.
...
{
	AI_Output (other, self, "DIA_Addon_10023_Wache_go_Thorus_15_00");//Mluvil jsem s Thorusem. Podle jeho rozkazu mají být otroci propuštêni.
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Thorus_11_01");//No dobâe, když to teda rozkázal Thorus. Ale nechápu, proè nêco takovýho dovolil...
	AI_Output (other, self, "DIA_Addon_10023_Wache_go_Thorus_15_02");//...ale za otázky nejsi placený.
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Thorus_11_03");//Dobrá, dobrá, evidentnê už mê tu nikdo nepotâebuje, takže si jdu dát nêco na zub.
