...
FUNC VOID DIA_Addon_10023_Wache_Hi_Info()
{
	...
	AI_Output (other, self, "DIA_Addon_10023_Wache_Hi_15_01");//No jasně, proč ne?
	AI_Output (self, other, "DIA_Addon_10023_Wache_Hi_11_02");//Tam vzadu jsou ještě další otroci. Pro mě za mě si tam klidně zalez, ale moc je nemlať, ať ještě můžou makat.
	AI_Output (self, other, "DIA_Addon_10023_Wache_Hi_11_03");//Stejně nechcem, aby tu jen tak posedávali. Maj dolovat zlato.
	AI_Output (other, self, "DIA_Addon_10023_Wache_Hi_15_04");//Chápu, a kdo to rozkázal?
	AI_Output (self, other, "DIA_Addon_10023_Wache_Hi_11_05");//To sou přímý rozkazy od Bloodwyna.
	AI_Output (other, self, "DIA_Addon_10023_Wache_Hi_15_06");//Já myslel, že tady šéfuje Havran.
	AI_Output (self, other, "DIA_Addon_10023_Wache_Hi_11_07");//To máš recht, jenže on všecky otroky předal Bloodwynovi. Už je na nic nepotřeboval.
...
FUNC VOID DIA_Addon_10023_Wache_go_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_10023_Wache_go_11_01");//Hele, tady to řídí Bloodwyn. Otroci patřej jemu, takže propustit je může jenom on.
...
FUNC VOID DIA_Addon_10023_Wache_go_WER()
{
	...
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_WER_11_01");//Děláš Estebanovu práci, takže tady nemáš co kecat ABSOLUTNĚ do ničeho. Odprejskni.
	Info_ClearChoices 	(DIA_Addon_10023_Wache_go);
};
//----------------------------------------
...
FUNC VOID DIA_Addon_10023_Wache_go_Blood()
{
	...
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Blood_11_01");//(blééé) Dej to pryč, NIC TAKOVÝHO nechci vidět.
	AI_Output (other, self, "DIA_Addon_10023_Wache_go_Blood_15_02");//Bylo by lepší, kdybys ty otroky propustil. HNED.
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Blood_11_03");//Počkej přece. Bloodwyn není jedinej, kdo tu má ňáký slovo. Dokud nedostanu rozkaz vod Thoruse, nikoho nepropustím.
	...
	else
	{
		...
		{
			AI_Output (other, self, "DIA_Addon_10023_Wache_go_Blood_15_04");//Ale právě jsi říkal, že otroci patří Bloodwynovi.
			AI_Output (self, other, "DIA_Addon_10023_Wache_go_Blood_11_05");//To jo, ale taky jsem řek, že nikoho nepropustim, dokud mi to nenakáže Thorus.
			AI_Output (other, self, "DIA_Addon_10023_Wache_go_Blood_15_06");//Ty by ses bez rozkazu ani nevysral, co?
			Wache_einmal = TRUE;
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_10023_Wache_go_Blood_11_07");//Jo, ale taky jsem řek...
...
{
	AI_Output (other, self, "DIA_Addon_10023_Wache_go_Thorus_15_00");//Mluvil jsem s Thorusem. Podle jeho rozkazu mají být otroci propuštěni.
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Thorus_11_01");//No dobře, když to teda rozkázal Thorus. Ale nechápu, proč něco takovýho dovolil...
	AI_Output (other, self, "DIA_Addon_10023_Wache_go_Thorus_15_02");//...ale za otázky nejsi placený.
	AI_Output (self, other, "DIA_Addon_10023_Wache_go_Thorus_11_03");//Dobrá, dobrá, evidentně už mě tu nikdo nepotřebuje, takže si jdu dát něco na zub.
