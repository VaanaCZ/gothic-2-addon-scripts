...
FUNC VOID DIA_Addon_Wache_02_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Wache_02_Hi_13_01");//Poèkej chvilku, neznáme se náhodou odnêkud?
	B_UseFakeScroll ();
...
FUNC VOID DIA_Addon_Wache_02_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Wache_02_Attentat_13_01");//Co o nêm vím? (smêje se) Zpâelámal jsem tomu chlapovi hnáty.
	AI_Output (self, other, "DIA_Addon_Wache_02_Attentat_13_02");//(výhružnê) A to samý se stane každýmu, kdo se pokusí napadnout Estebana.
};
//--------------------------------------------------------------------
//	Info perm
//--------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Wache_02_perm_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Wache_02_perm_13_02");//Ty najdi zrádce a my se o nêj pak postaráme.
	};
};
