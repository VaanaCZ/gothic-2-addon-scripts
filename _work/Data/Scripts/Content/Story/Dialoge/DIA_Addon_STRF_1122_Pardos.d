...
FUNC VOID DIA_Addon_Pardos_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_01");//(vyčerpaně) Jsem úplně hotovej. Je teď pěknej slunečnej den, nebo jasná noc s tisíci hvězd na obloze?
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_02");//(ještě unaveněji) Nemám zdání... kam zmizel svěží májový deštík, chladivý večerní vánek... už je necítím...
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_03");//(rezignovaně) Oči tu odejdou jako první.
};
//---------------------------------------------------------------------
//	Info save
//---------------------------------------------------------------------
...
{
	AI_Output (other, self, "DIA_Addon_Pardos_save_15_00");//Počkej tady, záchrana je na cestě.
	AI_Output (self, other, "DIA_Addon_Pardos_save_03_01");//(znaveně) Díky. Dík za ty slova.
...
INSTANCE DIA_Addon_Pardos_trank   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Tumáš, vypij tohle. (předat lektvar)";
};
...
FUNC VOID DIA_Addon_Pardos_trank_Info()
{
	...
	{
		Info_AddChoice (DIA_Addon_Pardos_trank,"Předat hojivou esenci",DIA_Addon_Pardos_trank_01);
	};
	if Npc_HasItems (other, ItPo_Health_02)
	{
		Info_AddChoice (DIA_Addon_Pardos_trank,"Předat hojivý extrakt",DIA_Addon_Pardos_trank_02);
	};
	if Npc_HasItems (other, ItPo_Health_03)
	{
		Info_AddChoice (DIA_Addon_Pardos_trank,"Předat hojivý elixír",DIA_Addon_Pardos_trank_03);
	};
	if Npc_HasItems (other, ItFo_Addon_Meatsoup)
	{
		Info_AddChoice (DIA_Addon_Pardos_trank,"Předat dušené maso",DIA_Addon_Pardos_trank_Soup);
	};
...
{
	AI_Output (self, other, "DIA_Addon_Pardos_trank_03_00");//Díky, to mi udělá dobře.
};
...
FUNC VOID DIA_Addon_Pardos_trank_Soup()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_trank_03_01");//Díky ti, už se cítím trochu silnější.
	B_GivePlayerXP (XP_Ambient *3);
};
//---------------------------------------------------------------------
//	Info perm
...
{
	AI_Output (other, self, "DIA_Addon_Pardos_perm_15_00");//Jak je ti teď?
	AI_Output (self, other, "DIA_Addon_Pardos_perm_03_01");//Líp, díky tobě. Cítím, jak se mi vrací síly.
};
