...
FUNC VOID DIA_Addon_Pardos_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_01");//(vyèerpanê) Jsem úplnê hotovej. Je teë pêknej sluneènej den, nebo jasná noc s tisíci hvêzd na obloze?
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_02");//(ještê unavenêji) Nemám zdání... kam zmizel svêží májový deštík, chladivý veèerní vánek... už je necítím...
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_03");//(rezignovanê) Oèi tu odejdou jako první.
};
//---------------------------------------------------------------------
//	Info save
//---------------------------------------------------------------------
...
{
	AI_Output (other, self, "DIA_Addon_Pardos_save_15_00");//Poèkej tady, záchrana je na cestê.
	AI_Output (self, other, "DIA_Addon_Pardos_save_03_01");//(znavenê) Díky. Dík za ty slova.
...
{
	AI_Output (self, other, "DIA_Addon_Pardos_trank_03_00");//Díky, to mi udêlá dobâe.
};
...
FUNC VOID DIA_Addon_Pardos_trank_Soup()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_trank_03_01");//Díky ti, už se cítím trochu silnêjší.
	B_GivePlayerXP (XP_Ambient *3);
};
//---------------------------------------------------------------------
//	Info perm
...
FUNC VOID DIA_Addon_Pardos_perm_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_perm_03_01");//Líp, díky tobê. Cítím, jak se mi vrací síly.
};
