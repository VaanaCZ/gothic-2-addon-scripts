...
func void DIA_Sylvio_WASISTPASSIERT_washastdudavon ()
{
	...
	AI_Output			(self, other, "DIA_Sylvio_WASISTPASSIERT_washastdudavon_09_01"); //K tomu samýmu co tobę. Ale abych ti odpovędęl na otázku, chci se dostat do tý zamrzlý oblasti.
...
instance DIA_Sylvio_DUHIER		(C_INFO)
{
	...
	description	 = 	"Uvítal bych nęjakou pomoc.";
};
...
{
	AI_Output			(other, self, "DIA_Sylvio_DUHIER_15_00"); //Uvítal bych nęjakou pomoc.
...
func void DIA_SylvioDJG_WHATNEXT_ATTACK ()
{
	...
	B_LogEntry (TOPIC_Dragonhunter,"Ten hajzl Sylvio si dęlal nároky na moje vítęzství nad ledovým drakem. Trochu jsme se kvůli tomu chytli."); 
