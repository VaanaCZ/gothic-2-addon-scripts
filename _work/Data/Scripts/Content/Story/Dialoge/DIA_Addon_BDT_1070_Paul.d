...
INSTANCE DIA_Addon_Paul_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Prodáváš kováâské vybavení?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Paul_Hi_15_00"); //Prodáváš i kováâské vybavení?
	AI_Output (self, other, "DIA_Addon_Paul_Hi_03_01"); //Ocel má Huno. Já tu mám jen pár kousků rudy.
	AI_Output (self, other, "DIA_Addon_Paul_Hi_03_02"); //Ale já se jí nevzdám. Je to jediná cenná vęc, kterou mám.
};
//---------------------------------------------------------------------
//	Info Huno
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Paul_Huno_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Paul_Huno_03_01"); //Chtęl jsem si vydęlat trochu zlata, a tak jsem se pâidal k Hunovi. Jenže od tý doby mi Esteban nedal ani floka.
	AI_Output (self, other, "DIA_Addon_Paul_Huno_03_02"); //Prej už mę nepotâebuje.
	AI_Output (self, other, "DIA_Addon_Paul_Huno_03_03"); //Co jinýho teda můžu dęlat než dál otročit pro Huna?
};
...
FUNC VOID DIA_Addon_Paul_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Paul_Attentat_03_00"); //Prostę nic! Nemoh jsem s tím vůbec nic dęlat! Co po mnę chceš?
};
...
{
	AI_Output (other, self, "DIA_Addon_Paul_HunoVerdacht_15_00"); //Huno prý má nęco společného s tím útokem.
...
INSTANCE DIA_Addon_Paul_HunoArbeit (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Ale vždyă pro Huna pracuješ, tak musíš nęco vędęt!";
};
...
{
	AI_Output (other, self, "DIA_Addon_Paul_HunoArbeit_15_00"); //Ale vždyă pracuješ pro Huna! Tak nęco musíš vędęt!
	AI_Output (self, other, "DIA_Addon_Paul_HunoArbeit_03_01"); //(zoufale) Nevím nic – čestnę! A teë už musím jít!
...
INSTANCE DIA_Addon_Paul_FearEsteban (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Víš, co udęlá Esteban, až zjistí, že Huna kryješ?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Paul_FearEsteban_15_00"); //Víš, co ti Esteban udęlá, až zjistí, že kryješ Huna?
	AI_Output (self, other, "DIA_Addon_Paul_FearEsteban_03_01"); //Nech mę bejt, čéče! S tou vęcí nemám nic společnýho!
...
{
	AI_Output (other, self, "DIA_Addon_Paul_MaulPaul_15_00"); //(pâátelsky) Jestli mi teë hned nevyklopíš, co víš, rozmáznu tę tady o tu zeë, Paule!
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_01"); //Nemůžeš mę zmlátit, páč pracuješ pro šéfa.
	...
	AI_Output (other, self, "DIA_Addon_Paul_MaulPaul_15_04"); //(netrpęlivę) Paule...
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_05"); //(horečnatę) Jediný, co vím, je, že Huno má s Estebanem ŕáký nevyâízený účty.
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_06"); //(horečnatę) Furt mę s tím Estebanem otravuje. Že mu úplnę zničil živnost a tak dále.
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_07"); //Vždycky jsem to jenom poslouchal, ale nic jsem neâíkal.
	AI_Output (other, self, "DIA_Addon_Paul_MaulPaul_15_08"); //Pâesnę tak! No vidíš, že to nebylo tak zlý.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_1070_Paul_Mine_03_00");//Konečnę! Tumáš, za tohle ti dám svou rudu.
...
INSTANCE DIA_Addon_Paul_PERM (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Všecko ostatní je v pohodę?";
};
...
{	
	AI_Output (other, self, "DIA_Addon_Paul_PERM_15_00"); //Jinak jsi v pohodę?
	...
	else 
	{
		...
		&& (Huno_zuSnaf == FALSE)
		{
			AI_Output (self, other, "DIA_Addon_Paul_PERM_03_02"); //Âeknu ti všecko, co vím!
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_Paul_PERM_03_03"); //Jen si chci dęlat svou práci!
		};
	};
};
