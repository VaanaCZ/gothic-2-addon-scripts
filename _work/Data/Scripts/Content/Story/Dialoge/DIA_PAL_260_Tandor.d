...
{
	AI_Output (self, other, "DIA_Tandor_Hallo_08_00"); //Prošel jsi pâes prùsmyk? Dobrá práce. Už jsme tam ztratili víc než dost dobrých mužù.
	AI_Output (self, other, "DIA_Tandor_Hallo_08_01"); //Sám dobâe vím, jak to tam vypadá - jeden èas jsem byl u prùzkumné jednotky.
	AI_Output (self, other, "DIA_Tandor_Hallo_08_02"); //Máš zbraà? Jestli potâebuješ dobrou zbraà, tak jsi tady správnê.
...
func void DIA_Tandor_Trupp_Info ()
{
	...
	AI_Output (self, other, "DIA_Tandor_Trupp_08_01"); //Prozkoumávali jsme oblast a chtêli se dostat na pobâeží. Utáboâili jsme se v jeskyni.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_02"); //Pozdê v noci pâišli skâeti. Šturmovali po svahu s pochodnêmi a bubny - a našli nás.
...
instance DIA_Tandor_Equipment		(C_INFO)
{
	...
	description	 = 	"Posílá mê Garond - potâebuju vybavit.";
};
...
{
	AI_Output (other, self, "DIA_Tandor_Equipment_15_00"); //Posílá mê Garond - potâebuju se vybavit.
	AI_Output (self, other, "DIA_Tandor_Equipment_08_01"); //Zbraà na blízko, nebo na dálku?
...
FUNC VOID DIA_Tandor_Equipment_Nah()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Nah_08_01"); //Bojuješ jednou rukou, nebo obêma?
	
	Info_ClearChoices (DIA_Tandor_Equipment);
	Info_AddChoice 	  (DIA_Tandor_Equipment,"Jednou rukou.",DIA_Tandor_Equipment_Ein);
	Info_AddChoice 	  (DIA_Tandor_Equipment,"Obêma rukama.",DIA_Tandor_Equipment_Zwei);
};
...
FUNC VOID DIA_Tandor_Equipment_Ein()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Ein_08_01"); //Tak si vezmi tohle. Je to dobrá zbraà.
	B_GiveInvItems (self,other, ItMw_Steinbrecher,1);
	Info_ClearChoices (DIA_Tandor_Equipment);
};
FUNC VOID DIA_Tandor_Equipment_Zwei()
{
	AI_Output (other, self, "DIA_Tandor_Equipment_Zwei_15_00"); //Obêma rukama.
	AI_Output (self, other, "DIA_Tandor_Equipment_Zwei_08_01"); //S tímhle obouruèákem bys mêl být spokojený.
...
FUNC VOID DIA_Tandor_Equipment_Bow()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Bow_08_01"); //Tenhle lovecký luk je pro tebe jako dêlaný. Dám ti také nêjaké šípy.
...
FUNC VOID DIA_Tandor_Equipment_Crossbow()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Crossbow_08_01"); //V tom pâípadê si vezmi tuhle lehkou kuši. Mùžu ti dát také nêjaké šipky.
...
{
	AI_Output (other, self, "DIA_Tandor_News_15_00"); //Nêco nového?

	if (hero.guild == GIL_DJG)
		{
			AI_Output (self, other, "DIA_Tandor_News_08_01"); //V poslední dobê se stala jediná vêc - pâišli drakobijci.
		}
	else
		{
			AI_Output (self, other, "DIA_Tandor_News_08_02"); //Pâijeli drakobijci.
			AI_Output (self, other, "DIA_Tandor_News_08_03"); //Vypadají jako pêknê tvrdí parchanti - a to doufám jsou, protože jinak moc dlouho nevydrží.
		};
};
//#####################################################################
//##
...
instance DIA_Tandor_WASISTLOS		(C_INFO)
{
	...
	description	 = 	"Netváâíš se zrovna šãastnê.";
};
...
{
	AI_Output			(other, self, "DIA_Tandor_WASISTLOS_15_00"); //Netváâíš se zrovna šãastnê.

	if (MIS_OCGateOpen == TRUE)
	{
	AI_Output			(self, other, "DIA_Tandor_WASISTLOS_08_01"); //Skâetù bude stále víc a víc. Dokud nebude po nás.
	}
	else
	{
	AI_Output			(self, other, "DIA_Tandor_WASISTLOS_08_02"); //Už týden jsem poâádnê nejedl. Mám hlad jako vlk.
	};
};
