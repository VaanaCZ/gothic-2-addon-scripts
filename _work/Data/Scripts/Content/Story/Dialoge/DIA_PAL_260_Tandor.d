...
{
	AI_Output (self, other, "DIA_Tandor_Hallo_08_00"); //Prošel jsi přes průsmyk? Dobrá práce. Už jsme tam ztratili víc než dost dobrých mužů.
	AI_Output (self, other, "DIA_Tandor_Hallo_08_01"); //Sám dobře vím, jak to tam vypadá - jeden čas jsem byl u průzkumné jednotky.
	AI_Output (self, other, "DIA_Tandor_Hallo_08_02"); //Máš zbraň? Jestli potřebuješ dobrou zbraň, tak jsi tady správně.
...
func void DIA_Tandor_Trupp_Info ()
{
	...
	AI_Output (self, other, "DIA_Tandor_Trupp_08_01"); //Prozkoumávali jsme oblast a chtěli se dostat na pobřeží. Utábořili jsme se v jeskyni.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_02"); //Pozdě v noci přišli skřeti. Šturmovali po svahu s pochodněmi a bubny - a našli nás.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_03"); //Pokusili jsme se uprchnout, ale byl jsem jediný, komu se podařilo odtamtud vyváznout.
	AI_Output (self, other, "DIA_Tandor_Trupp_08_04"); //Krátce na to postavili skřeti svou palisádu, tak jsme se stáhli do hradu.
};	
///////////////////////////////////////////////////////////////////////
//	Info Trade
///////////////////////////////////////////////////////////////////////
...
instance DIA_Tandor_Equipment		(C_INFO)
{
	...
	description	 = 	"Posílá mě Garond - potřebuju vybavit.";
};
...
{
	AI_Output (other, self, "DIA_Tandor_Equipment_15_00"); //Posílá mě Garond - potřebuju se vybavit.
	AI_Output (self, other, "DIA_Tandor_Equipment_08_01"); //Zbraň na blízko, nebo na dálku?
...
FUNC VOID DIA_Tandor_Equipment_Nah()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Nah_08_01"); //Bojuješ jednou rukou, nebo oběma?
	
	Info_ClearChoices (DIA_Tandor_Equipment);
	Info_AddChoice 	  (DIA_Tandor_Equipment,"Jednou rukou.",DIA_Tandor_Equipment_Ein);
	Info_AddChoice 	  (DIA_Tandor_Equipment,"Oběma rukama.",DIA_Tandor_Equipment_Zwei);
};
...
FUNC VOID DIA_Tandor_Equipment_Ein()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Ein_08_01"); //Tak si vezmi tohle. Je to dobrá zbraň.
	B_GiveInvItems (self,other, ItMw_Steinbrecher,1);
	Info_ClearChoices (DIA_Tandor_Equipment);
};
FUNC VOID DIA_Tandor_Equipment_Zwei()
{
	AI_Output (other, self, "DIA_Tandor_Equipment_Zwei_15_00"); //Oběma rukama.
	AI_Output (self, other, "DIA_Tandor_Equipment_Zwei_08_01"); //S tímhle obouručákem bys měl být spokojený.
...
FUNC VOID DIA_Tandor_Equipment_Bow()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Bow_08_01"); //Tenhle lovecký luk je pro tebe jako dělaný. Dám ti také nějaké šípy.
...
FUNC VOID DIA_Tandor_Equipment_Crossbow()
{
	...
	AI_Output (self, other, "DIA_Tandor_Equipment_Crossbow_08_01"); //V tom případě si vezmi tuhle lehkou kuši. Můžu ti dát také nějaké šipky.
...
{
	AI_Output (other, self, "DIA_Tandor_News_15_00"); //Něco nového?

	if (hero.guild == GIL_DJG)
		{
			AI_Output (self, other, "DIA_Tandor_News_08_01"); //V poslední době se stala jediná věc - přišli drakobijci.
		}
	else
		{
			AI_Output (self, other, "DIA_Tandor_News_08_02"); //Přijeli drakobijci.
			AI_Output (self, other, "DIA_Tandor_News_08_03"); //Vypadají jako pěkně tvrdí parchanti - a to doufám jsou, protože jinak moc dlouho nevydrží.
		};
};
//#####################################################################
//##
...
instance DIA_Tandor_WASISTLOS		(C_INFO)
{
	...
	description	 = 	"Netváříš se zrovna šťastně.";
};
...
{
	AI_Output			(other, self, "DIA_Tandor_WASISTLOS_15_00"); //Netváříš se zrovna šťastně.

	if (MIS_OCGateOpen == TRUE)
	{
	AI_Output			(self, other, "DIA_Tandor_WASISTLOS_08_01"); //Skřetů bude stále víc a víc. Dokud nebude po nás.
	}
	else
	{
	AI_Output			(self, other, "DIA_Tandor_WASISTLOS_08_02"); //Už týden jsem pořádně nejedl. Mám hlad jako vlk.
	};
};
