...
func void DIA_Pal_212_Schiffswache_WERSEIDIHR_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pal_212_Schiffswache_WERSEIDIHR_08_01"); //Jsme vyslanci krále Rhobara, služebníci Innosovi, jinak také âeèení paladini.
};
...
{
	AI_Output			(other, self, "DIA_Pal_212_Schiffswache_WASMACHSTDU2_15_00"); //Co tady dêláš?

	if (MIS_ShipIsFree == FALSE)
	{
		if ((hero.guild != GIL_PAL) && (hero.guild != GIL_KDF))
		{
			AI_Output			(self, other, "DIA_Pal_212_Schiffswache_WASMACHSTDU2_08_01"); //Na tu loë nevstoupíš. To je jediné, co potâebuješ vêdêt.
		}
		else
		{
	...
	{
			AI_Output			(self, other, "DIA_Pal_212_Schiffswache_WASMACHSTDU2_08_03"); //Mrháte mým èasem. Mnohem radêji bych byl s vašimi bratry v Hornickém údolí.
	};
	AI_StopProcessInfos (self);
};
