...
FUNC VOID DIA_Addon_Pardos_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_NW_Hi_03_01");//(ušklíbne se) A hele, jestli tohle není můj zachránce? Ještę jednou díky, teë už můžu celý dny vodpočívat.
	AI_Output (other, self, "DIA_Addon_Pardos_NW_Hi_15_02");//Dobâe, tak já tedy půjdu.
};
// ************************************************************
// 			  				PICK POCKET
// ************************************************************
