...
FUNC VOID DIA_Addon_Pardos_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_NW_Hi_03_01");//(ušklíbne se) A hele, jestli tohle není mùj zachránce? Ještì jednou díky, teï už mùžu celý dny vodpoèívat.
	AI_Output (other, self, "DIA_Addon_Pardos_NW_Hi_15_02");//Dobøe, tak já tedy pùjdu.
};
// ************************************************************
// 			  				PICK POCKET
// ************************************************************
