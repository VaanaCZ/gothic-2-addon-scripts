...
INSTANCE DIA_Addon_Pardos_NW_Hi   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Dobrze się czujesz?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Pardos_NW_Hi_15_00");//Dobrze się czujesz?
	AI_Output (self, other, "DIA_Addon_Pardos_NW_Hi_03_01");//Ej, wybawco... Jeszcze raz dziękuję. Teraz mogę cały dzień odpoczywać.
	AI_Output (other, self, "DIA_Addon_Pardos_NW_Hi_15_02");//Widzę. No cóż, na mnie już czas.
};
// ************************************************************
// 			  				PICK POCKET
// ************************************************************
