...
func void DIA_Addon_Gaan_MeetingIsRunning_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Gaan_MeetingIsRunning_03_00"); //Á, nová tváø. Vítej v kruhu vody.
		DIA_Addon_Gaan_MeetingIsRunning_One_time = TRUE;
	}
	else
	{
		AI_Output	(self, other, "DIA_Addon_Gaan_MeetingIsRunning_03_01"); //Vatras tì chce vidìt. Mìl bys za ním zajít.
	};
	AI_StopProcessInfos (self);
};
...
instance DIA_Addon_Gaan_Ranger		(C_INFO)
{
	...
	description	 = 	"Proè se tváøíš tak zasmušile?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Gaan_Ranger_15_00"); //Proè se tváøíš tak vážnì?
	AI_Output	(self, other, "DIA_Addon_Gaan_Ranger_03_01"); //Nosíš akvamarínový prsten.
	AI_Output	(other, self, "DIA_Addon_Gaan_Ranger_15_02"); //Ty patøíš ke kruhu vody?
	AI_Output	(self, other, "DIA_Addon_Gaan_Ranger_03_03"); //Samozøejmì. A rád mezi námi vidím novou tváø.
...
instance DIA_Addon_Gaan_AufgabeBeimRing		(C_INFO)
{
	...
	description	 = 	"Co v tom 'kruhu vody' dìláš ty?";
};
...
func void DIA_Addon_Gaan_AufgabeBeimRing_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Gaan_AufgabeBeimRing_03_01"); //Dohlížím na vstup do prùsmyku a hlídám, kdo pøichází a odchází.
	AI_Output	(self, other, "DIA_Addon_Gaan_AufgabeBeimRing_03_02"); //Ale od té doby, co paladinové zavøeli bránu, sem už moc lidí nechodí.
};
...
instance DIA_Addon_Gaan_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Slyšel jsi o tìch pohøešovaných lidech?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Gaan_MissingPeople_15_00"); //Nezaslechl jsi nìco o tìch pohøešovaných lidech?
	AI_Output	(self, other, "DIA_Addon_Gaan_MissingPeople_03_01"); //Jistìže ano. Právì proto musíme mít oèi na stopkách.
	AI_Output	(self, other, "DIA_Addon_Gaan_MissingPeople_03_02"); //Ale popravdì øeèeno jsem zatím nevidìl nic, co by ti mohlo poskytnout nìjakou stopu.
};
...
FUNC VOID DIA_Gaan_AskTeacher_Info()
{
	...
	AI_Output(self,other,"DIA_Gaan_AskTeacher_03_02"); //Kožešiny a ostatní trofeje ti na trhu vynesou spoustu penìz.
		
	Log_CreateTopic	(TOPIC_Teacher, LOG_NOTE);
	B_LogEntry		(TOPIC_Teacher, "Gaan mì nauèí, jak získat trofeje ze zvíøat.");
};
...
INSTANCE DIA_Gaan_PayTeacher (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Tady máš 100 zlaákù a vysvìtli mi, jak vyvrhnout zvíøata.";
};                       
...
func void DIA_Gaan_TEACHHUNTING_Info ()
{
	...
	if 	(
		...
		{
			AI_Output			(self, other, "DIA_Gaan_TEACHHUNTING_03_02"); //Teï už tì nemùžu nauèit nic, co bys ještì neznal. Je mi líto.
		};
};
	...
	if ((Npc_IsDead(Gaans_Snapper))== FALSE)
		{
			...
			AI_Output			(self, other, "DIA_Gaan_JAGD_03_02"); //Posledních nìkolik dní se tu potuluje nìjaká funící bestie.
