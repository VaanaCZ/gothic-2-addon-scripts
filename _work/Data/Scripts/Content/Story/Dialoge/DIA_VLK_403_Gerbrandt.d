...
INSTANCE DIA_Gerbrandt_PICKPOCKET (C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Ukrást mu penìženku nebude nic tìžkého.)";
};                       
...
{	
	...
	AI_Output (self ,other,"DIA_Gerbrandt_Hello_10_02"); //Øíkají mi Gerbrandt. Pro tebe to znamená: pan Gerbrandt. Jasný?
...
FUNC VOID DIA_Gerbrandt_Hello_Yes_No()
{
	...
	AI_Output (self ,other,"DIA_Gerbrandt_Hello_Yes_No_10_02"); //Jsem s tebou spokojený, mùžu ti nabídnout stálou práci. Je toho tady dost, co je tøeba udìlat.
