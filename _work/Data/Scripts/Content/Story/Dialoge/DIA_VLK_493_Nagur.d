...
///////////////////////////////////////////////////////////////////////
	...
	func void B_Nagur_Abfertigen()
	{
		...
		{
			AI_Output (self ,other,"DIA_Nagur_Add_08_02"); //Nemám dojem, že bych tê nepoznal jen proto, že máš jiný hadry!
		};
		
		AI_Output (self ,other,"DIA_Nagur_Add_08_03"); //(spiklenecky) Ty rád strkáš nos do vêcí, do kterých ti nic není, co?!
...
INSTANCE DIA_Nagur_Job   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kardif âíkal, že pro mê možná budeš mít nêjakou práci.";
};
...
{
	AI_Output (other, self, "DIA_Nagur_Job_15_00");//Kardif âíkal, že pro mê možná budeš mít nêjakou práci.
	...
	{
		AI_Output (self, other, "DIA_Nagur_Job_08_01");//(zkoumavê) Dobrá, dobrá, tak ty se poohlížíš po nêjaké speciální prácièce. Ale hraje se podle mejch pravidel, jasný?
		AI_Output (other, self, "DIA_Nagur_Job_15_02");//Co to znamená?
		AI_Output (self, other, "DIA_Nagur_Job_08_03");//To znamená to, že udêláš, co ti âeknu, a dostaneš tâetinu zisku.
...
FUNC VOID DIA_Nagur_Job_Klar()
{
	...
	AI_Output (self, other, "DIA_Nagur_Job_Klar_08_01");//Fajn, dej mi vêdêt, až budeš pâipravenej na nahrabání hromady penêz.
	Nagur_Deal = 80;
	Info_ClearChoices (DIA_Nagur_Job);
};
FUNC VOID DIA_Nagur_Job_Halbe()
{
	AI_Output (other, self, "DIA_Nagur_Job_Halbe_15_00");//Jsme parãáci, takže fifty-fifty.
	AI_Output (self, other, "DIA_Nagur_Job_Halbe_08_01");//Jo, jasnê, stejnê jsem si myslel, že to tak bude. Samozâejmê že se spravedlivê rozdêlíme.
	Nagur_Deal = 120;
	Info_ClearChoices (DIA_Nagur_Job);
};
///////////////////////////////////////////////////////////////////////
...
FUNC VOID DIA_Nagur_Auftrag_Info()
{
	...
	AI_Output (self, other, "DIA_Nagur_Auftrag_08_05");//Pâineseš mi ji a já ji pak prodám jednomu zajímavýmu zákazníkovi. Dá nám za to poâádnou sumièku zlata.
...
FUNC VOID DIA_Nagur_Auftrag_Akil()
{
	...
	AI_Output (self, other, "DIA_Nagur_Auftrag_Akil_08_01");//Opustíš mêsto východní branou. Je to ta pâímo u tržištê.
	AI_Output (self, other, "DIA_Nagur_Auftrag_Akil_08_02");//Když pùjdeš po cestê napravo, brzo narazíš na nêkolik stupàù vytesaných do skály.
...
FUNC VOID DIA_Nagur_Auftrag_Gewinn()
{
	...
	AI_Output (self, other, "DIA_Nagur_Auftrag_Gewinn_08_01");//Pâesnê têžko âíct. Ale tak kolem 400 zlatých.
};
...
FUNC VOID DIA_Nagur_Auftrag_Wann()
{
	...
	AI_Output (self, other, "DIA_Nagur_Auftrag_Wann_08_01");//Mùžeš jít hned teë. Už by mêl vêdêt, že se jeho poslíèek už nikdy neukáže. (sprostý smích)
};
...
FUNC VOID DIA_Nagur_Deal_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Nagur_Deal_08_01");//Jo, ale za míà, než jsem myslel. Dostal jsem jen 300 zlatých.
		...
		AI_Output (self, other, "DIA_Nagur_Deal_08_04");//Což nakonec dêlá 240 zlatých. Rozdêlíme si to, jak jsme se dohodli. Tady je tvùj díl.
		AI_Output (self, other, "DIA_Nagur_Deal_08_05");//Odvedl jsi dobrou práci. Nechal jsem na to svých zamêstnancích.
		AI_Output (self, other, "DIA_Nagur_Deal_08_06");//Co se na tom vydêlá, už nijak neovlivním.
...
INSTANCE DIA_Nagur_Auftraggeber   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kdo jsou tvý zamêstnanci?";
};
...
FUNC VOID DIA_Nagur_Auftraggeber_Info()
{
	...
	AI_Output (self, other, "DIA_Nagur_Auftraggeber_08_01");//Vážnê si nemyslíš, že ti to âeknu, že ne?
};
///////////////////////////////////////////////////////////////////////
//	Info erneutes ansprechen
///////////////////////////////////////////////////////////////////////
...
{	
	...
	AI_Output (self, other, "DIA_Nagur_Sign_08_01");//Drž se toho, co ti âekla Cassia - nestaráme se o to, kdo jsou ti ostatní. Jsi jedním z nás, a na nièem jiným nesejde.
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
//	Info Perm
...
{	
	AI_Output (self, other, "DIA_Nagur_Perm_08_00");//Podívej se po nêkom jiném. Potlouká se tu kolem dost lidí. Už pro tebe nic dalšího nemám.
	AI_StopProcessInfos (self);
};
