...
///////////////////////////////////////////////////////////////////////
	...
	func void B_Nagur_Abfertigen()
	{
		...
		AI_Output (self ,other,"DIA_Nagur_Add_08_03"); //(spiklenecky) Ty rád strkáš nos do věcí, do kterých ti nic není, co?!
...
FUNC VOID DIA_Nagur_Job_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Nagur_Job_08_01");//(zkoumavě) Dobrá, dobrá, tak ty se poohlížíš po nějaké speciální prácičce. Ale hraje se podle mejch pravidel, jasný?
...
INSTANCE DIA_Nagur_Auftraggeber   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kdo jsou tvý zaměstnanci?";
};
