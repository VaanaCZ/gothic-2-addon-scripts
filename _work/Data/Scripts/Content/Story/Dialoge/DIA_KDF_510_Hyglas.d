...
instance DIA_Hyglas_Feuer		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 =  "Požaduji zkoušku ohnê.";
};
...
{
	AI_Output (other, self, "DIA_Hyglas_Feuer_15_00"); //Chci vykonat zkoušku ohnê.
	AI_Output (self, other, "DIA_Hyglas_Feuer_14_01"); //Zkouška ohnê pochází ze starých èasù a už velice dlouho jí nikdo nepodstoupil.
	AI_Output (self, other, "DIA_Hyglas_Feuer_14_02"); //Co požaduješ, je velice nebezpeèné. Radêji si to ještê rozmysli.
};    
///////////////////////////////////////////////////////////////////////
//	Info Hallo
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (self, other, "DIA_Hyglas_Hallo_14_00"); //Jsem mistr Hyglas, Strážce ohnê a Opatrovník vêdomostí.
	
	if (other.guild == GIL_NOV)
	{
		AI_Output (self, other, "DIA_Hyglas_Hallo_14_01"); //Takže mistr Parlan ti dal svolení ke studiu svitkù.
		AI_Output (self, other, "DIA_Hyglas_Hallo_14_02"); //Takže pâesnê to bys teë mêl dêlat. Studovat, abys ve svatých knihách našel osvícení.
	};
};    
///////////////////////////////////////////////////////////////////////
//	Info JOB
...
func void DIA_Hyglas_JOB_Info ()
{
	...
	AI_Output (self, other, "DIA_Hyglas_JOB_14_01"); //Mùj výzkum se zamêâuje na oheà - Innosovu sílu.
	AI_Output (self, other, "DIA_Hyglas_JOB_14_02"); //Je to jeho dar a zároveà mocná zbraà - a já vytváâím runy, které obsahují jeho moc.
	
	if (other.guild == GIL_NOV)
	{
		AI_Output (other, self, "DIA_Hyglas_JOB_15_03"); //Velmi pouèné. Mohl bys mê to nauèit?
		AI_Output (self, other, "DIA_Hyglas_JOB_14_04"); //Je to Innos, kdo dává dar magie. Jen jeho služebníkùm, ohnivým mágùm, je pâáno vládnout jeho mocí.
	};
};    
///////////////////////////////////////////////////////////////////////
//	Info CONTEST
...
instance DIA_Hyglas_CONTEST		(C_INFO)
{
	...
	permanent	 =  FALSE;
	description	 = 	"Požádal jsem o zkoušk u ohnê.";
};
...
{
	AI_Output (other, self, "DIA_Hyglas_CONTEST_15_00"); //Požádal jsem o zkoušku ohnê. Ulthar mi dal za úkol vytvoâit runu ohnivého šípu.
	AI_Output (self, other, "DIA_Hyglas_CONTEST_14_01"); //A teë po mnê chceš, abych tê nauèil pâíslušnou formuli?
	...
	AI_Output (self, other, "DIA_Hyglas_CONTEST_14_04"); //Dobrá, nauèím tê tu formuli. Ale nejdâív budeš muset najít všechny potâebné ingredience.
	
	B_LogEntry (TOPIC_Rune,"Pokud si obstarám pâíslušné ingredience, nauèí mê Hyglas zaklínadlo pro runu ohnivého šípu.");
};	
///////////////////////////////////////////////////////////////////////
//	Info FIREBOLT
///////////////////////////////////////////////////////////////////////
...
func void DIA_Hyglas_FIREBOLT_Info ()
{
	...
	AI_Output (self, other, "DIA_Hyglas_FIREBOLT_14_01"); //Pâeèti si to - je to tam v têch knihách.
};
///////////////////////////////////////////////////////////////////////
...
instance DIA_Hyglas_TALENT_FIREBOLT		(C_INFO)
{
	...
	permanent 	 =  TRUE; 
	description	 = 	"Nauè mê vytvoâit runu OHNIVÉHO ŠÍPU.";
...
{
	AI_Output (other, self, "DIA_Hyglas_TALENT_FIREBOLT_15_00"); //Nauè mê vytvoâit runu OHNIVÉHO ŠÍPU.
	...
	if (B_TeachPlayerTalentRunes (self, other, SPL_Firebolt))	
	{
		...
		AI_Output (self, other, "DIA_Hyglas_TALENT_FIREBOLT_14_03"); //Takže jakmile budeš mít všechny potâebné vêci, pâistup k runovému stolu a vytvoâ svou runu.
	};
};
///////////////////////////////////////////////////////////////////////
//	Info BLANK_RUNE
...
func void DIA_Hyglas_BLANK_RUNE_Info ()
{
	...
	AI_Output (self, other, "DIA_Hyglas_BLANK_RUNE_14_01"); //Hele, jsi to ty, kdo požádal o zkoušku ohnê, ne já. Najít jej je souèástí zkoušky.
};
///////////////////////////////////////////////////////////////////////
//	Info GOTRUNE
///////////////////////////////////////////////////////////////////////
...
func void DIA_Hyglas_GOTRUNE_Info ()
{
	...
	AI_Output (self, other, "DIA_Hyglas_GOTRUNE_14_01"); //Inu dobrá. Zdá se, že v této èásti zkoušky jsi obstál. Konec koncù to nebylo až tak têžké.
...
func void DIA_Hyglas_TEACH_Info ()
{
	...
	abletolearn = 0;
	AI_Output (other, self, "DIA_Hyglas_TEACH_15_00"); //Uè mê.
...
{
	AI_Output (other,self ,"DIA_Hyglas_BringBook_15_00"); //Je nêco nového?
	AI_Output (self ,other,"DIA_Hyglas_BringBook_14_01"); //Hm, ano. Asi sis už všiml têch postav v èerných róbách.
	AI_Output (other,self ,"DIA_Hyglas_BringBook_15_02"); //Setkal jsem se s nimi.
	AI_Output (self ,other,"DIA_Hyglas_BringBook_14_03"); //To nás pâivádí k jádru vêci. V tuhle chvíli jsme svêdky velice vzácné hvêzdné konstelace.
	AI_Output (self ,other,"DIA_Hyglas_BringBook_14_04"); //Abych byl pâesnêjší, znamení Vola je v pâesné korelaci se znamením Váleèníka. Pâedpokládám, že víš, co to znamená.
	AI_Output (other,self ,"DIA_Hyglas_BringBook_15_05"); //Hmm. No, abych byl upâímný...
	AI_Output (self ,other,"DIA_Hyglas_BringBook_14_06"); //Ano, dobrá, chápu. No, nemùžu ti teë vysvêtlovat všechno, ale každopádnê to pâedznamenává velké zmêny. A já nemám zmêny rád.
	AI_Output (self ,other,"DIA_Hyglas_BringBook_14_07"); //Proto chci, abys mi z mêsta pâinesl jednu knihu. Jmenuje se "Posvátná moc hvêzd". Možná ji budeš muset chvilku hledat, ale jsem si jist, že ji nakonec objevíš.
...
FUNC VOID DIA_Hyglas_BringBook_GetItYourself()
{
	...
	AI_Output (self ,other,"DIA_Hyglas_BringBook_GetItYourself_14_02"); //Bêž mi z oèí a pâemýšlej o svém chování.
...
FUNC VOID DIA_Hyglas_BringBook_GetForIt()
{
	...
	AI_Output (other,self ,"DIA_Hyglas_BringBook_GetForIt_15_02"); //Rád bych vêdêl, co dostanu za to, když ti tu knihu pâinesu.
	AI_Output (self ,other,"DIA_Hyglas_BringBook_GetForIt_14_03"); //Nic. Co bys myslel, že dostaneš? Pokud máš èas dêlat mi ve mêstê poslíèka, je pâímo tvou povinností mi pomoci.
...
FUNC VOID DIA_Hyglas_BringBook_Yes()
{
	...
	AI_Output (self ,other,"DIA_Hyglas_BringBook_Yes_14_01"); //To je správné - získám tak trochu èasu navíc, abych se mohl poohlédnout také po nêèem jiném.
	AI_Output (self ,other,"DIA_Hyglas_BringBook_Yes_14_02"); //Ale aã ti to netrvá moc dlouho. Obávám se, že nemáme èasu nazbyt.
	...
	B_LogEntry (TOPIC_HyglasBringBook,"Hyglas mê požádal, zda bych mu nenašel knihu 'Božská moc hvêzd'. Zkusím se po ní podívat u mêstských obchodníkù.");
};
...
FUNC VOID DIA_Hyglas_HaveBook_Info()
{
	...
	{
		AI_Output (self ,other,"DIA_Hyglas_HaveBook_14_01"); //Výbornê, dej mi ji.
	}
	else
	{
...
INSTANCE DIA_Hyglas_Kap4_PERM   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Už jsi na nêco pâišel?";
};
...
{
	AI_Output (other,self ,"DIA_Hyglas_Kap4_PERM_15_00"); //Už jsi na nêco pâišel?
	
	if (Mis_HyglasBringBook == LOG_SUCCESS)
	{
		AI_Output (self ,other,"DIA_Hyglas_Kap4_PERM_14_01"); //No, nemohu si být úplnê jistý, ale zdá se, že souèasná konstelace hvêzd poukazuje na mnohá nebezpeèí.
		AI_Output (other,self ,"DIA_Hyglas_Kap4_PERM_15_02"); //Jaká nebezpeèí?
		AI_Output (self ,other,"DIA_Hyglas_Kap4_PERM_14_03"); //Inu, vypadá to, že struktura mezi svêty je velice slabá. K vytvoâení díry do této struktury je teë zapotâebí jen zlomek síly co obvykle.
		AI_Output (self ,other,"DIA_Hyglas_Kap4_PERM_14_04"); //Takovéto portály pak mohou používat démoni ke vstupu do našeho svêta, aniž by museli èelit nêjakému odporu.
	...
	{
		AI_Output (self ,other,"DIA_Hyglas_Kap4_PERM_14_06"); //Âekl jsem ti, že stále provádím výzkum, ale samozâejmê by mi to trvalo mnohem déle, kdybych nemêl potâebný materiál.
	};
