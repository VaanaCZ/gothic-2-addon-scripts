...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_ADWHello_15_00"); //Nęjaké nové objevy?
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_01"); //Stavitelé tohoto dávného męsta mę fascinují!
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_02"); //Škoda že jejich jazyk je stejnę mrtvý jako oni.
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_03"); //(rozvážnę) Zachránit je mohly pouze mocné obâady a vyvolávací rituály, které ovládali.
	AI_Output	(other, self, "DIA_Addon_Myxir_ADWHello_15_04"); //Vyvolávací rituály?
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_05"); //Stavitelé byli silnę napojeni na duchovní svęt.
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_06"); //Pokud jsem to dobâe pochopil, vęâili, že jsou v neustálém kontaktu se svými pâedky.
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_07"); //Pravidelnę poâádali obâady, pâi nichž vyvolávali duchy svých pâedků a žádali je o radu a osvícení.
...
func void DIA_Addon_Myxir_ADWHello_wie ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_wie_12_01"); //Strážci smrti męli zvláštní formule, kterými ovládali duchy.
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_wie_12_02"); //Ale nápisy, které jsem tu našel, mę trochu matou. Jen vzácnę v nich najdu jasnou odpovęë na své otázky.
};
func void DIA_Addon_Myxir_ADWHello_Watt ()
{
	AI_Output			(other, self, "DIA_Addon_Myxir_ADWHello_Watt_15_00"); //Nemrtví, které znám, nikdy nemęli mnoho co âíct.
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_Watt_12_01"); //Stavitelé ale nevytváâeli bezduché nemrtvé jako zombie nebo podobné stvůry.
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_Watt_12_02"); //Šlo o duchy velkých válečníků, knęzů a vládců.
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_Watt_12_03"); //Zatím nepochybuji, že skutečnę existovali.
};
...
instance DIA_Addon_Myxir_PermADW		(C_INFO)
{
	...
	description	 = 	"Kdybych nękdy nęjakého ducha potkal, dám ti vędęt.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_PermADW_15_00"); //Až uvidím ducha, dám ti vędęt.
	AI_Output	(self, other, "DIA_Addon_Myxir_PermADW_12_01"); //(smęje se) Ano, na tom trvám.
};
///////////////////////////////////////////////////////////////////////
//	Info GeistTafel
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (other, self, "DIA_Addon_Myxir_GeistTafel_15_00"); //Posílá mę Saturas.
	...
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_03"); //(zaraženę) Pâi Adanovi! 
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_04"); //Určitę vyvolal veleknęze Khardimona a ptal se ho na cestu do chrámu.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_05"); //Podle záznamů je jeho hrob v jeskyních pod pevností.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_06"); //A ty udęláš to samé.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_07"); //Ale Khardimona už se dál ptát nemůžeš.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_08"); //Hrob prince-válečníka Quarhodrona by męl být na západę údolí.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_09"); //Budeš ho muset najít a Quarhodrona probudit.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_10"); //Tyto nápisy hovoâí o tom, že ducha může vyvolat pouze ten, kdo vęâí v Adana.
	AI_Output (other, self, "DIA_Addon_Myxir_GeistTafel_15_11"); //Vážnę myslíš, že to bude fungovat?
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_12"); //Už jsem pâečetl spoustu šílených blábolů.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_13"); //Napâíklad záznamy Y'Beriona, vůdce Spáčova bratrstva.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_14"); //Ale autorovi TĘCHTO záznamů vęâím každé slovo.
	
	MIS_ADDON_Myxir_GeistBeschwoeren = LOG_RUNNING;

	Info_ClearChoices	(DIA_Addon_Myxir_GeistTafel);
	Info_AddChoice	(DIA_Addon_Myxir_GeistTafel, "To myslíš vážnę?", DIA_Addon_Myxir_GeistTafel_geist );
	Info_AddChoice	(DIA_Addon_Myxir_GeistTafel, "Proč Quarhodron? Proč ne veleknęz Khardimon?", DIA_Addon_Myxir_GeistTafel_Khardimon );
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistTafel_Khardimon_15_00"); //Proč Quarhodron? Proč ne veleknęz Khardimon?
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_Khardimon_12_01"); //Havran tím vyvoláváním Khardimonovu hrobku znesvętil. To musíme brát v potaz.
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistTafel_psi_15_00"); //Spáčovo bratrstvo nešíâilo POUZE lži. Spáč opravdu existoval.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_psi_12_01"); //Ale jejich lži nebyly tak nepravdępodobné jako samotná jejich slova.
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_psi_12_03"); //Slova na této kamenné tabulce hovoâí vážnę a prozíravę. A to mę utvrzuje v pâesvędčení, že TENTO človęk hovoâil pravdu.
};
func void DIA_Addon_Myxir_GeistTafel_geist ()
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistTafel_geist_15_00"); //To opravdu myslíš vážnę?
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_geist_12_01"); //Chci prošetâit každou možnost.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_geist_12_02"); //Je to jediná pâíležitost, jak se setkat s jedním ze stavitelů – i když je to pouze duch. Tak proč jí nevyužít.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_geist_12_03"); //Havran to každopádnę dokázal.
	
	Info_AddChoice	(DIA_Addon_Myxir_GeistTafel, "Âeknęme, že bych chtęl toho ducha vyvolat...", DIA_Addon_Myxir_GeistTafel_wie );
};
func void DIA_Addon_Myxir_GeistTafel_wie ()
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistTafel_wie_15_00"); //Co musím udęlat, abych toho ducha vyvolal?
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_wie_12_01"); //Quarhodronův hrob najdeš na západę údolí.
	...
	B_LogEntry (TOPIC_Addon_Quarhodron,"Myxir chce, abych probudil ducha prince Quarhodrona a požádal ho o radu. Dal mi svitek se zaklínadlem, které mám nahlas pâečíst u Quarhodronova hrobu na západę."); 
...
instance DIA_Addon_Myxir_GeistPerm		(C_INFO)
{
	...
	description	 = 	"Můžeš mi ještę zopakovat, co to bylo s tím válečnickým princem Quarhodronem?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistPerm_15_00"); //Můžeš mi ještę zopakovat, jak to bylo s princem Quarhodronem?
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistPerm_12_01"); //Musíš najít jeho hrob a slovy strážců smrti vyvolat jeho ducha.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistPerm_12_02"); //Ta slova jsem ti tady zapsal. Stačí je nahlas pâečíst.
};
...
func void DIA_Addon_Myxir_TalkedToGhost_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_01"); //(nadšenę) Takže jsi ho doopravdy probudil z mrtvých?
	AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_02"); //To je neuvęâitelné. Ti stavitelé mę čím dál víc pâekvapují.
	AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_03"); //Kdo ví, co mohli dokázat, kdyby ještę existovali.
	...
	&&	(Ghost_SCKnowsHow2GetInAdanosTempel == TRUE)
	{
		...
		AI_Output	(other, self, "DIA_Addon_Myxir_TalkedToGhost_15_05"); //Dal mi nęco, co mi pomůže dostat se do Adanova chrámu.
		AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_06"); //Pak bęž rovnou za Saturasem. Tvé informace ho určitę budou zajímat.

		B_LogEntry (TOPIC_Addon_Quarhodron,"Męl bych Saturasovi oznámit, že jsem probudil Quarhodrona."); 
	};
};
