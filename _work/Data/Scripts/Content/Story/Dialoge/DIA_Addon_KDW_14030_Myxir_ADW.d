...
func void DIA_Addon_Myxir_ADWHello_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_02"); //Škoda že jejich jazyk je stejnì mrtvý jako oni.
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_03"); //(rozvážnì) Zachránit je mohly pouze mocné obøady a vyvolávací rituály, které ovládali.
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_06"); //Pokud jsem to dobøe pochopil, vìøili, že jsou v neustálém kontaktu se svými pøedky.
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_07"); //Pravidelnì poøádali obøady, pøi nichž vyvolávali duchy svých pøedkù a žádali je o radu a osvícení.
...
func void DIA_Addon_Myxir_ADWHello_wie ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_wie_12_01"); //Strážci smrti mìli zvláštní formule, kterými ovládali duchy.
...
func void DIA_Addon_Myxir_ADWHello_Watt ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_Watt_12_02"); //Šlo o duchy velkých váleèníkù, knìzù a vládcù.
	AI_Output			(self, other, "DIA_Addon_Myxir_ADWHello_Watt_12_03"); //Zatím nepochybuji, že skuteènì existovali.
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_PermADW_15_00"); //Až uvidím ducha, dám ti vìdìt.
...
func void DIA_Addon_Myxir_GeistTafel_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_03"); //(zaraženì) Pøi Adanovi! 
	...
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_08"); //Hrob prince-váleèníka Quarhodrona by mìl být na západì údolí.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_09"); //Budeš ho muset najít a Quarhodrona probudit.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_10"); //Tyto nápisy hovoøí o tom, že ducha mùže vyvolat pouze ten, kdo vìøí v Adana.
	AI_Output (other, self, "DIA_Addon_Myxir_GeistTafel_15_11"); //Vážnì myslíš, že to bude fungovat?
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_12"); //Už jsem pøeèetl spoustu šílených blábolù.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_13"); //Napøíklad záznamy Y'Beriona, vùdce Spáèova bratrstva.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_14"); //Ale autorovi TÌCHTO záznamù vìøím každé slovo.
	
	MIS_ADDON_Myxir_GeistBeschwoeren = LOG_RUNNING;

	Info_ClearChoices	(DIA_Addon_Myxir_GeistTafel);
	Info_AddChoice	(DIA_Addon_Myxir_GeistTafel, "To myslíš vážnì?", DIA_Addon_Myxir_GeistTafel_geist );
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistTafel_psi_15_00"); //Spáèovo bratrstvo nešíøilo POUZE lži. Spáè opravdu existoval.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_psi_12_01"); //Ale jejich lži nebyly tak nepravdìpodobné jako samotná jejich slova.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_psi_12_02"); //Byli tak zmatení, že si to ani nedovedeš pøedstavit. Kouøili moc té své trávy z bažin.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_psi_12_03"); //Slova na této kamenné tabulce hovoøí vážnì a prozíravì. A to mì utvrzuje v pøesvìdèení, že TENTO èlovìk hovoøil pravdu.
};
func void DIA_Addon_Myxir_GeistTafel_geist ()
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistTafel_geist_15_00"); //To opravdu myslíš vážnì?
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_geist_12_01"); //Chci prošetøit každou možnost.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_geist_12_02"); //Je to jediná pøíležitost, jak se setkat s jedním ze stavitelù – i když je to pouze duch. Tak proè jí nevyužít.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_geist_12_03"); //Havran to každopádnì dokázal.
	
	Info_AddChoice	(DIA_Addon_Myxir_GeistTafel, "Øeknìme, že bych chtìl toho ducha vyvolat...", DIA_Addon_Myxir_GeistTafel_wie );
};
func void DIA_Addon_Myxir_GeistTafel_wie ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_wie_12_03"); //To je všechno. Teï zbývá už jen najít hrob.
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_wie_12_04"); //Hodnì štìstí, synu.

	B_LogEntry (TOPIC_Addon_Quarhodron,"Myxir chce, abych probudil ducha prince Quarhodrona a požádal ho o radu. Dal mi svitek se zaklínadlem, které mám nahlas pøeèíst u Quarhodronova hrobu na západì."); 
...
instance DIA_Addon_Myxir_GeistPerm		(C_INFO)
{
	...
	description	 = 	"Mùžeš mi ještì zopakovat, co to bylo s tím váleènickým princem Quarhodronem?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_GeistPerm_15_00"); //Mùžeš mi ještì zopakovat, jak to bylo s princem Quarhodronem?
...
func void DIA_Addon_Myxir_TalkedToGhost_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_01"); //(nadšenì) Takže jsi ho doopravdy probudil z mrtvých?
	...
	&&	(Ghost_SCKnowsHow2GetInAdanosTempel == TRUE)
	{
		...
		AI_Output	(other, self, "DIA_Addon_Myxir_TalkedToGhost_15_05"); //Dal mi nìco, co mi pomùže dostat se do Adanova chrámu.
		AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_06"); //Pak bìž rovnou za Saturasem. Tvé informace ho urèitì budou zajímat.

		B_LogEntry (TOPIC_Addon_Quarhodron,"Mìl bych Saturasovi oznámit, že jsem probudil Quarhodrona."); 
	};
};
