...
FUNC VOID DIA_Addon_Fortuno_Hi_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Fortuno_Hi_13_00");//(nervóznê) Temný mrak kolem domu... už se blíží...
		AI_Output (self, other, "DIA_Addon_Fortuno_Hi_13_01");//Krev... jen ta ho vyvolá... ON mê vidí... on mê vidí... ach ne, bêž pryè, ztraã se...
		...
		B_LogEntry (Topic_Addon_Fortuno,"Fortuno se úplnê pomátl. Hledá nêjakého 'zeleného novice'.");
	...
	Info_AddChoice 	  (DIA_Addon_Fortuno_Hi,"Ještê se vrátím. (KONEC)",DIA_Addon_Fortuno_Hi_BACK);	
	
	Info_AddChoice 	  (DIA_Addon_Fortuno_Hi,"Mùžu ti nêjak pomoci?",DIA_Addon_Fortuno_Hi_HILFE);
...
{
	AI_Output (other, self, "DIA_Addon_Fortuno_Hi_HILFE_15_00");//Mùžu ti nêjak pomoci?
...
{
	AI_Output (other, self, "DIA_Addon_Fortuno_wer_15_00");//No tak mi povêz, co je s tebou.
	AI_Output (self, other, "DIA_Addon_Fortuno_wer_13_01");//Kdysi jsem patâil k bratrstvu Spáèe. Všecko bylo tehdá fajn.
	AI_Output (self, other, "DIA_Addon_Fortuno_wer_13_02");//Ano, byli jsme bývalí zloèinci, ale jako novici jsme nemêli žádný starosti.
	AI_Output (other, self, "DIA_Addon_Fortuno_wer_15_03");//Hele, já byl v Hornickým údolí zavâenej taky, takže mi radši povêz nêco novýho.
	...
	AI_Output (self, other, "DIA_Addon_Fortuno_wer_13_06");//Havran... pamatuju si jenom Havrana a... a nêjaké temné místnosti.
	AI_Output (other, self, "DIA_Addon_Fortuno_wer_15_07");//Co je s Havranem? Co ti udêlal?
	AI_Output (self, other, "DIA_Addon_Fortuno_wer_13_08");//(povzdech) Je mi líto. Moje mysl jako by poâád byla ještê ve vêzení... sám to nechápu...
};
///////////////////////////////////////////////////////////////////////
//	Info FREE
///////////////////////////////////////////////////////////////////////
INSTANCE DIA_Addon_Fortuno_FREE   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Nêjak si tu pamêã pâece musíš osvêžit.";
};
...
{
	AI_Output (other, self, "DIA_Addon_Fortuno_FREE_15_00");//Musí být pâece nêjaký zpùsob, jak ti osvêžit pamêã.
	AI_Output (self, other, "DIA_Addon_Fortuno_FREE_13_01");//Jo... jo, možná to nêjak pùjde.
	AI_Output (self, other, "DIA_Addon_Fortuno_FREE_13_02");//Guru znali rùzné zpùsoby, jak pozmênit ducha a vùli.
	AI_Output (other, self, "DIA_Addon_Fortuno_FREE_15_03");//A PAMATUJEŠ si z toho nêco?
	AI_Output (self, other, "DIA_Addon_Fortuno_FREE_13_04");//Ne, obávám se, že tyhle vêdomosti zmizely spolu s guru.
	AI_Output (other, self, "DIA_Addon_Fortuno_FREE_15_05");//A sakra. No, jestli existuje nêjaký zpùsob, jak osvobodit ducha, tak ho najdu.
...
INSTANCE DIA_Addon_Fortuno_Herb   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Potâebuješ ještê další trávu z bažin?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Fortuno_Herb_15_00");//Nepotâebuješ ještê nêjakou trávu z bažin?
	AI_Output (self, other, "DIA_Addon_Fortuno_Herb_13_01");//Joooo, urèitê. Koupím všecku trávu, která se ti dostane do rukou.
...
{
	AI_Output (other, self, "DIA_Addon_Fortuno_Trade_15_00");//Mám pro tebe nêjakou trávu z bažin.
...
FUNC VOID DIA_Addon_Fortuno_Trank_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fortuno_Trank_13_01");//Vêâím ti.
...
FUNC VOID DIA_Addon_Fortuno_more_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_01");//Aáá! Už si vzpomínám! Teë už to vidím – Adane, stùj pâi mnê – co jsem to udêlal?!
	AI_Output (other, self, "DIA_Addon_Fortuno_more_15_02");//Tak co jsi udêlal? A hlavnê co udêlal Havran?
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_03");//Pomoh jsem mu. Pomoh jsem mu navázat kontakt. S NÍM. Chtêl nêjaké elixíry a já je pro nêj namíchal.
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_04");//Pokusil se otevâít portál a dostat se do chrámu.
	AI_Output (other, self, "DIA_Addon_Fortuno_more_15_05");//Proè? Co v tom chrámu chtêl?
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_06");//Mocný artefakt. Je pohâbený i s tím, kdo ho kdysi nosil. S mocným váleèníkem, co se pâidal k NÊMU.
	...
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_09");//Jenže Havran vêdêl JISTÊ, že to pùjde, když vykope knêzovu hrobku.
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_10");//A proto sem taky pâivedl všechny ty otroky. Obêti, který mohl pâimêt, aby kopaly tam, kde i sám èas odpoèívá v pokoji.
	AI_Output (other, self, "DIA_Addon_Fortuno_more_15_11");//Knêzovu hrobku?
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_12");//Místo posledního odpoèinku Adanova knêze. Leží v dole.
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_13");//Taky si vzpomínám na kamenný tabulky. Vêâil, že mu ukážou cestu.
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_14");//A když je koneènê rozluštil, už mê nepotâeboval.
	AI_Output (self, other, "DIA_Addon_Fortuno_more_13_15");//Seslal na mê kouzlo zapomnêní a... a pak jsi mê vysvobodil až ty.
	
	SC_KnowsFortunoInfos = TRUE;
	
	B_LogEntry (TOPIC_Addon_RavenKDW,"Havran chce z Adanova chrámu získat nêjaký mocný artefakt."); 
	Log_AddEntry (TOPIC_Addon_RavenKDW,"Havran v dole z jakéhosi dùvodu vykopal hrob nêjakého dávného knêze."); 
	Log_AddEntry (TOPIC_Addon_RavenKDW,"Havran vêâí, že mu v jeho snažení pomohou nêjaké kamenné tabulky."); 
...
FUNC VOID DIA_Addon_Fortuno_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fortuno_Attentat_13_00");//Útok? Promià, byl jsem na chvíli... tak nêjak mimo. Nevím o tom vùbec nic.
};
