...
{	
	...
	AI_Output (self ,other,"DIA_Larius_WhoAreYou_01_05"); //Velí tady tomu ten lord Hagen, alespoň po tu dobu, co je ve městě.
...
INSTANCE DIA_Larius_Disturb(C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Nechtěl jsem rušit.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Larius_Disturb_15_00"); //Nechtěl jsem rušit.
...
{	
	...
	AI_Output (self ,other,"DIA_Larius_DieLage_01_01"); //Co tady chceš? Dokud jsou paladinové ve městě, mají veškeré věci kolem Khorinidu na starosti oni.
};
...
INSTANCE DIA_Larius_Richterueberfall(C_INFO)
{
	...
	description	= "Soudce najal nějaké lumpy, aby tě napadli.";
};                       
