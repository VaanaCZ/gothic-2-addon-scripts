...
{
	AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_00"); //¡ALTO!
	...
	if (B_GetGreatestPetzCrime(self) >= CRIME_ATTACK)
	{
		...
		{
			AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_01"); //Violaría mi deber más sagrado si permitiese la entrada a un asesino.
		};
	
		if (B_GetGreatestPetzCrime(self) == CRIME_THEFT)
		{
			AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_02"); //Se te acusa de robo. Mientras sea así, ¡no puedes entrar!
		};
	
		if (B_GetGreatestPetzCrime(self) == CRIME_ATTACK)
		{
			AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_03"); //Tienes fama de camorrista. No voy a dejarte entrar.
		};
	
		AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_04"); //¡Ve a ver a lord Andre y arregla el asunto!
	}
	
	// ------ normales Reinkommen ------
	else 
	{
		AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_05"); //Solo pueden entrar al ayuntamiento los que están al servicio del rey.
	};
...
{
	AI_Output (self, other,"DIA_PAL_205_Torwache_SecondWarn_12_00"); //Si das un paso más, ¡por Innos que acabarás en el suelo!
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_Hagen_15_00"); //¡Tengo que hablar con lord Hagen!
	AI_Output (self, other,"DIA_PAL_205_Torwache_Hagen_12_01"); //¿Sabes cuántas veces he oído eso? No puedes entrar. Si lo intentas, tendré que matarte.
...
INSTANCE DIA_PAL_205_Torwache_PassAsMil (C_INFO)
{
	...
	permanent 	= TRUE; 
	description	= "Soy un miembro de la milicia.";
};                       
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_PassAsMil_15_00"); //Soy miembro de la milicia.
	AI_Output (self, other,"DIA_PAL_205_Torwache_PassAsMil_12_01"); //De acuerdo, puedes entrar.
...
INSTANCE DIA_PAL_205_Torwache_PassAsMage (C_INFO)
{
	...
	permanent 	= TRUE; 
	description	= "Soy un mago de fuego.";
};                       
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_PassAsMage_15_00"); //Soy uno de los magos de fuego.
	AI_Output (self, other,"DIA_PAL_205_Torwache_PassAsMage_12_01"); //Sí, claro. Perdóname, elegido, pero solo cumplo con mi deber.
...
INSTANCE DIA_PAL_205_Torwache_PassAsSld (C_INFO)
{
	...
	permanent 	= TRUE; 
	description	= "Déjame pasar, traigo un mensaje de los mercenarios.";
};                       
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_PassAsSld_15_00"); //Déjame pasar, traigo un mensaje de los mercenarios.
	AI_Output (self, other,"DIA_PAL_205_Torwache_PassAsSld_12_01"); //De acuerdo, pero te lo advierto. Si nos causas problemas, no tendrás tiempo de arrepentirte.
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_PERM_15_00"); //¿Qué tal va la guardia?
	
	if (other.guild == GIL_PAL) 
	|| (other.guild == GIL_MIL)
	{
		AI_Output (self, other,"DIA_PAL_205_Torwache_PERM_12_01"); //Lo tenemos todo bajo control.
	}
	else if (other.guild == GIL_KDF)
	{
		AI_Output (self, other,"DIA_PAL_205_Torwache_PERM_12_02"); //Mi labor me satisface, elegido.
	}
	else if (other.guild == GIL_SLD)
	||		(other.guild == GIL_DJG)
	{
		AI_Output (self, other,"DIA_PAL_205_Torwache_PERM_12_03"); //Entra y calla.
	}
	else //GIL_None 
	{
		AI_Output (self, other,"DIA_PAL_205_Torwache_PERM_12_04"); //¿Qué es lo que quieres?
	};
