...
func void DIA_PAL_205_Torwache_FirstWarn_Info()
{
	...
	if (B_GetGreatestPetzCrime(self) >= CRIME_ATTACK)
	{
		...
		{
			AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_02"); //Jsi obvinên z krádeže. Dokud naâèení trvá, nemùžeš vstoupit!
		};
	
		if (B_GetGreatestPetzCrime(self) == CRIME_ATTACK)
		{
			AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_03"); //Jsi známý jako rváè. Nepustím tê dovnitâ.
		};
	
		AI_Output (self, other,"DIA_PAL_205_Torwache_FirstWarn_12_04"); //Bêž za lordem Andrem a urovnej celou tu záležitost!
	}
...
{
	AI_Output (self, other,"DIA_PAL_205_Torwache_SecondWarn_12_00"); //Ještê jeden krok a pâísahám k Innosovi, že to bude krok poslední!
...
FUNC VOID DIA_PAL_205_Torwache_Hagen_Info()
{
	...
	AI_Output (self, other,"DIA_PAL_205_Torwache_Hagen_12_01"); //Víš, kolikrát jsem to už slyšel? Dovnitâ nemùžeš. Když to ale pâece jenom zkusíš, budu tê muset zabít.
...
FUNC VOID DIA_PAL_205_Torwache_PassAsMil_Info()
{
	...
	AI_Output (self, other,"DIA_PAL_205_Torwache_PassAsMil_12_01"); //Dobrá, mùžeš dovnitâ.
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_PassAsMage_15_00"); //Jsem mág ohnê.
	AI_Output (self, other,"DIA_PAL_205_Torwache_PassAsMage_12_01"); //Ano, samozâejmê. Odpusã, vyvolený, konám jen svou povinnost.
...
INSTANCE DIA_PAL_205_Torwache_PassAsSld (C_INFO)
{
	...
	permanent 	= TRUE; 
	description	= "Pusã mê dovnitâ, pâináším vzkaz od žoldnéâù.";
};                       
...
{
	AI_Output (other, self,"DIA_PAL_205_Torwache_PassAsSld_15_00"); //Pusã mê dovnitâ, pâináším vzkaz od žoldnéâù.
	AI_Output (self, other,"DIA_PAL_205_Torwache_PassAsSld_12_01"); //Dobrá, ale varuju tê. Jestli zkusíš dêlat nêjaké problémy, nebudeš mít ani èas toho litovat.
...
FUNC VOID DIA_PAL_205_Torwache_PERM_Info()
{
	...
	{
		AI_Output (self, other,"DIA_PAL_205_Torwache_PERM_12_02"); //Má služba mê plnê uspokojuje, vyvolený.
	}
