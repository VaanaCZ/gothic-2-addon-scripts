...
func void DIA_Kati_SLDNOCHDA_Info ()
{
	...
	if (Hilfe == FALSE)
	{
		AI_Output (self, other, "DIA_Kati_SLDNOCHDA_16_00"); //Ti hrdlořezové mému muži vyhrožují! Jsme řádnými občany města, věrnými králi, a žoldáci nás chtějí oloupit o všechno!
		Hilfe = TRUE;
	};
...
func void DIA_Kati_HIERWEG_Info ()
{
	...
	AI_Output (self, other, "DIA_Kati_HIERWEG_16_02"); //Jediné dvě cesty ven jsou průsmyk do Hornického údolí a přístav v Korinidu.
