...
func void DIA_Kati_SLDNOCHDA_Info ()
{
	...
	if (Hilfe == FALSE)
	{
		AI_Output (self, other, "DIA_Kati_SLDNOCHDA_16_00"); //Ti hrdloøezové mému muži vyhrožují! Jsme øádnými obèany mìsta, vìrnými králi, a žoldáci nás chtìjí oloupit o všechno!
		Hilfe = TRUE;
	};
...
func void DIA_Kati_BAUERNAUFSTAND_Info ()
{
	...
	AI_Output (self, other, "DIA_Kati_BAUERNAUFSTAND_16_02"); //Na druhou stranu, jsou tu i takoví jako Bengar a Sekob, co by se radìji vzdali svých farem, než by pracovali pro krále.
...
func void DIA_Kati_HIERWEG_Info ()
{
	...
	AI_Output (self, other, "DIA_Kati_HIERWEG_16_02"); //Jediné dvì cesty ven jsou prùsmyk do Hornického údolí a pøístav v Korinidu.
