...
func void DIA_Albrecht_Hagen_Info ()
{
	...
	AI_Output (self, other, "DIA_Albrecht_Hagen_03_02"); //Ale aã po nêm chceš cokoliv, snaž se to neprotahovat - je to velice zamêstnaný èlovêk!
};
///////////////////////////////////////////////////////////////////////
//	Info Hallo
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (other, self, "DIA_Albrecht_CanTeach_15_00"); //Mùžeš mê nêèemu nauèit?
	
	if (other.guild == GIL_PAL)
	{
		AI_Output (self, other, "DIA_Albrecht_CanTeach_03_01"); //Pokud se ukáže, že jsi toho hoden, vênuji ti magickou runu paladinù.
		AI_Output (self, other, "DIA_Albrecht_CanTeach_03_02"); //Kromê toho tê mohu nauèit, jak si zvýšit magickou sílu.
...
func void DIA_Albrecht_TEACHPalRunes_Info ()
{
	...
	if (PLAYER_TALENT_RUNES [SPL_PalLight] == FALSE)
	{
		...
		AI_Output (self,other, "DIA_Albrecht_TEACHPalRunes_03_01"); //Na znamení tvé hodnosti ti dávám runu svêtla. Je to symbol pravdy a spravedlnosti.
		AI_Output (self,other, "DIA_Albrecht_TEACHPalRunes_03_02"); //Osvêtluj cestu všem, kdo jdou po stopách Innosových.
		AI_Output (self,other, "DIA_Albrecht_TEACHPalRunes_03_03"); //Všechny ostatní runy si musíš vysloužit. Vraã se, až nabudeš dojmu, že jich jsi hoden.
...
{
	AI_Output (self ,other,"B_Albrecht_YouAreNotWorthy_03_00"); //Ještê nejsi hoden obdržet další kouzlo této cesty.
};
...
FUNC VOID DIA_Albrecht_TEACHPalRunes_Heal()
{
	...
	&&	(MIS_ReadyforChapter4 == TRUE)
	{
		Info_ClearChoices   (DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice (DIA_Albrecht_TEACHPalRunes,DIALOG_BACK,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice	(DIA_Albrecht_TEACHPalRunes, B_BuildLearnString ("Léèba lehkých zranêní", CostForPalSpells) ,DIA_Albrecht_TEACHPalRunes_PalLightHeal);
	}
	...
	&&	(Kapitel >= 5)
	{
		Info_ClearChoices   (DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice (DIA_Albrecht_TEACHPalRunes,DIALOG_BACK,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice	(DIA_Albrecht_TEACHPalRunes, B_BuildLearnString ("Léèba stâednê têžkých zranêní", CostForPalSpells) ,DIA_Albrecht_TEACHPalRunes_PalMediumHeal);
	}
	else
	{
...
func void DIA_Albrecht_Teach_BACK()
{
	...
	{
		AI_Output (self, other, "DIA_Albrecht_Teach_03_00"); //Pokud bys chtêl zvýšit svou magickou sílu ještê víc, budeš si už muset najít jiného uèitele.
	};
	Info_ClearChoices (DIA_Albrecht_TEACH);
};
