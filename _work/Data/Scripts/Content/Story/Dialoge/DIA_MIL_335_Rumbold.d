...
{
	AI_Output			(other, self, "DIA_Rumbold_PrePerm_15_00"); //Co tady dêláš?
	AI_Output			(self, other, "DIA_Rumbold_PrePerm_10_01"); //Ztraã se! Rozumíš?
...
{
	AI_Output (self, other, "DIA_Rumbold_Hallo_10_00"); //No podívejte na tohohle. Další vtipálek. Co tady dêláš, hm?
	...
	{
		AI_Output (self, other, "DIA_Rumbold_Hallo_10_02"); //Jsi jeden z têch špinavých žoldákù!
	};
	...
	Info_AddChoice	(DIA_Rumbold_HALLO, "Jsem tvoje nejhorší noèní mùra.", DIA_Rumbold_HALLO_Attack );

};
func void DIA_Rumbold_HALLO_Attack ()
{
	AI_Output (other, self, "DIA_Rumbold_HALLO_Attack_15_00"); //Jsem tvoje nejhorší noèní mùra.
...
func void DIA_Rumbold_HALLO_verschwindet ()
{
	...
	AI_Output (self, other, "DIA_Rumbold_HALLO_verschwindet_10_02"); //(výhrùžnê) A co se stane, když zùstaneme?

	Info_ClearChoices	(DIA_Rumbold_HALLO);

	Info_AddChoice	(DIA_Rumbold_HALLO, "Kolik vám musím zaplatit, abyste se ztratili?", DIA_Rumbold_HALLO_geld);
	Info_AddChoice	(DIA_Rumbold_HALLO, "V tom pâípadê to je naposledy, co jste ty farmáâe obtêžovali.", DIA_Rumbold_HALLO_AufsMaul);
};

func void DIA_Rumbold_HALLO_AufsMaul()
{
	AI_Output (other, self, "DIA_Rumbold_HALLO_AufsMaul_15_00"); //V tom pâípadê to je naposledy, co jste ty farmáâe obtêžovali.
	AI_Output (self, other, "DIA_Rumbold_HALLO_AufsMaul_10_01"); //Ukousl sis trošku vêtší sousto, než dokážeš spolknout, pitomèe!
...
func void DIA_Rumbold_HALLO_geld ()
{
	...
	AI_Output (self, other, "DIA_Rumbold_HALLO_geld_10_01"); //Chceš zaplatit za Bengara? To je nêco jiného.
	AI_Output (self, other, "DIA_Rumbold_HALLO_geld_10_02"); //Nech mê pâemýšlet. Se všemi têmi obrovskými výlohami nám Bengar dluží ještê 65 zlatých.
	AI_Output (self, other, "DIA_Rumbold_HALLO_geld_10_03"); //Buë vysolíš prachy na dâevo, nebo se do nièeho nemíchej.
	AI_Output (self, other, "DIA_Rumbold_HALLO_geld_10_04"); //Tak. Ty jsi Bengarùv pokladní, nebo co?
...
func void DIA_Rumbold_HALLO_geld_ok ()
{
	...
	AI_Output (self, other, "DIA_Rumbold_HALLO_geld_ok_10_01"); //Mnê je jedno, kdo za Bengara zaplatí. Pâeju hezký den. (k sobê) Pitomèe!
	...
	&& (!Npc_IsDead (Rick))	
	{	
		Npc_ExchangeRoutine	(Rick,"Zaèít"); 
	...
	&& (!Npc_IsDead (Bengar))	
	{	
		Npc_ExchangeRoutine	(Bengar,"Zaèít"); 
...
func void DIA_Rumbold_HALLO_Geld_TooMuch()
{
	...
	AI_Output (self, other, "DIA_Rumbold_HALLO_geld_TooMuch_10_01"); //V tom pâípadê se do nièeho nepleã!
	AI_StopProcessInfos (self);
};
...
func void DIA_Rumbold_FightNow_Info ()
{
	...
	AI_Output (self, other, "DIA_Rumbold_FightNow_10_01"); //Máš snad nêco s ušima, chlapèe?
...
instance DIA_Rumbold_StillThere (C_INFO)
{
	...
	permanent 	= TRUE;
	description = "Hele, jak to, že jsi ještê tady!";
};
...
{
	AI_Output (other, self, "DIA_Rumbold_StillThere_15_00"); //Hele, jak to, že jsi ještê tady!
