...
{	
	AI_Output (self ,other,"DIA_Addon_Brandon_Hello_04_00"); //A heleme se. Àákej zelenáè.
	AI_Output (self ,other,"DIA_Addon_Brandon_Hello_04_01"); //A ještê k tomu suchozemská krysa!
...
{	
	AI_Output (other,self ,"DIA_Addon_Brandon_AnyNews_15_00"); //Nêco nového?
	
	if (self.aivar[AIV_PARTYMEMBER] == TRUE)
	{
		if (self.attribute[ATR_HITPOINTS] < 100)
		{
			AI_Output (self ,other,"DIA_Addon_Brandon_Alright_04_01"); //To bych âek. Jsem zranênej, nemáš nêjakej léèivej lektvar?
		}
		else
		{
			if (C_AllCanyonRazorDead() == FALSE)
			{
				AI_Output (self ,other,"DIA_Addon_Brandon_Alright_04_02"); //Co teë? Pùjdem na ty potvory, nebo ne?
			}
			else //alle platt
			{
				AI_Output (self ,other,"DIA_Addon_Brandon_Alright_04_03"); //Že se ptáš! Myslím, že v tom zatraceným kaàonu už nezùstala ani jedna z têch potvor bâitváckejch.
			};
		};
	}
	...
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_AnyNews_04_04"); //Ne, ale co se vrátil Greg, urèitê se to zmêní. Aspoà doufám.
	}
	else
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_AnyNews_04_06"); //(spiklenecky) Momentíèek.
		AI_PlayAni (self, "T_SEARCH");
		AI_Output (self ,other,"DIA_Addon_Brandon_AnyNews_04_07"); //(smêje se) Ne, pokud vidím. Všechno pâi starým!
	};
};
...
{
	AI_Output (other, self,"DIA_Addon_Brandon_WannaLearn_15_00"); //Mùžeš mê nêco nauèit?
	AI_Output (self ,other,"DIA_Addon_Brandon_WannaLearn_04_01"); //Nauèit? To si piš! Mùžu ti ukázat, jak posílit svý têlo a stát se obratnêjším.
	AI_Output (self ,other,"DIA_Addon_Brandon_WannaLearn_04_02"); //Ale proè bych to dêlal?
	AI_Output (other,self ,"DIA_Addon_Pir_7_HenrysCrew_OfferDrink_15_00"); //Protože ti koupím nêco k pití?
	AI_Output (self ,other,"DIA_Addon_Brandon_WannaLearn_04_03"); //(šklebí se) To není špatný, hochu! Uhádnul – a hned napoprvý!
	AI_Output (self ,other,"DIA_Addon_Brandon_WannaLearn_04_04"); //Ale ne abys mi pâines àákej levnej samoser.
	...
	Log_AddEntry (TOPIC_Addon_BrandonBooze,"Brandon mê mùže nêèemu pâiuèit, ale napâed mu musím koupit nêco k pití.");
};
...
func void DIA_Addon_Brandon_HoleGrog_Info()
{
	...
	AI_Output (self ,other,"DIA_Addon_Brandon_HoleGrog_04_01"); //To mê chceš votrávit?
	AI_Output (self ,other,"DIA_Addon_Brandon_HoleGrog_04_02"); //Takový moèùvky se ani netknu! Máš vùbec ponêtí, co do toho dávaj?
	AI_Output (self ,other,"DIA_Addon_Brandon_HoleGrog_04_03"); //Starej Samuel prodává i DOBRÝ zboží! Tak mi koukej vobstarat nêco takovýho!
	...
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_HoleGrog_04_05"); //Už jsi nêkdy vyzkoušel Samuelùv zvláštní recept?
		AI_Output (other,self ,"DIA_Addon_Brandon_Hello_15_07"); //Ne, ještê ne.
		AI_Output (self ,other,"DIA_Addon_Brandon_HoleGrog_04_06"); //Tak to koukej rychle napravit!
	};
	AI_Output (self ,other,"DIA_Addon_Brandon_HoleGrog_04_08"); //Já tu jeho míchanici prostê ZBOŽÀUJU!
	
	B_LogEntry (TOPIC_Addon_BrandonBooze,"Koâalka Brandonovi nestaèí. Chce 'rychlého herynka', kterého prodává jedinê Samuel.");
};
// ------------------------------------------------------------
...
func void DIA_Addon_Brandon_SchnellerHering_Info()
{
	...
	AI_Output (self ,other,"DIA_Addon_Brandon_GiveGrog_04_01"); //Aáá! To to krásnê pálí! Jak voheà!
	
	B_LogEntry (TOPIC_Addon_BrandonBooze,"Dal jsem Brandonovi ten dêsný dryák. Teë už mê bude uèit.");
...
{	
	AI_Output (other,self ,"DIA_Addon_Francis_TeachPlayer_15_00"); //Nauè mê nêco!
	...
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_TeachPlayer_04_01"); //Mêls mi pâinýst nêco dobrýho k pití, hochu!
	};
};
// ------------------------------------------------------------
FUNC VOID DIA_Addon_Brandon_TeachPlayer_Back()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_TeachPlayer_Back_04_00"); //No dobâe! Už seš vo trochu silnêjší.
	};
	
	if other.attribute[ATR_DEXTERITY] > Brandon_Merke_Dex
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_TeachPlayer_Back_04_01"); //Èím budeš vobratnêjší, tím spíš zasáhneš cíl.
	};
	Info_ClearChoices (DIA_Addon_Brandon_TeachPlayer);
};
// ------------------------------------------------------------
...
{	
	...
	AI_Output (other,self ,"DIA_Addon_Brandon_FollowMe_15_02"); //Greg. Máme jít do kaàonu lovit bâitovce.
	AI_Output (self ,other,"DIA_Addon_Brandon_Anheuern_04_03"); //(šklebí se) Koneènê se tu taky nêco dêje!
	AI_Output (self ,other,"DIA_Addon_Brandon_Anheuern_04_04"); //Tak pojëme, èím dâív to s nima vyâídíme, tím dâív se sem vrátíme.
};
...
func void DIA_Addon_Brandon_ComeOn_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_Brandon_ComeOn_04_02"); //Napâed se kousek vraãme.
		AI_StopProcessInfos (self);
	}
	else
	{
...
{	
	AI_Output (other,self ,"DIA_Addon_Brandon_DontNeedYou_15_00"); //Už tê nepotâebuju.
	AI_Output (self ,other,"DIA_Addon_Brandon_GoHome_04_01"); //Fajn, v pohodê.
