...
{
	AI_Output (self, other, "DIA_Cedric_Hallo_12_00"); //Jsem Cedric, mistr meèe, královský paladin.
};
...
{
	AI_Output (other, self, "DIA_Cedric_CanTeach_15_00"); //Mùžeš mì uèit?
	
	if (other.guild == GIL_PAL)
	{
		AI_Output (self, other, "DIA_Cedric_CanTeach_12_01"); //Mùžu tì trénovat v boji s jednoruèními zbranìmi.
		Cedric_Teach1H = TRUE;
		B_LogEntry (TOPIC_CityTeacher,"Paladin Cedric mì nauèí zacházet s jednoruèními zbranìmi.");
	}
	else
	{
...
{	
	AI_Output (other,self ,"DIA_Cedric_Teach_15_00"); //Chci, abys mì uèil.
	
	if (other.HitChance[NPC_TALENT_1H] >= 90)
	{
		AI_Output (self,other,"DIA_DIA_Cedric_Teach_12_01"); //O boji s meèem už víš úplnì všechno. Už tì nemám co nauèit.
	}
	else
	{
