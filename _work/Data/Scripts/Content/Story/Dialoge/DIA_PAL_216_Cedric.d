...
{
	AI_Output (self, other, "DIA_Cedric_Hallo_12_00"); //Soy Cedric el maestro de armas, paladín del rey.
};
...
{
	AI_Output (other, self, "DIA_Cedric_CanTeach_15_00"); //¿Puedes entrenarme?
	
	if (other.guild == GIL_PAL)
	{
		AI_Output (self, other, "DIA_Cedric_CanTeach_12_01"); //Te puedo entrenar en el combate con armas a una mano,
		Cedric_Teach1H = TRUE;
		B_LogEntry (TOPIC_CityTeacher,"Cedric, el paladín, puede enseñarme a luchar con armas a una mano.");
	}
	else
	{
		AI_Output (self, other, "DIA_Cedric_CanTeach_12_02"); //Solo entreno a paladines.
	};
...
{	
	AI_Output (other,self ,"DIA_Cedric_Teach_15_00"); //Quiero entrenar.
	
	if (other.HitChance[NPC_TALENT_1H] >= 90)
	{
		AI_Output (self,other,"DIA_DIA_Cedric_Teach_12_01"); //Lo has aprendido todo acerca de la lucha a espada. No puedo enseñarte más.
	}
	else
	{
