...
{
	AI_Output (other, self, "DIA_Cedric_CanTeach_15_00"); //Mùžeš mê uèit?
	
	if (other.guild == GIL_PAL)
	{
		AI_Output (self, other, "DIA_Cedric_CanTeach_12_01"); //Mùžu tê trénovat v boji s jednoruèními zbranêmi.
		Cedric_Teach1H = TRUE;
...
{	
	...
	{
		AI_Output (self,other,"DIA_DIA_Cedric_Teach_12_01"); //O boji s meèem už víš úplnê všechno. Už tê nemám co nauèit.
	}
	else
	{
