...
func void DIA_Cedric_CanTeach_Info ()
{
	...
	if (other.guild == GIL_PAL)
	{
		...
		Cedric_Teach1H = TRUE;
		B_LogEntry (TOPIC_CityTeacher,"Il paladino Cedric può insegnarmi a combattere con armi a una mano.");
	}
	else
	{
...
{	
	...
	{
		AI_Output (self,other,"DIA_DIA_Cedric_Teach_12_01"); //Hai già imparato tutto sul combattimento con la spada. Non posso insegnarti nient'altro.
	}
	else
	{
