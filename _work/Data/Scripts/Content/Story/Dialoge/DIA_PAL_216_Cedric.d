...
{	
	AI_Output (other,self ,"DIA_Cedric_Teach_15_00"); //Chci, abys mě učil.
	
	if (other.HitChance[NPC_TALENT_1H] >= 90)
	{
		AI_Output (self,other,"DIA_DIA_Cedric_Teach_12_01"); //O boji s mečem už víš úplně všechno. Už tě nemám co naučit.
	}
	else
	{
