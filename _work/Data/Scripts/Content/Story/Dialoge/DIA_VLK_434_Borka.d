...
{
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_00");  //Hej, ty! Jak se vede? Nezáleží na tom, co máš v plánu - na to bude dost èasu pozdêji.
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_01");  //Stojíš pâímo pâed perlou Khorinidu - ÈERVENOU LUCERNOU. Je to ten nejkrásnêjší nevêstinec v celé Myrtanê, to si piš!
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_02");  //Kotví tu námoâníci ze všech koutù zemê, jen aby tu mohli strávit pár nocí.
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_03");  //A teë máš tuhle šanci - ne, èest - právê ty! Mùžeš strávit noc s Nadjou, nejvášnivêjším kvêtem, jaký kdy bohové stvoâili!
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_04");  //Pojë dál a užij si to, o èem se jiným ani nesnilo!
...
{
	AI_Output (self, other, "DIA_Borka_TROUBLE_11_00"); //Proè postáváš takhle stranou? Pojë dál a uvidíš naši vášnivou Nadju.
	AI_Output (self, other, "DIA_Borka_TROUBLE_11_01"); //Plameny, které v tobê tahle noèní bytost zažehne, dají tvému životu nový smysl!
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
//	Info Smoke
...
instance DIA_Borka_Smoke		(C_INFO)
{
	...
	permanent	 =  TRUE;
	description	 =  "Nevíš, kde bych sehnal nêco ke kouâení?";
};
...
{
	AI_Output (other, self, "DIA_Borka_Smoke_15_00"); //Nevíš, kde bych si mohl koupit nêjaké kuâivo - trávu nebo nêco takového?
...
func void DIA_Borka_BUYHERB_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Borka_BUYHERB_11_01"); //Je mi líto, pane strážník. To musí být nêjaká mýlka, o žádných drogách nic nevím.
	}
	else
	{
...
FUNC VOID DIA_Borka_BUYHERB_Egal ()
{
	...
	AI_Output	(self, other, "DIA_Borka_BUYHERB_Egal_11_01"); //Jenom chci vêdêt, kdo tê posílá, abych mêl jistotu, že jsi v poâádku.
...
FUNC VOID DIA_Borka_BUYHERB_NADJA ()
{
	...
	AI_Output (self, other, "DIA_Borka_BUYHERB_NADJA_11_01"); //Co ty víš - ptáèek si prostê zaštêbetal. Nemùžeš vêâit všemu, co ti ta holka nakuká.
...
FUNC VOID DIA_Borka_BUYHERB_Deal ()
{
	...
	AI_Output (self, other, "DIA_Borka_BUYHERB_Deal_11_01"); //...no dobâe... tak tedy budeme obchodovat. Dej mi 50 zlaãákù a já ti za nê dám nêco ke kouâení. A žádné smlouvání.
	Info_ClearChoices 	(DIA_Borka_BUYHERB);
	Borka_Deal = TRUE;
};	
///////////////////////////////////////////////////////////////////////
...
instance DIA_Borka_SECOND_CHANCE		(C_INFO)
{
	...
	permanent	 =  TRUE;  	
	description	 = 	"Tak uzavâeme obchod (zaplatit 50 zlaãákù).";
};
...
func void DIA_Borka_SECOND_CHANCE_Info ()
{
	...
	AI_PlayAni (self, "T_SEARCH");
	AI_Output (self, other, "DIA_Borka_SECOND_CHANCE_11_02"); //...tady je èerstvý, pryskyâicí vylepšený joint.
