...
func void DIA_Borka_PISSOFF_Info ()
{
	...
	AI_Output (self, other,"DIA_Borka_PISSOFF_11_01");  //Stojíš přímo před perlou Khorinidu - ČERVENOU LUCERNOU. Je to ten nejkrásnější nevěstinec v celé Myrtaně, to si piš!
...
instance DIA_Borka_Smoke		(C_INFO)
{
	...
	permanent	 =  TRUE;
	description	 =  "Nevíš, kde bych sehnal něco ke kouření?";
};
...
func void DIA_Borka_BUYHERB_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Borka_BUYHERB_11_01"); //Je mi líto, pane strážník. To musí být nějaká mýlka, o žádných drogách nic nevím.
	}
	else
	{
...
FUNC VOID DIA_Borka_BUYHERB_Deal ()
{
	...
	AI_Output (self, other, "DIA_Borka_BUYHERB_Deal_11_01"); //...no dobře... tak tedy budeme obchodovat. Dej mi 50 zlaťáků a já ti za ně dám něco ke kouření. A žádné smlouvání.
	Info_ClearChoices 	(DIA_Borka_BUYHERB);
	Borka_Deal = TRUE;
};	
///////////////////////////////////////////////////////////////////////
...
instance DIA_Borka_SECOND_CHANCE		(C_INFO)
{
	...
	permanent	 =  TRUE;  	
	description	 = 	"Tak uzavřeme obchod (zaplatit 50 zlaťáků).";
};
