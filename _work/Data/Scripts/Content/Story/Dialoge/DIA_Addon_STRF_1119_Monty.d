...
FUNC VOID DIA_Addon_Monty_Hi_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Monty_Hi_08_02");//Jestli si chceš o nêèem promluvit, zajdi za Patrickem.
		Monty_einmal = TRUE;
	};
};
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Monty_Hacken_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Monty_Hacken_08_00");//Pâi dolování je nejdùležitêjší úhel, jakým vedeš rány.
