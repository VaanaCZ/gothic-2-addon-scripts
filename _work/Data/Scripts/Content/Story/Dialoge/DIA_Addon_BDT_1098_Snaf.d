...
FUNC VOID DIA_Addon_Snaf_Cook_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Cook_01_01"); //Chci vyzkoušet nový jídlo – pálivý nudlièky ve cloumákový omáèce.
...
FUNC VOID DIA_Addon_Snaf_Cook_FEUER()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Cook_FEUER_01_01");//Kâupavý, krásnê opeèený maso s nakládanejma ohnivejma kopâivama.
...
FUNC VOID DIA_Addon_Snaf_Cook_HAMMER()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Cook_HAMMER_01_01");//Ta omáèka se dêlá z koâalky – cloumáka. Mám tu recept od jistýho Lou.
	AI_Output (self, other, "DIA_Addon_Snaf_Cook_HAMMER_01_02");//Když seženeš všecko potâebný a v alchymistický kolonê destiluješ koâalku, udêlám z ní tu omáèku. Co ty na to?
	
	Info_AddChoice (DIA_Addon_Snaf_Cook,"Na to nemám èas.",DIA_Addon_Snaf_Cook_NO);
	Info_AddChoice (DIA_Addon_Snaf_Cook,"Dobâe, udêlám to.",DIA_Addon_Snaf_Cook_YES);
	
};
FUNC VOID DIA_Addon_Snaf_Cook_NO ()
{
	AI_Output (other, self, "DIA_Addon_Snaf_Cook_HAMMER_NO_15_00");//Na tohle nemám èas.
	AI_Output (self, other, "DIA_Addon_Snaf_Cook_HAMMER_NO_01_01");//Pak na to zapomeà.
...
{
	AI_Output (other, self, "DIA_Addon_Snaf_Cook_HAMMER_YES_15_00");//Dobâe, udêlám to.
	...
	B_LogEntry (Topic_Addon_Hammer,"Snaf do své omáèky potâebuje trochu koâalky. Dal mi recept na cloumák, který mùžu namíchat na laboratorním stole.");
};
//---------------------------------------------------------------------
//	Info Booze
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Snaf_Booze_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Booze_01_01");//Výbornê, tak to dodêláme.
	AI_Output (self, other, "DIA_Addon_Snaf_Booze_01_02");//Tumáš, mùžeš to hned ochutnat. Poâádnê to posílí paže.
	AI_Output (self, other, "DIA_Addon_Snaf_Booze_01_03");//A jestli budeš ještê nêco potâebovat, tak odteëka máš všecky informace zadarmo.
	Snaf_Tip_Kosten = 0;
...
FUNC VOID DIA_Addon_Snaf_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_01_01"); //Myslíš tu vêc s Estebanem?
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_01_02"); //Však víš, jak to je. Barman slyší všecko, ale nikdy není na nièí stranê.
	
	Info_ClearChoices (DIA_Addon_Snaf_Attentat);
	Info_AddChoice 	  (DIA_Addon_Snaf_Attentat,"Aspoà mi povêz, za kým bych mêl jít.",DIA_Addon_Snaf_Attentat_GoWhere);
	Info_AddChoice 	  (DIA_Addon_Snaf_Attentat,"Co bys na mém místê dêlal ty?",DIA_Addon_Snaf_Attentat_YouBeingMe);
	Info_AddChoice 	  (DIA_Addon_Snaf_Attentat,"Takže víš nêco?",DIA_Addon_Snaf_Attentat_Something);	
};
	
func void DIA_Addon_Snaf_Attentat_Something()
{
	AI_Output (other, self, "DIA_Addon_Snaf_Attentat_Something_15_00"); //Tak zaslechl jsi nêco?
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_Something_01_01"); //To jsem neâek.
};
func void DIA_Addon_Snaf_Attentat_GoWhere()
{
	AI_Output (other, self, "DIA_Addon_Snaf_Attentat_GoWhere_15_00"); //Tak mi aspoà poraë, za kým bych mêl jít.
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_GoWhere_01_01"); //Ale no tak! Jakej by v tom byl rozdíl? Zapomeà na to!
};
func void DIA_Addon_Snaf_Attentat_YouBeingMe()
{
	AI_Output (other, self, "DIA_Addon_Snaf_Attentat_YouBeingMe_15_00"); //A co bys na mým místê dêlal ty?
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_YouBeingMe_01_01"); //Trochu bych popâemýšlel, jestli náhodou nevím, kdo to má na svêdomí.
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_YouBeingMe_01_02"); //Za prvé – nejspíš je to nêkdo z banditù, èili nêkdo z tohohle tábora.
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_YouBeingMe_01_03"); //Za druhé – když je to nêkdo z tohohle tábora, znamená to, že tê sleduje.
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_YouBeingMe_01_04"); //A za tâetí – pokud si myslí, že seš na Estebanovê stranê, dá si bacha, aby se neprozradil.
	AI_Output (self, other, "DIA_Addon_Snaf_Attentat_YouBeingMe_01_05"); //Takže NEJZAJÍMAVÊJŠÍ otázka zní, jaký máš vùbec šance toho chlapa najít?
...
FUNC VOID DIA_Addon_Snaf_Abrechnung_Info()
{
	...
	&& (!Npc_IsDead (Senyan))
	{
		...
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_03"); //Musíš se s ním pâestat stýkat, jinak nikdy nebudeš mít šanci najít toho, kdo má ten útok na svêdomí.
		
		if (Snaf_Tip_Senyan == FALSE)
		{
			B_LogEntry (Topic_Addon_Senyan,"Mêl bych nêjak skoncovat se Senyanem, ale nebylo by moc chytré na nêj pâímo zaútoèit. Napâed bych si s ním mêl promluvit.");
			Snaf_Tip_Senyan = TRUE;
		};
	}
	else if (Npc_IsDead(Senyan))
	{
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_04"); //Oddêlal jsi jednoho z Estebanovejch lidí. Ten chlap, po kterým jdeš, si teë bude myslet, že jsi na jeho stranê.
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_05"); //Ale jen tak se ti neprozradí. Stejnê budeš muset zjistit víc.
	}
	else if (Finn_Petzt == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_08"); //To znamená, žes mu nejspíš âek nêco, co nechtêl slyšet.
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_09"); //To urèitê potêší toho, koho hledáš.
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_10"); //Jenže se taky nakrásnê mùže stát, že s tím pobêží za Estebanem – (ironicky) ale to víš jistê sám.
	}
	if (Finn_TellAll == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_11"); //Prej jsi Finnovi âek, že pracuješ pro Estebana.
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_12"); //Nevím, co máš za lubem, ale ten, koho hledáš, si teë na tebe bude dávat mnohem vêtší pozor.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_13"); //Ale nic ještê není jistý.
	};
	...
	if (Snaf_Rechnung == FALSE)
	{
		if (Snaf_Einmal == FALSE)
		{
			...
			AI_Output (self, other, "DIA_Addon_Snaf_Abschied_01_15"); //(stroze) Hele, neâek jsem ti nic, co bys už nevêdêl, jasný?
		...
		else
		{
			...
			AI_Output (self, other, "DIA_Addon_Snaf_Abschied_01_17"); //Pâesnê tak.
		};
	};
};
...
instance DIA_Addon_Snaf_HOCH (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Podle Huna bych se tu mêl s nêkým setkat.";
};
...
{
	AI_Output (other, self, "DIA_Addon_Snaf_HOCH_15_00"); //Posílá mê Huno.
	AI_Output (self, other, "DIA_Addon_Snaf_HOCH_01_01"); //Vypadá to, žes už toho chlapa našel.
	AI_Output (self, other, "DIA_Addon_Snaf_HOCH_01_02"); //Pokraèuj do dalšího patra, nêkdo tam na tebe èeká.
...
FUNC VOID DIA_Addon_Snaf_People_Info()
{
	...
	&& (MIS_SnafHammer != LOG_SUCCESS)
	{
		AI_Output (self, other, "DIA_Addon_Snaf_People_01_02"); //Každá informace tê bude stát...
...
// --------------------------------------------
	...
	{
		AI_Output (self, other, "DIA_Addon_Snaf_NotEnough_01_00"); //Nemáš dost penêz, hochu!
	};
...
FUNC VOID DIA_Addon_Snaf_People_Paul()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Snaf_People_Paul_01_01"); //Nemyslím, že má Estebana nêjak zvlášã v lásce. Od tý doby, co zaèal dêlat pro Huna, se už do dolu nedostal.
	}
	else
	{
...
FUNC VOID DIA_Addon_Snaf_People_Huno()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_People_Huno_01_01"); //Á, Huno! O nêm nevím skoro nic.
	AI_Output (self, other, "DIA_Addon_Snaf_People_Huno_01_02"); //(ušklíbá se) Tahle informace je pochopitelnê zdarma.
};
FUNC VOID DIA_Addon_Snaf_People_Fisk()
{
	...
	if (B_GiveInvItems(other, self, ItMi_Gold, Snaf_Tip_Kosten))
	{
		AI_Output (self, other, "DIA_Addon_Snaf_People_Fisk_01_01"); //Fisk je Fisk. Platí Estebanovi poplatky a rozdêluje zboží, který vêtšinou získává od pirátù.
		AI_Output (self, other, "DIA_Addon_Snaf_People_Fisk_01_02"); //Nezdá se mi, že by se o Estebana nêjak staral.
	}
	else
	{
		B_Addon_Snaf_NotEnough();
...
FUNC VOID DIA_Addon_Snaf_People_Senyan()
{
	...
	if (B_GiveInvItems(other, self, ItMi_Gold, Snaf_Tip_Kosten))
	{
		AI_Output (self, other, "DIA_Addon_Snaf_People_Senyan_01_01"); //Senyan je jeden z Estebanovejch chlapù. Už àákou dobu pro nêj dêlá.
	}
	else
	{
		B_Addon_Snaf_NotEnough();
...
func VOID DIA_Addon_Snaf_People_Finn()
{
	...
	if (B_GiveInvItems(other, self, ItMi_Gold, Snaf_Tip_Kosten))
	{
		AI_Output (self, other, "DIA_Addon_Snaf_People_Finn_01_01"); //Dobrej kopáè. Má na zlato prostê nos.
		AI_Output (self, other, "DIA_Addon_Snaf_People_Finn_01_02"); //Esteban ho má kvùli tomu rád. Myslím, že si ho fakt váží.
	}
	else
	{
		B_Addon_Snaf_NotEnough();
...
FUNC VOID DIA_Addon_Snaf_Himself_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Himself_01_01"); //Každej, kdo o nêm mluví, je za chvíli mrtvej.
...
FUNC VOID DIA_Addon_Snaf_PERM_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_PERM_01_01"); //Dobâe! Estebanova smrt je pro nêkterý místní velkej dùvod k oslavê.
};
