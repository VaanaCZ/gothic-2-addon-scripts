...
func void DIA_Mil_325_Miliz_FirstWarn_Info()
{
	...
	AI_Output (self, other,"DIA_Mil_325_Miliz_FirstWarn_12_01"); //Nikt nie może wejść do magazynu.
...
{
	AI_Output (self, other,"DIA_Mil_325_Miliz_SecondWarn_12_00"); //Głuchy jesteś? Jeden krok dalej, a posiekam cię na kawałki.
...
func void DIA_Mil_325_Miliz_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Mil_325_Miliz_Attack_12_00"); //To był błąd!
...
INSTANCE DIA_Mil_325_Miliz_Pass (C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Należę do armii królewskiej. Potrzebuję wyposażenia!";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_Pass_15_00"); //Należę do armii królewskiej. Potrzebuję wyposażenia!
	AI_Output (self, other,"DIA_Mil_325_Miliz_Pass_12_01"); //Masz na to jakieś potwierdzenie?
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_Pass_Yes_15_00"); //Oczywiście.
	AI_Output (self, other,"DIA_Mil_325_Miliz_Pass_Yes_12_01"); //W porządku, możesz wejść!
...
func void DIA_Mil_325_Miliz_Pass_No()
{
	...
	AI_Output (self, other,"DIA_Mil_325_Miliz_Pass_No_12_01"); //W takim razie wynoś się.
	Info_ClearChoices (DIA_Mil_325_Miliz_Pass);
	AI_StopProcessInfos (self);
};
...
INSTANCE DIA_Mil_325_Miliz_PERM (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Dlaczego nikt nie może wejść do magazynu?";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_PERM_15_00"); //Dlaczego nikt nie może wejść do magazynu?
	AI_Output (self, other,"DIA_Mil_325_Miliz_PERM_12_01"); //Miłościwy Lord Hagen skonfiskował wszystko na potrzeby armii królewskiej.
};
