...
func void DIA_Mil_325_Miliz_FirstWarn_Info()
{
	...
	AI_Output (self, other,"DIA_Mil_325_Miliz_FirstWarn_12_01"); //Do skladiště nesmí nikdo vstoupit.
...
{
	AI_Output (self, other,"DIA_Mil_325_Miliz_SecondWarn_12_00"); //Jsi snad hluchý? Ještě jeden krok a nadělám z tebe sekanou!
...
INSTANCE DIA_Mil_325_Miliz_Pass (C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Patřím ke královské armádě. Chci si vyzvednout výstroj!";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_Pass_15_00"); //Patřím ke královské armádě. Chci si vyzvednout výstroj!
	AI_Output (self, other,"DIA_Mil_325_Miliz_Pass_12_01"); //A máš k tomu příkaz?
	
	Info_ClearChoices (DIA_Mil_325_Miliz_Pass);
	Info_AddChoice (DIA_Mil_325_Miliz_Pass, "Ne.", DIA_Mil_325_Miliz_Pass_No);
	Info_AddChoice (DIA_Mil_325_Miliz_Pass, "Jasně.", DIA_Mil_325_Miliz_Pass_Yes);
};

func void DIA_Mil_325_Miliz_Pass_Yes()
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_Pass_Yes_15_00"); //Jasně.
	AI_Output (self, other,"DIA_Mil_325_Miliz_Pass_Yes_12_01"); //Dobrá, můžeš dovnitř!
...
INSTANCE DIA_Mil_325_Miliz_PERM (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Proč do skladiště nikdo nesmí?";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_PERM_15_00"); //Proč do skladiště nikdo nesmí?
	AI_Output (self, other,"DIA_Mil_325_Miliz_PERM_12_01"); //Ctihodný lord Hagen zabavil zboží ve prospěch královské armády.
};
