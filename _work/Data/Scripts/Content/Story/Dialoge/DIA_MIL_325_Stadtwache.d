...
func void DIA_Mil_325_Miliz_FirstWarn_Info()
{
	...
	AI_Output (self, other,"DIA_Mil_325_Miliz_FirstWarn_12_01"); //Do skladištê nesmí nikdo vstoupit.
...
{
	AI_Output (self, other,"DIA_Mil_325_Miliz_SecondWarn_12_00"); //Jsi snad hluchý? Ještê jeden krok a nadêlám z tebe sekanou!
...
INSTANCE DIA_Mil_325_Miliz_Pass (C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Patâím ke královské armádê. Chci si vyzvednout výstroj!";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_Pass_15_00"); //Patâím ke královské armádê. Chci si vyzvednout výstroj!
	...
	Info_AddChoice (DIA_Mil_325_Miliz_Pass, "Jasnê.", DIA_Mil_325_Miliz_Pass_Yes);
};

func void DIA_Mil_325_Miliz_Pass_Yes()
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_Pass_Yes_15_00"); //Jasnê.
	AI_Output (self, other,"DIA_Mil_325_Miliz_Pass_Yes_12_01"); //Dobrá, mùžeš dovnitâ!
...
INSTANCE DIA_Mil_325_Miliz_PERM (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Proè do skladištê nikdo nesmí?";
};                       
...
{
	AI_Output (other, self,"DIA_Mil_325_Miliz_PERM_15_00"); //Proè do skladištê nikdo nesmí?
	AI_Output (self, other,"DIA_Mil_325_Miliz_PERM_12_01"); //Ctihodný lord Hagen zabavil zboží ve prospêch královské armády.
};
