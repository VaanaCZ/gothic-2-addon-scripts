...
func void DIA_Bronko_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Bronko_HALLO_06_03"); //Jestli se chceš poflakovat po mym pozemku, zaplaă mi 5 zlatých, jinak si koleduješ o pęknej náâez!
	...
	Info_AddChoice	(DIA_Bronko_HALLO, "Tvůj pozemek? Ty jsi zdejší statkáâ?", DIA_Bronko_HALLO_deinland );

};

func void DIA_Bronko_HALLO_deinland ()
{
	AI_Output			(other, self, "DIA_Bronko_HALLO_deinland_15_00"); //Tvůj pozemek? Ty jsi zdejší statkáâ?
...
instance DIA_Bronko_KEINBAUER		(C_INFO)
{
	...
	description	 = 	"Takový sedlák jako ty? To bys mę rozesmál. Vždyă jsi hotová nicka!";
};
