...
FUNC VOID DIA_1061_Wache_Hallo_Info()
{
	...
	AI_Output (other, self, "DIA_1061_Wache_Hallo_15_01");//Chtęl bych mluvit s tvým šéfem.
...
FUNC VOID DIA_1061_Wache_Hallo_Dexter()
{
	...
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Dexter_01_03");//Takže se zhluboka nadechni a nech hezky svoje zbranę tam, kde jsou. Dextera nejdeš v domę.
...
{
	AI_Output (self, other, "DIA_1061_Wache_Perm_01_00");//Pamatuj, buë v pohodę a dostaneš se odsud živej.
	AI_StopProcessInfos (self);
};
