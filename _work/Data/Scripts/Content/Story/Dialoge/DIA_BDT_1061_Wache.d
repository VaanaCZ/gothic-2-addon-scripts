...
FUNC VOID DIA_1061_Wache_Hallo_Info()
{
	...
	AI_Output (other, self, "DIA_1061_Wache_Hallo_15_01");//Chtêl bych mluvit s tvým šéfem.
	AI_Output (self, other, "DIA_1061_Wache_Hallo_01_02");//(ironicky) Ó, já vím, ty chceš mluvit s mým šéfem. Tak to tê SAMOZÂEJMÊ nechám projít.
	AI_Output (self, other, "DIA_1061_Wache_Hallo_01_03");//(smrtelnê vážnê) Ale jen v tom pâípadê, že znáš jeho jméno. Protože jestli ne, tak tê budu muset zabít! Jasný?
...
FUNC VOID DIA_1061_Wache_Hallo_Lee()
{
	...
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Lee_01_01");//Fajn, co na to mám âíct? Právê jsi propadl životem, chlape!
...
FUNC VOID DIA_1061_Wache_Hallo_Dexter()
{
	...
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Dexter_01_01");//Dobrá... Hádám, že šéfa znáš. Fajn, dovolím ti projít. Ale varuju tê.
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Dexter_01_02");//Kâivej pohyb a nedostaneš se odsud vcelku!
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Dexter_01_03");//Takže se zhluboka nadechni a nech hezky svoje zbranê tam, kde jsou. Dextera nejdeš v domê.
...
FUNC VOID DIA_1061_Wache_Hallo_Diego()
{
	...
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Diego_01_01");//Správnê!
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Diego_01_02");//Ne, to byl jen žert. Nemáš ani ponêtí, kdo je mùj šéf.
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Diego_01_03");//Takže nevidím žádnej dùvod, proè bych tê mêl nechat naživu.
...
{
	AI_Output (self, other, "DIA_1061_Wache_Perm_01_00");//Pamatuj, buë v pohodê a dostaneš se odsud živej.
	AI_StopProcessInfos (self);
};
