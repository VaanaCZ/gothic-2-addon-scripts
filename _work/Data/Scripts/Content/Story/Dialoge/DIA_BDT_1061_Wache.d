...
FUNC VOID DIA_1061_Wache_Hallo_Info()
{
	...
	AI_Output (other, self, "DIA_1061_Wache_Hallo_15_01");//Chtěl bych mluvit s tvým šéfem.
...
FUNC VOID DIA_1061_Wache_Hallo_Lee()
{
	...
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Lee_01_01");//Fajn, co na to mám říct? Právě jsi propadl životem, chlape!
...
FUNC VOID DIA_1061_Wache_Hallo_Dexter()
{
	...
	AI_Output (self, other, "DIA_1061_Wache_Hallo_Dexter_01_03");//Takže se zhluboka nadechni a nech hezky svoje zbraně tam, kde jsou. Dextera nejdeš v domě.
...
{
	AI_Output (self, other, "DIA_1061_Wache_Perm_01_00");//Pamatuj, buď v pohodě a dostaneš se odsud živej.
	AI_StopProcessInfos (self);
};
