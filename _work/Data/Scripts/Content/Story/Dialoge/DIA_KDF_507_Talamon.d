...
{
	AI_Output (self, other,"DIA_KDF_507_Talamon_SecondWarn_04_00"); //Innos na tebe sešle svùj hnêv, jestli nepùjdeš zpátky!
...
FUNC VOID DIA_Talamon_KAP5_Stop_Info()
{
	...
	AI_Output (self, other,"DIA_Talamon_KAP5_Stop_04_02"); //No, když to âíká. Dobrá, mùžeš vstoupit. Kniha, kterou hledáš, je tamhle u té alchymistické kolony.
...
FUNC VOID DIA_Talamon_FoundSecretDoor_Info()
{
	...
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_01"); //(pâekvapenê) Cože? Kde?
	...
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_05"); //To jsou dùležité zprávy, okamžitê je pâedám Pyrokarovi.
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_06"); //Mezitím bys mêl zjistit, co v tom sklepê je.
...
INSTANCE DIA_Talamon_ScoutSecretLibrary   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Byl jsem v té kryptê.";
};
...
{
	AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_00"); //Byl jsem v té kryptê.
	AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_01"); //A co jsi zjistil?
	
	if (Npc_IsDead (SecretLibrarySkeleton))
	{
		AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_02"); //Byl tam kostlivec váleèník, který hlídal dveâe. Zabil jsem ho.
	...
	else
	{
		...
		AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_06"); //Musí tam nêco být, hledej dál. A s têmi potvorami nemêj žádné slitování.
	};
};
