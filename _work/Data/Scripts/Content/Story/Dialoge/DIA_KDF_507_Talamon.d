...
INSTANCE DIA_Talamon_FoundSecretDoor   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Ho trovato una porta segreta.";
};
...
INSTANCE DIA_Talamon_ScoutSecretLibrary   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Sono stato nella cripta.";
};
...
{
	AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_00"); //Sono stato nella cripta.
	AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_01"); //E cosa hai trovato?
	
	if (Npc_IsDead (SecretLibrarySkeleton))
	{
		AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_02"); //C'era uno scheletro guerriero a guardia di una porta. L'ho ucciso.
		AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_03"); //Bel lavoro.
		AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_04"); //Ci occuperemo del sotterraneo una volta che avremo sconfitto il male.
