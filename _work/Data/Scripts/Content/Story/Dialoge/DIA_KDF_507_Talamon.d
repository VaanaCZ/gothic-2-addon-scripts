...
{
	AI_Output (self, other,"DIA_KDF_507_Talamon_FirstWarn_04_00"); //Nie wolno ci iść dalej. Zawróć!
...
{
	AI_Output (self, other,"DIA_KDF_507_Talamon_SecondWarn_04_00"); //Innos ukarze cię klątwą, jeśli nie zawrócisz!
...
{
	AI_Output (self, other,"DIA_Talamon_KAP5_Stop_04_00"); //Nie wolno ci iść dalej. Zawróć!
	AI_Output (other,self ,"DIA_Talamon_KAP5_Stop_15_01"); //Pyrokar mówi, że mogę przestudiować księgę Xardasa.
	AI_Output (self, other,"DIA_Talamon_KAP5_Stop_04_02"); //Tak mówi. W takim razie, możesz wejść. Księga, której szukasz, znajduje się na ławie alchemika.

	B_LogEntry (TOPIC_BuchHallenVonIrdorath,"Talamon trzymał księgę Xardasa na stole alchemicznym w piwnicy."); 
};
...
INSTANCE DIA_Talamon_FoundSecretDoor   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Znalazłem tajemne przejście.";
};
...
{
	AI_Output (other,self ,"DIA_Talamon_FoundSecretDoor_15_00"); //Znalazłem tajemne przejście.
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_01"); //Jak? Gdzie?
	AI_Output (other,self ,"DIA_Talamon_FoundSecretDoor_15_02"); //Za regałem z księgami.
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_03"); //Co się za nim znajduje?
	AI_Output (other,self ,"DIA_Talamon_FoundSecretDoor_15_04"); //Wygląda to na starą, podziemną kryptę.
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_05"); //To bardzo ważna informacja. Niezwłocznie powiadomię Pyrokara.
	AI_Output (self ,other,"DIA_Talamon_FoundSecretDoor_04_06"); //W tym czasie musisz sprawdzić, co kryją piwnice.
...
{
	AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_00"); //Byłem w krypcie.
	AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_01"); //I co udało ci się odnaleźć?
	
	if (Npc_IsDead (SecretLibrarySkeleton))
	{
		AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_02"); //Był tam szkielet wojownika, pilnował jakichś drzwi. Zabiłem go.
		AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_03"); //Dobra robota.
		AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_04"); //Kiedy już zwyciężymy zło, zajmiemy się kryptą.
	...
	{
		AI_Output (other,self ,"DIA_Talamon_ScoutSecretLibrary_15_05"); //Pełno tam różnych bestii.
		AI_Output (self ,other,"DIA_Talamon_ScoutSecretLibrary_04_06"); //Coś tam musi być, kontynuuj poszukiwania. A bestiom nie okazuj litości.
	};
};
