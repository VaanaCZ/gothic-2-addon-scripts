...
{
	//ADDON>
	AI_Output (other, self, "DIA_Addon_Bromor_GIRLS_15_00"); //Ty patâíš k tęm, co to tady vedou?
	//ADDON<
...
func void DIA_Addon_Bromor_MissingPeople_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_MissingPeople_07_01"); //Samozâejmę. Nebo si myslíš, že se nechám zavâít za to, že jim neplatím?
	AI_Output	(other, self, "DIA_Addon_Bromor_MissingPeople_15_02"); //(naštvanę) No, já nemyslel tvou výplatní listinu. Myslím tím, jestli tu všechny JSOU. Nechybí ti nękterá?
	AI_Output	(self, other, "DIA_Addon_Bromor_MissingPeople_07_03"); //No, vlastnę ano. Jedna z mých holek se odsud vypaâila. Jmenovala se Lucia.
	AI_Output	(self, other, "DIA_Addon_Bromor_MissingPeople_07_04"); //Nahlásil jsem to domobranę, ale tvrdili, že po ní zatím nenašli ani stopu.
	
	Log_CreateTopic (TOPIC_Addon_MissingPeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_MissingPeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_MissingPeople,"Z nevęstince dole v pâístavu zmizela prostitutka jménem Lucia."); 
};
...
func void DIA_Addon_Bromor_Lucia_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_Lucia_07_01"); //Pár dní. Vlastnę ani nevím, jak dlouho.
	AI_Output	(self, other, "DIA_Addon_Bromor_Lucia_07_02"); //Počítám, že utekla s nękterým ze svejch ctitelů.
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_Lucia_07_05"); //A jak jdou kšefty TOBĘ? Dęláš si ze mę šoufky, nebo co?
...
func void DIA_Addon_Bromor_LuciaGold_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_LuciaGold_07_01"); //Výbornę! Nejvyšší čas, abych ji dostal zpátky.
	
	Info_ClearChoices	(DIA_Addon_Bromor_LuciaGold);
	if (Bromor_Hausverbot == FALSE)
	{
		Info_AddChoice	(DIA_Addon_Bromor_LuciaGold, "A co takhle nęjakou odmęnu?", DIA_Addon_Bromor_LuciaGold_lohn );
	};
...
func void DIA_Addon_Bromor_LuciaGold_einfachgeben ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_einfachgeben_07_01"); //Díky, to je od tebe velice štędré. Ještę nęco?
...
{
	AI_Output			(other, self, "DIA_Addon_Bromor_LuciaGold_lucia_15_00"); //To ani nechceš vędęt, co se s Lucií stalo?
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_lucia_07_01"); //Ne, proč? Svou mísu jsem dostal zpátky, ne?
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_lucia_07_02"); //Zatím jsem se bez Lucie obešel a obejdu se bez ní i dál. Proč bych se teda męl starat o to, aby se vrátila?
	DIA_Addon_Bromor_LuciaGold_lucia_OneTime = TRUE;
};
func void DIA_Addon_Bromor_LuciaGold_lohn ()
{
	AI_Output			(other, self, "DIA_Addon_Bromor_LuciaGold_lohn_15_00"); //A co takhle nęjakou odmęnu?
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_lohn_07_01"); //Můžeš se pobavit s nękterou z mých holek - zadarmo. Co ty na to?
...
func void DIA_Addon_Bromor_LuciaGold_nein ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_nein_07_01"); //Pak odsud okamžitę vypadni, ty hajzle.
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_nein_07_02"); //A aă tę ani nenapadne dęlat tu nęjaký bordel.
	Info_ClearChoices	(DIA_Addon_Bromor_LuciaGold);
...
func void DIA_Addon_Bromor_LuciaGold_geben ()
{
	...
	B_GiveInvItems (other, self, ItMi_BromorsGeld_Addon,1);
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_geben_07_01"); //Díky. Bęž za Nadjou, doprovodí tę nahoru.
	Bromor_Pay = 1; 
	MIS_Bromor_LuciaStoleGold = LOG_SUCCESS;
	Bromor_Hausverbot = FALSE;
	B_GivePlayerXP (XP_Addon_Bromor_LuciaGold);
