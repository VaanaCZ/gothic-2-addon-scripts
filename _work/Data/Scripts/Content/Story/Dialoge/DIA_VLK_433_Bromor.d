...
{
	//ADDON>
	AI_Output (other, self, "DIA_Addon_Bromor_GIRLS_15_00"); //Ty patøíš k tìm, co to tady vedou?
	//ADDON<
...
func void DIA_Addon_Bromor_MissingPeople_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_MissingPeople_07_01"); //Samozøejmì. Nebo si myslíš, že se nechám zavøít za to, že jim neplatím?
	AI_Output	(other, self, "DIA_Addon_Bromor_MissingPeople_15_02"); //(naštvanì) No, já nemyslel tvou výplatní listinu. Myslím tím, jestli tu všechny JSOU. Nechybí ti nìkterá?
	AI_Output	(self, other, "DIA_Addon_Bromor_MissingPeople_07_03"); //No, vlastnì ano. Jedna z mých holek se odsud vypaøila. Jmenovala se Lucia.
	AI_Output	(self, other, "DIA_Addon_Bromor_MissingPeople_07_04"); //Nahlásil jsem to domobranì, ale tvrdili, že po ní zatím nenašli ani stopu.
	
	Log_CreateTopic (TOPIC_Addon_MissingPeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_MissingPeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_MissingPeople,"Z nevìstince dole v pøístavu zmizela prostitutka jménem Lucia."); 
};
...
instance DIA_Addon_Bromor_Lucia		(C_INFO)
{
	...
	description	 = 	"Jak dlouho už Lucii pohøešujete?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Bromor_Lucia_15_00"); //Jak dlouho už Lucii pohøešujete?
	AI_Output	(self, other, "DIA_Addon_Bromor_Lucia_07_01"); //Pár dní. Vlastnì ani nevím, jak dlouho.
	AI_Output	(self, other, "DIA_Addon_Bromor_Lucia_07_02"); //Poèítám, že utekla s nìkterým ze svejch ctitelù.
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_Lucia_07_05"); //A jak jdou kšefty TOBÌ? Dìláš si ze mì šoufky, nebo co?
...
func void DIA_Addon_Bromor_LuciaGold_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Bromor_LuciaGold_07_01"); //Výbornì! Nejvyšší èas, abych ji dostal zpátky.
	
	Info_ClearChoices	(DIA_Addon_Bromor_LuciaGold);
	if (Bromor_Hausverbot == FALSE)
	{
		Info_AddChoice	(DIA_Addon_Bromor_LuciaGold, "A co takhle nìjakou odmìnu?", DIA_Addon_Bromor_LuciaGold_lohn );
	};
...
func void DIA_Addon_Bromor_LuciaGold_einfachgeben ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_einfachgeben_07_01"); //Díky, to je od tebe velice štìdré. Ještì nìco?
...
{
	AI_Output			(other, self, "DIA_Addon_Bromor_LuciaGold_lucia_15_00"); //To ani nechceš vìdìt, co se s Lucií stalo?
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_lucia_07_01"); //Ne, proè? Svou mísu jsem dostal zpátky, ne?
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_lucia_07_02"); //Zatím jsem se bez Lucie obešel a obejdu se bez ní i dál. Proè bych se teda mìl starat o to, aby se vrátila?
	DIA_Addon_Bromor_LuciaGold_lucia_OneTime = TRUE;
};
func void DIA_Addon_Bromor_LuciaGold_lohn ()
{
	AI_Output			(other, self, "DIA_Addon_Bromor_LuciaGold_lohn_15_00"); //A co takhle nìjakou odmìnu?
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_lohn_07_01"); //Mùžeš se pobavit s nìkterou z mých holek - zadarmo. Co ty na to?
	...
	Info_AddChoice	(DIA_Addon_Bromor_LuciaGold, "No dobøe. Tady máš tu svou mísu.", DIA_Addon_Bromor_LuciaGold_geben );
};
...
{
	AI_Output			(other, self, "DIA_Addon_Bromor_LuciaGold_nein_15_00"); //Zapomeò na to.
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_nein_07_01"); //Pak odsud okamžitì vypadni, ty hajzle.
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_nein_07_02"); //A a tì ani nenapadne dìlat tu nìjaký bordel.
	Info_ClearChoices	(DIA_Addon_Bromor_LuciaGold);
...
func void DIA_Addon_Bromor_LuciaGold_geben ()
{
	...
	B_GiveInvItems (other, self, ItMi_BromorsGeld_Addon,1);
	AI_Output			(self, other, "DIA_Addon_Bromor_LuciaGold_geben_07_01"); //Díky. Bìž za Nadjou, doprovodí tì nahoru.
	Bromor_Pay = 1; 
	MIS_Bromor_LuciaStoleGold = LOG_SUCCESS;
	Bromor_Hausverbot = FALSE;
	B_GivePlayerXP (XP_Addon_Bromor_LuciaGold);
