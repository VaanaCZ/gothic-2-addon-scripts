...
func void DIA_Talbin_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Talbin_HALLO_07_02"); //No to mì podrž! Další ztracená voveèka, co? Nejdøív jsem tì mìl za jednoho z tìch hnusnejch šmejdù, co tu poøád vopruzujou.
...
func void DIA_Talbin_WASMACHTIHR_Info ()
{
	...
	Info_AddChoice	(DIA_Talbin_WASMACHTIHR, "Ty jsi bývalý vìzeò z kolonie?", DIA_Talbin_WASMACHTIHR_strf );
...
{
	AI_Output			(other, self, "DIA_Talbin_WASMACHTIHR_strf_15_00"); //Ty jsi bývalý vìzeò?
...
instance DIA_Talbin_ENGROMANGRY		(C_INFO)
{
	...
	description	 = 	"Myslím, že tvùj kámoš je trošku vydìšený.";
};
...
func void DIA_Talbin_FOUNDENGROM_Info ()
{
	...
	B_LogEntry (TOPIC_Talbin_Runs,"Talbin, lovec z Hornického údolí, probìhl pøes prùsmyk, i když mìl v patách celé roje krvavých much. Myslím, že míøí do Khorinidu."); 
