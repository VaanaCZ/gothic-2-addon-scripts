...
INSTANCE DIA_Cornelius_SeeMurder   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Vidêl jsi Lotharovu vraždu, co?";
};
...
{
	AI_Output (other,self ,"DIA_Cornelius_SeeMurder_15_00"); //Vidêl jsi Lotharovu vraždu, že ano?
	AI_Output (self ,other,"DIA_Cornelius_SeeMurder_13_01"); //(nervóznê) Nebudu odpovídat na žádné otázky týkající se probíhajího vyšetâování.
...
FUNC VOID DIA_Cornelius_WhatYouSee_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_WhatYouSee_13_01"); //(horeènatê) Opravdu teë nemám èas.
	AI_Output (self ,other,"DIA_Cornelius_WhatYouSee_13_02"); //(horeènatê) Musíš jít, úâad se právê zavírá.
...
INSTANCE DIA_Cornelius_Enough   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Dost už toho! Co jsi vidêl?";
};
...
{
	AI_Output (other,self ,"DIA_Cornelius_Enough_15_00"); //Dost už toho! Co jsi vidêl?
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_01"); //(nervóznê) Já... vidêl jsem, jak ten žoldák zezadu srazil toho paladina.
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_02"); //(nervóznê) A pak si vzal jeho meè a proklál mu jím hruë.
	AI_Output (other,self ,"DIA_Cornelius_Enough_15_03"); //Jsi si naprosto jistý?
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_04"); //(vydêšenê) Ano, samozâejmê. Vidêl jsem to na vlastní oèi.
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_05"); //(vydêšenê) Ale teë už vážnê nemám èas, èeká na mê halda papírování.
...
{
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_15_00"); //Nevêâím ti.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_13_01"); //(s falešnou dùvêrností) A co, co s tím budeš dêlat?
	...
	{
		Info_AddChoice (DIA_Cornelius_DontBelieveYou,"Mùžou ti zaâídit pâíjemný rozhovor v klášteâe.",DIA_Cornelius_DontBelieveYou_Monastery);
	};
	if (hero.guild == GIL_SLD)
	{
		Info_AddChoice (DIA_Cornelius_DontBelieveYou,"Mùžu žoldákùm âíct, kde bydlíš.",DIA_Cornelius_DontBelieveYou_KnowYourHome);
	};
...
FUNC VOID DIA_Cornelius_DontBelieveYou_WhatYouWant ()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_WhatYouWant_13_01"); //(arogantnê) Nikdy jsi nemêl tolik penêz, abys mi mohl zaplatit.
	...
	B_LogEntry (TOPIC_RESCUEBENNET,"Za 2000 zlaãákù je se mnou Cornelius ochoten mluvit.");
...
FUNC VOID DIA_Cornelius_DontBelieveYou_WantSurvive ()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_WantSurvive_13_01"); //(vydêšenê) Když mê napadneš, povêsí tê.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_WantSurvive_13_02"); //Mám mocné pâátele. Takže se na mê neopovažuj vztáhnout ruku.
...
{
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_Monastery_15_00"); //Mùžou ti zaâídit pâíjemný rozhovor v klášteâe.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_Monastery_13_01"); //(bílý jak stêna) Co tím myslíš?
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_Monastery_15_02"); //Mno, známe zpùsob, jak dostat pravdu na svêtlo. Bolestivý zpùsob.
...
{
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_KnowYourHome_15_00"); //Mùžu žoldákùm âíct, kde bydlíš.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_KnowYourHome_13_01"); //(bílý jak stêna) Kam s tím míâíš?
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_KnowYourHome_13_03"); //To nemùžeš. Zabijí mê.
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_KnowYourHome_15_04"); //S nejvêtší pravdêpodobností.
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_KnowYourHome_13_05"); //Âeknu ti, co budeš chtít, ale nesmíš to udêlat.
...
FUNC VOID DIA_Cornelius_DontBelieveYou_Perjury()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_Perjury_13_01"); //Snažíš se mi vyhrožovat? Mnê, tajemníkovi místodržícího?
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_Perjury_13_02"); //Jestli okamžitê nevypadneš, budu se dívat na to, jak tê degradují.
...
FUNC VOID DIA_Cornelius_PayCornelius_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_PayCornelius_13_01"); //Radêji se ani nebudu ptát, kdes k tomu pâišel.
	AI_Output (self ,other,"DIA_Cornelius_PayCornelius_13_02"); //Abych byl upâímný, tak mê to ani nezajímá.
...
FUNC VOID DIA_Cornelius_RealStory_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_RealStory_13_01"); //Nevím, co se stalo. Dostal jsem nêjaké zlato za to, že obviním toho žoldáka.
	AI_Output (self ,other,"DIA_Cornelius_RealStory_13_02"); //V takových èasech jako teë se každý stará jen sám o sebe. Potâeboval jsem peníze.
	AI_Output (other,self ,"DIA_Cornelius_RealStory_15_03"); //Kdo ti zaplatil?
	AI_Output (self ,other,"DIA_Cornelius_RealStory_13_04"); //To neâeknu. Zabije mê, když ho prásknu.
	AI_Output (other,self ,"DIA_Cornelius_RealStory_15_05"); //Jsi pâipraven tohle âíct také lordu Hagenovi?
	AI_Output (self ,other,"DIA_Cornelius_RealStory_13_06"); //Nejsem blázen. Nemùžu zùstat ve mêstê.
	...
	B_LogEntry (TOPIC_RESCUEBENNET,"Cornelius lhal - podplatili ho, aby Benneta dostal do basy. Kdo mu ale ty peníze dal, to mi neprozradil. Je celý podêlaný strachy.");
