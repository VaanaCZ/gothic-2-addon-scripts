...
{
	AI_Output (other,self ,"DIA_Cornelius_SeeMurder_15_00"); //Vidęl jsi Lotharovu vraždu, že ano?
...
FUNC VOID DIA_Cornelius_DontBelieveYou_Info()
{
	...
	{
		Info_AddChoice (DIA_Cornelius_DontBelieveYou,"Můžou ti zaâídit pâíjemný rozhovor v klášteâe.",DIA_Cornelius_DontBelieveYou_Monastery);
	};
...
FUNC VOID DIA_Cornelius_DontBelieveYou_Monastery()
{
	...
	AI_Output (other,self ,"DIA_Cornelius_DontBelieveYou_Monastery_15_02"); //Mno, známe způsob, jak dostat pravdu na svętlo. Bolestivý způsob.
...
FUNC VOID DIA_Cornelius_DontBelieveYou_KnowYourHome()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_KnowYourHome_13_01"); //(bílý jak stęna) Kam s tím míâíš?
