...
func void DIA_Lehmar_ENTSCHULDIGUNG_Info ()
{
	...
	AI_Output (self, other, "DIA_Lehmar_ENTSCHULDIGUNG_09_03"); //Jsem lichváâ. Co bys tak ode mę mohl chtít? Peníze, samozâejmę.
};
...
func void DIA_Lehmar_GELDLEIHEN_Info ()
{
	...
	Info_AddChoice	(DIA_Lehmar_GELDLEIHEN, " 200 zlaăáků.", DIA_Lehmar_GELDLEIHEN_200 );
	Info_AddChoice	(DIA_Lehmar_GELDLEIHEN, "   50 zlaăáků.", DIA_Lehmar_GELDLEIHEN_50 );
...
{
	AI_Output (self, other, "DIA_Lehmar_GELDEINTREIBEN_09_00"); //Máš zpoždęní, ty bastarde! Dej sem moje prachy! A až ti to budu muset zase pâipomínat, už to bude mnohem dražší.
...
func void DIA_Lehmar_GELDZURUECK_Info ()
{
	...
	&& (Lehmar_GeldGeliehen_Day<=(Wld_GetDay()-2))
	{
		...
		AI_Output (self, other, "DIA_Addon_Lehmar_GELDZURUECK_09_01"); //Cože? Ten hajzl je tvůj kamarád? No, vlastnę mi po tom nic není. Hezký den.
		Lehmar_GeldGeliehen = 0;
		AI_StopProcessInfos (self);		
	}
	else
