...
{	
	...
	AI_Output	(self ,other,"DIA_Keroloth_HELLO_07_01"); //Ano. Až ti skřeti, nebo ještě hůř draci znovu zaútočí, bude každá ruka dobrá.
};
//***********************************************
...
INSTANCE DIA_Keroloth_WantTeach(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Můžeš něco naučit i mě?";
};                       
...
{	
	AI_Output 	(other,self ,"DIA_Keroloth_WantTeach_15_00"); //Můžeš něco naučit i mě?
	AI_Output 	(self ,other,"DIA_Keroloth_WantTeach_07_01"); //Samozřejmě. Trénuji každého slušného člověka.
	AI_Output 	(self ,other,"DIA_Keroloth_WantTeach_07_02"); //Ale pokud tady chceš přežít, budeš potřebovat kromě talentu i nějakou dobrou zbraň.
	AI_Output 	(self ,other,"DIA_Keroloth_WantTeach_07_03"); //Požádej rytíře Tandora. Postará se o tebe.
...
{	
	AI_Output (other,self ,"DIA_Keroloth_Teach_15_00"); //Začněme.
...
{	
	...
	AI_Output 	(other,self ,"DIA_Keroloth_Udar_15_02"); //Můžeš mě trénovat i v něm?
	AI_Output	(self ,other,"DIA_Keroloth_Udar_07_03"); //Ne, ale můžeš se zeptat Udara, je to dobrý - ne, je to NEJLEPŠÍ střelec z kuše, jakého znám.
...
instance DIA_Keroloth_KAP4_HELLO		(C_INFO)
{
	...
	description	 = 	"Nějak protahuješ obličej.";
};
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_15_00"); //Nějak protahuješ obličej.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_07_01"); //(nahněvaně) Zatraceně. Jak povídám, jeden musí být jako ostříž.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_07_02"); //Na chvíli se otočíš zády a hned ti začnou mizet věci. Ksakru!

	Info_AddChoice	(DIA_Keroloth_KAP4_HELLO, DIALOG_BACK, DIA_Keroloth_KAP4_HELLO_ende );
	Info_AddChoice	(DIA_Keroloth_KAP4_HELLO, "Paladin by se neměl nikdy přestat ovládat.", DIA_Keroloth_KAP4_HELLO_ruhig );
 	Info_AddChoice	(DIA_Keroloth_KAP4_HELLO, "Někdo ti něco ukradl?", DIA_Keroloth_KAP4_HELLO_bestohlen );
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_bestohlen_15_00"); //Někdo ti něco ukradl?
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_07_01"); //Ne. Někdo mi strčil do kapsy 20 zlatých. Samozřejmě že mi někdo něco ukradl, blbečku!
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_07_02"); //Ale to ti povídám, až se mi ta prašivá svině dostane do rukou...
...
func void DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt ()
{
	...
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt_07_01"); //Měšec - měl jsem v něm všechny své úspory.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt_07_02"); //A teď je pryč!
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_bestohlen_wasfehlt_15_03"); //Určitě se někde objeví.
...
func void DIA_Keroloth_KAP4_HELLO_pack ()
{
	...
	if (hero.guild == GIL_DJG)
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_pack_07_01"); //Někdo z vás parchantů drakobijců, samozřejmě. Kdo jiný?
		}
	else
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_pack_07_02"); //Samozřejmě někdo z té drakobijecké chátry. O kom jiném bych asi tak mluvil?
		};
		
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_pack_07_03"); //(pro sebe) Povídám, že je zapotřebí mít je pořád na očích.
};

func void DIA_Keroloth_KAP4_HELLO_ruhig ()
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_HELLO_ruhig_15_00"); //Uklidni se! Paladin by se neměl přestat ovládat.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_ruhig_07_01"); //Ale já se nechci uklidnit. Bylo to zatraceně všechno, co jsem měl!
};
...
instance DIA_Keroloth_KAP4_GELDGEFUNDEN		(C_INFO)
{
	...
	description	 = 	"Asi jsem našel tvůj měšec.";
};
...
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_15_00"); //Asi jsem našel tvůj měšec.
	...
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_07_01"); //Je prázdný. Která svině to udělala?
	
		Keroloths_BeutelLeer = TRUE;
	};
	if (B_GiveInvItems (other, self, ItMi_KerolothsGeldbeutel_MIS,1))
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_07_02"); //Co? Kde? Který parchant to udělal?
	};
	
	if (hero.guild == GIL_DJG)
	{
		Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Momentíček - jaká bude odměna?", DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn );
	};

	Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Byl tady hned u kovárny.", DIA_Keroloth_KAP4_GELDGEFUNDEN_Schmiede );
	Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Podezírám někoho z drakobijců.", DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG );
	Info_AddChoice	(DIA_Keroloth_KAP4_GELDGEFUNDEN, "Jak bych to mohl vědět?", DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung);
};
func void DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung ()
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung_15_00"); //Jak bych to mohl vědět?

	if (hero.guild == GIL_DJG)
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung_07_01"); //Děláš si ze mě legraci? Přiznej se, žes to byl ty.
	...
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_keineAhnung_07_02"); //To ještě zjistím.
		AI_StopProcessInfos (self);
	};
};
...
func void DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG ()
{
	...
	AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_07_01"); //(rozzlobeně) Já to věděl.
	
	if (hero.guild == GIL_DJG)
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_07_02"); //(křičí) Nikdy tě neměli pouštět do hradu.
		}
		else
		{
...
func void DIA_Keroloth_KAP4_GELDGEFUNDEN_Schmiede ()
{
	...
	AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Schmiede_07_01"); //Kde? Poblíž kovárny? Určitě vypadl jednomu z těch drakobijců z kapsy, neříkej, že ne.
};

func void DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn ()
{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn_15_00"); //Počkej. A co odměna?
	
 	if (Keroloths_BeutelLeer == TRUE)
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn_07_01"); //Tak to je poslední kapka. Už dlouho ti nikdo pěstí nepřepočítal zuby, co?
		AI_StopProcessInfos	(self);
		B_Attack (self, other, AR_NONE, 1);	
	}
	else
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_Lohn_07_02"); //Arrh. Dobrá. Tady je pár zlatých. A teď mi řekneš, kdo to udělal?
...
instance DIA_Keroloth_KAP4_BELOHNUNG		(C_INFO)
{
	...
	description	 = 	"Chci nálezné za tvůj měšec.";
};
...
{
 	AI_Output			(other, self, "DIA_Keroloth_KAP4_BELOHNUNG_15_00"); //Chci nálezné za tvůj měšec.
	...
	{
		AI_Output			(self, other, "DIA_Keroloth_KAP4_BELOHNUNG_07_02"); //To je jediné, co tě zajímá? Tady máš sakra pár zlatých a teď zmiz.
...
func void DIA_Keroloth_KAP4_ENTSPANNDICH_Info ()
{
	...
	{
	AI_Output			(self, other, "DIA_Keroloth_KAP4_ENTSPANNDICH_07_01"); //Ano, mistře. Pokusím se.
	}
	else if (MIS_OCGateOpen == TRUE)
	{
	AI_Output			(self, other, "DIA_Keroloth_KAP4_ENTSPANNDICH_07_02"); //Nemůžu to dokázat, ale myslím, že ty jsi ten zrádce, který otevřel bránu.
	AI_Output			(self, other, "DIA_Keroloth_KAP4_ENTSPANNDICH_07_03"); //Za to teď zaplatíš.
	AI_StopProcessInfos (self);
	B_Attack (self, other, AR_NONE, 1);	
	}
	else 
	{
	AI_Output			(other, self, "DIA_Keroloth_KAP4_ENTSPANNDICH_15_04"); //Máš svůj měšec zpátky, ne?
