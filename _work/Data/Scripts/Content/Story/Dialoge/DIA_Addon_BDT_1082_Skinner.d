...
{
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_00");//Proè mê budíš? Vsadím se, že ani nevíš proè, co?
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_01");//Ne – neâíkej nic. Na omluvy už je stejnê pozdê.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_02");//Teë máš dvê možnosti. Buë se utkáš se mnou a s mojí Betty, nebo mùžeš zkusit utéct.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_03");//Na tvým místê bych radši zdrhnul.
