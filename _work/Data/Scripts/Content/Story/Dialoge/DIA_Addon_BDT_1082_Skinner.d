...
INSTANCE DIA_Addon_Skinner_Attentat   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "A propos de la tentative de meurtre...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Skinner_Attentat_15_00");//A propos de l'attaque...
	AI_Output (self, other, "DIA_Addon_Skinner_Attentat_08_01");//Qu'est-ce que vous voulez ?
