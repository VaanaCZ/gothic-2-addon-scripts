...
{
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_00");//Proè mì budíš? Vsadím se, že ani nevíš proè, co?
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_01");//Ne – neøíkej nic. Na omluvy už je stejnì pozdì.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_02");//Teï máš dvì možnosti. Buï se utkáš se mnou a s mojí Betty, nebo mùžeš zkusit utéct.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_03");//Na tvým místì bych radši zdrhnul.
...
INSTANCE DIA_Addon_Skinner_Attentat   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Co se týèe toho útoku...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Skinner_Attentat_15_00");//Co se týèe toho útoku...
