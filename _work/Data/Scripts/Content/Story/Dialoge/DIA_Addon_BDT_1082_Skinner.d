...
{
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_00");//Proč mę budíš? Vsadím se, že ani nevíš proč, co?
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_01");//Ne – neâíkej nic. Na omluvy už je stejnę pozdę.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_02");//Teë máš dvę možnosti. Buë se utkáš se mnou a s mojí Betty, nebo můžeš zkusit utéct.
	AI_Output (self, other, "DIA_Addon_Skinner_Hi_08_03");//Na tvým místę bych radši zdrhnul.
