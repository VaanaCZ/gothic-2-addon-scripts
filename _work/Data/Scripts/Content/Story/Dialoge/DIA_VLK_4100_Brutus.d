...
func void DIA_Brutus_PRISONER_Info ()
{
	...
	AI_Output (other, self, "DIA_Brutus_PRISONER_15_04"); //To zní pìknì dìsivì.
...
func void DIA_Brutus_Kasse_Info ()
{
	...
	B_LogEntry (TopicBrutusKasse,"Brutùv partner Den se ztratil i s 200 zlaáky a nìjakými klenoty. Když Brutovi pøinesu aspoò ty dvì stovky, pomùže mi zvýšit sílu.");
};
///////////////////////////////////////////////////////////////////////
//	Info Wo ist Den?
///////////////////////////////////////////////////////////////////////
...
func void DIA_Brutus_Gold_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Brutus_Gold_06_01"); //Výbornì. Teï tì mùžu vycvièit, jestli tedy chceš.
...
func void DIA_Brutus_WARUMNICHTARBBEIT_Info ()
{
	...
	B_LogEntry (TOPIC_BrutusMeatbugs,"Hradní popravèí Brutus se mi svìøil, že mu neškodné žravé štìnice v muèírnì nahánìjí husí kùži. Je to prostì drsòák každým coulem."); 
...
instance DIA_Brutus_MEATBUGSWEG		(C_INFO)
{
	...
	description	 = 	"Už je po štìnicích.";
};
