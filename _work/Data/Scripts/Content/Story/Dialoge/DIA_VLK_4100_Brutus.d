...
func void DIA_Brutus_PRISONER_Info ()
{
	...
	AI_Output (other, self, "DIA_Brutus_PRISONER_15_04"); //To zní pęknę dęsivę.
...
func void DIA_Brutus_Kasse_Info ()
{
	...
	B_LogEntry (TopicBrutusKasse,"Brutův partner Den se ztratil i s 200 zlaăáky a nęjakými klenoty. Když Brutovi pâinesu aspoŕ ty dvę stovky, pomůže mi zvýšit sílu.");
};
///////////////////////////////////////////////////////////////////////
//	Info Wo ist Den?
///////////////////////////////////////////////////////////////////////
...
func void DIA_Brutus_Gold_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Brutus_Gold_06_01"); //Výbornę. Teë tę můžu vycvičit, jestli tedy chceš.
...
func void DIA_Brutus_WARUMNICHTARBBEIT_Info ()
{
	...
	B_LogEntry (TOPIC_BrutusMeatbugs,"Hradní popravčí Brutus se mi svęâil, že mu neškodné žravé štęnice v mučírnę nahánęjí husí kůži. Je to prostę drsŕák každým coulem."); 
...
instance DIA_Brutus_MEATBUGSWEG		(C_INFO)
{
	...
	description	 = 	"Už je po štęnicích.";
};
