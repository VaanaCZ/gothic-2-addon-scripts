...
{	
	...
	AI_Output (self,other,"DIA_Addon_SawPirate_Hello_09_01"); //Nech mę bejt.
};
...
instance DIA_Addon_SawPirate_Anheuern(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Ty patâíš k Henryho hochům?";
};                       
...
{	
	AI_Output (other,self ,"DIA_Addon_Bones_JoinHenry_15_00"); //Ty patâíš k Henryho chlapům?
	AI_Output (self, other, "DIA_Addon_SawPirate_Anheuern_09_01"); //Ne, ten strom tu âežu jen tak pro zábavu.
	AI_Output (self, other, "DIA_Addon_SawPirate_Anheuern_09_02"); //Co je? Âek ti Henry, co máš dęlat?
	AI_Output (other,self ,"DIA_Addon_Bones_JoinHenry_15_04"); //Jo, mám pro nęj vyâídit pár banditů.
	AI_Output (self, other, "DIA_Addon_SawPirate_Anheuern_09_03"); //(odmítá) Ale né! Nekoukej na mę tak! Já tam nechci!
	AI_Output (self, other, "DIA_Addon_SawPirate_Anheuern_09_04"); //Jen mę nech v klidu âezat, jo?
};
// ------------------------------------------------------------
// 						Komm (wieder) mit!
// ------------------------------------------------------------
...
func void DIA_Addon_SawPirate_ComeOn_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_SawPirate_ComeOn_09_01"); //Proč? Dyk už s sebou nękoho máš.
	}
	else if (Npc_GetDistToWP (self, "ADW_PIRATECAMP_WAY_08") > 6000)
	{	
		AI_Output (self ,other,"DIA_Addon_SawPirate_ComeOn_09_04"); //Napâed se vraăme kousek k táboru.
		AI_StopProcessInfos (self);
	}
	else if (!Npc_IsDead(HammerPirate))
	&& (SawPirate_ComeOn_Once == FALSE)
	{
		AI_Output (self ,other,"DIA_Addon_SawPirate_ComeOn_09_02"); //(pro sebe) Taky moh âíct nękomu jinýmu.
...
{	
	AI_Output (other,self ,"DIA_Addon_SawPirate_GoHome_15_00"); //Už tę nepotâebuju.
	AI_Output (self ,other,"DIA_Addon_SawPirate_GoHome_09_01"); //Tak já teda půjdu zase âezat.
...
{	
	AI_Output (self ,other,"DIA_Addon_SawPirate_Success_09_01"); //Víš ty co? Trochu jsem o tom pâemejšlel. Seš pęknej hajzl!
	AI_Output (self ,other,"DIA_Addon_SawPirate_Success_09_02"); //Jdu zpátky do tábora a doufám, že už tę nikdy neuvidím!
