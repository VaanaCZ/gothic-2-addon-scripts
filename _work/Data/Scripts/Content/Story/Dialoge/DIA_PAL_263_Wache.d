...
func void DIA_PAL_263_PERM_Info ()
{
	...
	AI_Output			(self, other, "DIA_PAL_263_PERM_04_01"); //¡Sí, señor! En nuestro puesto, tal y como se nos ha ordenado. Sin más pérdidas. Las provisiones escasean, los orcos están tranquilos.
	AI_Output			(self, other, "DIA_PAL_263_PERM_04_02"); //El último ataque de un dragón destruyó por completo el baluarte exterior. Pero, desde entonces, no se ha producido nada inusual.
	AI_Output			(other, self, "DIA_PAL_263_PERM_15_03"); //De acuerdo, continúe.
};
///////////////////////////////////////////////////////////////////////
//	Info PERM_OTH
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output			(other, self, "DIA_PAL_263_PERM_OTH_15_00"); //¿Cuál es la situación?
	AI_Output			(self, other, "DIA_PAL_263_PERM_OTH_04_01"); //Está bajo control. No te preocupes, civil. Todo va a acabar bien.
};
