...
FUNC VOID DIA_Addon_Raven_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_01");//Můj pán mę varoval, že sem Innos pošle svý poskoky.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_02");//Jen jsem nečekal, že se tu objevíš tak brzo.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_03");//Ale když už jsi to dokázal tak rychle (smęje se), budeš mít taky rychlou smrt.
...
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_00");//Omyl, to TEBE teë čeká smrt.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_04");//(smęje se) Nejsi pro mę žádná hrozba. Nosím Beliarův meč.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_05");//Povedu draky na pevninu. Spolu svrhneme svęt lidí do nehlubších temnot.
};
FUNC VOID DIA_Addon_Raven_Hi_Soul()
{
	...
	Info_AddChoice (DIA_Addon_Raven_Hi,"Dęlám jen to, co je tâeba.",DIA_Addon_Raven_Hi_only);

};
FUNC VOID DIA_Addon_Raven_Hi_only()
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_02");//Jen dęlám, co musí být vykonáno.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_08");//(smęje se) Jen si ho poslechnęte. Poslali jste mi pokornýho služebníka Innosova! (nahlas se smęje)
	
	Info_ClearChoices (DIA_Addon_Raven_Hi);
	Info_AddChoice (DIA_Addon_Raven_Hi,"Chápu. Tak pojëme na to.",DIA_Addon_Raven_Hi_Attack);
	Info_AddChoice (DIA_Addon_Raven_Hi,"Vážnę si myslíš, že sloužím Innosovi?",DIA_Addon_Raven_Hi_Sure);	
};
FUNC VOID DIA_Addon_Raven_Hi_Sure()
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_03");//A víš tak jistę, že jsem zrovna Innosův služebník? 
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_09");//Co? Co to povídáš?
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_04");//Nezvážils nękdy možnost, že bych mohl být tâebas i služebníkem Adana?
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_10");//(smęje se) Nesmysl!
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_05");//A možná že TAKY sloužím Beliarovi – nebo jenom sám sobę. 
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_11");//(ušklíbá se) No, v tom pâípadę pro mę nejseš vhodným protivníkem.
...
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_06");//Chápu. Tak začnęme.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_12");//(ušklíbá se) To se vážnę tak tęšíš na smrt? Ale když na tom trváš.
