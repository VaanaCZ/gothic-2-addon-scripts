...
{
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_00");//A hele, kdo to pøišel. 
	...
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_01");//Mùj pán mì varoval, že sem Innos pošle svý poskoky.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_02");//Jen jsem neèekal, že se tu objevíš tak brzo.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_03");//Ale když už jsi to dokázal tak rychle (smìje se), budeš mít taky rychlou smrt.
	
	Info_ClearChoices (DIA_Addon_Raven_Hi);
	Info_AddChoice (DIA_Addon_Raven_Hi,"Ten, kdo umøe, budeš TY.",DIA_Addon_Raven_Hi_DU);
	Info_AddChoice (DIA_Addon_Raven_Hi,"Zaprodals duši Beliarovi!",DIA_Addon_Raven_Hi_Soul);
};
FUNC VOID DIA_Addon_Raven_Hi_DU()
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_00");//Omyl, to TEBE teï èeká smrt.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_04");//(smìje se) Nejsi pro mì žádná hrozba. Nosím Beliarùv meè.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_05");//Povedu draky na pevninu. Spolu svrhneme svìt lidí do nehlubších temnot.
};
FUNC VOID DIA_Addon_Raven_Hi_Soul()
{
	...
	Info_AddChoice (DIA_Addon_Raven_Hi,"Dìlám jen to, co je tøeba.",DIA_Addon_Raven_Hi_only);

};
FUNC VOID DIA_Addon_Raven_Hi_only()
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_02");//Jen dìlám, co musí být vykonáno.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_08");//(smìje se) Jen si ho poslechnìte. Poslali jste mi pokornýho služebníka Innosova! (nahlas se smìje)
	
	Info_ClearChoices (DIA_Addon_Raven_Hi);
	Info_AddChoice (DIA_Addon_Raven_Hi,"Chápu. Tak pojïme na to.",DIA_Addon_Raven_Hi_Attack);
	Info_AddChoice (DIA_Addon_Raven_Hi,"Vážnì si myslíš, že sloužím Innosovi?",DIA_Addon_Raven_Hi_Sure);	
};
FUNC VOID DIA_Addon_Raven_Hi_Sure()
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_03");//A víš tak jistì, že jsem zrovna Innosùv služebník? 
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_09");//Co? Co to povídáš?
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_04");//Nezvážils nìkdy možnost, že bych mohl být tøebas i služebníkem Adana?
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_10");//(smìje se) Nesmysl!
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_05");//A možná že TAKY sloužím Beliarovi – nebo jenom sám sobì. 
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_11");//(ušklíbá se) No, v tom pøípadì pro mì nejseš vhodným protivníkem.
...
{
	AI_Output (other, self, "DIA_Addon_Raven_Add_15_06");//Chápu. Tak zaènìme.
	AI_Output (self, other, "DIA_Addon_Raven_Add_10_12");//(ušklíbá se) To se vážnì tak tìšíš na smrt? Ale když na tom trváš.
