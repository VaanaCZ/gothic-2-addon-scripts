...
FUNC VOID DIA_Addon_Crimson_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Hi_10_01");//Ne, čistím tu zeleninu. Samozâejmę že tavím zlato – a vyrábím z nęj mince.
	AI_Output (self, other, "DIA_Addon_Crimson_Hi_10_02");//Protože – jen si to pâedstav – jednou večer sem pâišel Havran a dal mi do ruky razidlo mincí.
	AI_Output (self, other, "DIA_Addon_Crimson_Hi_10_03");//Z jedinýho zlatýho nuggetu můžu vyrobit hromádku penízů – jsem tak dobrej, že nikdo nepozná rozdíl!
};
//---------------------------------------------------------------------
//	Info How
//---------------------------------------------------------------------
INSTANCE DIA_Addon_Crimson_How   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kolik zlaăáků mi dáš za jeden nugget?";
};
...
FUNC VOID DIA_Addon_Crimson_How_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_How_10_01");//No, to vůbec nevím, ale udęlám ti zvláštní cenu. Za jeden nugget ti dám...
...
FUNC VOID DIA_Addon_Crimson_Feilsch_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Feilsch_10_03");//To je. Pro mę je zvláštní zákazník každej.
};	
//---------------------------------------------------------------------
//	Info Gold tauschen
//---------------------------------------------------------------------
INSTANCE DIA_Addon_Crimson_Gold   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Vymęnit zlaté nuggety...";
};
...
FUNC VOID DIA_Addon_Crimson_Gold_Info()
{
	...
	{
		Info_AddChoice (DIA_Addon_Crimson_Gold,"Vymęnit všechny zlaté nugety",DIA_Addon_Crimson_Gold_ALLE);
		Info_AddChoice (DIA_Addon_Crimson_Gold,"Vymęnit 1 zlatý nugget",DIA_Addon_Crimson_Gold_1);
	}
	else
	{
...
FUNC VOID DIA_Addon_Crimson_Raven_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_01");//Tomu neuvęâíš. Já tam byl a vidęl jsem, co v tý hrobce dęlal!
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_02");//(ustrašenę) Mumlal a opakoval ŕáký divný slova. Furt dokola.
	B_Say_CrimsonBeliar();
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_03");//(nahlas) A pak z hrobky vyšlehlo oslepující svętlo a já zaslech ten VÝKÂIK.
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_04");//(zvolá) Ach bozi, ten hlas! Znęlo to, jako když se blíží konec svęta!
...
INSTANCE DIA_Addon_Crimson_FATAGN   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Mohl bys mi ještę jednou zopakovat, co Havran âíkal?";
};
...
FUNC VOID DIA_Addon_Crimson_FATAGN_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Crimson_FATAGN_10_01");//Jasnę, seš pâipravenej?
