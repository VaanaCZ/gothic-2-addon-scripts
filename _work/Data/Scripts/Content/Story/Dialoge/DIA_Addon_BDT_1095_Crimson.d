...
FUNC VOID DIA_Addon_Crimson_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Hi_10_01");//Ne, èistím tu zeleninu. Samozøejmì že tavím zlato – a vyrábím z nìj mince.
	AI_Output (self, other, "DIA_Addon_Crimson_Hi_10_02");//Protože – jen si to pøedstav – jednou veèer sem pøišel Havran a dal mi do ruky razidlo mincí.
...
INSTANCE DIA_Addon_Crimson_How   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kolik zlaákù mi dáš za jeden nugget?";
};
...
FUNC VOID DIA_Addon_Crimson_How_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_How_10_01");//No, to vùbec nevím, ale udìlám ti zvláštní cenu. Za jeden nugget ti dám...
...
{
	AI_Output (other, self, "DIA_Addon_Crimson_Feilsch_15_00");//Pojïme smlouvat!
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Feilsch_10_03");//To je. Pro mì je zvláštní zákazník každej.
};	
//---------------------------------------------------------------------
//	Info Gold tauschen
//---------------------------------------------------------------------
INSTANCE DIA_Addon_Crimson_Gold   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Vymìnit zlaté nuggety...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Crimson_Gold_15_00");//Pojïme obchodovat.
	...
	{
		Info_AddChoice (DIA_Addon_Crimson_Gold,"Vymìnit všechny zlaté nugety",DIA_Addon_Crimson_Gold_ALLE);
		Info_AddChoice (DIA_Addon_Crimson_Gold,"Vymìnit 1 zlatý nugget",DIA_Addon_Crimson_Gold_1);
	}
	else
	{
...
FUNC VOID DIA_Addon_Crimson_Raven_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_01");//Tomu neuvìøíš. Já tam byl a vidìl jsem, co v tý hrobce dìlal!
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_02");//(ustrašenì) Mumlal a opakoval òáký divný slova. Furt dokola.
	B_Say_CrimsonBeliar();
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_03");//(nahlas) A pak z hrobky vyšlehlo oslepující svìtlo a já zaslech ten VÝKØIK.
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_04");//(zvolá) Ach bozi, ten hlas! Znìlo to, jako když se blíží konec svìta!
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_05");//Havran s tím mluvil, povídali si – Havran a TEN hlas!
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_06");//Nepamatuju se, co øíkali, vím jen, že jsem se zmátoøil až za pár hodin zpátky v táboøe.
};	
//---------------------------------------------------------------------
//	Info FATAGN
//---------------------------------------------------------------------
INSTANCE DIA_Addon_Crimson_FATAGN   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "Mohl bys mi ještì jednou zopakovat, co Havran øíkal?";
};
...
FUNC VOID DIA_Addon_Crimson_FATAGN_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Crimson_FATAGN_10_01");//Jasnì, seš pøipravenej?
