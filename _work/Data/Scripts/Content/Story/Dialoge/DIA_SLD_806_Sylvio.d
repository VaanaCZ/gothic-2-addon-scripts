...
func void DIA_Sylvio_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Hallo_09_01"); //Dal jsem ti svolení k tomu, abys mě oslovil?
...
func void DIA_Sylvio_Thekla_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Thekla_09_03"); //(cynicky přátelsky) Proč si nejdeš rovnou promluvit s mým přítelem Bullcem?
...
func void DIA_Sylvio_AboutLee_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_AboutLee_09_01"); //(trochu ironicky) Jo, je to dobrý bojovník. Nikdy bych s ním nechtěl bojovat.
...
func void DIA_Sylvio_Asshole_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Asshole_09_01"); //Nemyslíš si snad, že bych se nechal přemluvit do souboje s tebou?
	AI_Output (self, other, "DIA_Sylvio_Asshole_09_02"); //Běž se radši odplazit pod svůj kamínek.
