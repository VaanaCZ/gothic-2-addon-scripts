...
func void DIA_Sylvio_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Hallo_09_01"); //Czy pozwoliłem ci się do mnie odezwać?
...
instance DIA_Sylvio_Thekla		(C_INFO)
{
	...
	permanent 	= FALSE;
	description	= "Thekla ma z tobą pewien problem.";
};
...
{
	AI_Output (other, self, "DIA_Sylvio_Thekla_15_00"); //Thekla ma z tobą pewien problem.
	...
	AI_Output (self, other, "DIA_Sylvio_Thekla_09_03"); //Może chcesz o tym pomówić z moim przyjacielem, Bullkiem?
...
func void DIA_Sylvio_Gossip_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Gossip_09_01"); //Wiele osób gada za dużo.
...
{
	AI_Output (other, self, "DIA_Sylvio_AboutLee_15_00"); //Co myślisz o Lee?
	AI_Output (self, other, "DIA_Sylvio_AboutLee_09_01"); //Och, to świetny wojownik. Nie śmiałbym się z nim mierzyć.
	AI_Output (self, other, "DIA_Sylvio_AboutLee_09_02"); //Chyba, ma się rozumieć, że nie byłoby wyjścia.
...
{
	AI_Output (self, other, "DIA_Sylvio_MenDefeated_09_00"); //Doszły mnie słuchy, że masz coś do moich chłopaków!
	AI_Output (self, other, "DIA_Sylvio_MenDefeated_09_01"); //A z tego, co wiem, jesteś jednym z pupilków Lee.
	AI_Output (self, other, "DIA_Sylvio_MenDefeated_09_02"); //Ostrzegam cię! Wkrótce wiele się tu zmieni, a wtedy... Wtedy sobie pogadamy!
...
func void DIA_Sylvio_Asshole_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Asshole_09_01"); //Nie chcesz mnie chyba sprowokować?
	AI_Output (self, other, "DIA_Sylvio_Asshole_09_02"); //Odejdź, nędzna glisto, poszukaj sobie kamienia i schowaj się pod nim.
