...
func void DIA_Sylvio_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Hallo_09_01"); //Dal jsem ti svolení k tomu, abys mê oslovil?
...
func void DIA_Sylvio_Thekla_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Thekla_09_01"); //Skuteènê? A jakej má ta drahá paní problém? A proè nepâišla sama?
	AI_Output (other, self, "DIA_Sylvio_Thekla_15_02"); //To pâece rozhodnê víš...
	AI_Output (self, other, "DIA_Sylvio_Thekla_09_03"); //(cynicky pâátelsky) Proè si nejdeš rovnou promluvit s mým pâítelem Bullcem?
...
instance DIA_Sylvio_Gossip		(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Hodnê lidí o tobê mluví...";
};
...
{
	AI_Output (other, self, "DIA_Sylvio_Gossip_15_00"); //Hodnê lidí o tobê mluví.
	AI_Output (self, other, "DIA_Sylvio_Gossip_09_01"); //Hodnê lidí mluví víc, než je zdrávo.
...
func void DIA_Sylvio_AboutLee_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_AboutLee_09_01"); //(trochu ironicky) Jo, je to dobrý bojovník. Nikdy bych s ním nechtêl bojovat.
	AI_Output (self, other, "DIA_Sylvio_AboutLee_09_02"); //(chladnê) Samozâejmê pokud by nebylo vyhnutí.
...
func void DIA_Sylvio_MenDefeated_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_MenDefeated_09_01"); //A pokud vím, jsi jedním z Leeových chránêncù.
	AI_Output (self, other, "DIA_Sylvio_MenDefeated_09_02"); //Varuju tê! Pár vêcí se tady v brzké dobê zmêní a pak si o tom promluvíme!
...
func void DIA_Sylvio_Asshole_Info ()
{
	...
	AI_Output (self, other, "DIA_Sylvio_Asshole_09_02"); //Bêž se radši odplazit pod svùj kamínek.
