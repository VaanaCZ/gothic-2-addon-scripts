...
func void DIA_Addon_Owen_Hello_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Owen_Hello_13_01"); //Kdo seš? Ty patøíš k tìm banditùm?
	...
	{
		AI_Output	(self, other, "DIA_Addon_Owen_Hello_13_03"); //Sice máš na sobì naše hadry, ale já tì neznám.
	}
	else if ((Hlp_IsItem(itm, ItAr_BDT_M) == TRUE)
	|| (Hlp_IsItem(itm, ItAr_BDT_H) == TRUE))
	
	{
	 	AI_Output	(self, other, "DIA_Addon_Owen_Hello_13_04"); //Popravdì øeèeno ano.
	}
	else
	{
	 	AI_Output	(self, other, "DIA_Addon_Owen_Hello_13_05"); //Ne. Soudì podle obleèení jsi urazil hezkej kus cesty.
	};
};
...
{
	AI_Output	(other, self, "DIA_Addon_Owen_WasMachen_15_00"); //Co tu dìláš?
	AI_Output	(self, other, "DIA_Addon_Owen_WasMachen_13_01"); //Sekám døevo pro tábor.
	AI_Output	(self, other, "DIA_Addon_Owen_WasMachen_13_02"); //Já tu otroèím, mùžu si strhat cemr a v táboøe si všichni válej šunky.
};
...
func void DIA_Addon_Owen_Perm_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Owen_Perm_13_01"); //Kdybych vìdìl, že to vezme takovejhle obrat, tak jsem k pirátùm nikdy nelez.
};
...
instance DIA_Addon_Owen_Henry		(C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Henry èeká na døevo na stavbu palisády.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Owen_Henry_15_00"); //Henry èeká na døevo, který potøebuje na palisádu.

	if (MIS_Owen_FindMalcom != LOG_SUCCESS)
	{
		AI_Output	(self, other, "DIA_Addon_Owen_Henry_13_01"); //Napøed chci zjistit, co se stalo s mým kámošem Malcolmem.
	
			
	}
	else 
	{
		AI_Output	(self, other, "DIA_Addon_Owen_Henry_13_02"); //Hele, klídek. Døív nebo pozdìjc mu to pitomý døevo pøinesu.
		AI_Output	(self, other, "DIA_Addon_Owen_Henry_13_03"); //Tak mu to bìž øíct sám.
		
		B_LogEntry (TOPIC_Addon_HolOwen,"Mám Henrymu vyøídit, že døíví pøiveze Owen.");
...
func void DIA_Addon_Owen_MalcomStunt_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Owen_MalcomStunt_13_01"); //Mùj kámoš Malcolm zmizel.
	AI_Output (self, other, "DIA_Addon_Owen_MalcomStunt_13_02"); //Napad ho jeden z tìch hnusnejch èíhavcù.
	AI_Output (self, other, "DIA_Addon_Owen_MalcomStunt_13_03"); //Tak jsme zdrhli do týhle jeskynì.
	AI_Output (self, other, "DIA_Addon_Owen_MalcomStunt_13_04"); //Jenže ten èíhavec šel po nás.
	...
	AI_Output (self, other, "DIA_Addon_Owen_MalcomStunt_13_07"); //Chvíli tam voba ještì bojovali a pak všecko ztichlo.
	...
	B_LogEntry	(TOPIC_Addon_MalcomsStunt,"Owen chce vìdìt, zda je jeho pøítel Malcom ještì naživu. Kousek od ohništì spadl do hluboké jámy spolu s èíhavcem.");
	Log_AddEntry	(TOPIC_Addon_MalcomsStunt,"Owen prohlásil, že je tam dole voda a že Malcom byl zpoèátku urèitì naživu, ale pak už se odtamtud neozval ani hlásek.");
...
func void DIA_Addon_Owen_runter_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Owen_runter_13_01"); //Co já vím. Nejspíš tam budeš muset slézt nebo seskoèit.
};
...
instance DIA_Addon_Owen_MalcomDead		(C_INFO)
{
	...
	description	= "Tvùj kamarád Malcom je mrtvý.";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Owen_MalcomDead_15_00"); //Tvùj kamarád Malcolm je mrtvý.
	AI_Output	(self, other, "DIA_Addon_Owen_MalcomDead_13_01"); //Já si to myslel. Chudák malej. Asi jsem mu mìl pomoct.
	if (SC_MadeStunt == TRUE)
	{
		AI_Output	(self, other, "DIA_Addon_Owen_MalcomDead_13_02"); //Ty seš vážnì stateènej, víš to?
		AI_Output	(self, other, "DIA_Addon_Owen_MalcomDead_13_03"); //V tý škvíøe bych mu stejnì nepomoh.
	};
	
	B_LogEntry	(TOPIC_Addon_MalcomsStunt,"Sdìlil jsem Owenovi, že jeho pøítel Malcom je mrtvý. Vzal to docela klidnì.");
