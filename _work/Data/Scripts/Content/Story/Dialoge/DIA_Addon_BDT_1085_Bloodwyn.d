...
FUNC VOID Bloodwyn_Choices_1() 
{
	...
	Info_AddChoice (DIA_Addon_Bloodwyn_Wait,"A já myslel, že jsem tì už jednou dostal.",DIA_Addon_Bloodwyn_Wait_GOOD1);
...
FUNC VOID Bloodwyn_Choices_3() 
{
	Info_ClearChoices (DIA_Addon_Bloodwyn_Wait);
	Info_AddChoice (DIA_Addon_Bloodwyn_Wait,PRINT_ADDON_ENOUGHTALK,DIA_Addon_Bloodwyn_Wait_FIGHT);
	Info_AddChoice (DIA_Addon_Bloodwyn_Wait,"Oèividnì si nemùže vybírat.",DIA_Addon_Bloodwyn_Wait_GOOD3);
	Info_AddChoice (DIA_Addon_Bloodwyn_Wait,"Jo, to byla jeho nejvìtší chyba.",DIA_Addon_Bloodwyn_Wait_BAD3);
};
//---------------------------------------------------------------------
//	Info Wait
//---------------------------------------------------------------------
...
{
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_04_00");//Tys pobil ty dùlní èervy? No dobøe, o zbytek se postarám sám. No tak, na co èekáš? Koukej, kde nechal tesaø díru!
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_15_01");//Poèkej.
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_04_02");//Ty ještì nejseš pryè?

	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_15_03");//Ještì si musíme nìco vyjasnit.
...
FUNC VOID DIA_Addon_Bloodwyn_Wait_Raven()
{
	...
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_Raven_04_01");//Fakt? A proè si myslíš, že by s tebou Havran chtìl mluvit... moment, TY seš... seš to TY??
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_Raven_04_02");//Tak tebe celou tu dobu hledám. Co tady dìláš? Dyk máš bejt dávno mrtvej!
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_Raven_15_03");//Tak tohle mi lidi øíkají poøád.
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_Raven_04_04");//Ti tupci to zpackali, ale pøese mì se nedostaneš. Tentokrát si to s tebou vyøídím!
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_Raven_15_05");//Jak už jsem øek – hledám Havrana, tebe nepotøebuju.
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_Raven_04_06");//Zabiju tì – zatím jsem pøežil každou bitvu!
...
{
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_Raven_FIGHT_15_00");//Dost øeèí. Pojïme bojovat.
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_Raven_FIGHT_04_01");//(vítìznì) Stejnì už jdeš pozdì! Právì teï Havran otevírá chrám! Hahahaha – chcípni, grázle!
...
{
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Lach_04_00");//HAHAHA – stejnì tì zabiju!
};
...
{
	AI_Output (self, other, "DIA_Addon_Bloodwyn_SayChoice_2_04_00");//Já na rozdíl od tebe pøežil výbuch bariéry bez škrábnutí!
};
FUNC VOID Bloodwyn_Next_2()
{
	AI_Output (self, other, "DIA_Addon_Bloodwyn_SayChoice_3_04_00");//Mì neporazíš, jsem Havranùv nejlepší kámoš! Jeho pravá ruka!
};
//------------------------------------------------------------------------------
FUNC VOID DIA_Addon_Bloodwyn_Wait_GOOD1()
{
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_Raven_GOOD1_15_00");//A já myslel, jsem tì dostal.
	Bloodwyn_Wut();
	Bloodwyn_Next_1();
...
FUNC VOID DIA_Addon_Bloodwyn_Wait_GOOD3()
{
	...
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_Raven_GOOD3_15_00");//Oèividnì nemìl moc na výbìr.
	Bloodwyn_Wut();
	Info_ClearChoices (DIA_Addon_Bloodwyn_Wait);
	Info_AddChoice (DIA_Addon_Bloodwyn_Wait,PRINT_ADDON_ENOUGHTALK,DIA_Addon_Bloodwyn_Wait_FIGHT);
};
...
FUNC VOID DIA_Addon_Bloodwyn_Wait_BAD3()
{
	...
	AI_Output (other, self, "DIA_Addon_Bloodwyn_Wait_Raven_BAD3_15_00");//Jo, to byla jeho nejvìtší chyba.
	Bloodwyn_Wut();
	Info_ClearChoices (DIA_Addon_Bloodwyn_Wait);
	Info_AddChoice (DIA_Addon_Bloodwyn_Wait,PRINT_ADDON_ENOUGHTALK,DIA_Addon_Bloodwyn_Wait_FIGHT);
};
