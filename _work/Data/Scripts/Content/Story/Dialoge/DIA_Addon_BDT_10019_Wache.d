...
{	
	...
	Info_AddChoice (DIA_Addon_BDT_10019_Wache_Hi,"Vlastnê bych rád vidêl Havrana.",DIA_Addon_BDT_10019_Wache_Hi_Raven);
...
FUNC VOID B_Say_Wache_kaputt()
{
	...
	AI_Output (self, other, "DIA_Addon_BDT_10019_Wache_kaputt_06_01");//(ëábelský chechot) Umakali se k smrti.
	
	Info_ClearChoices (DIA_Addon_BDT_10019_Wache_Hi);
};
FUNC VOID DIA_Addon_BDT_10019_Wache_Hi_Raven()
{
	AI_Output (other, self, "DIA_Addon_BDT_10019_Wache_Hi_Raven_15_00");//Vlastnê chci vidêt Havrana.
	AI_Output (self, other, "DIA_Addon_BDT_10019_Wache_Hi_Raven_06_01");//(varovnê) Hele, jen si zkus vlézt do toho chrámu a budeš mrtvej jako tady ti vêzni.
...
FUNC VOID DIA_Addon_BDT_10019_Wache_Hi_Ja()
{
	...
	AI_Output (self, other, "DIA_Addon_BDT_10019_Wache_Hi_Ja_06_01");//Tak si dávej bacha. A to líp než ti, co sou tu teë všude rozkouskovaný.
