...
{
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_00"); //Strašnę se mi ulevilo, že jsi sem v poâádku dorazil.
	AI_Output	(other, self, "DIA_Addon_Nefarius_ADWHello_15_01"); //Jak to, že jsi sem dorazil dâív než já?
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_02"); //Cestovali jsme pâes zvláštní dimenzi. Kdo ví, jakými oklikami jsi to bral ty.
	AI_Output	(other, self, "DIA_Addon_Nefarius_ADWHello_15_03"); //A teë? Můžu ten portál použít znovu?
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_04"); //Pâišli jsme sem pâímo. Evidentnę to funguje docela dobâe.
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_05"); //Samozâejmę ti dám vędęt, kdybych męl nęjaké podezâení, že by to mohlo být jinak.
};
...
instance DIA_Addon_Nefarius_Neues		(C_INFO)
{
	...
	description	 = 	"Co jsi tu dosud dęlal?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Nefarius_Neues_15_00"); //Co jsi tu dosud dęlal?
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_01"); //Studuji historii stavitelů a snažím se pochopit, proč uzavâeli ten portál.
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_02"); //Vypadá to, jako by se to potopené męsto snažili ukrýt pâed celým svętem.
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_03"); //Pâed mnoha lety se tu staly dęsivé vęci. Zachvátilo je nęco strašlivého.
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_04"); //Pokud se dá vęâit jejich záznamům, tak nedlouho pâed pádem męsta tu propukla občanská válka.
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_05"); //Ulice byly v plamenech a nakonec osud stavitelů zpečetila povodeŕ, která se vzápętí pâihnala.
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_06"); //Ti nemnozí, kteâí celé to peklo pâežili, uzavâeli tuto část ostrova v nadęji, že tak celý chaos zastaví.
	...
	Info_AddChoice	(DIA_Addon_Nefarius_Neues, "Z čeho byli stavitelé tak vydęšeni?", DIA_Addon_Nefarius_Neues_was );
	Info_AddChoice	(DIA_Addon_Nefarius_Neues, "Zmiŕoval ses o povodni?", DIA_Addon_Nefarius_Neues_flut );
};
func void DIA_Addon_Nefarius_Neues_find ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_find_05_01"); //O tom se můžu jedinę dohadovat. Męl by sis promluvit se Saturasem.
	...
	B_LogEntry (TOPIC_Addon_Flut,"Nefarius tvrdí, že o potopeném męstę bych si męl promluvit se Saturasem."); 
...
{
	AI_Output			(other, self, "DIA_Addon_Nefarius_Neues_flut_15_00"); //Âíkal jsi, že propukla povodeŕ?
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_flut_05_01"); //Samotný Adanos se jim zjevil, aby celé šílenství ukončil.
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_flut_05_02"); //Zničil celé męsto do poslední mrtę.
};
func void DIA_Addon_Nefarius_Neues_was ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_was_05_02"); //Jednou vyjel z ochranných hradeb męsta, kde vybojoval úspęšnou bitvu. Avšak spolu s ním vstoupilo do męsta velké zlo.
...
func void DIA_Addon_Nefarius_Neues_auf ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_auf_05_01"); //Ani jedno mę netęší, vęâ mi.
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_auf_05_02"); //Ale męli jsme snad na vybranou?
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_auf_05_03"); //Jestli neučiníme pâítrž tomu, co se tady dęje, pak Khorinis postihne pâesnę stejný osud, který kdysi potkal i stavitele tohoto pradávného męsta.
};
...
func void DIA_Addon_Nefarius_PermADW_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Nefarius_PermADW_05_01"); //Ještę jsem tím neletęl.
};
...
instance DIA_Addon_Nefarius_PreTeach		(C_INFO)
{
	...
	description	 = 	"Mohl by ses se mnou podęlit o své magické vędęní?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Nefarius_PreTeach_15_00"); //Můžeš mi pâedat nęjaké magické vędomosti?
	AI_Output	(self, other, "DIA_Addon_Nefarius_PreTeach_05_01"); //Mohu tę naučit vytváâet runy a Cronos ti k nim může prodat magické formule.
