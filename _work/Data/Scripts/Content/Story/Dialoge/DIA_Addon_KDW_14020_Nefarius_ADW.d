...
{
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_00"); //Strašnê se mi ulevilo, že jsi sem v poâádku dorazil.
	...
	AI_Output	(other, self, "DIA_Addon_Nefarius_ADWHello_15_03"); //A teë? Mùžu ten portál použít znovu?
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_04"); //Pâišli jsme sem pâímo. Evidentnê to funguje docela dobâe.
	AI_Output	(self, other, "DIA_Addon_Nefarius_ADWHello_05_05"); //Samozâejmê ti dám vêdêt, kdybych mêl nêjaké podezâení, že by to mohlo být jinak.
};
...
func void DIA_Addon_Nefarius_Neues_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_01"); //Studuji historii stavitelù a snažím se pochopit, proè uzavâeli ten portál.
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_02"); //Vypadá to, jako by se to potopené mêsto snažili ukrýt pâed celým svêtem.
	...
	AI_Output	(self, other, "DIA_Addon_Nefarius_Neues_05_06"); //Ti nemnozí, kteâí celé to peklo pâežili, uzavâeli tuto èást ostrova v nadêji, že tak celý chaos zastaví.
...
func void DIA_Addon_Nefarius_Neues_find ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_find_05_01"); //O tom se mùžu jedinê dohadovat. Mêl by sis promluvit se Saturasem.
	...
	B_LogEntry (TOPIC_Addon_Flut,"Nefarius tvrdí, že o potopeném mêstê bych si mêl promluvit se Saturasem."); 
...
{
	AI_Output			(other, self, "DIA_Addon_Nefarius_Neues_flut_15_00"); //Âíkal jsi, že propukla povodeà?
...
func void DIA_Addon_Nefarius_Neues_was ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_was_05_02"); //Jednou vyjel z ochranných hradeb mêsta, kde vybojoval úspêšnou bitvu. Avšak spolu s ním vstoupilo do mêsta velké zlo.
...
func void DIA_Addon_Nefarius_Neues_auf ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nefarius_Neues_auf_05_03"); //Jestli neuèiníme pâítrž tomu, co se tady dêje, pak Khorinis postihne pâesnê stejný osud, který kdysi potkal i stavitele tohoto pradávného mêsta.
};
...
{
	AI_Output	(other, self, "DIA_Addon_Nefarius_PreTeach_15_00"); //Mùžeš mi pâedat nêjaké magické vêdomosti?
	AI_Output	(self, other, "DIA_Addon_Nefarius_PreTeach_05_01"); //Mohu tê nauèit vytváâet runy a Cronos ti k nim mùže prodat magické formule.
