...
FUNC VOID DIA_Dragomir_Hello_Info()
{
	...
	AI_Output (self,other,"DIA_Dragomir_Hello_12_01"); //Tady musíš být opatrný, zvlášã když se mùžeš spolehnout jen sám na sebe.
};		 
...
FUNC VOID DIA_Dragomir_OutHere_Info()
{
	...
	AI_Output (self ,other,"DIA_Dragomir_OutHere_12_01"); //No, hostinec je pro mê pâíliš drahý, tak jsem se utáboâil tady.
	AI_Output (self ,other,"DIA_Dragomir_OutHere_12_02"); //Vypadá to, že dâívêjší obyvatelé už to tu nepotâebují.
};		 		
...
FUNC VOID DIA_Dragomir_Settlers_Info()
{
	...
	AI_Output (self ,other,"DIA_Dragomir_Settlers_12_01"); //Nemám tušení, asi nêjací lovci. Pâedpokládám, že to tu pro nê zaèalo být pâíliš nebezpeèné.
};
...
FUNC VOID DIA_Dragomir_Dangerous_Info()
{
	...
	AI_Output (self ,other,"DIA_Dragomir_Dangerous_12_03"); //Ale staèí. Když víš, jak s ní zacházet. Míval jsem vêtší. Bohužel jsem ji však ztratil.
	...
	AI_Output (self ,other,"DIA_Dragomir_Dangerous_12_05"); //Když jsem tam lovil mrchožrouty, zaèali z lesa vylézat ti odporní nemrtví a napadli mê.
	AI_Output (self ,other,"DIA_Dragomir_Dangerous_12_06"); //Jediné, co jsem mohl dêlat, bylo vzít nohy na ramena.
	AI_Output (self ,other,"DIA_Dragomir_Dangerous_12_07"); //Jak jsem utíkal, vyklouzla mi ta kuše z rukou. Vsadím se, že se tam ještê poâád u toho podivného kamenného kruhu na severu nêkde povaluje.
...
FUNC VOID DIA_Dragomir_Armbrust_Info()
{
	...
	AI_Output (self ,other,"DIA_Dragomir_Armbrust_12_03"); //To od tebe byla pêkná lehkovážnost. Ale jinak díky.
	AI_Output (self ,other,"DIA_Dragomir_Armbrust_12_04"); //Samozâejmê ti za ni zaplatím. Doufám, že tohle bude staèit.
...
{
	AI_Output (other,self ,"DIA_Dragomir_Learn_15_00"); //Mùžeš mê nêèemu nauèit?
	
	if (other.attribute[ATR_DEXTERITY] < 30)
	{
		AI_Output (self ,other,"DIA_Dragomir_Learn_12_01"); //Než tê budu moct zaèít cokoli uèit, musíš nejprve posílit svoji obratnost.
	}
	else
	{
		AI_Output (self ,other,"DIA_Dragomir_Learn_12_02"); //Jestli na to máš. Jak už jsem âekl, právê se mi ponêkud nedostává hotovosti.
		...
		Info_AddChoice (DIA_Dragomir_Learn,"Možná pozdêji.",DIA_Dragomir_Learn_Later);
...
{
	AI_Output (other,self ,"DIA_Dragomir_Learn_Later_15_00"); //Možná pozdêji.
	Info_ClearChoices (DIA_Dragomir_Learn);
};
...
FUNC VOID DIA_Dragomir_Learn_Here()
{
	...
	AI_Output (self ,other,"DIA_Dragomir_Learn_Here_12_01"); //Výbornê, jestli se nemýlím, mùžeme hned zaèít.
...
{
	AI_Output (other,self ,"DIA_Dragomir_Teach_15_00"); //Mùžeš mê nêèemu nauèit?
...
func void DIA_Dragomir_Teach_Back ()
{
	...
	{
		AI_Output(self,other,"DIA_Dragomir_Teach_12_00"); //Už tê nemám èemu uèit. Je naèase, aby sis našel nêkoho zkušenêjšího.
