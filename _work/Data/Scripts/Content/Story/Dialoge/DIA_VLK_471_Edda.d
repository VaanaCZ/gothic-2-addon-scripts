...
{	
	...
	AI_Output (self ,other,"DIA_Edda_Stadt_17_01"); //Vętšina lidí z tohodle męsta se bojí zlodęjů. Proto není zrovna dobrej nápad chodit do cizích domů.
...
{	
	...
	else if (Edda_Day != Wld_GetDay())
	{
		...
		{
			AI_Output (self ,other,"DIA_Edda_Suppe_17_04"); //Pâines mi nęjakou rybu a já ti uvaâím dobrou polívku.
		};
...
{	
	...
	AI_Output (self ,other,"DIA_Edda_Statue_17_01"); //Ó - dękuju mockrát. Aă nad tebou Innos drží své ochranné svętlo.
