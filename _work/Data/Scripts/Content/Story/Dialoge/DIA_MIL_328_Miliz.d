...
{
	AI_Output (self, other, "DIA_328_Miliz_Hi_08_00"); //Ej, nie masz tu czego szukać, zrozumiałeś?
	AI_Output (other, self, "DIA_328_Miliz_Hi_15_01"); //Kim jesteś?
	AI_Output (self, other, "DIA_328_Miliz_Hi_08_02"); //To nie twoja sprawa! Ja tu jestem szefem, jasne?
	AI_Output (other, self, "DIA_328_Miliz_Hi_15_03"); //Szefem? Czego? Tych skrzyń?
	AI_Output (self, other, "DIA_328_Miliz_Hi_08_04"); //Magazyn jest pod moim nadzorem, zrozumiałeś? Więc spływaj, bo dostaniesz po łbie.
...
{
	AI_Output (self, other, "DIA_328_Miliz_Kill_08_00"); //Ciągle tu jesteś? Chyba mówiłem, żebyś stąd wypadł.
	AI_Output (self, other, "DIA_328_Miliz_Kill_08_01"); //Zaraz ci pokażę, kto tu jest szefem!
