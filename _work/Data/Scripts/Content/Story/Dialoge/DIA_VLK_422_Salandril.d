...
{
	AI_Output (self, other, "DIA_Salandril_PERM_13_00"); //Vítej, poutníku, hledáš nìjaký dobrý lektvar?
	AI_Output (self, other, "DIA_Salandril_PERM_13_01"); //U mì najdeš velký výbìr za pøijatelné ceny a mé lektvary jsou mnohem lepší než ty patoky, které prodává Zuris.
...
{
	AI_Output (self, other, "DIA_Salandril_Trank_13_00"); //Slyšel jsem, že ses s paladiny vypravil do Hornického údolí. To na mì udìlalo dojem.
	AI_Output (self, other, "DIA_Salandril_Trank_13_01"); //Mìl by sis vyšetøit chvilku a prohlédnout si mé zboží - zrovna ti mohu nabídnout jeden velmi zvláštní lektvar.
...
func void DIA_Salandril_Trade_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Salandril_Trade_13_01"); //Je mi potìšením, ctihodný bratøe.
	...
	{
		AI_Output (self, other, "DIA_Salandril_Trade_13_02"); //Je mi potìšením, šlechetný váleèníku.
	};
};
...
instance DIA_Salandril_KLOSTER		(C_INFO)
{
	...
	description	 = 	"Teï se vyprav do kláštera - budeš souzen.";
};
...
{
	AI_Output			(other, self, "DIA_Salandril_KLOSTER_15_00"); //Teï se vyprav do kláštera - budeš souzen.
	AI_Output			(self, other, "DIA_Salandril_KLOSTER_13_01"); //Cože? To jako abych zvednul zadek? Houby s octem! Ti mizerní mágové proti mnì nemají jediný dùkaz!
	...
	{
		AI_Output			(other, self, "DIA_Salandril_KLOSTER_15_03"); //Mám své pøíkazy, a ty taky vyplním. Takže buï pùjdeš po dobrém, nebo po zlém.
	};
	AI_Output			(self, other, "DIA_Salandril_KLOSTER_13_04"); //Cože? Klidnì tì pøes mìsto potáhnu za límec jako kus špinavého hadru!
	AI_StopProcessInfos (self);
...
instance DIA_Salandril_GehinsKloster		(C_INFO)
{
	...
	description	 = 	"Takže pùjdeš teï do toho kláštera, nebo chceš ještì jednu?";
};
...
{
	AI_Output			(other, self, "DIA_Salandril_GehinsKloster_15_00"); //Tak pùjdeš teï do toho kláštera, nebo chceš ještì jednu?
	AI_Output			(self, other, "DIA_Salandril_GehinsKloster_13_01"); //Toho budeš litovat. Jo, ksakru, pùjdu do toho pitomýho kláštera, ale nemysli si, že je to vyøízené.
	AI_StopProcessInfos (self);
