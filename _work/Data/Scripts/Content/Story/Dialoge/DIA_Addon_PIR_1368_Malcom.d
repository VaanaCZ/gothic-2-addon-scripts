...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_Malcom_perm_04_01"); //Nenech se sežrat od těch potvor. Tady je to fakt nebezpečný.
	}
	else
	{
		AI_Output	(self, other, "DIA_Addon_Malcom_Add_04_03"); //Hele, až dorazíš do tábora, vyřiď ode mě něco Henrymu.
		AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_04"); //Tady ty stromy jsou sakra odolný.
		AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_05"); //Takže si na dřevo bude muset ještě ňákou chvíli počkat. Vyřiď mu to.
...
func void DIA_Addon_Malcom_WasMachen_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Malcom_WasMachen_04_04"); //Furt postává u tábora a má plnou hubu keců.
	AI_Output	(self, other, "DIA_Addon_Malcom_WasMachen_04_05"); //Vo nadšený službě naší společnosti a podobný žvásty.
...
func void DIA_Addon_Malcom_Entertrupp_Info ()
{
	...
	if (GregIsBack == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_Malcom_Add_04_02"); //Ale ten tu teď není.
	};
};
...
func void DIA_Addon_Malcom_Lager_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_01"); //Běž tady touhle cestou na západ a dojdeš tam.
	AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_02"); //Henryho určitě hned uvidíš, jak tam někde postává.
};
