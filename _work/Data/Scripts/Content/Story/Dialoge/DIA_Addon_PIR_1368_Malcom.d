...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_Malcom_perm_04_01"); //Nenech se sežrat od tìch potvor. Tady je to fakt nebezpeèný.
	}
	else
	{
		AI_Output	(self, other, "DIA_Addon_Malcom_Add_04_03"); //Hele, až dorazíš do tábora, vyøiï ode mì nìco Henrymu.
		AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_04"); //Tady ty stromy jsou sakra odolný.
		AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_05"); //Takže si na døevo bude muset ještì òákou chvíli poèkat. Vyøiï mu to.
...
func void DIA_Addon_Malcom_WasMachen_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Malcom_WasMachen_04_05"); //Vo nadšený službì naší spoleènosti a podobný žvásty.
...
func void DIA_Addon_Malcom_Entertrupp_Info ()
{
	...
	if (GregIsBack == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_Malcom_Add_04_02"); //Ale ten tu teï není.
	};
};
...
func void DIA_Addon_Malcom_Lager_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_01"); //Bìž tady touhle cestou na západ a dojdeš tam.
	AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_02"); //Henryho urèitì hned uvidíš, jak tam nìkde postává.
};
