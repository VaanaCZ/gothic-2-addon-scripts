...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_Malcom_perm_04_01"); //Nenech se sežrat od tęch potvor. Tady je to fakt nebezpečný.
	}
	else
	{
		AI_Output	(self, other, "DIA_Addon_Malcom_Add_04_03"); //Hele, až dorazíš do tábora, vyâië ode mę nęco Henrymu.
		AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_04"); //Tady ty stromy jsou sakra odolný.
		AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_05"); //Takže si na dâevo bude muset ještę ŕákou chvíli počkat. Vyâië mu to.
...
func void DIA_Addon_Malcom_WasMachen_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Malcom_WasMachen_04_05"); //Vo nadšený službę naší společnosti a podobný žvásty.
...
func void DIA_Addon_Malcom_Lager_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_01"); //Bęž tady touhle cestou na západ a dojdeš tam.
	AI_Output	(self, other, "DIA_Addon_Malcom_Lager_04_02"); //Henryho určitę hned uvidíš, jak tam nękde postává.
};
