...
FUNC VOID DIA_Addon_Patrick_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_01");//Všecko je fajn. Vodní mágové nás bezpečnę odvedli z toho proklatýho údolí.
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_02");//A co budeš dęlat teë?
	...
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_05");//Uvidíme. Pokud je ještę poâád válka, půjdem proti skâetům, ale to se uvidí.
};
