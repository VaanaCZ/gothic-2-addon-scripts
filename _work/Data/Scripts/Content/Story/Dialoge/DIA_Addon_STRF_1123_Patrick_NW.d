...
INSTANCE DIA_Addon_Patrick_NW_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Allora? Tutto a posto?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_00");//Allora? Tutto a posto?
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_01");//Sì. I Maghi dell'Acqua ci hanno fatti uscire da questa maledetta valle.
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_02");//Cosa farai ora?
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_03");//Continuerò a combattere per Lee. E uno di questi giorni lasceremo l'isola...
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_04");//E poi?
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_05");//Si vedrà. Se la guerra è ancora in corso, affronteremo gli orchi. Ma questo resta da vedersi.
};
