...
INSTANCE DIA_Addon_Patrick_NW_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Takže už je ti dobâe?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_00");//Tak co, je všecko v poâádku?
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_01");//Všecko je fajn. Vodní mágové nás bezpeènê odvedli z toho proklatýho údolí.
	AI_Output (other, self, "DIA_Addon_Patrick_NW_Hi_15_02");//A co budeš dêlat teë?
	...
	AI_Output (self, other, "DIA_Addon_Patrick_NW_Hi_07_05");//Uvidíme. Pokud je ještê poâád válka, pùjdem proti skâetùm, ale to se uvidí.
};
