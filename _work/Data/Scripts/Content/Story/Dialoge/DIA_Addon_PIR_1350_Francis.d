...
{	
	...
	AI_Output (self ,other ,"DIA_Addon_Francis_LetMeIn_13_01"); //Na to zapomeŕ!
	AI_Output (self ,other ,"DIA_Addon_Francis_LetMeIn_13_02"); //Greg tu není. A já zamknul dveâe, aby nikoho nesvrbęly ruce a nemoh se tam proplížit. 
...
{	
	...
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_03"); //(nafoukanę) A von svęâil velení MNĘ!
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_04"); //Zvodpovídám za to, aby ta líná pakáž dęlala, co jí poručil.
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_05"); //Nękterý chlapi si myslej, že když kapitán vystrčil paty, můžou si dęlat, co chtęj.
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_06"); //A budou POÂÁDNĘ pâekvapený, až se Greg vrátí. 
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_07"); //Páč mu âeknu úplnę vo všem, co se tu dęlo, kapišto?
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_08"); //Včetnę toho, kdo se mu snažil vlézt do boudy.
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Francis_Key_13_01"); //To si snad dęláš srandu!
	
	Info_ClearChoices (DIA_Addon_Francis_Key);
	Info_AddChoice (DIA_Addon_Francis_Key, "Popâemýšlím o tom.", DIA_Addon_Francis_Key_BACK);
	Info_AddChoice (DIA_Addon_Francis_Key, "Dám ti 2000 zlaăáků!", DIA_Addon_Francis_Key_2000Gold);
	Info_AddChoice (DIA_Addon_Francis_Key, "Dám ti 1000 zlaăáků!", DIA_Addon_Francis_Key_1000Gold);
};
...
{
	AI_Output (other, self ,"DIA_Addon_Francis_Key_1000Gold_15_00"); //Dám ti za nęj 1000 zlaăáků!
	AI_Output (self ,other ,"DIA_Addon_Francis_Key_1000Gold_13_01"); //Nęco mi âíká, že za takovej pakatel svýho kapitána nezradím.
	AI_Output (self ,other ,"DIA_Addon_Francis_Key_1000Gold_13_02"); //Bacha na zobák, jinak tę stáhnu z kůže!
};
func void DIA_Addon_Francis_Key_2000Gold()
{
	AI_Output (other,self ,"DIA_Addon_Francis_Key_2000Gold_15_00"); //Dám ti 2000 zlaăáků!
	
	if (Npc_HasItems (other,ItMI_Gold) >= 2000)
	{
		AI_Output (self ,other,"DIA_Addon_Francis_Key_2000Gold_13_01"); //Hochu, ty po mnę chceš, abych se vzbouâil!
		AI_Output (self ,other,"DIA_Addon_Francis_Key_2000Gold_13_02"); //(pro sebe) No, ale na druhou stranu...
		AI_Output (self ,other,"DIA_Addon_Francis_Key_2000Gold_13_03"); //No dobâe, dej to sem. Nikdo to nemusí vędęt.
	...
	{
		AI_Output (self ,other,"DIA_Addon_FrancisNotEnoughGold_13_05"); //(smęje se) Ha! Vsadím se, že tolik ani nemáš!
	};
	Info_ClearChoices (DIA_Addon_Francis_Key);
};
// ------------------------------------------------------------
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Francis_AufsMaul_13_01"); //(pronikavę) Cože? Kapitán jsem tady já! 
	AI_Output (self, other, "DIA_Addon_Francis_AufsMaul_13_02"); //Já tę naučím úctę, ty suchozemská kryso!
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Francis_Buch_13_01"); //Ehm... tuhle knihu vidím poprvé v životę.
	AI_Output (self, other, "DIA_Addon_Francis_Buch_13_02"); //A... a i KDYBY byla moje...
	AI_Output (self, other, "DIA_Addon_Francis_Buch_13_03"); //Pâeci VÁŽNĘ nevęâíš, že by nękdo uvęâil tý TVÝ historce, co se opírá jen o pár zažloutlejch stránek.
	...
	if (Npc_HasItems (self, ITKE_Greg_ADDON_MIS))
	{
		if (Npc_KnowsInfo (other, DIA_Addon_Francis_LetMeIn))
		{
			AI_Output (self, other, "DIA_Addon_Francis_Buch_13_05"); //(podlézavę) Chtęls klíč od Gregovy chajdy, vië?
		};
		AI_Output (self, other, "DIA_Addon_Francis_Buch_13_06"); //Tak já ti ten klíč od Gregovy chatrče DÁM!
		AI_Output (self, other, "DIA_Addon_Francis_Buch_13_07"); //Je tam spousta cennejch vęcí...
		AI_Output (self, other, "DIA_Addon_Francis_Buch_13_08"); //(nervóznę) Ale vraă mi tu knížku a drž hubu, jo?
	...
	else
	{
		...
		&& (Npc_HasItems(self, itmi_gold) >= 2000)
		{
			...
			AI_Output (self, other, "DIA_Addon_Francis_Buch_13_11"); //A pâidám ti ještę dalších 500.
...
{	
	if (!Npc_IsDead(Greg))
	{
		AI_Output (self, other, "DIA_Addon_Francis_Ausgeschissen_13_00"); //(zuâivę) Kvůli tobę mę Greg nechá âezat dâíví tak dlouho, dokud bude na tomdle ostrovę stát jedinej strom!
	};
	AI_Output (self, other, "DIA_Addon_Francis_Ausgeschissen_13_01"); //Nech mę na pokoji!
	AI_StopProcessInfos (self);
};
