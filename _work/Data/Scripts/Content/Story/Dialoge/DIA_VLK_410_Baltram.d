...
func void DIA_Baltram_Hallo_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Baltram_Hallo_01_03"); //Pokud jsi u mì chtìl nakoupit jídlo, mùžeš jít klidnì zase pryè.
...
{
	AI_Output	(other, self, "DIA_Addon_Baltram_LaresAbloese_15_00"); //Proè se tváøíš tak pochybovaènì?
	AI_Output	(self, other, "DIA_Addon_Baltram_LaresAbloese_01_01"); //Vidím, že neseš znamení kruhu vody.
	AI_Output	(other, self, "DIA_Addon_Baltram_LaresAbloese_15_02"); //Takže ty k nim taky patøíš?
	AI_Output	(self, other, "DIA_Addon_Baltram_LaresAbloese_01_03"); //A co když ano?
	AI_Output	(other, self, "DIA_Addon_Baltram_LaresAbloese_15_04"); //Pak bych ti mìl øíct, že Lares by potøeboval, aby ho nìkdo tam dole v pøístavu nahradil.
	AI_Output	(self, other, "DIA_Addon_Baltram_LaresAbloese_01_05"); //Fajn, když je to tak, postarám se, aby se toho nìkdo ujal.
	AI_Output	(other, self, "DIA_Addon_Baltram_LaresAbloese_15_06"); //Chápu.
	B_GivePlayerXP (XP_Ambient);

	B_LogEntry (TOPIC_Addon_BringRangerToLares,"Baltram, obchodník z tržištì, je ochoten vystøídat Larese. Snad už tedy koneènì bude moci opustit pøístav."); 
...
func void DIA_Baltram_WAREZ_Info ()
{
	...
	||  (hero.guild == GIL_DJG)))
	{
		AI_Output (self ,other,"DIA_Baltram_WAREZ_01_03"); //Lidé jako ty ode mì nic nedostanou.
...
{
	AI_Output	(other, self, "DIA_Addon_Baltram_Skip_15_00"); //(bezstarostnì) Tak ty obchoduješ s piráty?
	...
	AI_Output	(self, other, "DIA_Addon_Baltram_Skip_01_03"); //Co mùžu dìlat? Doba je tìžká a každý si musí hledìt hlavnì svého.
	
	Info_ClearChoices	(DIA_Addon_Baltram_Skip);
	Info_AddChoice	(DIA_Addon_Baltram_Skip, "To ses nebál, že tì chytí?", DIA_Addon_Baltram_Skip_erwischen );
	Info_AddChoice	(DIA_Addon_Baltram_Skip, "Tohle si poøádnì odskáèeš!", DIA_Addon_Baltram_Skip_MIL );
};
func void DIA_Addon_Baltram_Skip_Back ()
{
	AI_Output (other, self, "DIA_Addon_Baltram_Skip_Back_15_00"); //To je všecko, co jsem chtìl vìdìt.
	Info_ClearChoices	(DIA_Addon_Baltram_Skip);
};

func void DIA_Addon_Baltram_Skip_MIL ()
{
	AI_Output (other, self, "DIA_Addon_Baltram_Skip_MIL_15_00"); //Tak tohle si poøádnì odskáèeš!
	AI_Output (self, other, "DIA_Addon_Baltram_Skip_MIL_01_01"); //Hele, poslouchej. Povím ti, co vím, a ty to na mì na oplátku nepráskneš, ok?
...
{
	AI_Output (other, self, "DIA_Addon_Baltram_Skip_erwischen_15_00"); //Copak se nebojíš, že tì chytnou?
	AI_Output (self, other, "DIA_Addon_Baltram_Skip_erwischen_01_01"); //To by se mohlo stát. Vždy tys na to taky pøišel, že jo?
	AI_Output (self, other, "DIA_Addon_Baltram_Skip_erwischen_01_02"); //Ale budeš držet jazyk za zuby, viï?
...
{
	AI_Output			(other, self, "DIA_Addon_Baltram_Skip_was_15_00"); //(odmìøenì) Co jim to prodáváš?
	AI_Output			(self, other, "DIA_Addon_Baltram_Skip_was_01_01"); //Vìtšinou je zásobuju jídlem.
	AI_Output			(self, other, "DIA_Addon_Baltram_Skip_was_01_02"); //A za to mi dávají nejlepší rum, jaký se dá v Khorinidu sehnat.
	
	Info_AddChoice	(DIA_Addon_Baltram_Skip, "Víc už vìdìt nepotøebuju.", DIA_Addon_Baltram_Skip_Back );
	Info_AddChoice	(DIA_Addon_Baltram_Skip, "Mùžu to pro tebe zaøídit.", DIA_Addon_Baltram_Skip_Ich );
};
...
func void DIA_Addon_Baltram_Skip_Ich ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Baltram_Skip_Ich_01_01"); //To by bylo skvìlé. V téhle chvíli se nemùžu z Khorinidu hnout.
	...
	AI_Output			(self, other, "DIA_Addon_Baltram_Skip_Ich_01_03"); //Mìl by ti za to dát aspoò 3 lahve.
	
	B_LogEntry (TOPIC_Addon_BaltramSkipTrade,"Baltram mi pøedal balík, který mám odnést Skipovi."); 
...
{
	AI_Output			(other, self, "DIA_Addon_Baltram_Skip_pirat_15_00"); //(odmìøenì) Co víš o pirátech?
	...
	AI_Output			(self, other, "DIA_Addon_Baltram_Skip_pirat_01_03"); //Lidi z Khorinidu se jich bojí, a mají pravdu. Je to banda pìknì hnusných hrdloøezù.
...
func void DIA_Addon_Baltram_SkipsRum_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Baltram_SkipsRum_01_01"); //(rozèilenì) Ten lakomec lakomá! Kdo si myslí, že je? No, tak je sem dej.
...
instance DIA_Baltram_LetUsTrade		(C_INFO)
{
	...
	permanent	 =  FALSE;
	description	 = 	"Mohli bychom potom všem spolu uzavøít obchod?";
};
