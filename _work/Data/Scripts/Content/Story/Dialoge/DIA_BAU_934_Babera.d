...
func void DIA_Babera_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Babera_HALLO_16_01"); //Pâestaà s têmi sladkými âeèièkami, hochu. Âekni, co chceš. Mám práci.
};
...
func void DIA_Babera_WIESIEHTSAUS_Info ()
{
	...
	AI_Output			(self, other, "DIA_Babera_WIESIEHTSAUS_16_01"); //Podívej se na ty obrovský lány, co musíme obdêlávat, a bude ti to jasné.
	...
	if (hero.guild == GIL_NONE)
		{
			Info_AddChoice	(DIA_Babera_WIESIEHTSAUS, "Ne. Vlastnê se chci stát žoldákem.", DIA_Babera_WIESIEHTSAUS_Nein );
...
func void DIA_Babera_WIESIEHTSAUS_Vielleicht ()
{
	...
	AI_Output			(self, other, "DIA_Babera_WIESIEHTSAUS_Vielleicht_16_01"); //V tom pâípadê bys mêl zajít za Sekobem, tím starým otrokáâem. Možná pro tebe nêco bude mít.
	AI_Output			(self, other, "DIA_Babera_WIESIEHTSAUS_Vielleicht_16_02"); //Taky mùžeš samozâejmê zkusit Onarovu farmu na konci téhle dlouhé cesty.
...
{
	AI_Output			(other, self, "DIA_Babera_WIESIEHTSAUS_Nein_15_00"); //Ne. Vlastnê se chci stát žoldákem.
	AI_Output			(self, other, "DIA_Babera_WIESIEHTSAUS_Nein_16_01"); //Tak to tady jsi špatnê. Žoldáky najdeš na farmê velkostatkáâe.
...
func void DIA_Babera_BRONKO_Info ()
{
	...
	AI_Output			(other, self, "DIA_Babera_BRONKO_15_02"); //To je farmáâ?
	AI_Output			(self, other, "DIA_Babera_BRONKO_16_03"); //(smích) Tak tohle ti âekl? Farmáâ je tu Sekob. Bronco není nic než povaleè a budižknièemu. Ale je silnej jako bejk.
	AI_Output			(self, other, "DIA_Babera_BRONKO_16_04"); //Proto mu taky nikdo nic neâekne, když nic nedêlá.

	if ((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
		{
			AI_Output			(self, other, "DIA_Babera_BRONKO_16_05"); //Nebojí se nikoho jiného než vás, žoldnéâù.

		}
	else
		{
			AI_Output			(self, other, "DIA_Babera_BRONKO_16_06"); //Jedinej, kdo ho mùže pâimêt k práci, je nêkdo od žoldákù. Bojí se jich.
...
func void DIA_Babera_Rosi_Info ()
{
	...
	B_LogEntry (TOPIC_RosisFlucht,"Rosi uprchla ze Sekobova statku. Podle Babery míâila na sever, do lesù."); 
	B_LogEntry (TOPIC_bringRosiBackToSekob,"Rosi uprchla ze Sekobova statku. Podle Babery míâila na sever, do lesù."); 
};
...
{
	AI_Output			(other, self, "DIA_Babera_DUSTOERST_15_00"); //A kromê toho?
