...
func void DIA_Mil_309_Stadtwache_Hallo_Info ()
{
	...
	|| (hero.guild == GIL_KDF)
	{
		AI_Output (self, other, "DIA_Mil_309_Stadtwache_Hallo_06_01"); //Všechno v pohodê. Mêli bychom mít oèi na stopkách.
	}
	else if (Stadtwache_310.aivar[AIV_PASSGATE] == FALSE)
	&& (MIl_309_News < 1)
	{
		AI_Output (self, other, "DIA_Mil_309_Stadtwache_Hallo_06_02"); //Teë poslouchej. Nemùžeme tê pustit do mêsta.
		AI_Output (self, other, "DIA_Mil_309_Stadtwache_Hallo_06_03"); //Ale dám ti tip, a to naprosto zadarmo.
		AI_Output (self, other, "DIA_Mil_309_Stadtwache_Hallo_06_04"); //Drž se dál od toho lesa pâed námi - potulují se po nêm líté bestie.
	...
	&&  (MIl_309_News < 2)
	{
		AI_Output (self, other, "DIA_Mil_309_Stadtwache_Hallo_06_06"); //Poslouchej - teë máš povolen pâístup do mêsta. Ale to neznamená, že by sis tady mohl dêlat, co se ti zlíbí.
	...
	&& 		(MIl_309_News == 2)
	{
		AI_Output (self, other, "DIA_Mil_309_Stadtwache_Hallo_06_08"); //Tak bêž - padej!
	};
