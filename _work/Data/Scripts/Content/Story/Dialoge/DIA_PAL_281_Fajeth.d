...
func void DIA_Fajeth_First_Info ()
{
	...
	AI_Output (other, self, "DIA_Fajeth_First_15_01"); //Jsem na cestě z rozkazu lorda Hagena.
	AI_Output (self, other, "DIA_Fajeth_First_12_02"); //V tom případě by ses měl pokusit dostat do hradu. Je tam velitel Garond. Má na povel celou naši výpravu.
...
func void DIA_Fajeth_Hallo_Info ()
{
	...
	AI_Output (other, self, "DIA_Fajeth_Hallo_15_01"); //Přicházím jménem Garonda.
	AI_Output (self, other, "DIA_Fajeth_Hallo_12_02"); //To je skvělé. Další muži se mi vždycky hodí.
	AI_Output (other, self, "DIA_Fajeth_Hallo_15_03"); //Nejsem zde proto, abych vám pomáhal.
	AI_Output (self, other, "DIA_Fajeth_Hallo_12_04"); //Ne? A proč jsi tedy přišel?
	AI_Output (other, self, "DIA_Fajeth_Hallo_15_05"); //Mám za úkol zjistit, kolik rudy jste už vydolovali.
	
	if (other.guild == GIL_KDF)
	{
		AI_Output (self, other, "DIA_Fajeth_Hallo_12_06"); //Ctihodný mágu. Tvoje přítomnost dodává mně a mým mužům jistotu.
		AI_Output (self, other, "DIA_Fajeth_Hallo_12_07"); //Hodilo by se nám, kdybys nám nějak pomohl prostřednictvím své síly darované Innosem.
		
		
		Info_AddChoice 	  (DIA_Fajeth_Hallo,"Co pro tebe můžu udělat?",DIA_Fajeth_Hallo_Tun);	
		Info_AddChoice 	  (DIA_Fajeth_Hallo,"Moje poslání je důležitější.",DIA_Fajeth_Hallo_KDFNein);	
	}
	else if (other.guild == GIL_MIL)
	{
		AI_Output (self, other, "DIA_Fajeth_Hallo_12_08"); //A mým úkolem je udělat všechno pro to, abych vytěžil co nejvíc rudy a ochránil ji.
		...
		Info_AddChoice 	  (DIA_Fajeth_Hallo,"Co pro tebe můžu udělat?",DIA_Fajeth_Hallo_Tun);	
		Info_AddChoice 	  (DIA_Fajeth_Hallo,"Už své příkazy mám, od Garonda.",DIA_Fajeth_Hallo_MILNein);	
	}
	else //GIL_SLD
	{
		AI_Output (self, other, "DIA_Fajeth_Hallo_12_10"); //Poslouchej - netuším, proč ke mně Garond poslal žoldáka. Ale určitě k tomu musel mít dobrý důvod.
		AI_Output (self, other, "DIA_Fajeth_Hallo_12_11"); //Avšak než tě pustím zpátky, něco pro mě uděláš.
...
FUNC VOID DIA_Fajeth_Hallo_Tun () //Mission
{
	...
	AI_Output (self, other, "DIA_Fajeth_Hallo_Tun_12_01"); //Už několik dní se kolem tábora potuluje smečka chňapavců. Vypadá to, že čekají jen na ideální příležitost k útoku.
	AI_Output (self, other, "DIA_Fajeth_Hallo_Tun_12_02"); //Nikdo neví, kdy k tomu dojde - ale dokud jsou tady, nebude v táboře klid.

	if ((Npc_IsDead(Fed)) == FALSE)
	{
		AI_Output (self, other, "DIA_Fajeth_Hallo_Tun_12_03"); //Ten Fed, mimo jiné, je strachy úplně bez sebe. Znepokojuje ostatní odsouzence.
	};
	...
	B_LogEntry (TOPIC_FajethKillSnapper,"Fajeth mi vysvětlil, jak účinně lovit chňapavce, kteří se už pár dní potulují kolem tábora.");
...
{
	AI_Output (other, self, "DIA_Fajeth_Hallo_KDFNein_15_00"); //Mám mnohem důležitější úkol. Nemůžu ti pomoci.
	AI_Output (self, other, "DIA_Fajeth_Hallo_KDFNein_12_01"); //Pochopitelně, ctihodnosti. Podám ti všechny informace, které budeš chtít.
	MIS_Fajeth_Kill_Snapper = LOG_OBSOLETE;
	Info_ClearChoices (DIA_Fajeth_Hallo);
};
FUNC VOID DIA_Fajeth_Hallo_MILNein ()
{
	AI_Output (other, self, "DIA_Fajeth_Hallo_MILNein_15_00"); //Už své příkazy mám, od Garonda.
	AI_Output (self, other, "DIA_Fajeth_Hallo_MILNein_12_01"); //A také je splníš. Ale až poté, co tě propustím.
	AI_Output (self, other, "DIA_Fajeth_Hallo_MILNein_12_02"); //Jediné, co od tebe chci slyšet, je 'Co pro tebe můžu udělat?' Rozuměno?
};
FUNC VOID DIA_Fajeth_Hallo_SLDJa ()
{
	...
	AI_Output (self, other, "DIA_Fajeth_Hallo_SLDJa_12_02"); //Ale pokud pro mě budeš pracovat, dám ti na důkaz své dobré vůle 100 zlatých.
...
FUNC VOID DIA_Fajeth_Hallo_SLDNein ()
{
	...
	AI_Output (self, other, "DIA_Fajeth_Hallo_SLDNein_12_01"); //Odmítáš tak snadno vydělané peníze? To bych od žoldáka nikdy nečekal.
	AI_Output (self, other, "DIA_Fajeth_Hallo_SLDNein_12_02"); //Protože nám nechceš pomoci, předpokládám, že budeš chtít co nejrychleji získat odpovědi na své otázky a pak hned vypadneš.
	MIS_Fajeth_Kill_Snapper = LOG_OBSOLETE;
	Info_ClearChoices (DIA_Fajeth_Hallo);
};
///////////////////////////////////////////////////////////////////////	
...
instance DIA_Fajeth_SNAPPER_KILLED		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"S chňapavci jsem skoncoval.";
};
...
func void DIA_Fajeth_SNAPPER_KILLED_Info ()
{
	...
	AI_Output (hero, self, "DIA_Fajeth_SNAPPER_KILLED_15_00"); //S chňapavci jsem skoncoval.
	AI_Output (self, hero, "DIA_Fajeth_SNAPPER_KILLED_12_01"); //Dobrá práce. O zbytek bychom už měli být schopni se postarat sami.
...
func void DIA_Fajeth_Running_Info ()
{
	...
	AI_Output (self, other, "DIA_Fajeth_Running_12_01"); //Chceš vědět, jak to vypadá s morálkou? Strachy sotva pracují!
	AI_Output (self, other, "DIA_Fajeth_Running_12_02"); //Postarej se o ty chňapavce, jinak to špatně dopadne!
};
///////////////////////////////////////////////////////////////////////
//	Info Belohnung
///////////////////////////////////////////////////////////////////////
instance DIA_Fajeth_BELOHNUNG		(C_INFO)
{
	...
	permanent	 =  FALSE;
	description	 = 	"Pověz mi, kolik rudy jste už vydolovali.";
};
...
{
	AI_Output (other, self, "DIA_Fajeth_BELOHNUNG_15_00"); //Pověz mi, kolik rudy jste už vydolovali.
	AI_Output (self, other, "DIA_Fajeth_BELOHNUNG_12_01"); //Nahlas Garondovi, že zatím se nám podařilo získat jenom DVĚ bedny rudy.
	AI_Output (self, other, "DIA_Fajeth_BELOHNUNG_12_02"); //Kvůli neustálým nájezdům jsem už přišel o spoustu mužů.
	AI_Output (self, other, "DIA_Fajeth_BELOHNUNG_12_03"); //Pokud by nám Garond poslal více mužů, měli bychom rudy víc.
	AI_Output (other, self, "DIA_Fajeth_BELOHNUNG_15_04"); //Jasně. Vyřídím mu to.
	AI_Output (self, other, "DIA_Fajeth_BELOHNUNG_12_05"); //Dobrá. Teď je to na tobě. Budeme držet pozice tak dlouho, jak to jen půjde.
	
	Fajeth_Ore = TRUE;
	
	B_LogEntry (TOPIC_ScoutMine,"Fajethovi kopáči už vydolovali DVĚ bedny rudy.");
...
func void DIA_Fajeth_Perm2_Info ()
{
	...
	AI_Output (self, other, "DIA_Fajeth_Perm2_12_01"); //Špatně. Vůbec to nejde.
	AI_Output (self, other, "DIA_Fajeth_Perm2_12_02"); //Když jsme přijeli, bylo to v pořádku - ale pak mí hoši nedokázali vydolovat nic než zbytky. Nic pořádného.
	AI_Output (self, other, "DIA_Fajeth_Perm2_12_03"); //Ale nevzdáváme se - alespoň ne dokud tomu tady velím já.
};
//#####################################################################
//##
//##
...
instance DIA_Fajeth_ERZABBAU		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Jak to vypadá s těžbou?";
};
...
{
	AI_Output (other, self, "DIA_Fajeth_ERZABBAU_15_00"); //Jak to vypadá s těžbou?
	
	if (MIS_AllDragonsDead == TRUE)
	{
		AI_Output (self, other, "DIA_Fajeth_ERZABBAU_12_01"); //Nějak se všechno uklidnilo. Čím to je?
		AI_Output (other, self, "DIA_Fajeth_ERZABBAU_15_02"); //Draci jsou mrtví.
		AI_Output (self, other, "DIA_Fajeth_ERZABBAU_12_03"); //No, v tom případě doufám, že už brzy bude po všem. Už jsem si přestával dělat naděje.
	}
	else 
	{
