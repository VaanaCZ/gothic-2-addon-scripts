...
{
	AI_Output (other,self ,"DIA_1051_Wegelagerer_Hello_15_00"); //Co tady dêláš?
...
FUNC VOID DIA_Wegelagerer_Novice_Info()
{
	...
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Novice_07_01"); //To je zajímavé. Taky nêkoho hledáme.
...
FUNC VOID DIA_Wegelagerer_Question_Info()
{
	...
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Question_07_01"); //Jasný. Ale co tady dêláš?
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Question_07_02"); //Mimochodem, tohle je naše cesta a nemáme rádi, když nás tu nêkdo obtêžuje.
...
FUNC VOID DIA_1051_Wegelagerer_Question_Novice ()
{
	...
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Question_Novice_07_01"); //To je zajímavé. Taky nêkoho hledáme.
...
FUNC VOID DIA_1051_Wegelagerer_Question_MyConcern_No ()
{
	...
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Question_MyConcern_No_07_01"); //Rozumím, nadêlal sis do kalhot. Teë se zdejchni.
...
FUNC VOID DIA_1051_Wegelagerer_Question_MyConcern_Yes ()
{
	...
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Question_MyConcern_Yes_07_01"); //Hele, hele, máš nêjak nevymáchanou hubu.
	AI_Output (self ,other,"DIA_1051_Wegelagerer_Question_MyConcern_Yes_07_02"); //Už je naèase, abych ti ji zavâel.
...
FUNC VOID DIA_1051_Wegelagerer_Question_LookAround ()
{
	...
	AI_Output 	(self ,other,"DIA_1051_Wegelagerer_Question_LookAround_07_01"); //Klidnê si v tom pokraèuj, ale pâestaà nás otravovat.
