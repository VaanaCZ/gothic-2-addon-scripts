...
instance DIA_Cipher_DoWithThief (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Co tedy hodláš s tím zlodìjem udìlat?";
};                       
...
{	
	...
	AI_Output (self, other, "DIA_Cipher_DoWithThief_07_03"); //Kdybych ho napadnul tady uprostøed dvora, ostatní by si toho všimli a já bych si to odskákal.
...
{	
	...
	AI_Output (self, other, "DIA_Cipher_WannaJoin_07_04"); //Ale poslední dobou to už pøehání. Chce si sem prostì jen tak sednout a èekat, dokud paladinové neumøou hlady.
...
instance DIA_Cipher_DarLOST (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Vážnì jsi dal Darovi co proto... cítíš se teï líp?";
};                       
...
{	
	...
	AI_Output (other, self, "DIA_Cipher_DarLOST_15_02"); //Pøedpokládám, že ON ne...
