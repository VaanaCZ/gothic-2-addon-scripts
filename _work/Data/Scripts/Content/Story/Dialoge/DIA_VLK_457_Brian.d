...
instance DIA_Brian_AboutLehrling (C_INFO)
{
	...
	permanent 	= FALSE;
	description = "Co obnáší být kovářským učedníkem?";
};
...
{
	AI_Output (other, self, "DIA_Brian_AboutLehrling_15_00"); //Co obnáší být kovářským učedníkem?
...
func void DIA_Brian_WhyLeave_Info ()
{
	...
	AI_Output (self, other, "DIA_Brian_WhyLeave_04_01"); //Ještě si pamatuju, co bylo kolem mého přijetí za učedníka u Harada povyku.
	AI_Output (self, other, "DIA_Brian_WhyLeave_04_02"); //Vážně, každej z těch šašků do toho musel kecat.
	AI_Output (self, other, "DIA_Brian_WhyLeave_04_03"); //Chci se rozhodovat sám, ke komu půjdu, nebo nepůjdu dělat učedníka.
};
...
func void DIA_Brian_OtherMasters_Info ()
{
	...
	AI_Output (self ,other, "DIA_Brian_Add_04_02"); //Prodává zbroje, ale je především kupcem.
	AI_Output (self ,other, "DIA_Brian_Add_04_03"); //Všichni mistři mají své obchody tady v téhle ulici.
...
func void DIA_Brian_AboutHarad_Info ()
{
	...
	AI_Output (self, other, "DIA_Brian_AboutHarad_04_02"); //Před několika dny za ním přišli paladinové s rozkazem ukovat nějaké meče.
	AI_Output (self, other, "DIA_Brian_AboutHarad_04_03"); //Zakázali mu prodávat meče komukoli jinému.
	AI_Output (self, other, "DIA_Brian_AboutHarad_04_04"); //Teď dře celé dny a noci, jen aby tu zakázku dokončil co nejdříve.
};
...
{
	AI_Output (other, self, "DIA_Brian_NEEDWEAPONS_15_00"); //Mohu si od tebe koupit nějaké zbraně?
	AI_Output (self, other, "DIA_Brian_NEEDWEAPONS_04_01"); //Vážně ne. Jsem jen pomocník.
	AI_Output (self, other, "DIA_Brian_NEEDWEAPONS_04_02"); //Ty zbraně, co se vyrábějí tady v kovárně, sebere domobrana a odnese je do věží.
	AI_Output (self, other, "DIA_Brian_NEEDWEAPONS_04_03"); //Ale kdybys měl zájem o něco, co potřebuješ v kovárně, možná bych ti mohl pomoct.
};
...
func void DIA_Brian_WASKAUFEN_Info ()
{
	...
	if (Npc_IsDead(Harad))
	{
		AI_Output			(self, other, "DIA_Brian_WASKAUFEN_04_01"); //Jelikož ještě pořád mám několik ocelových prutů, můžou být tvoje. Obávám se, že to je všechno.
		
		if (MIS_Jack_NewLighthouseOfficer == 0)
		{
			AI_Output			(self, other, "DIA_Brian_WASKAUFEN_04_02"); //Jelikož už tu není Harad, dává na mě domobrana pozor.
...
func void DIA_Brian_RepairNecklace_Info ()
{
	...
	AI_Output (self	,other,"DIA_Brian_RepairNecklace_04_01"); //Jsem jen pomocník, budu rád, když někdy dokážu ukovat alespoň nějaký nůž.
	
	if ((Npc_IsDead (Harad))== FALSE)
	{
		AI_Output (self ,other,"DIA_Brian_RepairNecklace_04_02"); //Šperky? Měl by ses zeptat mistra.
	};
...
func void DIA_Brian_NEWLIGHTHOUSEOFFICER_Info ()
{
	...
	AI_Output			(other, self, "DIA_Brian_NEWLIGHTHOUSEOFFICER_15_01"); //Jack uvažuje o tom, že by se vrátil na moře. Ale jeho maják pak nebude mít kdo hlídat.
	AI_Output			(self, other, "DIA_Brian_NEWLIGHTHOUSEOFFICER_04_02"); //Ale snad je Jackovi jasné, že si tam u majáku zařídím kovárnu, když tam už nebude.
	AI_Output			(other, self, "DIA_Brian_NEWLIGHTHOUSEOFFICER_15_03"); //Je v tom nějaký problém?
	AI_Output			(self, other, "DIA_Brian_NEWLIGHTHOUSEOFFICER_04_04"); //(smích) Pro mě ne. Stejně se mi nechce zůstávat u Harada. Žádnej problém.
...
{
	AI_Output			(other, self, "DIA_Brian_LIGHTHOUSEFREE_15_00"); //A co jsi říkal?
