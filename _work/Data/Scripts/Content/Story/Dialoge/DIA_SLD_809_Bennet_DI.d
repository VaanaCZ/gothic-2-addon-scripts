...
{	
	...
	if (ORkSturmDI == FALSE)
	{
		AI_Output	(self ,other,"DIA_Bennet_DI_Hello_06_01");	//Kovárna na téhle lodi je tak kapku zarezlá. Mùže za to ta moøská sùl. Vyrobit tu nìco komplikovanìjšího mùže být docela problém. Ale zase na druhou stranu...
	}
	else
	{
...
func void DIA_Bennet_DI_DragonEgg_Info ()
{
	...
	AI_Output			(self, other, "DIA_Bennet_DI_DragonEgg_06_03"); //Vím, na cos myslel. Zapomeò na to, nech si tu vìc. Já to nechci.
...
func void DIA_Bennet_DI_UndeadDragonDead_Info ()
{
	...
	AI_Output			(self, other, "DIA_Bennet_DI_UndeadDragonDead_06_01"); //To rád slyším. Už jsem mám téhle staré kovárny po krk. Potøebuju se zase postavit na zem pevnýma nohama.
	AI_StopProcessInfos (self);
};
