...
func void DIA_RodDJG_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_RodDJG_HALLO_06_01"); //Ty boty mê zabijou! Ta nová zbroj je výborná, ale proè je to âemení na botách tak natêsno?
...
func void DIA_RodDJG_HALLO_Woher ()
{
	...
	AI_Output			(self, other, "DIA_RodDJG_HALLO_Woher_06_01"); //Ten starej skunk Bennet je udêlal pro drakobijce a nechal si za ty škrpály královsky zaplatit.
	AI_Output			(self, other, "DIA_RodDJG_HALLO_Woher_06_02"); //Až se mi nêkdy dostane do rukou, nechám ho nejdâív ty vêci sežrat a pak z nêj vymlátim svoje prachy.
...
func void DIA_RodDJG_HALLO_warten ()
{
	...
	if ((Npc_IsDead(DJG_Cipher))== FALSE)
		{
		AI_Output			(self, other, "DIA_RodDJG_HALLO_warten_06_01"); //Na to, až se Cipher uráèí pâinejmenším zvednout ten svùj zadek. Už je naèase, abysme vypadli.
		AI_StopProcessInfos (self);
		}
		else
		{
		AI_Output		(self, other, "DIA_RodDJG_HALLO_warten_06_02"); //Pâemýšlel jsem o tom, že bychom mêli blíž prozkoumat tamtu bažinatou oblast.
		...
		Info_AddChoice	(DIA_RodDJG_HALLO, "Co víš o têch bažinách?", DIA_RodDJG_HALLO_warten_wasweisstdu );
...
{
	AI_Output			(other, self, "DIA_RodDJG_HALLO_warten_wasweisstdu_15_00"); //Co víš o têch bažinách?
...
func void DIA_RodDJG_HALLO_warten_allein ()
{
	...
	AI_Output			(self, other, "DIA_RodDJG_HALLO_warten_allein_06_01"); //Fajn, tak ti pâeju hodnê štêstí.
...
func void DIA_RodDJG_WARTEMAL_Info ()
{
	...
	if 	(
		...
		{
			AI_Output			(self, other, "DIA_RodDJG_WARTEMAL_06_01"); //Hele, chlape. Mám dojem, že se nám tahle vêc zaèíná vymykat z rukou. Prostê odsud potichouèku mizím.
			DJG_SwampParty = FALSE;
	...
	if 	(Npc_IsDead(SwampDragon))
		{
			AI_Output			(other, self, "DIA_RodDJG_WARTEMAL_15_03"); //A co budeš dêlat teë?
			AI_Output			(self, other, "DIA_RodDJG_WARTEMAL_06_04"); //Ty se teda dokážeš ptát! Ze všeho nejdâív si koupím nêjaký nový boty, chlape!
			self.aivar[AIV_PARTYMEMBER] = FALSE;
			AI_StopProcessInfos (self);
			Npc_ExchangeRoutine	(self,	"Zaèít");
		};
