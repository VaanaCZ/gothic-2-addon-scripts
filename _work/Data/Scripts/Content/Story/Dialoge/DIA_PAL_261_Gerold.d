...
INSTANCE DIA_Gerold_Deal (C_INFO)
{
	...
	permanent	= FALSE;
	description ="Mám tu zprávu pro jednoho z vęzŕů...";
};                       
...
INSTANCE DIA_Gerold_Stuff (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Nęco tu pro tebe mám...";
};
//-----------------------------------                       
...
INSTANCE DIA_Gerold_SetGornFree (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Pusă Gorna na svobodu.";
};                       
...
func void DIA_Gerold_KAP4_ALLESRUHIG_Info ()
{
	...
	AI_Output			(self, other, "DIA_Gerold_KAP4_ALLESRUHIG_12_01"); //V poâádku, jistę.
...
func void DIA_Gerold_KAP4_ALLESRUHIG_geben ()
{
	...
	B_LogEntry (TOPIC_GeroldGiveFood,"Garond opęt omezil pâídęly potravin. Radši bych męl Geroldovi dát nęco k jídlu, nebo z hladu vyvede nęjakou hroznou pitomost. Mám se s ním setkat u pâíbytku mágů na hradę, až budou všichni spát."); 
