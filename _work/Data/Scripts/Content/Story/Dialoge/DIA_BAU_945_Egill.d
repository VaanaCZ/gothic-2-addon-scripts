...
func void DIA_Egill_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_HALLO_08_01"); //Jeśli odwiedzają nas jacyś przybysze, to przeważnie nie w pokojowych zamiarach.
	AI_Output			(self, other, "DIA_Egill_HALLO_08_02"); //Mam nadzieję, że się nie mylę co do ciebie.
...
{
	AI_Output			(other, self, "DIA_Egill_FELDARBEIT_15_00"); //Jak idą prace w polu?
	AI_Output			(self, other, "DIA_Egill_FELDARBEIT_08_01"); //Wspaniale. Gdyby tylko polne bestie nie niszczyły naszych plonów...
...
func void DIA_Egill_FELDRAEUBER_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_FELDRAEUBER_08_01"); //Żartujesz chyba. Od kiedy tutaj mieszkam, zabiłem już ich tyle, że całkiem straciłem rachubę.
	AI_Output			(self, other, "DIA_Egill_FELDRAEUBER_08_02"); //Niestety, wciąż ich przybywa.
};
...
instance DIA_Egill_STREIT2		(C_INFO)
{
	...
	description	 = 	"Twój brat opowiedział podobną historię.";
};
...
{
	AI_Output			(other, self, "DIA_Egill_STREIT2_15_00"); //Twój brat opowiedział podobną historię.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_01"); //Taaak? A co dokładnie powiedział?
	AI_Output			(other, self, "DIA_Egill_STREIT2_15_02"); //Twierdzi, że on również zabił mnóstwo polnych bestii.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_03"); //Co? Ten dureń nie trafiłby sam do domu!
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_04"); //Powiedz mu, że nie powinien się tak przechwalać.
...
instance DIA_Egill_STREIT4		(C_INFO)
{
	...
	description	 = 	"Ehnim jest odrobinę poirytowany z powodu całej tej sprawy.";
};
...
{
	AI_Output			(other, self, "DIA_Egill_STREIT4_15_00"); //Ehnim jest odrobinę poirytowany z powodu całej tej sprawy.
	AI_Output			(self, other, "DIA_Egill_STREIT4_08_01"); //Niech się za bardzo nie nadyma, bo spuszczę mu lanie. Możesz mu to ode mnie przekazać.
...
{
	AI_Output			(self, other, "DIA_Egill_PERMKAP1_08_00"); //Czy nie narobiłeś już dosyć szkód? Lepiej idź sobie.
