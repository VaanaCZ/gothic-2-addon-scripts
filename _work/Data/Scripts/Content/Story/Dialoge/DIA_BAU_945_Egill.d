...
func void DIA_Egill_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_HALLO_08_01"); //Už je to hodnê dlouho, co jsme na našem pozemku naposledy vidêli nêjakého cizince, co nás nechtêl stáhnout z kùže.
	AI_Output			(self, other, "DIA_Egill_HALLO_08_02"); //Doufám, že se v tobê nemýlím.
...
func void DIA_Egill_FELDARBEIT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_FELDARBEIT_08_01"); //Výbornê. Kdyby ty mizerný polní škùdci poâád nenièili naši úrodu...
...
{
	AI_Output			(other, self, "DIA_Egill_FELDRAEUBER_15_00"); //Proè s têmi škùdci nêco neudêláte?
	AI_Output			(self, other, "DIA_Egill_FELDRAEUBER_08_01"); //Si dêláš srandu. Od tý doby, co jsem na týhle farmê, už jsem jich zabil tolik, že už to ani nespoèítám.
...
instance DIA_Egill_STREIT2		(C_INFO)
{
	...
	description	 = 	"Tvùj bratr mi vyprávêl nêco podobnýho.";
};
...
{
	AI_Output			(other, self, "DIA_Egill_STREIT2_15_00"); //Tvùj bratr mi vyprávêl nêco podobnýho.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_01"); //(prohnanê) Aha. Co pâesnê âíkal?
	AI_Output			(other, self, "DIA_Egill_STREIT2_15_02"); //Že taky sejmul spoustu polních škùdcù.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_03"); //Co? Ten bâídil nedokáže sám ani najít cestu domù.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_04"); //Âekni mu, že se takhle nemùže vytahovat.
...
func void DIA_Egill_STREIT4_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_STREIT4_08_01"); //Aã se tak nenaparuje, nebo mu utrhnu hlavu. Âekni mu to.
...
{
	AI_Output			(self, other, "DIA_Egill_PERMKAP1_08_00"); //Nenadêlal už jsi dost škody? Mám dojem, že bys mêl vypadnout. Hned.
