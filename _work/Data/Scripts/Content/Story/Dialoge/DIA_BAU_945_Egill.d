...
func void DIA_Egill_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_HALLO_08_01"); //Už je to hodně dlouho, co jsme na našem pozemku naposledy viděli nějakého cizince, co nás nechtěl stáhnout z kůže.
	AI_Output			(self, other, "DIA_Egill_HALLO_08_02"); //Doufám, že se v tobě nemýlím.
...
func void DIA_Egill_FELDARBEIT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_FELDARBEIT_08_01"); //Výborně. Kdyby ty mizerný polní škůdci pořád neničili naši úrodu...
...
func void DIA_Egill_FELDRAEUBER_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_FELDRAEUBER_08_01"); //Si děláš srandu. Od tý doby, co jsem na týhle farmě, už jsem jich zabil tolik, že už to ani nespočítám.
	AI_Output			(self, other, "DIA_Egill_FELDRAEUBER_08_02"); //Ale bohužel, vždycky přijdou další.
};
...
instance DIA_Egill_STREIT2		(C_INFO)
{
	...
	description	 = 	"Tvůj bratr mi vyprávěl něco podobnýho.";
};
...
{
	AI_Output			(other, self, "DIA_Egill_STREIT2_15_00"); //Tvůj bratr mi vyprávěl něco podobnýho.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_01"); //(prohnaně) Aha. Co přesně říkal?
	AI_Output			(other, self, "DIA_Egill_STREIT2_15_02"); //Že taky sejmul spoustu polních škůdců.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_03"); //Co? Ten břídil nedokáže sám ani najít cestu domů.
	AI_Output			(self, other, "DIA_Egill_STREIT2_08_04"); //Řekni mu, že se takhle nemůže vytahovat.
...
func void DIA_Egill_STREIT4_Info ()
{
	...
	AI_Output			(self, other, "DIA_Egill_STREIT4_08_01"); //Ať se tak nenaparuje, nebo mu utrhnu hlavu. Řekni mu to.
...
{
	AI_Output			(self, other, "DIA_Egill_PERMKAP1_08_00"); //Nenadělal už jsi dost škody? Mám dojem, že bys měl vypadnout. Hned.
