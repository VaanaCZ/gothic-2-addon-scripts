...
{
	AI_Output (self, other, "DIA_Tengron_First_07_00"); //Co tady dêláš?
...
{
	AI_Output (self, other, "DIA_Tengron_HALLO_07_00"); //Nechã tê Innos doprovází! Pâinášíš zprávy z hradu? Už se blíží posily?
	
	if (Npc_IsDead(Fajeth) == FALSE)
	{
		AI_Output (other, self, "DIA_Tengron_HALLO_15_01"); //Nepâišel jsem se zprávami, ale pro nê.
		AI_Output (self, other, "DIA_Tengron_HALLO_07_02"); //V tom pâípadê si promluv s Fajethem. Má to tady na povel. Ale kdybys mêl nêjaké zprávy z hradu, dej mi vêdêt.
	};
};
///////////////////////////////////////////////////////////////////////
//	Info News
...
instance DIA_Tengron_News		(C_INFO)
{
	...
	permanent 	 =  FALSE;
	description	 = 	"Co se têch zpráv týèe...";
};
...
{
	AI_Output (other, self, "DIA_Tengron_News_15_00"); //Co se têch zpráv týèe...
	AI_Output (self, other, "DIA_Tengron_News_07_01"); //Ano - jak to vypadá na hradê?
	AI_Output (other, self, "DIA_Tengron_News_15_02"); //Ještê poâád ho obléhají skâeti a poâád na nêj mohou zaútoèit draci.
	AI_Output (self, other, "DIA_Tengron_News_07_03"); //Zatracenê, doufám, že se chlapci udrží.
	AI_Output (self, other, "DIA_Tengron_News_07_04"); //Poslouchej, mám na hradê pâítele. Jmenuje se Udar. Známe se už dlouhou dobu a bojovali jsme pospolu v nejedné bitvê.
	AI_Output (self, other, "DIA_Tengron_News_07_05"); //Chci, abys mu dal tenhle prsten. Aã mi ho pohlídá. Vyâië mu, že až se vrátím, vezmu si ho zpêt.
...
FUNC VOID DIA_Tengron_News_Yes()
{
	...
	B_LogEntry (Topic_TengronRing,"Tengron mi svêâil prsten, který mám na hradê pâedat Udarovi.");
};
///////////////////////////////////////////////////////////////////////
//	Info Situation
///////////////////////////////////////////////////////////////////////
...
func void DIA_Tengron_Situation_Info ()
{
	...
	AI_Output (self, other, "DIA_Tengron_Situation_07_01"); //Všude kolem jsou samé pâíšery a nevydolovali jsme skoro žádnou rudu. Navíc jsme ztratili spoustu dobrých chlapù.
...
{
	AI_Output (other, self, "DIA_Tengron_HELP_15_00"); //Mohl bys mi pomoci. Fajeth chce, abych lovil ještêry, a...
	AI_Output (self, other, "DIA_Tengron_HELP_07_01"); //Pâijímám rozkazy JEN od Fajetha. A moje rozkazy âíkají, že mám hlídat dùl. A pâesnê to dêlám.
	AI_Output (self, other, "DIA_Tengron_HELP_07_02"); //Možná by ti mohl pomoci nêkdo jiný.
};
