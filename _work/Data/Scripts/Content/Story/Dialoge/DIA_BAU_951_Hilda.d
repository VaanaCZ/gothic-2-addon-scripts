...
func void DIA_Hilda_BringBeet_Info ()
{
	...
	if (Npc_HasItems (other,ItPl_Beet) >= 20)
	{
		...
		AI_Output (self, other, "DIA_Hilda_BringBeet_17_02"); //Každopádne, dokud jsi tady - viděla jsem tudy před pár minutami procházet kočovného kupce.
...
func void DIA_Hilda_Einkaufen_Info ()
{
	AI_Output (other, self, "DIA_Hilda_Einkaufen_15_00"); //Dej mi zlato a já za tím kupcem zajdu.
		...
		if (hero.guild == GIL_NONE)
		{
			AI_Output (self, other, "DIA_Hilda_Einkaufen_17_01"); //Říkáš, že ti mám věřit? Tak hlavně ty peníze nevyhoď za chlast, slyšíš?!
		};
