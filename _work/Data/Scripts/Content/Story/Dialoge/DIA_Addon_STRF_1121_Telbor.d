...
{
	AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_00");//Hoj, jsem v pohodě.
	
	if (Sklaven_Flucht == FALSE)
	{
		if (Pardos_Geheilt == FALSE)
		{
			AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_01");//Ale Pardos je pěkně vyřízenej.
		}
		else
		{
	...
	AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_03");//Jestli něco chceš, promluv si s Patrickem. To je náš mluvčí.
