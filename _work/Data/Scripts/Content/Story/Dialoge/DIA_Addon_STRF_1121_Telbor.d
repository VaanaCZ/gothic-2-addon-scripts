...
{
	AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_00");//Eh, yo estoy bien.
	
	if (Sklaven_Flucht == FALSE)
	{
		if (Pardos_Geheilt == FALSE)
		{
			AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_01");//Pero Pardos está hecho polvo.
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_02");//Gracias por ayudar a Pardos.
	...
	AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_03");//Si necesitas algo, habla con Patrick. Es nuestro portavoz.
