...
{
	AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_00");//Hoj, jsem v pohodê.
	
	if (Sklaven_Flucht == FALSE)
	{
		if (Pardos_Geheilt == FALSE)
		{
			AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_01");//Ale Pardos je pêknê vyâízenej.
		}
		else
		{
	...
	AI_Output (self, other, "DIA_Addon_Telbor_Hi_12_03");//Jestli nêco chceš, promluv si s Patrickem. To je náš mluvèí.
