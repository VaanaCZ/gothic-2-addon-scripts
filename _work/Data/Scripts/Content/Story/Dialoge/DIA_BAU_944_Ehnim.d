...
func void DIA_Ehnim_FELDARBEIT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Ehnim_FELDARBEIT_12_02"); //Ale męl by ses mít na pozoru pâed polními škůdci. Utrhnou ti ruku, ani nemrkneš.
...
func void DIA_Ehnim_MoleRatFett_Info ()
{
	...
	AI_Output			(self, other, "DIA_Ehnim_MoleRatFett_12_04"); //Ále, nic důležitýho. Jen jsem chtęl mluvit s Vinem o jeho palírnę.
...
{
	AI_Output			(other, self, "DIA_Ehnim_MoleRatFett_was_15_00"); //O palírnę? O jaké palírnę?
	AI_Output			(self, other, "DIA_Ehnim_MoleRatFett_was_12_01"); //Eh. Asi jsem to nemęl âíkat. Vino byl na to své malé tajemství vždycky hodnę citlivý.
	...
	B_LogEntry (TOPIC_FoundVinosKellerei,"Podle Ehnima se Vino stále ukrývá v lesích poblíž Akilova statku. Ale mechanismus dveâí je zadâený a dokud jej nenamažu rysčím sádlem, dovnitâ se nedostanu."); 
...
func void DIA_Ehnim_MoleRatFett_was_Fett ()
{
	...
	AI_Output			(self, other, "DIA_Ehnim_MoleRatFett_was_Fett_12_01"); //Jo, jasnę. Nejlepší, co se tu dá sehnat. Rysčí sádlo. Pâíšerná vęc, to ti povím. Taky se používá na promazání lodních dęl.
