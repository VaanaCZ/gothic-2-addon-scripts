...
{
	AI_Output (self, other, "DIA_Zuris_Sperre_14_00"); //Jsi bývalý trestanec z těžařské kolonie. Odpal!
	AI_StopProcessInfos (self);	 
};
///////////////////////////////////////////////////////////////////////
//	Info GREET
...
func void DIA_Zuris_WAREZ_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Zuris_GREET_14_02"); //Právě jsem dostal nějaké nové lektvary. Můj host - ohnivý mág, mistr Daron - mi je donesl přímo z kláštera.
		Zuris_einmal = TRUE;
	};
};
///////////////////////////////////////////////////////////////////////
