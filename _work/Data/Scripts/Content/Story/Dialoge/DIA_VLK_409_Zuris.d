...
INSTANCE DIA_Zuris_PICKPOCKET (C_INFO)
{
	...
	permanent	= TRUE;
	description = "(Lektvar mu mùžeš ukrást velmi snadno.)";
};                       
...
{
	AI_Output (self, other, "DIA_Zuris_Sperre_14_00"); //Jsi bývalý trestanec z têžaâské kolonie. Odpal!
	AI_StopProcessInfos (self);	 
};
///////////////////////////////////////////////////////////////////////
//	Info GREET
...
func void DIA_Zuris_GREET_Info ()
{
	...
	AI_Output (self, other, "DIA_Zuris_GREET_14_01"); //Potâebuješ esenci hojivé síly nebo nêjaký magický elixír? Pak jsi na správném místê.
...
func void DIA_Zuris_WAREZ_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Zuris_GREET_14_02"); //Právê jsem dostal nêjaké nové lektvary. Mùj host - ohnivý mág, mistr Daron - mi je donesl pâímo z kláštera.
		Zuris_einmal = TRUE;
	};
};
///////////////////////////////////////////////////////////////////////
...
instance DIA_Zuris_POTIONS		(C_INFO)
{
	...
	permanent	= FALSE;
	description	= 	"Mícháš si také nêjaké vlastní elixíry?";
};
...
{
	AI_Output (other, self, "DIA_Zuris_POTIONS_15_00"); //Mícháš si také nêjaké vlastní elixíry?
	...
	{
		AI_Output (self, other, "DIA_Zuris_POTIONS_14_02"); //Pokud tê zajímá míchání lektvarù, pak neváhej a promluv si s ním. Nêjakého pomocníka jistê potâebuje.
		AI_Output (self, other, "DIA_Zuris_POTIONS_14_03"); //Ale je moc umínêný, než aby si nêkoho najal sám. Je palièatý jak mezek.
	};
	
	AI_Output (self, other, "DIA_Zuris_Add_14_00"); //Když jde trhat ty své rostliny, vždycky prochází pâímo kolem mê.
};
...
instance DIA_Zuris_Kraut (C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Kde pâesnê Constantino ty své byliny sbírá?";
};
...
{
	AI_Output (other, self, "DIA_Zuris_Add_15_01"); //Kde pâesnê Constantino ty své byliny sbírá?
	AI_Output (self, other, "DIA_Zuris_Add_14_02"); //Pokaždé projde tady východní branou a pak zmizí v divoèinê nalevo.
	AI_Output (self, other, "DIA_Zuris_Add_14_03"); //Jednou mi vykládal, že tu roste skoro všechno kromê královského šãovíku.
...
instance DIA_Zuris_Kronstoeckel (C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Zmínil se Constantino nêkdy, kde hledat královský šãovík?";
};
...
{
	AI_Output (other, self, "DIA_Zuris_Add_15_04"); //Zmínil se Constantino nêkdy, kde hledat královský šãovík?
	AI_Output (self, other, "DIA_Zuris_Add_14_05"); //Jednou jsem slyšel, jak âíká, že ten nejlepší roste poblíž kamenných kruhù.
	...
	AI_Output (self, other, "DIA_Zuris_Add_14_07"); //Myslím, že leží na kopci. Dâív to bývalo nêjaké pohâebištê nebo tak nêco.
...
func void DIA_Zuris_WHERE_Info ()
{
	...
	AI_Output (self, other, "DIA_Zuris_WHERE_14_01"); //Jeho obydlí najdeš v prùchodu poblíž Haradovy kovárny. Urèitê ho nemineš.
};
...
instance DIA_Zuris_Kloster		(C_INFO)
{
	...
	description  =  "Povêz mi nêco o klášteâe.";
};
...
{
	AI_Output (other, self, "DIA_Zuris_Kloster_14_00"); //Povêz mi nêco o klášteâe.
	AI_Output (self, other, "DIA_Zuris_Kloster_14_01"); //O tom by sis mêl radši pohovoâit pâímo s Daronem. Ten ví daleko víc než já.
};
...
{	
	...
	AI_Output (self, other, "DIA_Zuris_Minenanteil_14_01"); //Ano, nêkteré šly ale rapidnê dolù. To je naposled, co jsem se pustil do nêèeho takhle podezâelého!
