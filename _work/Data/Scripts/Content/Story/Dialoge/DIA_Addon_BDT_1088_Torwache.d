...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	if (MIS_Send_Buddler == LOG_SUCCESS)
	{
		...
		AI_Output (other, self,"DIA_Addon_BDT_1088_Torwache_FirstWarn_15_01"); //Przepuść mnie, strażniku.
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_06_02"); //W porządku. Możesz przejść.
	...
	&& 		(MIS_Send_Buddler != LOG_SUCCESS)
	{
		...
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04"); //Nie zrozumiałeś? Z DROGI!
	...
	{
		AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_06"); //Hej, bez pozwolenia od Thorusa nie mogę cię przepuścić.
	};
...
{
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_SecondWarn_06_00"); //Dobra, spokojnie. To twoja ostatnia szansa. NATYCHMIAST się cofnij, bo inaczej po tobie...
...
func void DIA_BDT_1088_Addon_Torwache_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_Attack_06_00"); //Chyba sobie żartujesz. No w każdym razie ja jestem poważny...
