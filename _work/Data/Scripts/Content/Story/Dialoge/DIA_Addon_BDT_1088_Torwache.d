...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	if (MIS_Send_Buddler == LOG_SUCCESS)
	{
		...
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_06_02"); //No dobâe, můžeš jít.
	...
	&& 		(MIS_Send_Buddler != LOG_SUCCESS)
	{
		...
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_03"); //Pokud ti Thorus nedal červenej kámen, tak tę tu nechcem.
			Torwache_Greetings = 1;
		}
		else if (Torwache_Greetings == 1)
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04"); //Nerozumęls? (energicky) VYPADNI!
...
{
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_SecondWarn_06_00"); //Dobrý, klídek. Máš poslední šanci. Buë se OKAMŽITĘ vrátíš, nebo chcípneš.
...
func void DIA_BDT_1088_Addon_Torwache_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_Attack_06_00"); //(povzdych) Myslíš, že si dęlám srandu? Já ti ukážu!
