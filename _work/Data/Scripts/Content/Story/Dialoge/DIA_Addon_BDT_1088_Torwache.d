...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	if (MIS_Send_Buddler == LOG_SUCCESS)
	{
		...
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_06_02"); //No dobøe, mùžeš jít.
	...
	&& 		(MIS_Send_Buddler != LOG_SUCCESS)
	{
		...
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_03"); //Pokud ti Thorus nedal èervenej kámen, tak tì tu nechcem.
			Torwache_Greetings = 1;
		}
		else if (Torwache_Greetings == 1)
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04"); //Nerozumìls? (energicky) VYPADNI!
...
{
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_SecondWarn_06_00"); //Dobrý, klídek. Máš poslední šanci. Buï se OKAMŽITÌ vrátíš, nebo chcípneš.
...
func void DIA_BDT_1088_Addon_Torwache_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_Attack_06_00"); //(povzdych) Myslíš, že si dìlám srandu? Já ti ukážu!
