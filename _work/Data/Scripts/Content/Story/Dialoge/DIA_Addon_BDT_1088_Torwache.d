...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	if (MIS_Send_Buddler == LOG_SUCCESS)
	{
		...
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_06_02"); //No dobâe, mùžeš jít.
	...
	&& 		(MIS_Send_Buddler != LOG_SUCCESS)
	{
		...
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_03"); //Pokud ti Thorus nedal èervenej kámen, tak tê tu nechcem.
			Torwache_Greetings = 1;
		}
		else if (Torwache_Greetings == 1)
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04"); //Nerozumêls? (energicky) VYPADNI!
	...
	{
		AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_06"); //Hele, jestli ti Thorus nedal povolení, pak se dál nedostaneš.
	};
...
{
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_SecondWarn_06_00"); //Dobrý, klídek. Máš poslední šanci. Buë se OKAMŽITÊ vrátíš, nebo chcípneš.
...
func void DIA_BDT_1088_Addon_Torwache_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_Attack_06_00"); //(povzdych) Myslíš, že si dêlám srandu? Já ti ukážu!
