...
{	
	...
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_Exit_12_00"); //Kdybys mì hledal, tak vobvykle bejvám ve svým táboøe naproti palisádì.
	
		if (PIR_1354_Addon_Henry.aivar [AIV_TalkedToPlayer] == FALSE)
		{
			AI_Output (other ,self,"DIA_Addon_AlligatorJack_Exit_15_01"); //Jaké palisádì?
			AI_Output (self ,other,"DIA_Addon_AlligatorJack_Exit_12_02"); //Prostì vodsuï pokraèuj na západ a uvidíš, co myslím.
		};
...
{	
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Hello_12_00"); //Kdo pro všecko na svìtì SEŠ? Nevypadáš jak vostatní.
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_Hello_15_01"); //Jací ostatní?
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Hello_12_02"); //No, mágové, co se poøád potulujou kolem tìchhle rozvalin.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Hello_12_03"); //Ty k nim taky patøíš?
...
func void DIA_Addon_AlligatorJack_WerBistDu_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_01"); //Urèitì už jsi vo mnì slyšel.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_02"); //(hrdì) Jsem Krokodýl Jack.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_03"); //Bojí se mì celá zem, jsem jeden z nejnebezpeènìjších pirátù.
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_05"); //Takže teï koukáš na živoucí legendu.
};
...
instance DIA_Addon_AlligatorJack_Vorschlag		(C_INFO)
{
	...
	description	 = 	"Víš nìco o nìjakém maníkovi jménem Havran?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Vorschlag_15_00"); //Neznáš nìjakého Havrana?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_12_01"); //Jasnì. Je to velitel banditù na východì.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_12_02"); //A co mu chceš?
	
	B_LogEntry (TOPIC_Addon_RavenKDW,"Havran se se svými bandity usadil na východì údolí.");
	
	Info_ClearChoices	(DIA_Addon_AlligatorJack_Vorschlag);
	Info_AddChoice	(DIA_Addon_AlligatorJack_Vorschlag, "Chci se k nìmu pøidat.", DIA_Addon_AlligatorJack_Vorschlag_join );
...
func void 	B_AlligatorJack_Besser ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Besser_12_01"); //Pøidej se k nám.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Besser_12_02"); //Budeš mít pak èas si to promyslet.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Besser_12_03"); //Když jednou koštneš náš domácí rum, budeš na vìci koukat jinak.
	Info_ClearChoices	(DIA_Addon_AlligatorJack_Vorschlag);
};
func void DIA_Addon_AlligatorJack_Vorschlag_tot ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_01"); //(smìje se) Cože? TY? A jak si myslíš, že to provedeš?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_02"); //Není to trochu nad tvý možnosti?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_03"); //Dyk se k nìmu ani nedostaneš. To tì jeho banditi døív stáhnou zaživa z kùže.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_04"); //Nedostaneš se ani pøes jejich první základnu.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_05"); //Vypadáš tak, že tì banditi zahlídnou už na míli daleko.
	
	B_AlligatorJack_Besser ();
};
func void DIA_Addon_AlligatorJack_Vorschlag_join ()
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Vorschlag_join_15_00"); //Chci se k nìmu pøidat.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_join_12_01"); //(mazanì) Vážnì?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_join_12_02"); //Ale nevypadáš jako nìkdo, kdo by se chtìl pøidat k takovejm cvokùm.
...
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_BDTRuestung_15_00"); //Potøebuju zbroj banditù.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_12_01"); //A co s ní chceš dìlat?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_12_02"); //Pokud tì v ní nìkdo zahlídne, budeš z toho mít akorát polízanici.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_12_03"); //Všichni tì budou považovat za banditu a pùjdou po tobì jak slepice po flusu.
	...
	Info_AddChoice	(DIA_Addon_AlligatorJack_BDTRuestung, "Netušíš, kde bych sehnal takovéhle brnìní?", DIA_Addon_AlligatorJack_BDTRuestung_wo );
...
func void DIA_Addon_AlligatorJack_BDTRuestung_gut ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_gut_12_01"); //Jo, ale jen pro nìkoho se sebevražednejma sklonama.
};
func void DIA_Addon_AlligatorJack_BDTRuestung_wo ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_wo_12_01"); //Jednu jsme mívali v pirátským táboøe.
	//AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_wo_12_02"); //Mmh ... Ich denke, die hatte genau deine Größe.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_wo_12_03"); //Ale nevím, kde je teï.
	
	B_LogEntry (TOPIC_Addon_BDTRuestung,"Zbroj banditù bych mìl sehnat u pirátù, jenže Krokodýl Jack mi neøekne, jestli opravdu existuje."); 
...
func void DIA_Addon_AlligatorJack_Greg_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_01"); //Jo, je to nejvìtší pirát, jakýho kdy moøe zrodilo.
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Greg_15_02"); //Myslím, že vašeho kapitána znám, potkal jsem ho v Khorinidu.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_03"); //(smìje se) Greg a v Khorinidu? Blbost!
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_04"); //Greg ještì s nìkolika chlapama vyjel loupit na moøe.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_05"); //Jediný, co by Grega mohlo pøitáhnout do Khorinidu, je královská vìzeòská galéra.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_06"); //Je jedním z nejhledanìjších lidí v zemi.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_07"); //Nikdy by dobrovolnì nevlez do mìsta, aby ho královská stráž mohla hned zatknout.
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Greg_15_08"); //Když to øíkáš.
};
...
func void DIA_Addon_AlligatorJack_PIRLager_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_01"); //Vidíš tamhle tu jeskyni? Projdi na druhou stranu a pak pokraèuj k západu. Døív nebo pozdìjc dorazíš na naši pláž.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_02"); //Tam máme svý sruby.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_03"); //Když budeš chtít, mùžu tì tam zavést, ale napøed vod tebe budu chtít jednu laskavost.
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_07"); //Takže by se mi hodila pomoc pøi lovu. Máš zájem?

	Log_CreateTopic (TOPIC_Addon_RatHunt,LOG_MISSION);
	Log_SetTopicStatus (TOPIC_Addon_RatHunt,LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_RatHunt,"Krokodýl Jack potøebuje pomoci s lovem.");
...
func void DIA_Addon_AlligatorJack_WasJagen_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WasJagen_12_03"); //Takže teï beru, co se dá – moèálový krysy.
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_WasJagen_15_04"); //Cože?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WasJagen_12_05"); //Vìtšina zdejších potvor chutná jak špinavý fusekle nebo maj stejnì tvrdý maso jako krokodýli.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WasJagen_12_06"); //Tlustý moèálový krysy jsou to jedný, co se ještì jakž-takž dá žrát.

	B_LogEntry (TOPIC_Addon_RatHunt,"Jediné, co se tu dá aspoò trochu jíst, jsou moèálové krysy.");
};
...
INSTANCE DIA_Addon_AlligatorJack_Pirates(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Povìz mi o vás pirátech víc.";
};                       
...
{
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_Pirates_15_00"); //Povìz mi o vás pirátech nìco víc.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_01"); //Už tu žijem celý léta. Eštì pøed válkou nás znal každej vodsuï až na pevninu.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_02"); //Staèil jedinej pohled na naši vlajku a posádky kupeckejch lodí byly podìlaný hrùzou.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_03"); //Ale to už je dávno pryè. Už je to pár tejdnù, co jsme narazili na nìjakou kupeckou loï.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_04"); //Náš kapitán Greg chtìl zkusit òákou pøepadnout.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_05"); //My vostatní sedíme tady v táboøe, chytáme lelky a èekáme, až se vrátí.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_06"); //Doufám, že pøiveze tuènou koøist.
};
...
{	
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_LetsGoHunting_15_00"); //Tak pojïme na lov.
	AI_Output (self,other ,"DIA_Addon_AlligatorJack_LetsGoHunting_12_01"); //Dobøe, ve dvou to bude hraèka.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_LetsGoHunting_12_02"); //Jsi pøipravenej?
...
FUNC VOID DIA_Addon_AlligatorJack_LetsGoHunting_Yes()
{
	...
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_LetsGoHunting_Yes_12_01"); //Skvìlý, tak se drž za mnou.
...
FUNC VOID DIA_Addon_AlligatorJack_LetsGoHunting_No()
{
	...
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_LetsGoHunting_No_12_01"); //Tak si pospìš.
...
func void DIA_Addon_AlligatorJack_AlligatorJackInter1_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_AlligatorJackInter1_12_01"); //Nìkde by tu nìjaký ty potvory mìly bejt.
...
func void DIA_Addon_AlligatorJack_TheHunt_Info ()
{
	...
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_02"); //Tìchhle pár potvor je tak pùlka, než kolik bych potøeboval.
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_03"); //Budem to muset vzít do kaòonu.
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_04"); //Dávej bacha, dál v kaòonu je to pìknì o hubu.
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_05"); //Jestli je ti život milej, drž se co nejblíž u mì.
	
	Wld_InsertNpc (Waran ,"ADW_ENTRANCE_2_VALLEY_10");
	Wld_InsertNpc (Waran ,"ADW_ENTRANCE_2_VALLEY_10");

	Info_ClearChoices (DIA_Addon_AlligatorJack_TheHunt);
	Info_AddChoice (DIA_Addon_AlligatorJack_TheHunt,"A co má v tom kaòonu jako být?",DIA_Addon_AlligatorJack_TheHunt_Enough);
	Info_AddChoice (DIA_Addon_AlligatorJack_TheHunt,"No tak pojïme.",DIA_Addon_AlligatorJack_TheHunt_Running);
};

FUNC VOID DIA_Addon_AlligatorJack_TheHunt_Enough ()
{
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_TheHunt_Enough_15_00"); //Co PØESNÌ má v tom kaòonu být?
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_TheHunt_Enough_12_01"); //Vyhejbáme se mu, jak jen to jde.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_TheHunt_Enough_12_02"); //Žijou tam bøitovci, a ty jsou fakt tuhý. Jestli se chceš dožít rána, tak se vod nich drž co nejdál.
};

FUNC VOID DIA_Addon_AlligatorJack_TheHunt_Running ()
{
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_TheHunt_Running_15_00"); //Fajn, tak pojïme.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_TheHunt_Running_12_01"); //Dobøe.
...
func void DIA_Addon_AlligatorJack_HuntEnd_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_00"); //Hele, mùžeš mi øíct, proè tì tu s sebou vlastnì tahám?
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_01"); //Ještì jsi nezabil ani jednu krysu.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_02"); //No, snad budeš užiteènej nìjak jinak.
		
	}
	else if AlligatorJack_KrokosKilled == 1
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_03"); //Výbornì, nìkdo jako ty se nám vždycky hodí.
	...
	else	//mehr als 1!!
	{
		...
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_06"); //Tý vole! Jestli budeš takhle pokraèovat, tak pøíštì rovnou zùstanu v táboøe.
	};
	...
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_PassHenry_12_09"); //Nejspíš si bude dávat šlofíka nìkde na pláži, ale èeká na nìj.
	...
	if (PIR_1354_Addon_Henry.aivar[AIV_PASSGATE] == FALSE)
	{
		...
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_PassHenry_12_11"); //Jestli tì nepustí dovnitø, øekni mu, že tì posílám já.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_PassHenry_12_12"); //Pak by mìl bejt pøíjemnìjší.
	...
	B_LogEntry (TOPIC_Addon_RatHunt,"Lov byl úspìšný. Chytili jsme nìkolik moèálových krys.");
...
func void DIA_Addon_AlligatorJack_Angus_Info ()
{
	...
	AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Angus_12_03"); //Už jsem je òákou dobu nevidìl.
...
func void DIA_Addon_AlligatorJack_Lake_Info ()
{
	...
	else
	{
		...
		AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Lake_12_05"); //Staèí jít z tábora smìrem na východ, to údolí nemùžeš minout.
		AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Lake_12_06"); //Je tam spousta malejch vodopádù.
		AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Lake_12_07"); //Ale pozor – pokud pod nohama ucejtíš už jenom suchej písek, tak jsi to pøešel a už jsi v kaòonu.
	};
	
	B_LogEntry	(TOPIC_Addon_SkipsGrog,"Jeskynì by mìla být v údolí východnì od tábora, pøímo u jezera.");
};
...
func void DIA_Addon_AlligatorJack_CanLearn_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_01"); //Jasnì, jsem dobrej lovec a mùžu ti ukázat, jak zvíøatùm stáhnout kùži a vyndat zuby.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_02"); //Jestli chceš, nauèím tì to.
		
		Log_CreateTopic (Topic_Addon_PIR_Teacher,LOG_NOTE);
		B_LogEntry		(Topic_Addon_PIR_Teacher,"Krokodýl Jack mi mùže ukázat, jak stahovat zvíøata z kùže a jak jim vyjímat zuby. Krom toho mì také pocvièí v lukostøelbì.");
		
		AlligatorJack_Addon_TeachPlayer = TRUE;
	}
	else
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_03"); //Ale napøed mi pøedveï, že taky umíš lovit.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_04"); //Až si spolu zalovíme, tak to tøeba udìlám.
	};
};
///////////////////////////////////////////////////////////////////////
FUNC VOID B_AJ_Teach()
{
	...
	Info_AddChoice	(DIA_Addon_AlligatorJack_Teach, B_BuildLearnString ("Stahovat zvíøata",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_ReptileSkin)),  DIA_Addon_AlligatorJack_Teach_FUR);
...
{
	AI_Output	(other,self ,"DIA_Addon_AlligatorJack_Teach_15_00"); //Nauè mì nìco!
	AI_Output 	(self ,other,"DIA_Addon_AlligatorJack_Teach_12_01"); //Co bys rád umìl?
...
FUNC VOID DIA_Addon_AlligatorJack_Teach_FUR()
{
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_ReptileSkin] == FALSE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_AlligatorJack_Teach_Fur_12_00"); //Øez vždycky zaèínej na bøiše, jinak bude výsledek nekvalitní.
		};
	}
	else
	{
...
{
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Anheuern_12_01"); //No dobøe.
};
// ------------------------------------------------------------
...
{	
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_Anheuern_15_00"); //Tak pojïme lovit.
	B_AlliJack_AlliKlar();
	AI_StopProcessInfos (self);
...
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_KommMit_15_00"); //Pojï.
...
{	
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_DontNeedYou_15_00"); //Už tì nepotøebuju.
	B_AlliJack_AlliKlar();
