...
{	
	...
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_Exit_12_00"); //Kdybys mę hledal, tak vobvykle bejvám ve svým táboâe naproti palisádę.
	
		if (PIR_1354_Addon_Henry.aivar [AIV_TalkedToPlayer] == FALSE)
		{
			AI_Output (other ,self,"DIA_Addon_AlligatorJack_Exit_15_01"); //Jaké palisádę?
			AI_Output (self ,other,"DIA_Addon_AlligatorJack_Exit_12_02"); //Prostę vodsuë pokračuj na západ a uvidíš, co myslím.
		};
...
{	
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Hello_12_00"); //Kdo pro všecko na svętę SEŠ? Nevypadáš jak vostatní.
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_Hello_15_01"); //Jací ostatní?
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Hello_12_02"); //No, mágové, co se poâád potulujou kolem tęchhle rozvalin.
...
func void DIA_Addon_AlligatorJack_WerBistDu_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_01"); //Určitę už jsi vo mnę slyšel.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_02"); //(hrdę) Jsem Krokodýl Jack.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WerBistDu_12_03"); //Bojí se mę celá zem, jsem jeden z nejnebezpečnęjších pirátů.
...
instance DIA_Addon_AlligatorJack_Vorschlag		(C_INFO)
{
	...
	description	 = 	"Víš nęco o nęjakém maníkovi jménem Havran?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Vorschlag_15_00"); //Neznáš nęjakého Havrana?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_12_01"); //Jasnę. Je to velitel banditů na východę.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_12_02"); //A co mu chceš?
	
	B_LogEntry (TOPIC_Addon_RavenKDW,"Havran se se svými bandity usadil na východę údolí.");
	
	Info_ClearChoices	(DIA_Addon_AlligatorJack_Vorschlag);
	Info_AddChoice	(DIA_Addon_AlligatorJack_Vorschlag, "Chci se k nęmu pâidat.", DIA_Addon_AlligatorJack_Vorschlag_join );
...
func void 	B_AlligatorJack_Besser ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Besser_12_03"); //Když jednou koštneš náš domácí rum, budeš na vęci koukat jinak.
	Info_ClearChoices	(DIA_Addon_AlligatorJack_Vorschlag);
};
func void DIA_Addon_AlligatorJack_Vorschlag_tot ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_01"); //(smęje se) Cože? TY? A jak si myslíš, že to provedeš?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_02"); //Není to trochu nad tvý možnosti?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_03"); //Dyk se k nęmu ani nedostaneš. To tę jeho banditi dâív stáhnou zaživa z kůže.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_04"); //Nedostaneš se ani pâes jejich první základnu.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_tot_12_05"); //Vypadáš tak, že tę banditi zahlídnou už na míli daleko.
	
	B_AlligatorJack_Besser ();
};
func void DIA_Addon_AlligatorJack_Vorschlag_join ()
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Vorschlag_join_15_00"); //Chci se k nęmu pâidat.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_join_12_01"); //(mazanę) Vážnę?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Vorschlag_join_12_02"); //Ale nevypadáš jako nękdo, kdo by se chtęl pâidat k takovejm cvokům.
...
{
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_BDTRuestung_15_00"); //Potâebuju zbroj banditů.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_12_01"); //A co s ní chceš dęlat?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_12_02"); //Pokud tę v ní nękdo zahlídne, budeš z toho mít akorát polízanici.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_12_03"); //Všichni tę budou považovat za banditu a půjdou po tobę jak slepice po flusu.
	...
	Info_AddChoice	(DIA_Addon_AlligatorJack_BDTRuestung, "Netušíš, kde bych sehnal takovéhle brnęní?", DIA_Addon_AlligatorJack_BDTRuestung_wo );
...
func void DIA_Addon_AlligatorJack_BDTRuestung_gut ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_BDTRuestung_gut_12_01"); //Jo, ale jen pro nękoho se sebevražednejma sklonama.
};
func void DIA_Addon_AlligatorJack_BDTRuestung_wo ()
{
	...
	B_LogEntry (TOPIC_Addon_BDTRuestung,"Zbroj banditů bych męl sehnat u pirátů, jenže Krokodýl Jack mi neâekne, jestli opravdu existuje."); 
...
func void DIA_Addon_AlligatorJack_Greg_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_01"); //Jo, je to nejvętší pirát, jakýho kdy moâe zrodilo.
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_Greg_15_02"); //Myslím, že vašeho kapitána znám, potkal jsem ho v Khorinidu.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_03"); //(smęje se) Greg a v Khorinidu? Blbost!
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_04"); //Greg ještę s nękolika chlapama vyjel loupit na moâe.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_05"); //Jediný, co by Grega mohlo pâitáhnout do Khorinidu, je královská vęzeŕská galéra.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_06"); //Je jedním z nejhledanęjších lidí v zemi.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_Greg_12_07"); //Nikdy by dobrovolnę nevlez do męsta, aby ho královská stráž mohla hned zatknout.
...
func void DIA_Addon_AlligatorJack_PIRLager_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_01"); //Vidíš tamhle tu jeskyni? Projdi na druhou stranu a pak pokračuj k západu. Dâív nebo pozdęjc dorazíš na naši pláž.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_02"); //Tam máme svý sruby.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_PIRLager_12_03"); //Když budeš chtít, můžu tę tam zavést, ale napâed vod tebe budu chtít jednu laskavost.
...
func void DIA_Addon_AlligatorJack_WasJagen_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WasJagen_12_03"); //Takže teë beru, co se dá – močálový krysy.
	AI_Output	(other, self, "DIA_Addon_AlligatorJack_WasJagen_15_04"); //Cože?
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WasJagen_12_05"); //Vętšina zdejších potvor chutná jak špinavý fusekle nebo maj stejnę tvrdý maso jako krokodýli.
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_WasJagen_12_06"); //Tlustý močálový krysy jsou to jedný, co se ještę jakž-takž dá žrát.

	B_LogEntry (TOPIC_Addon_RatHunt,"Jediné, co se tu dá aspoŕ trochu jíst, jsou močálové krysy.");
};
...
INSTANCE DIA_Addon_AlligatorJack_Pirates(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Povęz mi o vás pirátech víc.";
};                       
...
{
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_Pirates_15_00"); //Povęz mi o vás pirátech nęco víc.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_01"); //Už tu žijem celý léta. Eštę pâed válkou nás znal každej vodsuë až na pevninu.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_02"); //Stačil jedinej pohled na naši vlajku a posádky kupeckejch lodí byly podęlaný hrůzou.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_03"); //Ale to už je dávno pryč. Už je to pár tejdnů, co jsme narazili na nęjakou kupeckou loë.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_04"); //Náš kapitán Greg chtęl zkusit ŕákou pâepadnout.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_05"); //My vostatní sedíme tady v táboâe, chytáme lelky a čekáme, až se vrátí.
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_Pirates_12_06"); //Doufám, že pâiveze tučnou koâist.
};
...
{	
	...
	AI_Output (self,other ,"DIA_Addon_AlligatorJack_LetsGoHunting_12_01"); //Dobâe, ve dvou to bude hračka.
...
FUNC VOID DIA_Addon_AlligatorJack_LetsGoHunting_Yes()
{
	...
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_LetsGoHunting_Yes_12_01"); //Skvęlý, tak se drž za mnou.
...
FUNC VOID DIA_Addon_AlligatorJack_LetsGoHunting_No()
{
	...
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_LetsGoHunting_No_12_01"); //Tak si pospęš.
...
func void DIA_Addon_AlligatorJack_AlligatorJackInter1_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_AlligatorJack_AlligatorJackInter1_12_01"); //Nękde by tu nęjaký ty potvory męly bejt.
...
func void DIA_Addon_AlligatorJack_TheHunt_Info ()
{
	...
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_02"); //Tęchhle pár potvor je tak půlka, než kolik bych potâeboval.
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_03"); //Budem to muset vzít do kaŕonu.
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_04"); //Dávej bacha, dál v kaŕonu je to pęknę o hubu.
	AI_Output	(self,other , "DIA_Addon_AlligatorJack_TheHunt_12_05"); //Jestli je ti život milej, drž se co nejblíž u mę.
	
	Wld_InsertNpc (Waran ,"ADW_ENTRANCE_2_VALLEY_10");
	Wld_InsertNpc (Waran ,"ADW_ENTRANCE_2_VALLEY_10");

	Info_ClearChoices (DIA_Addon_AlligatorJack_TheHunt);
	Info_AddChoice (DIA_Addon_AlligatorJack_TheHunt,"A co má v tom kaŕonu jako být?",DIA_Addon_AlligatorJack_TheHunt_Enough);
...
{
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_TheHunt_Enough_15_00"); //Co PÂESNĘ má v tom kaŕonu být?
...
func void DIA_Addon_AlligatorJack_HuntEnd_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_00"); //Hele, můžeš mi âíct, proč tę tu s sebou vlastnę tahám?
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_01"); //Ještę jsi nezabil ani jednu krysu.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_02"); //No, snad budeš užitečnej nęjak jinak.
		
	}
	else if AlligatorJack_KrokosKilled == 1
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_03"); //Výbornę, nękdo jako ty se nám vždycky hodí.
	...
	else	//mehr als 1!!
	{
		...
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_HuntEnd_12_06"); //Tý vole! Jestli budeš takhle pokračovat, tak pâíštę rovnou zůstanu v táboâe.
	};
	...
	AI_Output (self ,other,"DIA_Addon_AlligatorJack_PassHenry_12_09"); //Nejspíš si bude dávat šlofíka nękde na pláži, ale čeká na nęj.
	...
	if (PIR_1354_Addon_Henry.aivar[AIV_PASSGATE] == FALSE)
	{
		...
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_PassHenry_12_11"); //Jestli tę nepustí dovnitâ, âekni mu, že tę posílám já.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_PassHenry_12_12"); //Pak by męl bejt pâíjemnęjší.
	...
	B_LogEntry (TOPIC_Addon_RatHunt,"Lov byl úspęšný. Chytili jsme nękolik močálových krys.");
...
func void DIA_Addon_AlligatorJack_Angus_Info ()
{
	...
	AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Angus_12_03"); //Už jsem je ŕákou dobu nevidęl.
...
func void DIA_Addon_AlligatorJack_Lake_Info ()
{
	...
	else
	{
		...
		AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Lake_12_05"); //Stačí jít z tábora smęrem na východ, to údolí nemůžeš minout.
		AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Lake_12_06"); //Je tam spousta malejch vodopádů.
		AI_Output 	(self ,other, "DIA_Addon_AlligatorJack_Lake_12_07"); //Ale pozor – pokud pod nohama ucejtíš už jenom suchej písek, tak jsi to pâešel a už jsi v kaŕonu.
	};
	
	B_LogEntry	(TOPIC_Addon_SkipsGrog,"Jeskynę by męla být v údolí východnę od tábora, pâímo u jezera.");
};
...
func void DIA_Addon_AlligatorJack_CanLearn_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_01"); //Jasnę, jsem dobrej lovec a můžu ti ukázat, jak zvíâatům stáhnout kůži a vyndat zuby.
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_02"); //Jestli chceš, naučím tę to.
		
		Log_CreateTopic (Topic_Addon_PIR_Teacher,LOG_NOTE);
		B_LogEntry		(Topic_Addon_PIR_Teacher,"Krokodýl Jack mi může ukázat, jak stahovat zvíâata z kůže a jak jim vyjímat zuby. Krom toho mę také pocvičí v lukostâelbę.");
	...
	else
	{
		...
		AI_Output (self ,other,"DIA_Addon_AlligatorJack_CanLearn_12_04"); //Až si spolu zalovíme, tak to tâeba udęlám.
	};
};
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output	(other,self ,"DIA_Addon_AlligatorJack_Teach_15_00"); //Nauč mę nęco!
	AI_Output 	(self ,other,"DIA_Addon_AlligatorJack_Teach_12_01"); //Co bys rád umęl?
...
FUNC VOID DIA_Addon_AlligatorJack_Teach_FUR()
{
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_ReptileSkin] == FALSE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_AlligatorJack_Teach_Fur_12_00"); //Âez vždycky začínej na bâiše, jinak bude výsledek nekvalitní.
		};
	}
	else
	{
...
{	
	AI_Output (other,self ,"DIA_Addon_AlligatorJack_DontNeedYou_15_00"); //Už tę nepotâebuju.
	B_AlliJack_AlliKlar();
