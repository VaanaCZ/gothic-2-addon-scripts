...
{
	AI_Output (other,self ,"DIA_Torlof_DI_Hallo_15_00"); //È tutto tranquillo?

	if (ORkSturmDI == FALSE)
	{
		AI_Output (self ,other,"DIA_Torlof_DI_Hallo_01_01"); //Finora sì. Ma le cose potrebbero cambiare in un istante. Fai attenzione.
	}
	else
	{
		AI_Output (self ,other,"DIA_Torlof_DI_Hallo_01_02"); //Se quei miserabili orchi se ne stanno dove sono, non vedo nessun problema.
...
{	
	AI_Output (other,self ,"DIA_Torlof_DI_Teach_15_00"); //Voglio migliorare le mie abilità!
...
instance DIA_Torlof_DI_UndeadDragonDead		(C_INFO)
{
	...
	description = 	"Ho eliminato il nemico.";
...
{
	AI_Output			(other ,self, "DIA_Torlof_DI_UndeadDragonDead_15_00"); //Ho eliminato il nemico.
	AI_Output			(self ,other, "DIA_Torlof_DI_UndeadDragonDead_01_01"); //Non mi aspettavo diversamente. Come ti pare? Possiamo andarcene finalmente?
	...
	Info_AddChoice	(DIA_Torlof_DI_UndeadDragonDead, "Sì. È finita. Andiamo.", DIA_Torlof_DI_UndeadDragonDead_over );
	
};
func void DIA_Torlof_DI_UndeadDragonDead_moment ()
{
	AI_Output			(other, self, "DIA_Torlof_DI_UndeadDragonDead_moment_15_00"); //Mi serve ancora qualche minuto.
	AI_Output			(self, other, "DIA_Torlof_DI_UndeadDragonDead_moment_01_01"); //Sbrigati!
	AI_StopProcessInfos (self);
};
