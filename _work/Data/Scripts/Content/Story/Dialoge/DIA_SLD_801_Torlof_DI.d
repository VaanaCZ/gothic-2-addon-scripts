...
{
	AI_Output (other,self ,"DIA_Torlof_DI_Hallo_15_00"); //Wszystko w porządku?

	if (ORkSturmDI == FALSE)
	{
		AI_Output (self ,other,"DIA_Torlof_DI_Hallo_01_01"); //Jak na razie... Ale to się może szybko zmienić. Uważaj na siebie.
	}
	else
	{
		AI_Output (self ,other,"DIA_Torlof_DI_Hallo_01_02"); //Jeśli ci przeklęci orkowie będą się trzymać z dala, wszystko będzie w porządku.
...
{	
	AI_Output (other,self ,"DIA_Torlof_DI_Teach_15_00"); //Pomóż mi popracować nad moimi umiejętnościami.
...
instance DIA_Torlof_DI_UndeadDragonDead		(C_INFO)
{
	...
	description = 	"Wróg został pokonany.";
...
{
	AI_Output			(other ,self, "DIA_Torlof_DI_UndeadDragonDead_15_00"); //Wróg został pokonany.
	AI_Output			(self ,other, "DIA_Torlof_DI_UndeadDragonDead_01_01"); //Wcale mnie to nie dziwi. To jak? Możemy już odbijać od brzegu?

	Info_ClearChoices	(DIA_Torlof_DI_UndeadDragonDead);
	Info_AddChoice	(DIA_Torlof_DI_UndeadDragonDead, "Muszę jeszcze coś załatwić.", DIA_Torlof_DI_UndeadDragonDead_moment );
	Info_AddChoice	(DIA_Torlof_DI_UndeadDragonDead, "Tak, to już koniec. Chodźmy.", DIA_Torlof_DI_UndeadDragonDead_over );
	
};
func void DIA_Torlof_DI_UndeadDragonDead_moment ()
{
	AI_Output			(other, self, "DIA_Torlof_DI_UndeadDragonDead_moment_15_00"); //Muszę jeszcze coś załatwić.
	AI_Output			(self, other, "DIA_Torlof_DI_UndeadDragonDead_moment_01_01"); //No to się pośpiesz!
	AI_StopProcessInfos (self);
};
