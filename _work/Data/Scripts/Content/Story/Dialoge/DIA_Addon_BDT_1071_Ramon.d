...
func void DIA_Addon_Ramon_FirstWarn_Info()
{
	if Npc_IsDead (Franco)
	{
		...
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_02"); //Takže teë je na TOBĘ, aby ti líní psi poâádnę makali?
		AI_Output (other, self,"DIA_Addon_Ramon_FirstWarn_15_03"); //Hele, nenechám se otravovat od nęjakejch lovců. Chci se dostat do tábora.
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_04"); //Tak na to zapomeŕ. Sejmul jsi Franca, takže teë to tu vedeš ty. Šupito presto, do práce.
		AI_Output (other, self,"DIA_Addon_Ramon_FirstWarn_15_05"); //Jestli to tu vedu, pak rozhoduju, kdo je právę na âadę.
		AI_Output (other, self,"DIA_Addon_Ramon_FirstWarn_15_06"); //A rozhodl jsem se, že další půjdu JÁ!
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_07"); //(smęje se) To není tak lehký. O NIKOHO jsme nežádali, takže dovnitâ nepůjde NIKDO.
		AI_Output (other, self,"DIA_Addon_Ramon_FirstWarn_15_08"); //Thorus může lovcům poslat novýho velitele a pak si můžu vevnitâ trochu oddáchnout.
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_09"); //(smęje se) Ty se jen tak nevzdáš, co? No dobâe, pohni zadkem, aă už jsi uvnitâ.
	...
	{
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_12"); //Hele, co chceš? Nedokážu si pâedstavit, že by tę jen tak mirnyx-týrnyx pustili pro tábora.
		
		if Npc_KnowsInfo (other, DIA_Addon_Franco_HI)
		{
			AI_Output (other, self,"DIA_Addon_Ramon_FirstWarn_15_13"); //Posílá mę Franco. Chce vędęt, jestli nękoho v táboâe nepotâebujete.
		};
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_14"); //Jo, nękoho potâebujem. Včera natáhnul brka další chlápek
		...
		B_LogEntry (Topic_Addon_Franco,"Thorus potâebuje v táboâe nękoho nového. To bude Franca zajímat.");
	...
	{
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_19"); //Hele, zpomal! Tady není nic k vidęní. Koukej vypadnout!
		AI_StopProcessInfos(self);
	};
...
FUNC VOID DIA_Addon_Ramon_FirstWarn_YES()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_01"); //Jo, TEN Thorus. TEN chlap, kterej chtęl nový lidi.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_02"); //Ten chlap, kterej rozhoduje, kdy a jestli vůbec se nękdo novej dostane z bažiny a do tábora.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_03"); //Nechceš mi snad namluvit, že ho znáš nękdy z dâívęjška.
	...
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_06"); //Ale stejnę dovnitâ nepůjdeš – a já mu nic vzkazovat NEBUDU!
...
FUNC VOID DIA_Addon_Ramon_FirstWarn_NO()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_01"); //Čoveče, ty ho neznáš? Dyk to bejval šéf stráží ve Starým táboâe.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_02"); //Je to chlap, kterýmu tu každej vęâí.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_03"); //Žádá o nový lidi a rozhoduje, kdy a jestli vůbec se nękdo z novę pâíchozích dostane do tábora.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_04"); //Jestli ještę nęjakou dobu pâežiješ, určitę ho poznáš.
...
{
	AI_Output (self, other,"DIA_Addon_Ramon_SecondWarn_07_00"); //Ještę krok a bude to tvůj poslední!
...
func void DIA_Addon_Ramon_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_Attack_07_00"); //Nękterý lidi se nikdy nepoučí.
...
func void DIA_Addon_Ramon_News_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_News_07_01"); //Hele, nesnaž se mę napálit. O tom, kdo z vás se dostane do tábora, furt ještę rozhoduje Franco.
};
// ************************************************************
// 			Lie
// ************************************************************
...
{
	AI_Output (other, self,"DIA_Addon_Ramon_Lie_15_00"); //Posílá mę Franco.
...
func void DIA_Addon_Ramon_Perm_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_Perm_07_01"); //Všecko je v pohodę, pokud se sem nepokouší vloudit nękdo, kdo tu NEMÁ CO DĘLAT
