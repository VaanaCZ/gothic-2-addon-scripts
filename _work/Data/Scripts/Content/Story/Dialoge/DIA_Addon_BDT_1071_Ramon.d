...
func void DIA_Addon_Ramon_FirstWarn_Info()
{
	if Npc_IsDead (Franco)
	{
		...
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_02"); //Takže teï je na TOBÌ, aby ti líní psi poøádnì makali?
		...
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_04"); //Tak na to zapomeò. Sejmul jsi Franca, takže teï to tu vedeš ty. Šupito presto, do práce.
		...
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_07"); //(smìje se) To není tak lehký. O NIKOHO jsme nežádali, takže dovnitø nepùjde NIKDO.
		AI_Output (other, self,"DIA_Addon_Ramon_FirstWarn_15_08"); //Thorus mùže lovcùm poslat novýho velitele a pak si mùžu vevnitø trochu oddáchnout.
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_09"); //(smìje se) Ty se jen tak nevzdáš, co? No dobøe, pohni zadkem, a už jsi uvnitø.
	...
	{
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_12"); //Hele, co chceš? Nedokážu si pøedstavit, že by tì jen tak mirnyx-týrnyx pustili pro tábora.
		...
		AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_07_18"); //Tak vyøiï Francovi, že Thorus chce novýho chlapa, jasný?
...
FUNC VOID DIA_Addon_Ramon_FirstWarn_YES()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_01"); //Jo, TEN Thorus. TEN chlap, kterej chtìl nový lidi.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_02"); //Ten chlap, kterej rozhoduje, kdy a jestli vùbec se nìkdo novej dostane z bažiny a do tábora.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_YES_07_03"); //Nechceš mi snad namluvit, že ho znáš nìkdy z døívìjška.
...
FUNC VOID DIA_Addon_Ramon_FirstWarn_NO()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_01"); //Èoveèe, ty ho neznáš? Dyk to bejval šéf stráží ve Starým táboøe.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_02"); //Je to chlap, kterýmu tu každej vìøí.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_03"); //Žádá o nový lidi a rozhoduje, kdy a jestli vùbec se nìkdo z novì pøíchozích dostane do tábora.
	AI_Output (self, other,"DIA_Addon_Ramon_FirstWarn_NO_07_04"); //Jestli ještì nìjakou dobu pøežiješ, urèitì ho poznáš.
...
func void DIA_Addon_Ramon_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_Attack_07_00"); //Nìkterý lidi se nikdy nepouèí.
...
func void DIA_Addon_Ramon_News_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_News_07_01"); //Hele, nesnaž se mì napálit. O tom, kdo z vás se dostane do tábora, furt ještì rozhoduje Franco.
};
// ************************************************************
// 			Lie
// ************************************************************
...
func void DIA_Addon_Ramon_Lie_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Ramon_Lie_07_01"); //Tak to teda ne. Koukej zmizet, než ti zpøelámu hnáty.
