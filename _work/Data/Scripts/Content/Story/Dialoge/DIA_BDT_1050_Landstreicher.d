...
{
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_09_00"); //Co se to tady dêje?
...
func void DIA_Landstreicher_HALLO_wo ()
{
	...
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_wo_09_01"); //Metelil to dál po cestê jak namydlenej blesk.
};

func void DIA_Landstreicher_HALLO_wer ()
{
	AI_Output			(other, self, "DIA_Landstreicher_HALLO_wer_15_00"); //Kdo byl ten druhej chlápek?
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_wer_09_01"); //Vypadal jako jeden z têch chytrolínskejch novicù z kláštera.
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_wer_09_02"); //Âíkej si, co chceš, ale nêkterý z têch klukù to nemaj v hlavê v poâádku.
	
	if (hero.guild == GIL_KDF)
	{
		AI_Output			(self, other, "DIA_Landstreicher_HALLO_wer_09_03"); //Staèí se podívat na ty jejich pâiblblý hábity. Nechtêl bych, aby mê v tom nêkdo chytil v noci na ulici. (smích)
...
func void DIA_Landstreicher_HALLO_wer_vorsicht ()
{
	...
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_wer_vorsicht_09_01"); //(smích) Ty ubohá sviàko. To vysvêtluje pár vêcí.
	...
	Info_AddChoice		(DIA_Landstreicher_HALLO, "Nêkdo by tê mêl nauèit dobrýmu vychování.", DIA_Landstreicher_HALLO_wer_vorsicht_Manieren );

};
func void DIA_Landstreicher_HALLO_wer_vorsicht_Manieren ()
{
	AI_Output			(other, self, "DIA_Landstreicher_HALLO_wer_vorsicht_Manieren_15_00"); //Nêkdo by tê mêl nauèit slušnýmu chování.
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_wer_vorsicht_Manieren_09_01"); //No tak se netvaâ tak dotèenê. Fajn, když tak toužíš po boji, máš ho mít.
	AI_Output			(self, other, "DIA_Landstreicher_HALLO_wer_vorsicht_Manieren_09_02"); //Tak mi ukaž, co v tobê je, novici.
...
{
	AI_Output			(other, self, "DIA_Landstreicher_WASMACHSTDU_15_00"); //Co tady dêláš?
	
		if (Npc_KnowsInfo(other, DIA_Landstreicher_HALLO))
		{
			AI_Output			(self, other, "DIA_Landstreicher_WASMACHSTDU_09_01"); //Máš nêjak moc otázek na takovýho náfuku.
		};

	AI_Output			(self, other, "DIA_Landstreicher_WASMACHSTDU_09_02"); //Vzpomeà si na tu skâetí jeskyni, co jsme spolu prolezli, a já ti âeknu to tajemství.
