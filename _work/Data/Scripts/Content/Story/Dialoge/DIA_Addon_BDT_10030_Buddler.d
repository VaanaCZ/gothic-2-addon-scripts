...
{	
	...
	{	
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_01");//Otroci nám z cesty odstraŕujou velký kusy.
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_02");//(šklebí se) A my tak můžem mnohem líp sklízet zlatý ovoce.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_03");//A teë si posbíráme svý zlatý štęstí.
		AI_StopProcessInfos(self);
	};
};
