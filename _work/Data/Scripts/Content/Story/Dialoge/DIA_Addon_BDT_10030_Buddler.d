...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10030_Buddler_Hi_15_00");//Jsi v poøádku?
	
	if (Sklaven_Flucht == FALSE)
	{	
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_01");//Otroci nám z cesty odstraòujou velký kusy.
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_02");//(šklebí se) A my tak mùžem mnohem líp sklízet zlatý ovoce.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_03");//A teï si posbíráme svý zlatý štìstí.
		AI_StopProcessInfos(self);
	};
};
