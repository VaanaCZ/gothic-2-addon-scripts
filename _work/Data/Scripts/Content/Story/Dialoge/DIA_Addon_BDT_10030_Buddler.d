...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10030_Buddler_Hi_15_00");//Jsi v pořádku?
	
	if (Sklaven_Flucht == FALSE)
	{	
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_01");//Otroci nám z cesty odstraňujou velký kusy.
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_02");//(šklebí se) A my tak můžem mnohem líp sklízet zlatý ovoce.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BDT_10030_Buddler_Hi_08_03");//A teď si posbíráme svý zlatý štěstí.
		AI_StopProcessInfos(self);
	};
};
