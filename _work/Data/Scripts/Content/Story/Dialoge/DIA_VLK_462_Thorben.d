...
{	
	...
	B_LogEntry (TOPIC_Lehrling, "Thorben mę do učení nepâijme.");
};
...
{	
	...
	AI_Output (self, other,"DIA_Thorben_OtherMasters_06_02"); //Ale nejdâív bys męl získat požehnání od bohů.
...
{
	AI_Output (self, other,"B_Thorben_GetBlessings_06_00"); //Tak to jdi za Vatrasem, Adanovým knęzem, a popros ho, aă ti požehná.
	if (other.guild != GIL_KDF)
	&& (other.guild != GIL_NOV)
	&& (other.guild != GIL_PAL)
	{
	...
	B_LogEntry (TOPIC_Thorben,"Thorben se za mę pâimluví teprve tehdy, až si vyprosím požehnání od Adanova a Innosova knęze.");
};
...
func void DIA_Thorben_OtherMasters_Naja()
{
	...
	AI_Output (self, other,"DIA_Thorben_OtherMasters_Naja_06_02"); //Nękdo, kdo není dostatečnę zbožný, můj souhlas nikdy nezíská.
...
{	
	...
	AI_Output (self, other,"DIA_Thorben_Locksmith_06_03"); //Odbytý zámek se dá snadno zlomit. A tady v Khorinidu se všude kolem potuluje spousta zlodęjů. Zvláštę poslední dobou!
};
...
{	
	...
	{
		AI_Output (self, other,"DIA_Thorben_Teach_06_01"); //Potâebuješ akorát nęjaký paklíč. Pokud jím budeš v zámku opatrnę otáčet doprava a doleva, můžeš mechanismus otevâít.
		AI_Output (self, other,"DIA_Thorben_Teach_06_02"); //Ale pokud otočíš pâíliš rychle nebo moc silnę ve špatném smęru, paklíč se zlomí.
		AI_Output (self, other,"DIA_Thorben_Teach_06_03"); //Čím budeš obratnęjší, tím ménę budeš potâebovat paklíčů. To je všechno, opravdu.
	};
};
...
INSTANCE DIA_Thorben_TRADE(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Můžeš mi prodat nęjaké paklíče?";
	trade		= TRUE;
};                       
...
{	
	AI_Output (other, self,"DIA_Thorben_TRADE_15_00"); //Můžeš mi prodat nęjaké paklíče?
	...
	B_LogEntry (Topic_CityTrader,"Tesaâ Thorben prodává paklíče."); 
};
...
instance DIA_Addon_Thorben_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Ty už jsi nękdy nęjakého učedníka męl?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Thorben_MissingPeople_15_00"); //Už jsi nękdy męl nęjakého učedníka?
	...
	AI_Output	(self, other, "DIA_Addon_Thorben_MissingPeople_06_04"); //A byl jsem s ním docela spokojený, ale jednoho dne prostę nepâišel do práce.
	
	MIS_Thorben_BringElvrichBack = LOG_RUNNING;

	Log_CreateTopic (TOPIC_Addon_MissingPeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_MissingPeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_MissingPeople,"Elvrich, učedník tesaâe Thorbena, zmizel."); 
	...
	Info_AddChoice	(DIA_Addon_Thorben_MissingPeople, "A ohlásil jsi to domobranę?", DIA_Addon_Thorben_MissingPeople_Mil );
...
{
	AI_Output			(other, self, "DIA_Addon_Thorben_MissingPeople_wann_15_00"); //Jak je to dlouho, co jsi ho nevidęl?
...
func void DIA_Addon_Thorben_MissingPeople_where ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Thorben_MissingPeople_where_06_01"); //Jak to mám vędęt? Ale furt se poflakoval kolem toho špinavýho bordelu v pâístavu.
	AI_Output			(self, other, "DIA_Addon_Thorben_MissingPeople_where_06_02"); //Ani by mę nepâekvapilo, kdyby si tam ještę teë užíval s nęjakou štętkou.
};

func void DIA_Addon_Thorben_MissingPeople_Mil ()
{
	AI_Output			(other, self, "DIA_Addon_Thorben_MissingPeople_Mil_15_00"); //Ohlásil jsi to domobranę?
	AI_Output			(self, other, "DIA_Addon_Thorben_MissingPeople_Mil_06_01"); //Samozâejmę. Męli ho chytit a dohlídnout, aby se ta líná kůže vrátila zpátky do práce. Ale já už to stejnę zabalil.
	AI_Output			(self, other, "DIA_Addon_Thorben_MissingPeople_Mil_06_02"); //Aă si dęlá, co chce. Dâív nebo pozdęji stejnę zjistí, že bez slušné práce si v Khorinidu neškrtne.
...
instance DIA_Addon_Thorben_ElvrichIsBack		(C_INFO)
{
	...
	description	 = 	"Elvrich pro tebe bude od nynęjška znovu pracovat.";
};
...
func void DIA_Addon_Thorben_ElvrichIsBack_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Thorben_ElvrichIsBack_06_01"); //Můžu jenom doufat, že nezmizí znova, až se kolem ochomýtne nęjaká suknę.
	AI_Output	(self, other, "DIA_Addon_Thorben_ElvrichIsBack_06_02"); //Za to, že jsi mi pâivedl učedníka, si vezmi tohle zlato.
...
{	
	...
	AI_Output (self, other,"DIA_Thorben_Bauernaufstand_06_04"); //Onarova farma leží na východ odsud, je to docela daleko. Nevíme, jestli se tam k nęčemu chystá.
...
func void B_Thorben_DeletePetzCrimeGritta()
{
	...
	{
		AI_Output (self, other,"B_Thorben_DeletePetzCrimeGritta_06_00"); //A co vím o té malé zmiji, jsem si jistý, že bęžela pâímo za męstskou stráží, aby tę taky obvinila!
