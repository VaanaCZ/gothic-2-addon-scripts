...
func void DIA_Ruga_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Ruga_Hallo_11_01"); //Cvièím chlapy v zacházení s kuší a pomáhám jim být trochu obratnêjší.
	
	Log_CreateTopic (Topic_CityTeacher, LOG_NOTE);
	B_LogEntry (Topic_CityTeacher, "Ruga, pâíslušník mêstské gardy, mi vylepší obratnost a nauèí mê používat kuši. Musím ale nejdâíve vstoupit do královských služeb.");
};
///////////////////////////////////////////////////////////////////////
//	Info Train
///////////////////////////////////////////////////////////////////////
...
func void DIA_Ruga_Train_Info ()
{
	...
	|| (hero.guild == GIL_KDF)
	{
		AI_Output (self, other, "DIA_Ruga_Train_11_01"); //Jasná páka. Jestli jsi dostateènê zkušený, pomohu ti.
	...
	|| 		 (hero.guild == GIL_DJG))
	{
		AI_Output (self, other, "DIA_Ruga_Train_11_04"); //Táhni mi z oèí, (opovržlivê) žoldáku.
		AI_StopProcessInfos (self);
	}
	else 
	{	 
		AI_Output (self, other, "DIA_Ruga_Train_11_05"); //Ne, mohu cvièit jen muže v královských službách. Nikoho jiného.
		AI_Output (self, other, "DIA_Ruga_Train_11_06"); //Ale vždycky se nám hodí dobâí chlapi. Takže pokud by ses chtêl pâidat k domobranê, bêž si promluvit s lordem Andrem.
	};     
};
//**************************************
//			Ich will trainieren
...
FUNC VOID DIA_Ruga_Teach_Back ()
{
	...
	{
		AI_Output(self,other,"DIA_Ruga_Teach_11_00"); //Už není nic, co bych tê mohl nauèit. Je naèase, aby sis našel nového uèitele.
...
{
	AI_Output (other, self, "DIA_Ruga_TEACHDEX_15_00"); //Chtêl bych být o nêco obratnêjší.
...
func void DIA_Ruga_TEACHDEX_BACK()
{
	...
	{
		AI_Output (self, other, "DIA_Ruga_TEACHDEX_11_00"); //To je vše, co tê mùžu nauèit. Jestli chceš být ještê obratnêjší, najdi si jiného uèitele.
