...
func void DIA_Wulfgar_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Wulfgar_Hallo_04_02"); //(rozhodnê) Ale až s nimi skonèím, každý z nich bude tvrdý, pevný parchant.
};
...
func void DIA_Wulfgar_WannaJoin_Info ()
{
	...
	if (Player_IsApprentice == APP_NONE)
	{
		...
		AI_Output (self, other, "DIA_Wulfgar_WannaJoin_04_04"); //Samozâejmê že si s ním mùžeš promluvit - ale neâekl bych, že u tebe uèiní výjimku.
	}
	else
	{
...
func void DIA_Wulfgar_AboutMiliz_Info ()
{
	...
	AI_Output (self, other, "DIA_Wulfgar_AboutMiliz_04_02"); //Domobrana se dâív zodpovídala místodržícímu. (smêje se) Ten nemêl ponêtí, co tady dêláme.
	AI_Output (self, other, "DIA_Wulfgar_AboutMiliz_04_03"); //Ale lord Andre dobâe ví, co dêlá. O chlapy se stará vážnê dobâe.
	AI_Output (self, other, "DIA_Wulfgar_AboutMiliz_04_04"); //Každý, kdo tady zaèíná, dostane slušnou zbroj a dobrou zbraà.
	AI_Output (self, other, "DIA_Wulfgar_AboutMiliz_04_05"); //A když odvádíš dobrou práci, dostaneš nêco navíc. Za každého lapeného kriminálníka dostaneš odmênu.
};
...
instance DIA_Wulfgar_CanYouTrain		(C_INFO)
{
	...
	permanent	 = 	FALSE;
	description	 = 	"Mùžeš uèit v boji s meèem i mê?";
};
...
{
	AI_Output (other, self, "DIA_Wulfgar_CanYouTrain_15_00"); //Mùžeš uèit boji s meèem i mê?
	AI_Output (self, other, "DIA_Wulfgar_CanYouTrain_04_01"); //Lord Andre mi pâikázal, abych cvièil každého, kdo by mohl být schopen bránit mêsto.
	...
	{
		AI_Output (self, other, "DIA_Wulfgar_CanYouTrain_04_03"); //To ovšem platí jen pro bojový výcvik. Všechny ostatní druhy výcviku jsou vyhrazeny domobranê.
		...
		B_LogEntry (Topic_CityTeacher, "Wulfgar, èlen mêstské gardy, mê mùže vycvièit v jednoruèním i obouruèním boji.");
...
func void DIA_Wulfgar_Advantage_Info ()
{
	...
	AI_Output (self, other, "DIA_Wulfgar_Advantage_04_01"); //Je to prosté. S jednoruèní zbraní jsi rychlejší. To mùže být v bitvê pomêrnê znaèná výhoda.
	AI_Output (self, other, "DIA_Wulfgar_Advantage_04_02"); //Obouruèní zbranê jsou têžkopádnêjší. Musíš bojovat obezâetnê - pâi zásahu však zpùsobíš mnohem vêtší zranêní.
};
...
func void DIA_Wulfgar_HowToBegin_Info ()
{
	...
	AI_Output (self, other, "DIA_Wulfgar_HowToBegin_04_02"); //Pokud se zamêâíš jen na jeden typ zbraní, budeš se zároveà uèit i ten druhý.
	AI_Output (self, other, "DIA_Wulfgar_HowToBegin_04_03"); //Jestliže jsi napâíklad dobrý v boji s jednoruèními meèi, ale jsi stále zaèáteèník v boji s obouruèními zbranêmi...
	AI_Output (self, other, "DIA_Wulfgar_HowToBegin_04_04"); //...tvé dovednosti s obouruèními zbranêmi se zvýší, i když trénuješ s jednoruèní zbraní.
	AI_Output (self, other, "DIA_Wulfgar_HowToBegin_04_05"); //V takovém pâípadê je výcvik nároènêjší, než když se uèíš s obêma typy zbraní.
...
INSTANCE DIA_Wulfgar_Teach(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zaènême s výcvikem.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Wulfgar_Teach_15_00"); //Zaènême s výcvikem.
...
{	
	AI_Output (self, other, "DIA_Wulfgar_AlsMil_04_00"); //Takže tê lord Andre pâijal!
	AI_Output (self, other, "DIA_Wulfgar_AlsMil_04_01"); //Pâedpokládám, že sem budeš chodit cvièit pravidelnê.
	AI_Output (self, other, "DIA_Wulfgar_AlsMil_04_02"); //Ruga tê bude uèit v umêní stâelby z kuše a Mortis ti pomùže zvýšit sílu.
	AI_Output (self, other, "DIA_Wulfgar_AlsMil_04_03"); //Ale nejdùležitêjší pro tebe je poâádnê se nauèit zacházet s meèem.
...
{
	AI_Output (self, other, "DIA_Wulfgar_Bonus_04_00"); //Tak brzy a již na nohou? V tuhle denní dobu tady bývám vêtšinou sám. Ale když už jsi tady, mùžeš se nêèemu pâiuèit.
	AI_Output (self, other, "DIA_Wulfgar_Bonus_04_01"); //Tak dávej pozor. Nêkteré protivníky mùžeš zmást, když se jejich úderùm vyhneš a pak v pravou chvíli udeâíš.
