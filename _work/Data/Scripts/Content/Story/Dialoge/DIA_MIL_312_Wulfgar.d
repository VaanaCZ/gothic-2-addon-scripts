...
INSTANCE DIA_Wulfgar_Teach(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Iniciemos el entrenamiento.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Wulfgar_Teach_15_00"); //Iniciemos el entrenamiento.
	...
	else
	{
		...
		{
			AI_Output (self, other, "DIA_Wulfgar_Add_04_01"); //Por supuesto, reverendo.
		};
