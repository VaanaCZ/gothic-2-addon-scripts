...
func void DIA_Girion_DI_Hallo_Info ()
{
	...
	if (ORkSturmDI == TRUE)
		...
		{
			AI_Output			(self, other, "DIA_Girion_DI_Hallo_08_03"); //Âekl bych. Zabere ti tvůj úkol tady na útesu hodnę času?
		}
	else
		{
...
INSTANCE DIA_Girion_DI_Teach(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Když mę vycvičíš, budeme odsud moci rychleji vypadnout!";
};                       
...
FUNC VOID DIA_Girion_DI_Teach_1H_5 ()
{
	...
	{
			AI_Output (self ,other,"DIA_Girion_DI_Teach_1H_5_08_00"); //Svou sílu používej s rozmyslem. Když se bezhlavę rozbęhneš proti nepâíteli, moc úspęchů nesklidíš.
	};
	Info_ClearChoices 	(DIA_Girion_DI_Teach);
	Info_AddChoice 		(DIA_Girion_DI_Teach,	DIALOG_BACK		,DIA_Girion_DI_Teach_Back);
	Info_AddChoice		(DIA_Girion_DI_Teach, B_BuildLearnString(PRINT_LearnCrossBow1	, 		  B_GetLearnCostTalent(other, NPC_TALENT_CROSSBOW, 1))		,DIA_Girion_DI_Teach_CROSSBOW_1);
	...
	if (DIA_Girion_DI_UndeadDragonDead_OneTime == FALSE)
		{
			...
			AI_Output			(other ,self, "DIA_Girion_DI_UndeadDragonDead_15_03"); //Ještę nejsme v Khorinidu. A upâímnę âečeno, zpátky do Khorinidu se mi moc nechce.
