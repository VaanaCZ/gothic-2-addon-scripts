...
{		
	AI_Output (other,self,"DIA_Addon_Logan_EXIT_15_00");//Pâijdu pozdęji.
	
	if ((!MIS_HlpLogan == LOG_RUNNING)
	|| ( !MIS_HlpLogan == LOG_SUCCESS))
	&& (Logan_Inside == FALSE)
	{
		AI_Output (self,other,"DIA_Addon_Logan_EXIT_10_01");//(vrčí) Jo, klidnę si zdrhej. Já zůstanu taky a zastavím všecko, co se moc pâiblíží.
	};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_1072_Logan_Mine_10_00");//Takže jsi to zvládnul? No, dobâe žes mę tam nenechal trčet.
...
FUNC VOID DIA_Addon_Logan_How2_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_How2_10_01"); //No, aspoŕ že jsem tady. Lucie vaâí ŕákej dęsnej chlast.
	AI_Output (self, other, "DIA_Addon_Logan_How2_10_02"); //Jenže Esteban mę do dolu nepustí. Aspoŕ ne teë. Dal mi jinou práci.
	AI_Output (other, self, "DIA_Addon_Logan_How2_15_03"); //A co po tobę chce?
	AI_Output (self, other, "DIA_Addon_Logan_How2_10_04"); //Nękdo se pokusil Estebana zabít, tak chce vędęt, kdo to má na svędomí.
	AI_Output (self, other, "DIA_Addon_Logan_How2_10_05"); //(tiše) Esteban si myslí, že v tom má prsty Snaf, tak na nęj mám dohlížet.
...
FUNC VOID DIA_Addon_Logan_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_Attentat_10_00");//Hledáš, kdo za tím vęzí, co?
	AI_Output (self, other, "DIA_Addon_Logan_Attentat_10_01");//Ale nevím o tom vůbec nic. Jak bych taky moh? Byl jsem tehdá ještę v bažinę.
};
//---------------------------------------------------------------------
//	Info HI 
//---------------------------------------------------------------------
...
{
	AI_Output (self, other, "DIA_Addon_Logan_HI_10_00");//A hele, nękdo novej.
	...
	{
		AI_Output (other, self, "DIA_Addon_Logan_HI_15_02");//Posílá mę Franco, prý potâebuješ pomoct. Tak povídej, co je?
	}
	else
	{
		AI_Output (other, self, "DIA_Addon_Logan_HI_15_03");//To záleží na tom, s čím tu pomoc potâebuješ.
	};
	AI_Output (self, other, "DIA_Addon_Logan_HI_10_04");//Močáloví žraloci už lezou na můj vkus až moc blízko – nejvyšší čas, aby jich nękdo pár pobil.
	
	Log_CreateTopic (Topic_Addon_Logan,LOG_MISSION);
	Log_SetTopicStatus (Topic_Addon_Logan,LOG_RUNNING);
	B_LogEntry (Topic_Addon_Logan,"Logan chce, abych se s ním vydal na lov močálových žraloků.");
};
//---------------------------------------------------------------------
//	Info Why
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Logan_Why_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_01"); //(vrčí) Když to neudęláš, Franco tę tu nechá shnít.
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_02"); //Jestli se chceš dostat do tábora, musíš pâiložit ruku k dílu. Planejma âečma se nikam nedostaneš.
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_03"); //Krom toho ti můžu ukázat, jak vyvrhnout zvíâata.
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_04"); //Ale nemyslím, že tę Franco pošle rovnou do tábora jenom proto, že si pohraješ s pár žralokama.
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_05"); //Je tu dost lidí, co už čekaj jak dlouho, aby se dostali dovnitâ.
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_06"); //A další na âadę jsem já (vrčí). Nebo bych aspoŕ męl bejt.
	
	Log_CreateTopic (Topic_Addon_BDT_Teacher,LOG_NOTE);
	B_LogEntry 	(Topic_Addon_BDT_Teacher,"Logan mę naučí stahovat kůže a vyjímat drápy a zuby.");	
};
//---------------------------------------------------------------------
//	Info Lager
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Logan_Lager_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_Lager_10_01");//(vrčí) Spíš se ptej, co v táboâe NENÍ. Nejsou tam žádný močálový žraloci, žádný hluboký bažiny, prostę vůbec ŽÁDNÝ mokâiny.
	AI_Output (self, other, "DIA_Addon_Logan_Lager_10_02");//Místo toho je tam chlast a zlato. Pokud vím, tak tam snad je i ŕáká ženská. Chápeš?
};
//---------------------------------------------------------------------
...
INSTANCE DIA_Addon_Logan_MIS   (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Pojëme na ty močálové žraloky.";
};
...
FUNC VOID DIA_Addon_Logan_MIS_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_MIS_10_01");//Už víš, jak na to. To mę tęší. Psst – slyšíš to? Já teda jo.
	AI_Output (other, self, "DIA_Addon_Logan_MIS_15_02");//Chápu – a co udęláme teë?
	AI_Output (self, other, "DIA_Addon_Logan_MIS_10_03");//Už se blíží. Dostali chuă na kousek lidskýho masíčka. Jojo, uvidíme, kdo koho dneska sežere. Pojëme.
...
{	 
	AI_Output (self, other, "DIA_Addon_Logan_tot_10_00");//Dobrej močálovej žralok je mrtvej močálovej žralok. To bude pro jeho bráchy poâádný varování.
	AI_Output (other, self, "DIA_Addon_Logan_tot_15_01");//Fajn, je tu potâeba ještę nęco dalšího? Jinak jdu pryč.
	AI_Output (self, other, "DIA_Addon_Logan_tot_10_02");//Klidnę. A až se budeš chtít ještę nęco naučit, víš, kde mę hledat.
...
INSTANCE DIA_Addon_Logan_Lern   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Nauč mę vyvrhovat zvíâata...";
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Logan_Lern_10_01");//Jestli se chceš naučit nęco o krvavejch mouchách, zajdi si za Edgorem. Ten o nich ví všecko.
	AI_Output (self, other, "DIA_Addon_Logan_Lern_10_02");//A kdybys chtęl vyvrhovat močálový žraloky nebo ještęry, musíš vędęt, jak jim stáhnout kůže a vyndat zuby. Ukážu ti jak.
};
///////////////////////////////////////////////////////////////////////
...
FUNC VOID DIA_Addon_Logan_Allg_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_Addon_Logan_Allg, B_BuildLearnString ("Vyjmutí zubů",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Teeth)),  DIA_Addon_Logan_Allg_Teeth);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Claws] == FALSE)
	{ 
		Info_AddChoice	(DIA_Addon_Logan_Allg, B_BuildLearnString ("Vyjmutí drápů",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Claws)),  DIA_Addon_Logan_Allg_Claws);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Fur] == FALSE)
	{ 
		Info_AddChoice	(DIA_Addon_Logan_Allg, B_BuildLearnString ("Stažení z kůže",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Fur)),  DIA_Addon_Logan_Allg_Fur);
	};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Logan_Hacker_10_01"); //Zdar! Díky tobę jsem to zvládnul! Jsem v dole!
	AI_Output (self, other, "DIA_Addon_BDT_10004_Logan_Hacker_10_02"); //O dolování zlata sice moc nevím, ale to se poddá.
	
	if (Logan_Lohn == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_BDT_10004_Logan_Hacker_10_03"); //Naučil jsem se to nejdůležitęjší. Nohy pevnę na zemi a vždycky silnę bušit.
