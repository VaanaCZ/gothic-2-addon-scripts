...
FUNC VOID DIA_Wirt_Hallo_Info()
{
	...
	AI_Output (self, other,"DIA_Wirt_Hallo_14_00");//Hej, pojï blíž - dej si pauzu a pár lokù dobøe chlazeného piva.
	...
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_03");//Paladinové dají všechno do poøádku, takže si klidnì ještì lokni a užij si to.
	...
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_04");//O Khorinidu si øíkej, co chceš, ale náš 'Temný paladin' je prostì nejlepší z celé Myrtany.
		AI_StopProcessInfos (self);
	};
};
