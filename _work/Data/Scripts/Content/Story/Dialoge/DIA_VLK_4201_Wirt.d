...
FUNC VOID DIA_Wirt_Hallo_Info()
{
	...
	AI_Output (self, other,"DIA_Wirt_Hallo_14_00");//Hej, podejdź bliżej. Zrób sobie przerwę i napij się chłodnego piwka.
	
	if (self.aivar [AIV_TalkedToPlayer] == FALSE) 
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_01");//Lord Andre stawia kilka baryłek przedniego piwa.
		AI_StopProcessInfos (self);
	}
	else if (randy == 0)
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_02");//Nic tak nie orzeźwia po pracy jak kufelek zimnego, złocistego piwa.
		AI_StopProcessInfos (self);
	}
	else if (randy == 1)
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_03");//Paladyni wszystkim się zajmą. Nalej sobie jeszcze jednego i baw się dobrze.
	...
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_04");//Gadaj, co chcesz, o Khorinis, ale lepszego 'Mrocznego Paladyna' próżno by szukać w całej Myrtanie.
		AI_StopProcessInfos (self);
	};
};
