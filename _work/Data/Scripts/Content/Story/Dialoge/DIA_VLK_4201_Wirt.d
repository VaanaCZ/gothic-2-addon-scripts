...
FUNC VOID DIA_Wirt_Hallo_Info()
{
	...
	AI_Output (self, other,"DIA_Wirt_Hallo_14_00");//Ehi, avvicinati, prenditi una pausa e beviti una birra fresca.
	
	if (self.aivar [AIV_TalkedToPlayer] == FALSE) 
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_01");//Lord Andre sta facendo sgorgare birra gratis da alcuni barili!
		AI_StopProcessInfos (self);
	}
	else if (randy == 0)
	{
