...
FUNC VOID DIA_Wirt_Hallo_Info()
{
	...
	AI_Output (self, other,"DIA_Wirt_Hallo_14_00");//Hej, pojë blíž - dej si pauzu a pár lokù dobâe chlazeného piva.
	...
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_03");//Paladinové dají všechno do poâádku, takže si klidnê ještê lokni a užij si to.
	...
	{
		AI_Output (self, other,"DIA_Wirt_Hallo_14_04");//O Khorinidu si âíkej, co chceš, ale náš 'Temný paladin' je prostê nejlepší z celé Myrtany.
		AI_StopProcessInfos (self);
	};
};
