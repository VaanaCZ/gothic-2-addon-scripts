...
func void DIA_BridgeDementor_Info ()
{
	...
	AI_Output			(self ,other, "DIA_BridgeDementor_19_00"); //Vêdêli jsme, že pâijdeš!
	AI_Output			(self ,other, "DIA_BridgeDementor_19_01"); //Mùj Pán dosáhne vítêzství a pâevezme vládu nad celým svêtem.
	AI_Output			(self ,other, "DIA_BridgeDementor_19_02"); //Ty popletenej hlupáku! Nemáš ani tušení, komu ses postavil, a já tê znièím právê teë a právê tady!
