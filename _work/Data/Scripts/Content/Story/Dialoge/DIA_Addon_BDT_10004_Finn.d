...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Hacker_07_01"); //Jo, teë se snažím z tohohle dolu vykutat zlato do poslední mrtê.
};
//----------------------------------------------------------------------
//	Info Hacke
//----------------------------------------------------------------------
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Hi_07_01"); //(nabruèenê) Co chceš?
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_01"); //Bêž za kováâem Hunem. Ale i když budeš mít krumpáè, neznamená to, že se dostaneš do dolu.
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_02"); //Jestli tam opravdu chceš, musíš si promluvit s Estebanem.
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_03"); //Za Thorusem ani nemusíš chodit - ten tê pustí dovnitâ, jedinê když budeš mít èervený kámen.
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_Esteban_07_01"); //(opatrnê) Je zdejší šéf a je... no, myslím že je dobrej.
	AI_Output (self, other, "DIA_Addon_Finn_Esteban_07_02"); //(váhavê) Vždycky do dolu posílá jenom dobrý chlapy. Myslím ty, kteâí se vyznají v dolování.
};
...
INSTANCE DIA_Addon_Finn_Profi (C_INFO)
{
	...
	permanent   = FALSE;
	description = "A víš nêco o dolování?";
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_00"); //No jasnê, šéfe. Chceš vidêt nejlepšího z dolu? Právê se na nêj koukáš.
	
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_01");//Ne, nêco jinýho. Zasvêtím tê do tajemství kopáèù.
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_02");//Obèas se hodí do toho poâádnê majznout.
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_03");//Když nêkolikrát udeâíš a nic nevykopeš, pâejeë špièkou krumpáèe po bocích kamene.
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_04");//S trochou štêstí tak najdeš i více valounù najednou.
...
FUNC VOID DIA_Addon_Finn_Gold_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_00");//No, nêco bys mêl vêdêt. Zlato není ruda. Je v tom jeden zatracenej rozdíl.
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_01");//Tím myslím, že žádná ženská by si nejspíš na krk nepovêsila náhrdelník z rudy.
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_02");//Pâi kopání postupuj odshora dolù. Tak nejlíp uvolníš nuggety.
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_03");//Nêkteâí kopáèi to dêlaj jinak, ale to je mnohem složitêjší.
...
FUNC VOID DIA_Addon_Finn_ein_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Finn_ein_07_01");//No jasnê, už v tom dêlám víc jak pêtatâicet let. Mùžu posoudit úplnê všecko.
		Finn_einmal = TRUE;
	};
	AI_Output (self, other, "DIA_Addon_Finn_ein_07_02");//Co se tebe týèe, tak bych âekl, že jsi
	...
	{
		AI_Output (self, other, "DIA_Addon_Finn_ein_07_07"); //zatracenê dobrej kopáè.
	}
	...
	else 
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_Finn_ein_07_10");//Tak teë seš stejnê dobrej jak já. Gratuluju, kámo.
	...
	ConcatText = ConcatStrings ("Natêžené zlato: ", IntToString (Hero_HackChance));
...
FUNC VOID DIA_Addon_Finn_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_Attentat_07_00"); //(opatrnê) Ano?
	AI_Output (other, self, "DIA_Addon_Finn_Attentat_15_01"); //Máš ponêtí, kdo za tím stojí?
	AI_Output (self, other, "DIA_Addon_Finn_Attentat_07_02"); //Proè to chceš vêdêt?
...
{
	AI_Output (self, other, "DIA_Addon_Finn_TellAll_07_00"); //(vypráví) Pâi tom útoku jsem si zrovna šel ke kováâi Hunovi pro novej krumpáè.
...
func void DIA_Addon_Finn_Attentat_ForTheBoss()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_ForTheBoss_07_01"); //No teda! Ty dêláš pro šéfa?
...
func void DIA_Addon_Finn_Attentat_WannaTalk()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_WannaTalk_07_01"); //(obezâetnê) A co po nêm chceš?
	
	Info_ClearChoices (DIA_Addon_Finn_Attentat);
	Info_AddChoice (DIA_Addon_Finn_Attentat,"Do toho ti nic není!",DIA_Addon_Finn_Attentat_ForgetIt);
	Info_AddChoice (DIA_Addon_Finn_Attentat,"Mám pro nêj jistou zajímavou informaci.",DIA_Addon_Finn_Attentat_HaveInfos);
	Info_AddChoice (DIA_Addon_Finn_Attentat,"Chci odkrouhnout Estebana a hledám nêkoho, kdo mi s tím pomùže!",DIA_Addon_Finn_Attentat_KillEsteban);
};	
		
func void DIA_Addon_Finn_Attentat_KillEsteban()
{
	AI_Output (other, self, "DIA_Addon_Finn_KillEsteban_15_00"); //Chci oddêlat Estebana a hledám nêkoho, kdo mi v tom pomùže!
...
{
	AI_Output (other, self, "DIA_Addon_Finn_HaveInfos_15_00"); //Mám pro nêj zajímavou informaci.
	...
	Info_AddChoice (DIA_Addon_Finn_Attentat,"To rozhodnê ne!",DIA_Addon_Finn_Attentat_NoNo);
};

	func void DIA_Addon_Finn_Attentat_NoNo()
	{
		AI_Output (other, self, "DIA_Addon_Finn_NoNo_15_00"); //To teda ne!
		AI_Output (self, other, "DIA_Addon_Finn_NoNo_07_01"); //(odhadnê) No dobâe. Povím ti, co vím.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_ForgetIt_07_01"); //Takže? Já o tý vêci stejnê nic nevím.
...
INSTANCE DIA_Addon_Finn_Again  (C_INFO)
{
	...
	permanent   = TRUE;
	description	= "Ještê k tomu útoku...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Finn_Again_15_00"); //Ještê k tomu útoku.
	if (Finn_TellAll == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_Finn_Again_07_01"); //Už jsem ti âekl všechno, co vím.
		
		Info_ClearChoices (DIA_Addon_Finn_Again);
		Info_AddChoice (DIA_Addon_Finn_Again, "OK... (zpêt)", DIA_Addon_Finn_Again_Exit);
		Info_AddChoice (DIA_Addon_Finn_Again, "Tak mi to âekni znova!", DIA_Addon_Finn_Again_Nochmal);		
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Finn_Again_07_02"); //Tak mê s tím už neotravuj.
		AI_StopProcessInfos(self);
	};
};
...
{
	AI_Output (other, self, "DIA_Addon_Finn_Again_Exit_15_00"); //(odhadnê) Dobâe.
	Info_ClearChoices (DIA_Addon_Finn_Again);
};
