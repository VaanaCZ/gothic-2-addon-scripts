...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Hacker_07_01"); //Jo, teď se snažím z tohohle dolu vykutat zlato do poslední mrtě.
};
//----------------------------------------------------------------------
//	Info Hacke
//----------------------------------------------------------------------
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Hi_07_01"); //(nabručeně) Co chceš?
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_01"); //Běž za kovářem Hunem. Ale i když budeš mít krumpáč, neznamená to, že se dostaneš do dolu.
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_02"); //Jestli tam opravdu chceš, musíš si promluvit s Estebanem.
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_03"); //Za Thorusem ani nemusíš chodit - ten tě pustí dovnitř, jedině když budeš mít červený kámen.
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_Esteban_07_01"); //(opatrně) Je zdejší šéf a je... no, myslím že je dobrej.
	AI_Output (self, other, "DIA_Addon_Finn_Esteban_07_02"); //(váhavě) Vždycky do dolu posílá jenom dobrý chlapy. Myslím ty, kteří se vyznají v dolování.
};
...
INSTANCE DIA_Addon_Finn_Profi (C_INFO)
{
	...
	permanent   = FALSE;
	description = "A víš něco o dolování?";
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_00"); //No jasně, šéfe. Chceš vidět nejlepšího z dolu? Právě se na něj koukáš.
	
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_01");//Ne, něco jinýho. Zasvětím tě do tajemství kopáčů.
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_02");//Občas se hodí do toho pořádně majznout.
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_03");//Když několikrát udeříš a nic nevykopeš, přejeď špičkou krumpáče po bocích kamene.
	AI_Output (self, other, "DIA_Addon_BDT_10004_Finn_Mine_07_04");//S trochou štěstí tak najdeš i více valounů najednou.
...
FUNC VOID DIA_Addon_Finn_Gold_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_00");//No, něco bys měl vědět. Zlato není ruda. Je v tom jeden zatracenej rozdíl.
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_01");//Tím myslím, že žádná ženská by si nejspíš na krk nepověsila náhrdelník z rudy.
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_02");//Při kopání postupuj odshora dolů. Tak nejlíp uvolníš nuggety.
	AI_Output (self, other, "DIA_Addon_Finn_Gold_07_03");//Někteří kopáči to dělaj jinak, ale to je mnohem složitější.
...
FUNC VOID DIA_Addon_Finn_ein_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Finn_ein_07_01");//No jasně, už v tom dělám víc jak pětatřicet let. Můžu posoudit úplně všecko.
		Finn_einmal = TRUE;
	};
	AI_Output (self, other, "DIA_Addon_Finn_ein_07_02");//Co se tebe týče, tak bych řekl, že jsi
	...
	{
		AI_Output (self, other, "DIA_Addon_Finn_ein_07_07"); //zatraceně dobrej kopáč.
	}
	...
	else 
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_Finn_ein_07_10");//Tak teď seš stejně dobrej jak já. Gratuluju, kámo.
	...
	ConcatText = ConcatStrings ("Natěžené zlato: ", IntToString (Hero_HackChance));
...
FUNC VOID DIA_Addon_Finn_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_Attentat_07_00"); //(opatrně) Ano?
	AI_Output (other, self, "DIA_Addon_Finn_Attentat_15_01"); //Máš ponětí, kdo za tím stojí?
...
{
	AI_Output (self, other, "DIA_Addon_Finn_TellAll_07_00"); //(vypráví) Při tom útoku jsem si zrovna šel ke kováři Hunovi pro novej krumpáč.
	...
	AI_Output (self, other, "DIA_Addon_Finn_TellAll_07_03"); //Obvykle tam VŽDYCKY bývá, takže je to FAKT podezřelý, to ti povím.
...
func void DIA_Addon_Finn_Attentat_ForTheBoss()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_ForTheBoss_07_01"); //No teda! Ty děláš pro šéfa?
...
func void DIA_Addon_Finn_Attentat_WannaTalk()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_WannaTalk_07_01"); //(obezřetně) A co po něm chceš?
	
	Info_ClearChoices (DIA_Addon_Finn_Attentat);
	Info_AddChoice (DIA_Addon_Finn_Attentat,"Do toho ti nic není!",DIA_Addon_Finn_Attentat_ForgetIt);
	Info_AddChoice (DIA_Addon_Finn_Attentat,"Mám pro něj jistou zajímavou informaci.",DIA_Addon_Finn_Attentat_HaveInfos);
	Info_AddChoice (DIA_Addon_Finn_Attentat,"Chci odkrouhnout Estebana a hledám někoho, kdo mi s tím pomůže!",DIA_Addon_Finn_Attentat_KillEsteban);
};	
		
func void DIA_Addon_Finn_Attentat_KillEsteban()
{
	AI_Output (other, self, "DIA_Addon_Finn_KillEsteban_15_00"); //Chci oddělat Estebana a hledám někoho, kdo mi v tom pomůže!
...
{
	AI_Output (other, self, "DIA_Addon_Finn_HaveInfos_15_00"); //Mám pro něj zajímavou informaci.
	...
	Info_AddChoice (DIA_Addon_Finn_Attentat,"To rozhodně ne!",DIA_Addon_Finn_Attentat_NoNo);
};

	func void DIA_Addon_Finn_Attentat_NoNo()
	{
		AI_Output (other, self, "DIA_Addon_Finn_NoNo_15_00"); //To teda ne!
		AI_Output (self, other, "DIA_Addon_Finn_NoNo_07_01"); //(odhadně) No dobře. Povím ti, co vím.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_ForgetIt_07_01"); //Takže? Já o tý věci stejně nic nevím.
...
INSTANCE DIA_Addon_Finn_Again  (C_INFO)
{
	...
	permanent   = TRUE;
	description	= "Ještě k tomu útoku...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Finn_Again_15_00"); //Ještě k tomu útoku.
	if (Finn_TellAll == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_Finn_Again_07_01"); //Už jsem ti řekl všechno, co vím.
		
		Info_ClearChoices (DIA_Addon_Finn_Again);
		Info_AddChoice (DIA_Addon_Finn_Again, "OK... (zpět)", DIA_Addon_Finn_Again_Exit);
		Info_AddChoice (DIA_Addon_Finn_Again, "Tak mi to řekni znova!", DIA_Addon_Finn_Again_Nochmal);		
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Finn_Again_07_02"); //Tak mě s tím už neotravuj.
		AI_StopProcessInfos(self);
	};
};
...
{
	AI_Output (other, self, "DIA_Addon_Finn_Again_Exit_15_00"); //(odhadně) Dobře.
	Info_ClearChoices (DIA_Addon_Finn_Again);
};

func void DIA_Addon_Finn_Again_Nochmal()
{
	AI_Output (other, self, "DIA_Addon_Finn_Again_Nochmal_15_00"); //Tak mi to řekni znovu!
