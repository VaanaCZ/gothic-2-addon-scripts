...
instance DIA_Engor_ABOUTPARLAF		(C_INFO)
{
	...
	description	 = 	"Ty máš na starosti pâídęly potravin, nemýlím-li se.";
};
...
instance DIA_Engor_RSkaufen		(C_INFO)
{
	...
	permanent 	 =  TRUE;
	description	 = 	"Koupit tęžkou zbroj domobrany (Ochrana: zbranę 60, šípy 60. Cena: 2500 zlatých)"; 
};
//--------------------------------------
...
{
	AI_Output (other, self, "DIA_Engor_HELP_15_00"); //Možná ti mohl s nęčím pomoci.
...
FUNC VOID DIA_Engor_HELP_YES()
{
	...
	AI_Output (self, other, "DIA_Engor_HELP_YES_13_01"); //Takové dva tucty poâádných kusů masa by mi pomohly nasytit nejménę sto hladových krků. Vraă se, až budeš mít maso. Teë se musím vrátit ke své práci.
	...
	B_LogEntry  (TOPIC_BringMeat,"Nezáleží na tom, půjde-li o klobásy, šunku, pečené či syrové maso. Jenom aby chlapi męli co zakousnout.");  
...
instance DIA_Engor_BRINGMEAT		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Tumáš, nęco jsem pro tebe sehnal. (pâedat maso)";
};
...
// ***** gebratenes Fleisch *****
	if (Npc_HasItems (hero,ItFoMutton) >= 1) 
	{
		...
		&& (Meat_Counter < Meat_Amount) 
		{
			...
			ConcatMutton = ConcatStrings (ConcatMutton, " Pâedat pečené maso");
