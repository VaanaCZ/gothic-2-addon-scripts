...
FUNC VOID DIA_Addon_Senyan_EXIT_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Senyan_EXIT_12_00");//Ty víš, co dęlat.
	};
...
{
	AI_Output (self, other, "DIA_Addon_Senyan_Attack_12_00");//(šklebí se) Tak na co tę tu teda eštę mám, ty flákači?
...
FUNC VOID B_Senyan_Erpressung()
{
	...
	AI_Output (self, other, "DIA_Addon_Senyan_Erpressung_12_01");//(pâedstírá ublížení) Ale ne, kdepak! Nechci z tebe mámit žádný zlato! To by mę v životę nenapadlo!
	AI_Output (other, self, "DIA_Addon_Senyan_Erpressung_15_02");//Tak co chceš?
	AI_Output (self, other, "DIA_Addon_Senyan_Erpressung_12_03");//Nedávno se nękdo pokusil odklidit Estebana, ale on utekl ke svý ochrance.
	...
	B_LogEntry (Topic_Addon_Senyan,"Senyan mę poznal - ví, kdo jsem. Chce to využít ku vlastnímu prospęchu - určitę má nęco za lubem. Chce, abych si napâed promluvil s Estebanem.");
};
//----------------------------------------------------------------------
//	Info Hi
//----------------------------------------------------------------------
...
FUNC VOID DIA_Addon_BDT_1084_Senyan_Hi_good()
{
	...
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_Hi_good_12_02");//No, vlastnę nevím proč, ale nadęlal sis tu pár pęknę mocnejch nepâátel.
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_Hi_good_12_03");//Máš kliku, že jsem tę poznal já a ne nękdo jinej.
...
FUNC VOID DIA_Addon_BDT_1084_Senyan_Hi_bad()
{
	if (Senyan_Msg == FALSE)
	{
		AI_Output (other, self, "DIA_Addon_BDT_1084_Senyan_Hi_bad_15_00");//Napâed mi povęz tu špatnou zprávu.
		Senyan_Msg = TRUE;
	}
	else
	{
	...
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_Hi_bad_12_02");//Havran tę hledá. Teda jeho stráže. Vlastnę tę hledaj všichni banditi.
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_Hi_bad_12_03");//A až tę najdou, zabijou tę.
	AI_Output (other, self, "DIA_Addon_BDT_1084_Senyan_Hi_bad_15_04");//To už zkusila spousta lidí.
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_Hi_bad_12_05");//Pak seš stejnę dobrej bojovník, jako jsi chytrej. Pâijít do tábora s takovýmhle brnęním je jako...
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_Hi_bad_12_06");//...jako když ovce vleze mezi vlky. Tvůj život visí na vlásku, seš v pękným maléru.
...
FUNC VOID DIA_Addon_Senyan_unterwegs_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Senyan_unterwegs_12_03");//No, tak bys to męl brzo udęlat.
};
//---------------------------------------------------------------------
//	Info Attentat
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Senyan_Attentat_Info()
{
	...
	AI_Output (other, self, "DIA_Addon_Senyan_Attentat_15_02");//Rozkázal mi, abych zjistil, kdo na nęj toho vraha poslal. Nevíš o tom nęco?
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_12_03");//O nic víc než ty. Taky se snažím vypátrat, kdo za tím vęzí. A teë se dostáváme k tomu nejzajímavęjšímu.
	AI_Output (other, self, "DIA_Addon_Senyan_Attentat_15_04");//Tak povídej.
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_12_05");//Chci, abys splnil svůj úkol a splnil ho dobâe. Chci, abys našel toho zrádce.
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_12_06");//(chladnę) A až ho najdeš, tak chci, abys ho za mę zabil.
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_12_07");//Dám ti za to odmęnu.
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_12_08");//A nezapomínej, že mám furt ten papír s tvým portrétem a zprávou, že tę hledaj. Tak se koukej snažit, jinak určitę víš, co se stane.
	...
	Info_AddChoice (DIA_Addon_Senyan_Attentat,"Zapomeŕ!",DIA_Addon_Senyan_Attentat_NO);
};
FUNC VOID DIA_Addon_Senyan_Attentat_NO()
{
	AI_Output (other, self, "DIA_Addon_Senyan_Attentat_NO_15_00");//Na to zapomeŕ!
...
FUNC VOID DIA_Addon_Senyan_Attentat_JA()
{
	...
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_JA_12_01");//Já vędęl, že se dohodnem.
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_JA_12_02");//(úsečnę) Až zjistíš, kdo to je, zabijem toho hajzla spolu. A teë zmiz!
	
	Senyan_Erpressung = LOG_RUNNING;
	Info_ClearChoices (DIA_Addon_Senyan_Attentat);
	
	B_LogEntry (Topic_Addon_Senyan,"Senyan chce, abych zjistil, kdo to má na svędomí, a zabil ho. Pokud se mi to podaâí, čeká na mę odmęna.");
};
