...
func void DIA_Addon_Merdarion_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Hallo_06_01"); //Tyhle hrobky jsou pro mę velkou záhadou. Jen tęžko si dokážu pâedstavit, že je dosud nikdo nenašel.
	AI_Output	(self, other, "DIA_Addon_Merdarion_Hallo_06_02"); //Vchod jsme objevili bez problémů.
	AI_Output	(self, other, "DIA_Addon_Merdarion_Hallo_06_03"); //Lidé męli vždycky tolik práce se starostmi všedních dní, že se na tuhle budovu nikdo nikdy blíže nepodíval.
	AI_Output	(self, other, "DIA_Addon_Merdarion_Hallo_06_04"); //Mám pro to jiné vysvętlení.
};
///////////////////////////////////////////////////////////////////////
//	Info Aufgabe
///////////////////////////////////////////////////////////////////////
...
func void DIA_Addon_Merdarion_Aufgabe_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Aufgabe_06_02"); //A krom toho pomáhám Nefariovi najít chybęjící ornament.
	AI_Output	(self, other, "DIA_Addon_Merdarion_Aufgabe_06_03"); //Je jisté, že tento portál vede do části ostrova, o které jsme dosud nemęli ani tušení.
	AI_Output	(self, other, "DIA_Addon_Merdarion_Aufgabe_06_04"); //(uvážlivę) Vůbec si nepamatuju, že bych o nęčem takovém kdy slyšel nebo četl.
	...
	{
		B_LogEntry (TOPIC_Addon_KDW,"Nefarius hledá nęjaký ztracený ornament."); 
	};	
};
///////////////////////////////////////////////////////////////////////
//	Info DaDurch
...
{
	AI_Output	(other, self, "DIA_Addon_Merdarion_DaDurch_15_00"); //Vážnę chcete projít portálem?
	AI_Output	(self, other, "DIA_Addon_Merdarion_DaDurch_06_01"); //Samozâejmę. Pokud tedy najdeme ten ztracený ornament.
	AI_Output	(self, other, "DIA_Addon_Merdarion_DaDurch_06_02"); //Ale pâiznám se, že je to celé trochu riskantní.
	AI_Output	(self, other, "DIA_Addon_Merdarion_DaDurch_06_03"); //Ale rozhodnę musíme zjistit, co působí ta neustálá zemętâesení.
};
///////////////////////////////////////////////////////////////////////
//	Info Bedrohung
///////////////////////////////////////////////////////////////////////
...
func void DIA_Addon_Merdarion_Bedrohung_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Bedrohung_06_01"); //Ty způsobuje nęco na druhé stranę.
...
func void DIA_Addon_Merdarion_Wasdahinter2_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Wasdahinter2_06_02"); //Na druhou stranu ale počítám, že tam budou podobné budovy jako tahle. A protęjšek k tomuto portálu.
...
{
	AI_Output	(other, self, "DIA_Addon_Merdarion_PERM_15_00"); //Můžeš mę naučit nęjakou magii?
...
instance DIA_Addon_Merdarion_Teleportstein		(C_INFO)
{
	...
	description	 = 	"Jak se nejrychleji dostanu do męsta?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Merdarion_Teleportstein_15_00"); //Jak se nejrychleji dostanu do męsta?
	AI_Output	(self, other, "DIA_Addon_Merdarion_Teleportstein_06_01"); //Doporučuju jít stejnou cestou, jakou jsi pâišel.
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Teleportstein_06_04"); //No, stavitelé tęchto síní męli vlastní metodu cestování.
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Teleportstein_06_08"); //Zdejší teleportační kámen by męl vést do pâístavního męsta.
...
func void DIA_Addon_Merdarion_Teleportstein_wo ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Merdarion_Teleportstein_wo_06_01"); //V místnosti s nádržkou jsou dveâe. Kámen je zamčený za nimi.
...
{
	AI_Output			(other, self, "DIA_Addon_Merdarion_Teleportstein_ich_15_00"); //A co když bych ho chtęl použít?
	AI_Output			(self, other, "DIA_Addon_Merdarion_Teleportstein_ich_06_01"); //Ani nápad. Víme o nęm pâíliš málo a je možné, že bys to nepâežil.
};
func void DIA_Addon_Merdarion_Teleportstein_key ()
{
	AI_Output			(other, self, "DIA_Addon_Merdarion_Teleportstein_key_15_00"); //Dej mi klíč, chtęl bych se na ten kámen podívat.
	AI_Output			(self, other, "DIA_Addon_Merdarion_Teleportstein_key_06_01"); //(nejistę) Opravdu? Ale já za to nenesu žádnou zodpovędnost.
	...
	B_LogEntry (TOPIC_Addon_TeleportsNW,"Merdarion mi dal klíč k zamčeným dveâím v hrobce u portálu. Za nimi jsem našel teleportační kámen, který mne pâenese zpátky do pâístavu."); 
...
func void DIA_Addon_Merdarion_WHereOtherTeleports_Info ()
{
	...
	B_LogEntry (TOPIC_Addon_TeleportsNW,"Další teleportační kámen by męl být nękde u hospody U Mrtvé harpyje."); 
};
...
func void DIA_Addon_Merdarion_TeleportsteinSuccess_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_TeleportsteinSuccess_06_01"); //Tys to opravdu udęlal? Použil jsi je?
	AI_Output	(other, self, "DIA_Addon_Merdarion_TeleportsteinSuccess_15_02"); //Ano, a zjevnę jsou stále funkční.
	AI_Output	(self, other, "DIA_Addon_Merdarion_TeleportsteinSuccess_06_03"); //(fascinovanę) To je neuvęâitelné. Budu to pak muset blíže prozkoumat.
};
