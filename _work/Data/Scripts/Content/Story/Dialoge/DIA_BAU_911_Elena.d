...
func void DIA_Elena_Regeln_Info ()
{
	...
	AI_Output (self, other, "DIA_Elena_Regeln_16_04"); //Pokud začneš hádku s farmáři, budou tady všichni proti tobě.
};
...
func void DIA_Elena_AUFGABE_Info ()
{
	...
	B_LogEntry (Topic_SoldierTrader,"Ellena prodává na Onarově statku různé zboží.");
};
...
func void DIA_Elena_PERM_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Elena_PERM_16_04"); //V zemi je teď nebezpečno. Skoro nikdo si netroufne ani za humna. Už je to pěkně dlouho, co se někdo od nás naposledy vypravil do města.
	}
	else if (kapitel == 4)
	{
		AI_Output			(self, other, "DIA_Elena_PERM_16_05"); //Žoldnéři byli čím dál tím víc nesví. Ale jakmile odtáhl Sylvio se svými kumpány, vypadají už trochu klidněji.
	}
	else //Kapitel 5
	{
...
func void DIA_Elena_MINENANTEIL_Info ()
{
	...
	AI_Output			(self, other, "DIA_Elena_MINENANTEIL_16_01"); //No a co? Sám jsem za ně zaplatil poslední drobné.
