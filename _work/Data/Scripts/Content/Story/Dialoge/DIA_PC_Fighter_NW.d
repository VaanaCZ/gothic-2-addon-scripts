...
{	
	...
	{
		AI_Output (self ,other,"DIA_GornNW_Add_12_03"); //Milten mê z toho dostal.
...
{	
	AI_Output (other,self ,"DIA_GornNW_Add_15_05"); //Co budeš dêlat teë?
	AI_Output (self ,other,"DIA_GornNW_Add_12_06"); //Myslím, že se ze všeho nejdâív poâádnê nadlábnu.
	AI_Output (other,self ,"DIA_GornNW_Add_15_07"); //A pak?
	AI_Output (self ,other,"DIA_GornNW_Add_12_08"); //Kdo ví... Možná se vrátím do têžaâské kolonie.
	AI_Output (self ,other,"DIA_GornNW_Add_12_09"); //Nêkdo by mêl dávat pozor na skâety - jinak se objeví u našeho prahu bez jediného varování.
};
