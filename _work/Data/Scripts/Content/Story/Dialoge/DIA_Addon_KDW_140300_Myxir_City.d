...
instance DIA_Addon_Myxir_CITY_HelloCITY		(C_INFO)
{
	...
	description	 = 	"Zùstaneš teï ve mìstì?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_00"); //Zùstaneš teï ve mìstì?
	AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_01"); //Pokud Vatras odejde z mìsta, musí tu zùstat jeden z nás.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_02"); //Ještì jedna vìc.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_03"); //To bylo vážnì hrdinské, jak sis vedl v Jharkendaru.
		AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_04"); //Bohužel jsem ale ještì neskonèil se vším, co mám udìlat tady v Khorinidu.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_05"); //Pravda, ale ty to všechno urèitì taky zvládneš, Ochránèe.
