...
instance DIA_Addon_Myxir_CITY_HelloCITY		(C_INFO)
{
	...
	description	 = 	"Allez-vous rester dans la ville ?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_00"); //Allez-vous rester dans la ville ?
	AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_01"); //L'un de nous doit rester ici, si Vatras doit quitter la ville.
