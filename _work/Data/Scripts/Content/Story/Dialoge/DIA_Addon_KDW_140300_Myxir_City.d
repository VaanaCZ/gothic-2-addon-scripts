...
instance DIA_Addon_Myxir_CITY_HelloCITY		(C_INFO)
{
	...
	description	 = 	"Zůstaneš teë ve męstę?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_00"); //Zůstaneš teë ve męstę?
	AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_01"); //Pokud Vatras odejde z męsta, musí tu zůstat jeden z nás.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_02"); //Ještę jedna vęc.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_03"); //To bylo vážnę hrdinské, jak sis vedl v Jharkendaru.
		AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_04"); //Bohužel jsem ale ještę neskončil se vším, co mám udęlat tady v Khorinidu.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_05"); //Pravda, ale ty to všechno určitę taky zvládneš, Ochránče.
