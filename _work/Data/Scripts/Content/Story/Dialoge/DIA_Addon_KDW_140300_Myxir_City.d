...
instance DIA_Addon_Myxir_CITY_HelloCITY		(C_INFO)
{
	...
	description	 = 	"Tu resterai in città?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_00"); //Tu resterai in città?
	...
	{
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_02"); //Ah, un'altra cosa.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_03"); //Hai compiuto un'impresa davvero eroica a Jharkendar.
		AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_04"); //Purtroppo non ho ancora assolto a tutti i miei impegni qui a Khorinis.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_05"); //Ma sono sicuro che li porterai a termine con altrettanto successo.
		AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_06"); //Vedremo.
