...
instance DIA_Addon_Myxir_CITY_HelloCITY		(C_INFO)
{
	...
	description	 = 	"Zůstaneš teď ve městě?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_00"); //Zůstaneš teď ve městě?
	AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_01"); //Pokud Vatras odejde z města, musí tu zůstat jeden z nás.
	...
	&& (DIA_Addon_Myxir_CITY_HelloCITY_OneTime == FALSE)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_03"); //To bylo vážně hrdinské, jak sis vedl v Jharkendaru.
		AI_Output	(other, self, "DIA_Addon_Myxir_CITY_HelloCITY_15_04"); //Bohužel jsem ale ještě neskončil se vším, co mám udělat tady v Khorinidu.
		AI_Output	(self, other, "DIA_Addon_Myxir_CITY_HelloCITY_12_05"); //Pravda, ale ty to všechno určitě taky zvládneš, Ochránče.
