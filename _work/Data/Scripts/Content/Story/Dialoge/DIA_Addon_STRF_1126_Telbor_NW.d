...
FUNC VOID DIA_Addon_Telbor_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_01");//Mój wybawca, niech mnie kule biją! Tak, wracam zmagać się z codziennym trudem.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_02");//I z tymi dwoma kopniętymi braćmi. Nawet bandyci nie byli tak denerwujący.
	};
};
