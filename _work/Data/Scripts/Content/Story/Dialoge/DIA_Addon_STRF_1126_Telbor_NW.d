...
FUNC VOID DIA_Addon_Telbor_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_01");//A hele, to je ten, co mi zachránil život! Jo, teď musím dřít trochu víc.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_02");//Zvlášť s těmahle dvěma trhlejma bráchama. Čoveče, ti banditi nebyli zas TAK špatný!
	};
};
