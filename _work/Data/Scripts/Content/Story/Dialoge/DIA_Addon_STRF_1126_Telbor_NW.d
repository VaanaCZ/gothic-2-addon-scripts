...
FUNC VOID DIA_Addon_Telbor_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_01");//A hele, to je ten, co mi zachr·nil ûivot! Jo, teÔ musÌm d¯Ìt trochu vÌc.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_02");//Zvl·öù s tÏmahle dvÏma trhlejma br·chama. »oveËe, ti banditi nebyli zas TAK öpatn˝!
	};
};
