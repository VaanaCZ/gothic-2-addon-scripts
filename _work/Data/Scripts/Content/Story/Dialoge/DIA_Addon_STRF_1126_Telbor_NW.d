...
{
	AI_Output (other, self, "DIA_Addon_Telbor_NW_Hi_15_00");//Tak už zase pracuješ na polích?
	AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_01");//A hele, to je ten, co mi zachránil život! Jo, teë musím dâít trochu víc.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Telbor_NW_Hi_12_02");//Zvlášã s têmahle dvêma trhlejma bráchama. Èoveèe, ti banditi nebyli zas TAK špatný!
	};
};
