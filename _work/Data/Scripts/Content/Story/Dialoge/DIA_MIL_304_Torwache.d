...
func void DIA_Mil_304_Torwache_WASMACHSTDU_Info ()
{
	...
	|| (hero.guild == GIL_KDF)
	{
		AI_Output			(self, other, "DIA_Mil_304_Torwache_WASMACHSTDU_08_01"); //Nemohu si stêžovat. Konám svou povinnost, jak ode mne Innos oèekává.
	}
	else
	{
		AI_Output			(self, other, "DIA_Mil_304_Torwache_WASMACHSTDU_08_02"); //Hele, s tím svým èíslem 'tak jak to vypadá' se tady aplauzu nedoèkáš. Bêž mi z oèí, jasný?
	};
