...
func void DIA_Parlaf_HALLO_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Parlaf_HALLO_03_02"); //A vèera nám Engor ještê k tomu zase zmenšil pâídêl jídla. Když to takhle pùjde dál, za chvíli pomâeme hlady.
...
func void DIA_Parlaf_ENGOR_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_ENGOR_03_01"); //Engor se stará o zásobování a rozdêluje potraviny - pâídêly jsou ale každý týden menší a menší.
	AI_Output (self, other, "DIA_Parlaf_ENGOR_03_02"); //No jasnê, mùžeš s ním smlouvat, ale potâebuješ k tomu tvrdou zlatou mênu.
	AI_Output (other, self, "DIA_Parlaf_ENGOR_15_03"); //A ty to nemùžeš zatáhnout?
	AI_Output (self, other, "DIA_Parlaf_ENGOR_03_04"); //Za svùj mizerný žold si mùžu koupit leda tak pár pitomých tuâínù!
...
func void DIA_Parlaf_Wo_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_Wo_03_01"); //V rytíâském sídle. Staèí projít otevâeným prùchodem u kovárny.
};
///////////////////////////////////////////////////////////////////////
//	Info HUNGRIG
///////////////////////////////////////////////////////////////////////
...
func void DIA_Parlaf_HUNGRIG_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlaf_HUNGRIG_03_01"); //Ten zatracený Engor by mêl vydávat víc jídla!
};
///////////////////////////////////////////////////////////////////////
//	Info SATT
///////////////////////////////////////////////////////////////////////
...
func void DIA_Parlaf_SATT_Info ()
{
	...
	&& ((Npc_IsDead(Engor))== FALSE)
	{
		AI_Output (self, other, "DIA_Parlaf_SATT_03_01"); //Engor vydal nové pâídêly masa. Už bylo naèase.
		DIA_Parlaf_SATT_OneTime = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Parlaf_SATT_03_02"); //Tvùj pâíjezd je jedinou novinkou, která je opravdu nová.
	};
};
