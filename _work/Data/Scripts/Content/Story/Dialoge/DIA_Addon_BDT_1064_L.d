...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Do tábora se živej dostaneš pouze jednou cestou, a to je pâes most.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Chceš, aby se rozmáznul vo tebe? Stačí JEDINEJ krok a shodím tę dolů z útesu!
...
func void DIA_Bdt_1064_BanditGuard_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_02"); //Jestli to tak chceš...
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Nežvaŕ nesmysly!
	AI_StopProcessInfos(self);
};
