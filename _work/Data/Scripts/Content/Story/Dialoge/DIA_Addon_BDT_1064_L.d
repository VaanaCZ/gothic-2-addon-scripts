...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Il n'y qu'un moyen d'accéder au camp en un morceau, et c'est en franchissant le pont.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Vous avez besoin que je vous fasse un dessin ? Faites un pas de plus et je vous balance au pied de la falaise !
...
func void DIA_Bdt_1064_BanditGuard_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_02"); //Si c'est ce que vous voulez...
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Ne me bassinez pas !
	AI_StopProcessInfos(self);
};
