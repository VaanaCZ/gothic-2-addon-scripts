...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Jest tylko JEDEN sposób, żebyś dostał się do obozu ŻYWY - przez most.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Chcesz oberwać, co? Zrób jeszcze JEDEN krok, a zrzucę cię z urwiska.
...
func void DIA_Bdt_1064_BanditGuard_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_02"); //Dobra, sam się o to prosiłeś...
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Nie drażnij mnie!
	AI_StopProcessInfos(self);
};
