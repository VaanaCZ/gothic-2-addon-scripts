...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Hai solo un modo per entrare vivo nel nostro campo: devi passare sul ponte.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Te lo devo ripetere ancora? Fai UN solo passo avanti e ti scaravento di sotto!
...
func void DIA_Bdt_1064_BanditGuard_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_02"); //Se è questo che vuoi
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Niente stupidaggini con me!
	AI_StopProcessInfos(self);
};
