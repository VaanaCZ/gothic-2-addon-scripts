...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Do tábora se živej dostaneš pouze jednou cestou, a to je pøes most.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Chceš, aby se rozmáznul vo tebe? Staèí JEDINEJ krok a shodím tì dolù z útesu!
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Nežvaò nesmysly!
	AI_StopProcessInfos(self);
};
