...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_00"); //Do tábora se živej dostaneš pouze jednou cestou, a to je přes most.
...
{
	AI_Output (self, other,"DIA_Addon_Dexwache_Add_04_01");  //Chceš, aby se rozmáznul vo tebe? Stačí JEDINEJ krok a shodím tě dolů z útesu!
...
{
	AI_Output (self, other, "DIA_Addon_Dexwache_Add_04_03"); //Nežvaň nesmysly!
	AI_StopProcessInfos(self);
};
