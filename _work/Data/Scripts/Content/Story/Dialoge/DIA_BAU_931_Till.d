...
func void DIA_Till_BRONKO_Info ()
{
	...
	if (Npc_IsDead(Sekob)== FALSE)
	{
		AI_Output			(self, other, "DIA_Till_BRONKO_03_05"); //Mùj otec je na mì pìknì naštvanej, že jsem ho ještì nedokázal pøinutit, aby se vrátil do práce.
	};
};
	...
	if (Till_IchMachsNurEinmal == TRUE)
	 ...
	 if (Till_Angebot == 10)
		...
		{	
			...
			Info_ClearChoices	(DIA_Till_BRONKOZURARBEIT);
			Info_AddChoice	(DIA_Till_BRONKOZURARBEIT, "Dobrá. Uvidím, co se dá dìlat.", DIA_Till_BRONKOZURARBEIT_mehr );
			Info_AddChoice	(DIA_Till_BRONKOZURARBEIT, "Dobrá. Uvidím, co se dá dìlat.", DIA_Till_BRONKOZURARBEIT_ok );
			Till_Angebot = 50;
		}
