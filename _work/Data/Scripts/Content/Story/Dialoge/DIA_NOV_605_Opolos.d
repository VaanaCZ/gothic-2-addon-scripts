...
FUNC VOID DIA_Opolos_rezept_Info()
{
	if (Npc_HasItems (other, ItWr_Manarezept) >= 1)
	{
		...
		B_UseFakeScroll ();
		AI_Output (self ,other,"DIA_Opolos_rezept_12_03"); //A je to. Pokud chceš, můžu tě něco naučit.
...
instance DIA_Opolos_LIESEL		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"Podívej, přivedl jsem ti Betsy.";
};
...
FUNC VOID DIA_Opolos_Kap3_PERM_DMT()
{
	...
	AI_Output (other,self ,"DIA_Opolos_Kap3_PERM_DMT_15_03"); //Vypadá to na nějaké mágy. Nebo aspoň na někoho, kdo umí kouzlit.
