...
func void DIA_Hodges_HALLO_Info ()
{
	...
	AI_Output (self, other, "DIA_Hodges_HALLO_03_01"); //Neber si to nijak zle, ale není mi do řeči - jsem úplně hotovej.
	AI_Output (other, self, "DIA_Hodges_HALLO_15_02"); //Máš práce nad hlavu, co?
	AI_Output (self, other, "DIA_Hodges_HALLO_03_03"); //Tak to máš pravdu. Bennet dělá tolik zbraní, že je ani nestačím leštit.
};
...
instance DIA_Hodges_TellAboutFarm	(C_INFO)
{
	...
	permanent 	 = 	FALSE;
	description	 = 	"Co mi můžeš říct o farmě?";
};
...
{	
	AI_Output (other,self ,"DIA_Hodges_TellAboutFarm_15_00"); //Co mi můžeš říct o farmě?
	...
	AI_Output (self ,other,"DIA_Hodges_TellAboutFarm_03_04"); //(překotně) Ale já jsem spokojený, je dobrý mít lidi na hlídání farmy.
	...
	{
		AI_Output (self ,other,"DIA_Hodges_TellAboutFarm_03_06"); //Kuchyň je v té budově, co má zepředu kovárnu.
	};
...
{	
	AI_Output (other,self ,"DIA_Hodges_AboutSld_15_00"); //A co ti žoldnéři?
	AI_Output (self ,other,"DIA_Hodges_AboutSld_03_01"); //Onar je najal, aby drželi domobranu zpátky.
	AI_Output (self ,other,"DIA_Hodges_AboutSld_03_02"); //Ale také hlídají farmu, ovce a farmáře.
	...
	AI_Output (self ,other,"DIA_Hodges_AboutSld_03_04"); //Jen čekají na příležitost, jak tě vyřídit.
};
...
{	
	...
	AI_Output (self ,other,"DIA_Hodges_WhatHappened_03_01"); //No, byli jsme ve městě nakupovat, když všichni najednou začali křičet. A někdo zařval: Támhle jsou, chyťte je!
	AI_Output (self ,other,"DIA_Hodges_WhatHappened_03_02"); //Chlape, jak já byl vyděšenej! Vzal jsem nohy na ramena a utíkal, jako by mi v patách byl ďábel sám.
	AI_Output (self ,other,"DIA_Hodges_WhatHappened_03_03"); //Bennet byl hned za mnou. Nevím, co se stalo, ale když jsem se dostal z města, už jsem ho nikde neviděl.
	AI_Output (self ,other,"DIA_Hodges_WhatHappened_03_04"); //Musel se mi ztratit někde ve městě.
};
...
instance DIA_Hodges_BennetsCrime			(C_INFO)
{
	...
	permanent 	 = 	FALSE;
	description	 = 	"Tak proč Benneta zavřeli?";
};
...
{	
	AI_Output (other,self ,"DIA_Hodges_BennetsCrime_15_00"); //Tak proč Benneta zavřeli?
	AI_Output (self ,other,"DIA_Hodges_BennetsCrime_03_01"); //Za vraždu! Bennet byl obviněn z vraždy paladina. Takovej nesmysl. Byl jsem celou dobu s ním.
	AI_Output (other,self ,"DIA_Hodges_BennetsCrime_15_02"); //Tak proč nezajdeš do města a celou tu věc nevysvětlíš?
	AI_Output (self ,other,"DIA_Hodges_BennetsCrime_03_03"); //Šoupnou mě do basy jako komplice. Ne, za týhle situace tam rozhodně nepůjdu.
	AI_Output (other,self ,"DIA_Hodges_BennetsCrime_15_04"); //Jaký situace?
	AI_Output (self ,other,"DIA_Hodges_BennetsCrime_03_05"); //Vždyť víš, Onar a město. To by dopadlo špatně.

	B_LogEntry (TOPIC_RESCUEBENNET,"Bennet prý zavraždil paladina. Jeho učedník Hodges ale tvrdí, že je nevinný. Ovšem nedovolil si vstoupit do města."); 
};
...
instance DIA_Hodges_BennetAndSLD			(C_INFO)
{
	...
	permanent 	 = 	FALSE;
	description	 = 	"Co na to žoldnéři tady na farmě?";
};
...
{	
	AI_Output (other,self ,"DIA_Hodges_BennetAndSLD_15_00"); //Co na to žoldnéři tady na farmě?
	AI_Output (self ,other,"DIA_Hodges_BennetAndSLD_03_01"); //Nevím, co maj za lubem, ale některý z nich jsou fakt vytočený.
	AI_Output (other,self ,"DIA_Hodges_BennetAndSLD_15_02"); //To je pochopitelné.
	AI_Output (self ,other,"DIA_Hodges_BennetAndSLD_03_03"); //Kdyby to bylo jen na nich, nejradši by hned vpadli do města a dostali Benneta ven.
	AI_Output (self ,other,"DIA_Hodges_BennetAndSLD_03_04"); //Promluv si s Leem, třeba ti něco najde.
};
//##################################################
//##
//##	Kapitel 4
