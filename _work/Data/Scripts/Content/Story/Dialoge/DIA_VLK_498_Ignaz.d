...
FUNC VOID DIA_Ignaz_Experiment_Info()
{
	...
	AI_Output (self, other, "DIA_Ignaz_Experiment_14_02");//Už se mi podaøilo zjistit, že to funguje, pokud je dotyèná osoba naštvaná - napøíklad pokud jí nìkdo právì dal nakládaèku, nebo ji oloupil.
...
FUNC VOID DIA_Ignaz_teilnehmen_Info()
{
	...
	B_LogEntry (TOPIC_Ignaz,"Tohle je ideální pøíležitost vyzkoušet to kouzlo - pod jeho pùsobením také zapomene ohlásit mimoøádnou událost. Nemyslím si, že by menší rvaèka v pøístavu vzbudila velký rozruch.");
...
FUNC VOID DIA_Ignaz_Danach_Info()
{
	...
	B_LogEntry (Topic_CityTeacher,"Ignaz mi ukáže nìkteré recepty na míchání lektvarù. Žije v pøístavní ètvrti.");
