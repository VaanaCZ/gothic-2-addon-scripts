...
FUNC VOID DIA_Ignaz_Experiment_Info()
{
	...
	AI_Output (self, other, "DIA_Ignaz_Experiment_14_02");//Už se mi podaâilo zjistit, že to funguje, pokud je dotyčná osoba naštvaná - napâíklad pokud jí nękdo právę dal nakládačku, nebo ji oloupil.
...
FUNC VOID DIA_Ignaz_teilnehmen_Info()
{
	...
	B_LogEntry (TOPIC_Ignaz,"Tohle je ideální pâíležitost vyzkoušet to kouzlo - pod jeho působením také zapomene ohlásit mimoâádnou událost. Nemyslím si, že by menší rvačka v pâístavu vzbudila velký rozruch.");
...
FUNC VOID DIA_Ignaz_Teach_Info()
{
	...
	if (talente > 0)
	{
		...
		{
			AI_Output (self, other,"DIA_Ignaz_Teach_14_01"); //K pâípravę lektvaru s pomocí alchymistické kolony potâebuješ laboratorní baŕku.
