...
{
	AI_Output (self, other, "DIA_Halvor_Night_06_00"); //Hej, jestli máš zájem o mé ryby, pøijï k mému stánku zítra, dobrá?
};
...
instance DIA_Addon_Halvor_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Nevíš nìco o tìch pohøešovaných lidech?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Halvor_MissingPeople_15_00"); //Mùžeš mi øíct nìco o tìch zmizelých lidech?
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_01"); //O zmizelých lidech? Tady jsi v pøístavu, kámo. Takový vìci se tu stávají.
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_02"); //Moøe je zrádný a to prostì sem tam nìkoho stojí i život.
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_03"); //Kapitáni velkých lodí si v pøístavech, jako je Khorinis, vždycky doplòují posádku.
	AI_Output	(self, other, "DIA_Addon_Halvor_MissingPeople_06_04"); //A když nenajdou žádné dobrovolníky, prostì nìkoho na loï odvleèou i proti jeho vùli. A takoví lidi se pak pohøešujou.
	...
	Info_AddChoice	(DIA_Addon_Halvor_MissingPeople, "Jaká loï?", DIA_Addon_Halvor_MissingPeople_schiff );
	Info_AddChoice	(DIA_Addon_Halvor_MissingPeople, "Nevíš o nìkom, kdo se pohøešuje?", DIA_Addon_Halvor_MissingPeople_wer );
	Info_AddChoice	(DIA_Addon_Halvor_MissingPeople, "A ty sám také nìkoho postrádáš?", DIA_Addon_Halvor_MissingPeople_you );
};
...
{
	AI_Output			(other, self, "DIA_Addon_Halvor_MissingPeople_wer_15_00"); //Víš o nìkom, kdo se pohøešuje?
	AI_Output			(self, other, "DIA_Addon_Halvor_MissingPeople_wer_06_01"); //Nemám páru. Na to se zeptej spíš loïaøù.

	Log_CreateTopic (TOPIC_Addon_WhoStolePeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_WhoStolePeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_WhoStolePeople,"Prodavaè ryb Halvor mi pouze poradil, že bych se mìl poptat u loïaøù."); 
};
func void DIA_Addon_Halvor_MissingPeople_schiff ()
{
	AI_Output			(other, self, "DIA_Addon_Halvor_MissingPeople_schiff_15_00"); //Jaká loï by to mohla být?
	AI_Output			(self, other, "DIA_Addon_Halvor_MissingPeople_schiff_06_01"); //To je dobrá otázka. Poslední dobou do Khorinidu moc lodí nepøiplouvá, to je fakt.
};
...
FUNC VOID DIA_Halvor_MESSAGE_OFFER()
{
	...
	Info_ClearChoices (DIA_Halvor_MESSAGE);
	Info_AddChoice    (DIA_Halvor_MESSAGE,"No dobøe, souhlasím.",DIA_Halvor_MESSAGE_Okay);
	Info_AddChoice    (DIA_Halvor_MESSAGE,"Vypadá to, že patøíš do basy.",DIA_Halvor_MESSAGE_PRISON);
...
INSTANCE DIA_Halvor_Hehlerei   (C_INFO)
{
	...
	permanent   = TRUE;
	description = "(Prodat staré talíøe a kalichy.)";
};
...
FUNC VOID DIA_Halvor_Hehlerei_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Halvor_Zeichen_06_04");//Lituju, dneska už žádné obchody. Vra se zítra, dobrá?
	};
