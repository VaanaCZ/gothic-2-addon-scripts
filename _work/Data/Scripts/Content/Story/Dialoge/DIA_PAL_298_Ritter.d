...
func void DIA_PAL_298_Pass_Info ()
{
	...
	AI_Output (self, other, "DIA_PAL_298_Pass_09_02");//My jsme na téhle straně - na té druhé se zakopalo několik skřetů.
...
{
	AI_Output (self, other, "DIA_PAL_298_TRESPASS_09_00");//Vážně tam chceš jít? Obávám se, že se moc daleko nedostaneš - na druhé straně jsou skřeti.
	AI_Output (other, self, "DIA_PAL_298_TRESPASS_15_01");//Pokud do Hornického údolí vede nějaká cesta, tak ji najdu.
	AI_Output (self, other, "DIA_PAL_298_TRESPASS_09_02");//Dobrá, v tom případě běž. Nechť tě Innos doprovází.
};
///////////////////////////////////////////////////////////////////////
//	Info Perm 
///////////////////////////////////////////////////////////////////////
instance DIA_PAL_298_Perm1		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"A co když to přece jenom risknu?";
};
...
{
	AI_Output (other, self, "DIA_PAL_298_Perm1_15_00");//A co když to přece jenom risknu?
	AI_Output (self, other, "DIA_PAL_298_Perm1_09_01");//Pak zemřeš. Proto tady jsme. Abychom tě uchránili před tak hloupými nápady.
};
///////////////////////////////////////////////////////////////////////
//	Info Perm 
///////////////////////////////////////////////////////////////////////
...
func void DIA_PAL_298_Perm2_Info ()
{
	...
	AI_Output (self, other, "DIA_PAL_298_Perm2_09_01");//Všechno v pořádku. Máme situaci pod kontrolou.
};
