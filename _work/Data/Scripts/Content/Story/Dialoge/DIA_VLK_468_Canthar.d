...
{	
	...
	if (Canthar_GotME == TRUE)
	{
		...
		if (Npc_HasEquippedArmor(other) == FALSE)
		{	
			AI_Output (self, other,"DIA_Canthar_WhatOffer_09_05"); //S tímhle kouskem papíru v kapse můžeš vypadat tak otrhanę, jak se ti zachce, a stráže tę nechají na pokoji.
		};
	...
	B_LogEntry (Topic_CityTrader,"Canthar obchoduje se všemožnými zbranęmi."); 
};
...
func void DIA_Canthar_WhatOffer_Ok()
{
	...
	B_LogEntry (TOPIC_City,"Od obchodníka Canthara jsem dostal propustku, díky níž se dostanu męsta. Dlužím mu za to protislužbu.");
...
func void DIA_Canthar_Success_Info ()
{
	...
	if (Canthar_Gefallen == FALSE)
	{
		AI_Output (other, self, "DIA_Canthar_Success_15_02"); //Slíbils mi zbraŕ.
...
FUNC VOID DIA_Canthar_Pay_Ja()
{
	...
	AI_Output (self, other, "DIA_Canthar_Pay_Ja_09_01"); //(smęje se) Výbornę. Tak to bych se męl postarat o to, aby tvá reputace mezi obchodníky zase stoupla.
