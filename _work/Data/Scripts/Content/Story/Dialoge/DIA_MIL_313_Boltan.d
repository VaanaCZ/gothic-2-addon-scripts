...
func void DIA_Boltan_ToConvicts_Info ()
{
	...
	&& (MIS_RescueBennet != LOG_SUCCESS)
	{
		...
		{
			AI_Output (self ,other, "DIA_Boltan_Add_05_07"); //Jasan, jen bêž a rozluè se se svým kamarádíèkem.
		}
		else
		{
	...
	else
	{
		...
		{
			AI_Output (self ,other, "DIA_Boltan_Add_05_03"); //Jen bêž, ale nebuë tam dlouho, rozumíš?
		};
	};
};		
...
{
	AI_Output (self ,other, "DIA_Boltan_Add_05_08"); //Nepâišel jsi odsud vysekat toho svého pâítelíèka, že ne?
	AI_Output (self ,other, "DIA_Boltan_Add_05_09"); //Tak na to zapomeà! Jakmile spustím poplach, okamžitê tady budou ostatní hoši!
	AI_Output (self ,other, "DIA_Boltan_Add_05_10"); //A pak si dáme pár žoldanátkù! (ošklivê se zasmêje)
};		
...
func void DIA_Boltan_HalloCanthar_Info ()
{
	...
	AI_Output (self ,other, "DIA_Boltan_Add_05_12"); //Pâišla se za nêj pâimluvit spousta lidí. Docela významných lidí.
	AI_Output (self ,other, "DIA_Boltan_Add_05_13"); //Celá ta vêc musela být jedno velké nedorozumêní. To se stává.
