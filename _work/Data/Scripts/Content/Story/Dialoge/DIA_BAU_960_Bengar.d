...
instance DIA_Addon_Bengar_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Neudálo se tu poslední dobou nęco divného?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Bengar_MissingPeople_15_00"); //Nesebęhlo se tu v poslední dobę nęco divného?
	AI_Output	(self, other, "DIA_Addon_Bengar_MissingPeople_10_01"); //Poslední dobou se tu dęjí divné vęci.
	AI_Output	(self, other, "DIA_Addon_Bengar_MissingPeople_10_02"); //Ale nic není divnęjšího než to záhadné zmizení Parda.
	AI_Output	(self, other, "DIA_Addon_Bengar_MissingPeople_10_03"); //Býval jedním z dęlníků na poli a rozhodnę nepatâil k tęm, co by najednou se vším praštili, sebrali se a takhle utekli.
	...
	Info_AddChoice	(DIA_Addon_Bengar_MissingPeople, "Napadá tę, proč zmizel?", DIA_Addon_Bengar_MissingPeople_Hint );
	Info_AddChoice	(DIA_Addon_Bengar_MissingPeople, "Možná už męl prostę všeho dost.", DIA_Addon_Bengar_MissingPeople_voll );
...
{
	AI_Output			(other, self, "DIA_Addon_Bengar_MissingPeople_was_15_00"); //Co pâesnę je na tom jeho zmizení divného?
	...
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_was_10_02"); //Zdrhnul by, i kdyby nękde zahlídnul žravou štęnici.
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_was_10_03"); //Na tu sice není pękný pohled, ale rozhodnę se nedá âíct, že by šlo o nebezpečnou potvoru.
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_was_10_04"); //(znechucenę) A to se prý najdou lidi, kteâí je jedí. Fuj tajbl.
...
{
	AI_Output			(other, self, "DIA_Addon_Bengar_MissingPeople_voll_15_00"); //Možná už toho męl prostę plné zuby.
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_voll_10_01"); //On prací na polích žil. Nedokážu si pâedstavit, že by utekl makat na jiný statek.
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_voll_10_02"); //U mę si mohl dęlat, co chtęl.
	
};
func void DIA_Addon_Bengar_MissingPeople_Hint ()
{
	AI_Output			(other, self, "DIA_Addon_Bengar_MissingPeople_Hint_15_00"); //Máš nęjaké stopy?
	...
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_Hint_10_02"); //Jednou jsem vidęl, jak do svého tábora táhli nękoho z męsta.
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_Hint_10_03"); //Vypadalo to, že z nęj chtęjí udęlat otroka.
...
func void DIA_Addon_Bengar_MissingPeople_Lager ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_Lager_10_02"); //Moc rád bych si tam pro Parda zašel, ale já proti tęm chlapům nemám žádnou šanci.
	AI_Output			(self, other, "DIA_Addon_Bengar_MissingPeople_Lager_10_03"); //A ty by ses jim męl taky na sto honů vyhnout. Nemají zrovna smysl pro humor.
...
func void DIA_Addon_Bengar_ReturnPardos_Info ()
{
	...
	AI_Output	(other, self, "DIA_Addon_Bengar_ReturnPardos_15_02"); //To nestojí za âeč.
	AI_Output	(self, other, "DIA_Addon_Bengar_ReturnPardos_10_03"); //Počkej, chci se ti odmęnit, ale nemám...
...
instance DIA_Addon_Bengar_FernandosWeapons		(C_INFO)
{
	...
	description	 = 	"Když tudy ti bandité procházeli, męli u sebe zbranę?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Bengar_FernandosWeapons_15_00"); //Když tudy ti bandité procházeli, nemęli u sebe nęjaké zbranę?
	...
	AI_Output	(self, other, "DIA_Addon_Bengar_FernandosWeapons_10_03"); //Chápu. Jo, když o tom mluvíš, tak toho vážnę nesli hromady.
	AI_Output	(self, other, "DIA_Addon_Bengar_FernandosWeapons_10_04"); //Nęco v sudech, nęco ve vacích a nęco i na vozech, které s sebou męli.
	 B_GivePlayerXP (XP_Ambient);
};
...
func void DIA_Bengar_REBELLIEREN_Info ()
{
	...
	AI_Output (self, other, "DIA_Bengar_REBELLIEREN_10_03"); //Ale já nemám na výbęr. Domobrana si sem chodí jen proto, aby si odnesla naše zboží, ale chránit nás ji ani nenapadne.
...
func void DIA_Bengar_MILIZ_Info ()
{
	...
	if (other.guild == GIL_NONE)
	{
		...
		AI_Output (self, other, "DIA_Bengar_MILIZ_10_03"); //Výbornę. Umíš si pâedstavit, co se mnou domobrana udęlá, když to zpackáš?
	}
	else //SLD oder DJG
	{
...
instance DIA_Bengar_Selber (C_INFO)
{
	...
	permanent 	= FALSE;
	description	= "A proč se tedy té domobranę nepostavíš sám?";
};
...
func void DIA_Bengar_MILIZWEG_Info ()
{
	...
	&& (Npc_IsDead (Rumbold) == FALSE)
	{
		...
		AI_Output (self, other, "DIA_Bengar_MILIZWEG_10_02"); //Poâád tu okounęjí. Âekni jim, aă odtáhnou ÚPLNĘ!
	}
	else
	{
...
func void DIA_Bengar_BALTHASAR_Info ()
{
	...
	AI_Output			(self, other, "DIA_Bengar_BALTHASAR_10_01"); //No, ano. To je takhle: Âekl jsem Sekobovi, že by mi męl platit, když chce své ovce pást na mých pozemcích.
	AI_Output			(self, other, "DIA_Bengar_BALTHASAR_10_02"); //Ale pravda je, že jsem to âekl jen proto, aby už sem nechodil. Nemůžu Balthazara vystát.
...
func void DIA_Bengar_ALLEIN_Info ()
{
	...
	AI_Output			(self, other, "DIA_Bengar_ALLEIN_10_06"); //Jeden z nich se chystal, že pro mę bude pracovat. Asi zmęnil názor. Mám dojem, že se jmenoval "Vlk".
	...
	B_LogEntry (TOPIC_BengarALLEIN,"Jeho statek je teë úplnę nechránęný a potâebuje pomoc. Zmiŕoval se o nęjakém žoldnéâi jménem Vlk. Copak já toho chlápka neznám?"); 
};
...
func void DIA_Bengar_PERM_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Bengar_PERM_10_03"); //Vlk je divnej chlap, ale myslím, že to nęjak zvládneme.
	}
	else
	{
	...
	&& (MIS_BengarsHelpingSLD == LOG_SUCCESS)
	{
	B_StartOtherRoutine	(SLD_815_Soeldner,"Začít");
	B_StartOtherRoutine	(SLD_817_Soeldner,"Začít");
	};
};
