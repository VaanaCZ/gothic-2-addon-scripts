...
{
	AI_Output (self, other,"DIA_Joe_Hallo_10_00");//Hej, dzięki, człowieku! Naprawdę wielkie dzięki. Już myślałem, że nigdy się stąd nie wydostanę...
	TOPIC_END_Joe = TRUE;
	B_GivePlayerXP ((XP_Ambient*4));
	
	AI_Output (other, self,"DIA_Joe_Hallo_15_01");//Co ty TUTAJ robisz?
	AI_Output (self, other,"DIA_Joe_Hallo_10_02");//Dałem się zamknąć. Drzwi były otwarte i chciałem się jedynie trochę rozejrzeć, ale kiedy tylko wszedłem do środka, pojawiła się straż i zamknęła te cholerne drzwi.
	AI_Output (self, other,"DIA_Joe_Hallo_10_03");//To dość krępująca sytuacja. Byłbym bardzo wdzięczny, gdyby pozostało to między nami.
	AI_Output (other, self,"DIA_Joe_Hallo_15_04");//Rozumiem, to rzeczywiście nie jest powód do dumy.
	AI_Output (self, other,"DIA_Joe_Hallo_10_05");//Chyba muszę się napić.
	AI_StopProcessInfos (self);
...
{
	AI_Output (other, self,"DIA_Joe_Perm_15_00");//Wszystko w porządku?
	AI_Output (self, other,"DIA_Joe_Perm_10_01");//Dzięki za uwolnienie.
...
FUNC VOID DIA_Joe_Sign_Info()
{
	...
	AI_Output (self, other,"DIA_Joe_Sign_10_00");//Hej, wiesz co - mamy wspólnych znajomych. W takim razie pozwól mi wyrazić wdzięczność za uratowanie.
	AI_Output (self, other,"DIA_Joe_Sign_10_01");//Proszę, weź te wytrychy. Na pewno ci się przydadzą.
