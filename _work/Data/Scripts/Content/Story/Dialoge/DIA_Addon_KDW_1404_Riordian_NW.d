...
func void DIA_Addon_Riordian_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Riordian_Hallo_10_02"); //Podle písemností, které jsme tu našli, tu žili velmi dlouho před námi.
...
instance DIA_Addon_Riordian_Atlantis		(C_INFO)
{
	...
	description	 = 	"Ztracené město na ostrově Khorinidu?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Riordian_Atlantis_15_00"); //Ztracené město na ostrově Khorinidu?
	AI_Output	(self, other, "DIA_Addon_Riordian_Atlantis_10_01"); //Ano. Dosud jsme žili v domnění, že celý ostrov už máme zmapovaný.
	AI_Output	(self, other, "DIA_Addon_Riordian_Atlantis_10_02"); //Počítali jsme, že na severovýchodě se rozkládá jen jedno velké pohoří.
	AI_Output	(self, other, "DIA_Addon_Riordian_Atlantis_10_03"); //Ale mýlili jsme se.
	AI_Output	(self, other, "DIA_Addon_Riordian_Atlantis_10_04"); //Za těmi horami leží ještě údolí. A kdysi tam stávalo město dávného lidu.
	AI_Output	(self, other, "DIA_Addon_Riordian_Atlantis_10_05"); //(povzdechne si) Moc rád bych viděl, jaké domy v tom městě stály, ale už se nejspíš dávno obrátily v prach.
	
	B_LogEntry (TOPIC_Addon_KDW,"Vodní mágové se domnívají, že za portálem leží pradávné ztracené město."); 
};
///////////////////////////////////////////////////////////////////////
//	Info SaturasWantYou
///////////////////////////////////////////////////////////////////////
...
func void DIA_Addon_Riordian_SaturasWantYou_Info ()
{
	...
	if (Nefarius_NW.aivar[AIV_TalkedToPlayer] == FALSE)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Riordian_SaturasWantYou_10_03"); //Najdeš ho kousek dál, vzadu v těchto hrobkách.
	};	
...
{
	AI_Output	(other, self, "DIA_Addon_Riordian_Perm_15_00"); //Našli jste něco nového?
	if (Riordian_PermNews == FALSE)
	{
		AI_Output	(self, other, "DIA_Addon_Riordian_Perm_10_01"); //Už je to jisté. Lid téhle prastaré kultury skutečně věřil v Adana!
...
func void DIA_Addon_Riordian_TeachPre_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Riordian_TeachPre_10_01"); //Á! (rozvážně) Vzácný artefakt. Může ti posloužit i k výcviku bludičky, víš to?
