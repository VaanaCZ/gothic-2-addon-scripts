...
func void DIA_Ritter_OUT_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Ritter_OUT_06_00"); //Przybywasz z Khorinis, prawda? Gdy to wszystko się skończy, chcę tam powrócić.
		DIA_Ritter_OUT_NoPerm = TRUE;
	};
	
	if (hero.guild == GIL_KDF)
		{
			AI_Output			(self, other, "DIA_Ritter_OUT_06_01"); //To wielki zaszczyt, Panie, mieć cię u naszego boku.
		}
		else
		{
			AI_Output			(self, other, "DIA_Ritter_OUT_06_02"); //Damy radę! Wrócimy do Khorinis z rudą i okryjemy się chwałą.
		};
};
