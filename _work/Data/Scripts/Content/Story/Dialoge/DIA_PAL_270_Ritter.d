...
func void DIA_Ritter_OUT_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Ritter_OUT_06_00"); //Pâišel jsi z Khorinidu, že? Až bude po všem, vrátím se tam.
		DIA_Ritter_OUT_NoPerm = TRUE;
	};
	
	if (hero.guild == GIL_KDF)
		{
			AI_Output			(self, other, "DIA_Ritter_OUT_06_01"); //Je to obrovská úleva, sire, že tê máme po boku.
		}
		else
		{
			AI_Output			(self, other, "DIA_Ritter_OUT_06_02"); //Zvládneme to. Dopravíme rudu do Khorinidu a budou nás oslavovat!
		};
};
