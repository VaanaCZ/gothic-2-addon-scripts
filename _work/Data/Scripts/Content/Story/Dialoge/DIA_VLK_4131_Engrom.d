...
func void DIA_Engrom_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Engrom_HALLO_12_01"); //Mizernê!
	AI_Output			(other, self, "DIA_Engrom_HALLO_15_02"); //Mmh!
	AI_Output			(self, other, "DIA_Engrom_HALLO_12_03"); //Co chceš slyšet. Celé dny nedêlám nic jiného, než že koukám na tuhle zatracenou âeku.
	AI_Output			(self, other, "DIA_Engrom_HALLO_12_04"); //Nalevo se flákají skâeti, napravo banditi a každý den jím akorát èíhavèí maso. Víš, už mi to všecko leze krkem.
};
...
instance DIA_Engrom_WhatAboutLeaving		(C_INFO)
{
	...
	description	 = 	"Pâemýšlel jsi nêkdy o tom, že odsud odejdeš?";
};
...
{
	AI_Output			(other, self, "DIA_Engrom_WhatAboutLeaving_15_00"); //Pâemýšlel jsi nêkdy o tom, že odsud odejdeš?
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_01"); //No jasnê, to pâeci není problém!
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_02"); //Nejdâív se prosekám tlupama skâetù, pozdravím všecky ty ostatní pâíšery, co tu všude obcházejí, a pak prostê projdu prùsmykem!
	...
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_05"); //Chceš mi nakukat, žes prostê prošel prùsmykem?
	AI_Output			(other, self, "DIA_Engrom_WhatAboutLeaving_15_06"); //Víceménê ano!
	AI_Output			(self, other, "DIA_Engrom_WhatAboutLeaving_12_07"); //Tak to jsi mêl teda kliku. Dokud tu bude všechno vzhùru nohama, ani se odsud nehnu.
...
func void DIA_Engrom_Jagd_Info ()
{
	...
	AI_Output			(self, other, "DIA_Engrom_Jagd_12_01"); //Jedinou útêchu vidím v lovu, ale rád bych tu nêkdy vidêl i nêco jiného než poâád ty nechutný èíhavce.
};
...
{
	AI_Output			(other, self, "DIA_Engrom_BESSEN_15_00"); //Posedlo tê zlo.

	AI_Output			(other, self, "DIA_Engrom_BESSEN_15_01"); //Dovol mi, abych ti pomohl.
	AI_Output			(self, other, "DIA_Engrom_BESSEN_12_02"); //(kâièí) Nesahej na mê!
