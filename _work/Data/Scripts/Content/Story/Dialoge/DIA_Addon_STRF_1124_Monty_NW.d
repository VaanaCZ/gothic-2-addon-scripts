...
FUNC VOID DIA_Addon_Monty_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Monty_NW_Hi_08_01");//Člověče – co jsem byl pryč, nehli tu ani prstem. Teď se musím znova zavrtat do těch stavebních plánů.
	AI_Output (other, self, "DIA_Addon_Monty_NW_Hi_15_02");//Fajn, nebudu tě rušit.
	AI_Output (self, other, "DIA_Addon_Monty_NW_Hi_08_03");//(směje se) Prima, šťastnou cestu.
};
// ************************************************************
// 			  				PICK POCKET
// ************************************************************
