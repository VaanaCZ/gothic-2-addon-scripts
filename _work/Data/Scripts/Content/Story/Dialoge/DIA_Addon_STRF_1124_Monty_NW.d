...
INSTANCE DIA_Addon_Monty_NW_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Takže se už vrátíš do práce?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Monty_NW_Hi_15_00");//Tak co, už zase v práci?
	AI_Output (self, other, "DIA_Addon_Monty_NW_Hi_08_01");//Človęče – co jsem byl pryč, nehli tu ani prstem. Teë se musím znova zavrtat do tęch stavebních plánů.
	AI_Output (other, self, "DIA_Addon_Monty_NW_Hi_15_02");//Fajn, nebudu tę rušit.
	AI_Output (self, other, "DIA_Addon_Monty_NW_Hi_08_03");//(smęje se) Prima, šăastnou cestu.
};
// ************************************************************
// 			  				PICK POCKET
// ************************************************************
