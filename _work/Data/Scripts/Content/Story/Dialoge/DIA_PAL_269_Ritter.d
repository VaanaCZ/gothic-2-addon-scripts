...
{
	AI_Output			(self, other, "DIA_Ritter_HERO_04_00"); //Twoje pojawienie się tutaj jest dla nas wszystkich znakiem. Twoja obecność tchnęła w nas nową odwagę.

	if (DIA_Ritter_HERO_NoPerm == FALSE)
		{
			AI_Output			(self, other, "DIA_Ritter_HERO_04_01"); //Wiemy, że nasi kompani w mieście nie zapomnieli o nas. Oko Innosa czuwa nad nami.
			AI_Output			(self, other, "DIA_Ritter_HERO_04_02"); //Jeśli orkowie i smoki zaatakują, odważnie stawimy im czoła, cokolwiek nas czeka - zwycięstwo czy śmierć.
