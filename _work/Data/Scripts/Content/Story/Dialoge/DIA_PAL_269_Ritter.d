...
{
	AI_Output			(self, other, "DIA_Ritter_HERO_04_00"); //Tvùj pâíchod je znamením pro nás všechny. Dodává nám to odvahu.

	if (DIA_Ritter_HERO_NoPerm == FALSE)
		{
			AI_Output			(self, other, "DIA_Ritter_HERO_04_01"); //Víme, že na nás naši spolubojovníci z mêsta nezapomnêli. Innosovo oko na nás dohlíží.
			AI_Output			(self, other, "DIA_Ritter_HERO_04_02"); //A jestli skâeti a draci vtrhnou na naše brány, postavíme se jim hrdê, aã už nám bude souzeno pâežít nebo zemâít.
