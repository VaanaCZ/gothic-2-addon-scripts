...
INSTANCE DIA_NONE_101_MARIO_DI_Job (C_INFO)
{
	...
	description	= "Dam ci szansę wykazania się w walce, no, dalej!";
};
...
{
	AI_Output (other,self ,"DIA_NONE_101_MARIO_DI_Job_15_00"); //Dam ci szansę wykazania się w walce, no, dalej!
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_Job_07_01"); //Powoli, wszystko w swoim czasie.
	AI_Output (other,self ,"DIA_NONE_101_MARIO_DI_Job_15_02"); //Mmm. Tego się właśnie spodziewałem.
...
{
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_ambush_07_00"); //Podejdź bliżej przyjacielu, pokaż na co cię stać.
	AI_Output (other,self ,"DIA_NONE_101_MARIO_DI_ambush_15_01"); //O co ci chodzi?
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_ambush_07_02"); //To proste. Mistrz już dawno chciał się ciebie pozbyć.
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_ambush_07_03"); //Powinienem był cię zabić wcześniej. Teraz jednak moi przyjaciele naprawią ten błąd.
