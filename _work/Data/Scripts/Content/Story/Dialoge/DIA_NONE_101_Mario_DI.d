...
INSTANCE DIA_NONE_101_MARIO_DI_Job (C_INFO)
{
	...
	description	= "Máš jedineènou pâíležitost dokázat své schopnosti v boji.";
};
...
{
	AI_Output (other,self ,"DIA_NONE_101_MARIO_DI_Job_15_00"); //Máš jedineènou pâíležitost dokázat své schopnosti v boji.
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_Job_07_01"); //Pomalu. Všechno má svùj èas.
	AI_Output (other,self ,"DIA_NONE_101_MARIO_DI_Job_15_02"); //Hmm. Pâesnê to jsem od tebe èekal.
...
FUNC VOID DIA_NONE_101_MARIO_DI_ambush_Info()
{
	...
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_ambush_07_02"); //Je to prosté. Pán tê už má dost.
	AI_Output (self ,other,"DIA_NONE_101_MARIO_DI_ambush_07_03"); //Mêl jsem tê zabít už dâív. Ale já a mí pâátelé tu chybu hned napravíme.
