...
{	
	...
	&& (!C_NpcIsDown(Sentenza))
	{
		...
		AI_Output (self ,other,"DIA_Raoul_NoSentenza_01_03"); //(falešnę slušnę) Chvilku strpení, bude tu coby dup!
	...
	{
		AI_Output (self ,other,"DIA_Raoul_NoSentenza_01_05"); //Kde teda je? No, to nevadí, męls prostę kliku.
	};
...
func void DIA_Raoul_PERM_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Raoul_PERM_01_01"); //Pâestaŕ žvanit a radši mi obstarej tu kůži z černýho trola.
	}
	else 
	{
...
func void DIA_Raoul_TROLL_Info ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_TROLL_01_06"); //Pro mę nikdy nebudeš nic víc než špinavej flákač.
...
func void DIA_Raoul_TROLL_rechnung ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_01_01"); //Takový jako ty moc dobâe znám. Mají akorát plnou hubu keců.
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_01_02"); //Nesnáším lidi, co dęlají haura a kasají se, jaký hrdinské skutky vykonají.
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_01_03"); //Zrovna včera jsem tu jednomu chlápkovi dal pár do zubů, protože tvrdil, že by černýho trola sundal i s jednou rukou pâivázanou za zády.
	...
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_01_06"); //Už jsi nękdy vidęl černýho trola, ty velkohubej nádivo? Máš vůbec ponętí, jak obrovská potvora to je?
	...
	Info_ClearChoices	(DIA_Raoul_TROLL);
	Info_AddChoice	(DIA_Raoul_TROLL, "To jde mimo mę.", DIA_Raoul_TROLL_rechnung_hastrecht );
...
func void B_Raoul_Blame ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_B_Raoul_Blame_01_05"); //No, âeknęme, že jestli mi pâineseš kůži černýho trola, dám ti pęknou hromadu penęz. Co ty na to?
...
func void DIA_Raoul_TROLLFELL_Info ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_TROLLFELL_01_02"); //To je fakt neuvęâitelný. Co za ni chceš?
