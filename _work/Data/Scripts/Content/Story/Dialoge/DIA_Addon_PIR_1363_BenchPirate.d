...
{	
	...
	if (GregIsBack == TRUE)
	{
		if (randy == 0)
		{
			AI_Output (self ,other,"DIA_Addon_Pir_7_Hello_07_01"); //Greg už je konečnę zpátky. Už bylo načase.
		}
		else if (randy == 1)
		{
			AI_Output (self ,other,"DIA_Addon_Pir_7_Hello_07_02"); //Francis by męl obstarat ŕáký dâevo na palisádu. Doufám, že to na nęj není moc.
		}
		else 
		{
			AI_Output (self ,other,"DIA_Addon_Pir_7_Hello_07_03"); //Tak teda hurá na bandity. Když je na naší stranę Greg, nebojíme se jich.
		};
	}
	else
	{
		if (randy == 0)
		{
			AI_Output (self ,other,"DIA_Addon_Pir_7_Hello_07_04"); //Francis, velitel tábora, není nic než šašek. Copak ho nękdo bere vážnę?
		}
		else if (randy == 1)
		{
			AI_Output (self ,other,"DIA_Addon_Pir_7_Hello_07_05"); //Greg vęâí Francisovi, protože je moc hloupej na to, aby ho moh podvádęt! Ale to z nęj pâeci nedęlá našeho šéfa.
		}
		else
		{
...
{	
	...
	AI_Output (other,self ,"DIA_Addon_BenchPirate_Anheuern_15_08"); //Pâesnę tak.
};
...
func void DIA_Addon_BenchPirate_ComeOn_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_BenchPirate_ComeOn_07_02"); //Pâesnę tam teë míâím.
		AI_StopProcessInfos (self);
	}
	else
	{
...
{	
	AI_Output (other,self ,"DIA_Addon_BenchPirate_GoHome_15_00"); //Už tę nepotâebuju.
