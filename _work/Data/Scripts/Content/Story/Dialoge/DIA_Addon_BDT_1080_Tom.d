...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_HI_11_01"); //Mám problémy. A protože je mi život milej, snažím se, abych se v táboâe nęjakou chvíli neukázal.
	AI_Output (other,self,"DIA_Addon_Tom_HI_15_02"); //Co se dęje?
	AI_Output (self,other,"DIA_Addon_Tom_HI_11_03"); //S pár pirátama jsem męl fakt dobrý vztahy, chápeš?
	AI_Output (self,other,"DIA_Addon_Tom_HI_11_04"); //Vždycky jsem se s nima scházel za táborem a obchodovali jsme.
	AI_Output (self,other,"DIA_Addon_Tom_HI_11_05"); //Jojo, kupoval jsem vęci pro půlku tábora. 'Tome, pâines mi tohle, Tome, pâines mi támhleto.'
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_Juan_11_02"); //Zrovna jsem męl s pirátama rozjednanej kšeft, když se vyloupnul ze tmy a dvęma ranama mę sejmul!
	AI_Output (self,other,"DIA_Addon_Tom_Juan_11_03"); //Byl sakra rychlej, to ti povím! Ale ne dost – ještę jsem mu stačil zdrhnout.
	SC_Knows_JuanMurderedAngus = TRUE;
	
	B_LogEntry	(TOPIC_Addon_KillJuan,"Takže Hankovu a Angusovu vraždu má na svędomí Juan. Počkal si na oba dva a pak je zabil.");
};
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_Esteban_11_01"); //Napâed jsem se vrátil do tábora a âekl Fiskovi, Hunovi i ostatním, aby se rozloučili s novým zbožím.
	AI_Output (self,other,"DIA_Addon_Tom_Esteban_11_02"); //A že to všecko spískal Esteban.
	AI_Output (self,other,"DIA_Addon_Tom_Esteban_11_03"); //Jestli Esteban zjistí, že jsem všem âek, že za tím vęzí ON, jsem mrtvej muž.
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_Dead_11_01"); //Vážnę? No čoveče, to je ale klika!
	AI_Output (self,other,"DIA_Addon_Tom_Dead_11_02"); //Kdo to udęlal?
	AI_Output (other,self,"DIA_Addon_Tom_Dead_15_03"); //(zlomyslnę) No, âeknęme že nękdo, koho znáš.
	AI_Output (self,other,"DIA_Addon_Tom_Dead_11_04"); //Dík, že jsi za mnou zašel. Teë se teda můžu vrátit do tábora...
...
{	
	...
	{
		AI_Output (self,other,"DIA_Addon_Tom_PERM_11_01"); //Teë už můžu zase v klidu popíjet Luciinu koâalku.
	}
	else
	{	
		if (Npc_KnowsInfo (other, DIA_Addon_Tom_Dead))
		{
			AI_Output (self,other,"DIA_Addon_Tom_PERM_11_02"); //Teë už se zase můžu ukázat v táboâe!
		}
		else
		{
			AI_Output (self,other,"DIA_Addon_Tom_PERM_11_03"); //Jinak? Jinak tu budu sedęt a počítat šutráky.
		};
	};
};
