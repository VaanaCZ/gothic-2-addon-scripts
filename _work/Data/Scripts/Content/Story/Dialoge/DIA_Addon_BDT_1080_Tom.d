...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_HI_11_01"); //Mám problémy. A protože je mi život milej, snažím se, abych se v táboøe nìjakou chvíli neukázal.
	AI_Output (other,self,"DIA_Addon_Tom_HI_15_02"); //Co se dìje?
	AI_Output (self,other,"DIA_Addon_Tom_HI_11_03"); //S pár pirátama jsem mìl fakt dobrý vztahy, chápeš?
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_Juan_11_02"); //Zrovna jsem mìl s pirátama rozjednanej kšeft, když se vyloupnul ze tmy a dvìma ranama mì sejmul!
	...
	B_LogEntry	(TOPIC_Addon_KillJuan,"Takže Hankovu a Angusovu vraždu má na svìdomí Juan. Poèkal si na oba dva a pak je zabil.");
};
...
INSTANCE DIA_Addon_Tom_Esteban   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "A od toho pøepadení se ukrýváš tady?";
};
...
{	
	AI_Output (other,self,"DIA_Addon_Tom_Esteban_15_00"); //A od toho pøepadení se ukrýváš tady?
	AI_Output (self,other,"DIA_Addon_Tom_Esteban_11_01"); //Napøed jsem se vrátil do tábora a øekl Fiskovi, Hunovi i ostatním, aby se rozlouèili s novým zbožím.
	AI_Output (self,other,"DIA_Addon_Tom_Esteban_11_02"); //A že to všecko spískal Esteban.
	AI_Output (self,other,"DIA_Addon_Tom_Esteban_11_03"); //Jestli Esteban zjistí, že jsem všem øek, že za tím vìzí ON, jsem mrtvej muž.
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Tom_Dead_11_01"); //Vážnì? No èoveèe, to je ale klika!
	AI_Output (self,other,"DIA_Addon_Tom_Dead_11_02"); //Kdo to udìlal?
	AI_Output (other,self,"DIA_Addon_Tom_Dead_15_03"); //(zlomyslnì) No, øeknìme že nìkdo, koho znáš.
	AI_Output (self,other,"DIA_Addon_Tom_Dead_11_04"); //Dík, že jsi za mnou zašel. Teï se teda mùžu vrátit do tábora...
...
{	
	...
	{
		AI_Output (self,other,"DIA_Addon_Tom_PERM_11_01"); //Teï už mùžu zase v klidu popíjet Luciinu koøalku.
	}
	else
	{	
		if (Npc_KnowsInfo (other, DIA_Addon_Tom_Dead))
		{
			AI_Output (self,other,"DIA_Addon_Tom_PERM_11_02"); //Teï už se zase mùžu ukázat v táboøe!
		}
		else
		{
