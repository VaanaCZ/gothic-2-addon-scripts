...
FUNC VOID DIA_Addon_10008_Bandit_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_10008_Bandit_Hi_01_03");//Ten chlap je nevyzpytatelnej. Toho, kdo ho poslednê vzbudil, zabil.
...
FUNC VOID DIA_Addon_10008_Bandit_soup_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_10008_Bandit_soup_01_02");//Dêlám tu akorát dušený maso. Tumáš, ochutnej, posílí tê.
	B_GiveInvItems (self, other, ItFo_Addon_Meatsoup,1);
	AI_Output (self, other, "DIA_Addon_10008_Bandit_soup_01_03");//Posilování se vždycky hodí - všude èíhá spousta nebezpeèí.
	AI_Output (self, other, "DIA_Addon_10008_Bandit_soup_01_04");//Jestli chceš, mùžu ti poradit, jak bejt silnêjší.
	
	Log_CreateTopic (Topic_Addon_BDT_Teacher,LOG_NOTE);
	B_LogEntry 	(Topic_Addon_BDT_Teacher,"Bandita u kotle s polévkou mi pomùže zvýšit sílu.");	
};
//*******************************************
//	TechPlayer
//*******************************************
...
{	
	AI_Output (other,self ,"DIA_Addon_10008_Bandit_Teach_15_00"); //Chci být silnêjší.
