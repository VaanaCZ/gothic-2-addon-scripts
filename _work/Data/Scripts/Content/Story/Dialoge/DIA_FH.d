...
FUNC VOID	Change_FH_Visual()
{
	...
	PrintScreen	("Texture pelle:" 		, -1, 10, "FONT_OLD_10_WHITE.TGA", 4 );
	
	printText = IntToString	(FH_SkinTexture);
	PrintScreen	(printText		, -1, 12, "FONT_OLD_10_WHITE.TGA", 2 );
	
	
	PrintScreen	("Reticolato della testa:"		, -1, 20, "FONT_OLD_10_WHITE.TGA", 2 );
...
INSTANCE DIA_FH_WomanFace (C_INFO)
{
	...
	permanent		= 1;
	description		= "Visualizza volti femminili";
};                       
...
INSTANCE DIA_FH_Choose_HeadMesh (C_INFO)
{
	...
	permanent		= 1;
	description		= "Scegli ingrandimento principale";
};                       
...
{	
	...
	Info_AddChoice		(DIA_FH_Choose_HeadMesh, "Indietro" 				, DIA_FH_Choose_HeadMesh_7);
