...
FUNC VOID	Change_FH_Visual()
{
	...
	PrintScreen	("Texture de peau :" 		, -1, 10, "FONT_OLD_10_WHITE.TGA", 4 );
	
	printText = IntToString	(FH_SkinTexture);
	PrintScreen	(printText		, -1, 12, "FONT_OLD_10_WHITE.TGA", 2 );
	
	
	PrintScreen	("Chevelure :"		, -1, 20, "FONT_OLD_10_WHITE.TGA", 2 );
...
INSTANCE DIA_FH_NextFace10 (C_INFO)
{
	...
	permanent		= 1;
	description		= "10 visages suivants";
};                       
...
{	
	...
	Info_AddChoice		(DIA_FH_Choose_HeadMesh, "Retour" 				, DIA_FH_Choose_HeadMesh_7);
