...
FUNC VOID	Change_FH_Visual()
{
	...
	PrintScreen	("Textura skinu:" 		, -1, 10, "FONT_OLD_10_WHITE.TGA", 4 );
	
	printText = IntToString	(FH_SkinTexture);
	PrintScreen	(printText		, -1, 12, "FONT_OLD_10_WHITE.TGA", 2 );
	
	
	PrintScreen	("Textura hlavy"		, -1, 20, "FONT_OLD_10_WHITE.TGA", 2 );
...
INSTANCE DIA_FH_PreviousFace10 (C_INFO)
{
	...
	permanent		= 1;
	description		= "Předchozí portrét 10 kroků";
};                       
...
INSTANCE DIA_FH_WomanFace (C_INFO)
{
	...
	permanent		= 1;
	description		= "Přejít na portréty žen";
};                       
...
INSTANCE DIA_FH_Choose_HeadMesh (C_INFO)
{
	...
	permanent		= 1;
	description		= "Vyber texturu hlavy";
};                       
...
{	
	...
	Info_AddChoice		(DIA_FH_Choose_HeadMesh, "ZPĚT" 				, DIA_FH_Choose_HeadMesh_7);
