...
instance DIA_Bullco_Hallo		(C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Mêli bysme si spolu promluvit...";
};
...
{
	AI_Output (other, self, "DIA_Bullco_HALLO_15_00"); //Mêli bychom si promluvit.
	...
	{
		AI_Output (self, other, "DIA_Bullco_HALLO_06_02"); //Nevêdêl bych o èem.
	};
	AI_StopProcessInfos (self);
};
...
{
	AI_Output (self, other, "DIA_Bullco_Quatscher_06_00"); //Sylvio se nerad vybavuje. To bys teë snad už mêl vêdêt.
...
func void DIA_Bullco_PleaseLeave_Info ()
{
	...
	AI_Output (self, other, "DIA_Bullco_PleaseLeave_06_02"); //Myslím, že nejlepší by bylo, kdyby se tu na farmê tvùj ksicht už neukázal.
	AI_Output (self, other, "DIA_Bullco_PleaseLeave_06_03"); //Dohodnême se, že od zítâka tê tu už nikdo neuvidí. Rozumíme si?
...
func void DIA_Bullco_DailyCheck_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Bullco_DailyCheck_06_00"); //Ty jsi po tom všem ještê tady?
		AI_Output (self, other, "DIA_Bullco_DailyCheck_06_01"); //Myslel jsem, že jsme se domluvili na tom, že se potichu vypaâíš.
		AI_Output (self, other, "DIA_Bullco_DailyCheck_06_02"); //Opravdu jsi mê mêl poslechnout.
	}
	else
	{
...
func void DIA_Bullco_WontLeave_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Bullco_WontLeave_06_02"); //(mrzutê) Jo, jasnê, bêž to âíct nêkomu, koho to bude zajímat.
		Bullco_scharf = FALSE;
		AI_StopProcessInfos (self);
	};
};
...
instance DIA_Bullco_PepesSchafe (C_INFO)
{
	...
	permanent	= FALSE;
	description = "Pâipomíná ti nêco jméno Pepe?";
};
...
{
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_00"); //Pâipomíná ti nêco jméno Pepe?
	AI_Output (self, other, "DIA_Bullco_PepesSchafe_06_01"); //Nerozumím sice tomu, o èem to vùbec kecáš, ale nelíbí se mi tvùj tón!
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_02"); //Mêl jsi hlídat jeho ovce.
	AI_Output (self, other, "DIA_Bullco_PepesSchafe_06_03"); //Proè se mám starat o jeho ovce?
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_04"); //Lee se o nê stará.
	AI_Output (self, other, "DIA_Bullco_PepesSchafe_06_05"); //O co ti jde?
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_06"); //Jestli mê nepâestaneš štvát, dohlédnu na to, abys ty ovce zaplatil.
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_07"); //Takže pokud chceš dostat svoje peníze, nech mê teë na pokoji!
	AI_Output (self, other, "DIA_Bullco_PepesSchafe_06_08"); //(nazlobenê) Ty, ty...
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_09"); //(chladnê) Ano?
