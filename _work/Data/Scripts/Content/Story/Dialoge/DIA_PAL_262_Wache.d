...
{
	AI_Output (self, other, "DIA_PAL_262_GREET_10_00"); //Zatrzymaj się - kim jesteś?
	AI_Output (other, self, "DIA_PAL_262_GREET_15_01"); //Nieważne kim jestem, ważne skąd przychodzę. Niedawno przekroczyłem przełęcz.
	AI_Output (other, self, "DIA_PAL_262_GREET_15_02"); //Będziesz sprawiał problemy, czy po prostu pozwolisz mi wejść?
	AI_Output (self, other, "DIA_PAL_262_GREET_10_03"); //Skąd miałem wiedzieć? Oczywiście, że cię wpuszczę, wchodź.
...
func void DIA_Wache_PERM_Info ()
{
	...
	*/
	...
	AI_Output (self, other, "DIA_Addon_Wache_PERM_10_02"); //Wchodź śmiało - za dnia kręcą się po Sali tronowej na parterze.
};
