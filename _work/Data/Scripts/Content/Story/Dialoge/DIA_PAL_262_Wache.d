...
func void DIA_PAL_262_GREET_Info ()
{
	...
	AI_Output (other, self, "DIA_PAL_262_GREET_15_01"); //Mnohem dùležitêjší je otázka, odkud jsem pâišel. Pâišel jsem skrz prùsmyk.
	AI_Output (other, self, "DIA_PAL_262_GREET_15_02"); //Budeš mi tedy dál stát v cestê, nebo mê pustíš dál?
	AI_Output (self, other, "DIA_PAL_262_GREET_10_03"); //No, to jsem pâece nemohl vêdêt. Jasnê že mùžeš jít dál.
...
func void DIA_Wache_PERM_Info ()
{
	...
	*/
	...
	AI_Output (self, other, "DIA_Addon_Wache_PERM_10_01"); //Náš velitel Garond se svými dvêma rádci, paladiny Oricem a Parcivalem.
	AI_Output (self, other, "DIA_Addon_Wache_PERM_10_02"); //Jen pojë dál. Ve dne je najdeš v trùnním sále v pâízemí.
};
