...
instance DIA_Malak_PALADINE		(C_INFO)
{
	...
	description	 = 	"Povìz mi o paladinech nìco víc. Jak dlouho už tu jsou?";
};
...
instance DIA_Malak_BACKTOBENGAR		(C_INFO)
{
	...
	description	 = 	"Bengar tì potøebuje. Èeká, až se k nìmu vrátíš nìmu na statek.";
};
...
func void DIA_Malak_BACKTOBENGAR_Info ()
{
	...
	AI_Output			(self, other, "DIA_Malak_BACKTOBENGAR_08_05"); //(zvìdavì) Mmh. Asi není šance, že bys mi to øekl, co?
