...
func void DIA_Malak_PASS_Info ()
{
	...
	AI_Output			(self, other, "DIA_Malak_PASS_08_02"); //Ale jinak jediná věc, na kterou si my farmáři musíme dávat pozor, jsou karavany, co každý měsíc vozí do Hornického údolí všechno možné.
...
func void DIA_Malak_WARSTDUSCHONDA_Info ()
{
	...
	AI_Output			(self, other, "DIA_Malak_WARSTDUSCHONDA_08_03"); //Ale jinak je Hornické údolí vlastně takové přirozené vězení. Jakmile tam jedou vejdeš, ven už se nedostaneš.
...
instance DIA_Malak_PALADINE		(C_INFO)
{
	...
	description	 = 	"Pověz mi o paladinech něco víc. Jak dlouho už tu jsou?";
};
...
instance DIA_Malak_BACKTOBENGAR		(C_INFO)
{
	...
	description	 = 	"Bengar tě potřebuje. Čeká, až se k němu vrátíš němu na statek.";
};
...
func void DIA_Malak_BACKTOBENGAR_Info ()
{
	...
	AI_Output			(self, other, "DIA_Malak_BACKTOBENGAR_08_01"); //Nejsem blázen. Dokud nebude farma dobře zabezpečená, nehodlám odsud vystrčit nos!
	
	B_LogEntry (TOPIC_BengarALLEIN,"Malak se nemíní vrátit na Bengarův statek, dokud zůstává nechráněný."); 
	...
	AI_Output			(self, other, "DIA_Malak_BACKTOBENGAR_08_03"); //Tak to je samozřejmě jiná. Ale počkat. Kdo toho chlapíka platí, he?
	AI_Output			(other, self, "DIA_Malak_BACKTOBENGAR_15_04"); //To je můj problém.
	AI_Output			(self, other, "DIA_Malak_BACKTOBENGAR_08_05"); //(zvědavě) Mmh. Asi není šance, že bys mi to řekl, co?
