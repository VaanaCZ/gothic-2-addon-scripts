...
func void DIA_Addon_Myxir_WasMachstDu_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_WasMachstDu_12_03"); //Každý z nás se ho musí nauèit, jinak tahle expedice skonèí døív, než vùbec nìco zjistíme.
	AI_Output	(self, other, "DIA_Addon_Myxir_WasMachstDu_12_04"); //Stavitelé své vìdomosti zaznamenávali na kamenné tabulky. Spousta z nich se bohužel rozbila nebo už je lidé dávno rozkradli.
};
///////////////////////////////////////////////////////////////////////
//	Info Steintafeln
///////////////////////////////////////////////////////////////////////
instance DIA_Addon_Myxir_Steintafeln		(C_INFO)
{
	...
	description	 = 	"Tak co je tedy na tìch kamenných tabulkách?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_Steintafeln_15_00"); //A co je tedy na tìch kamenných tabulkách?
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_01"); //Obsahují všechny vìdomosti, které tento pradávný lid nashromáždil.
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_02"); //Nìkteré magicky zvyšují bojové schopnosti a magii.
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_03"); //Pro toho, kdo je dokáže èíst, mohou pøedstavovat skuteèný poklad.


	Log_CreateTopic (TOPIC_Addon_Stoneplates, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_Stoneplates, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_Stoneplates,"Kamenné tabulky obsahují vìdìní dávného lidu stavitelù. Nìkteré z nich mi zvýší bojové nebo magické schopnosti, ale napøed se je musím nauèit èíst."); 
};
///////////////////////////////////////////////////////////////////////
//	Info WillYouTeachMe
///////////////////////////////////////////////////////////////////////
