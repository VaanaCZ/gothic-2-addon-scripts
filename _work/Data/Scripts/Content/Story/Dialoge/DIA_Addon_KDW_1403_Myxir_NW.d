...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_WasMachstDu_15_00"); //Co tu dêláš?
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_WasMachstDu_12_03"); //Každý z nás se ho musí nauèit, jinak tahle expedice skonèí dâív, než vùbec nêco zjistíme.
	AI_Output	(self, other, "DIA_Addon_Myxir_WasMachstDu_12_04"); //Stavitelé své vêdomosti zaznamenávali na kamenné tabulky. Spousta z nich se bohužel rozbila nebo už je lidé dávno rozkradli.
};
///////////////////////////////////////////////////////////////////////
//	Info Steintafeln
///////////////////////////////////////////////////////////////////////
instance DIA_Addon_Myxir_Steintafeln		(C_INFO)
{
	...
	description	 = 	"Tak co je tedy na têch kamenných tabulkách?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_Steintafeln_15_00"); //A co je tedy na têch kamenných tabulkách?
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_01"); //Obsahují všechny vêdomosti, které tento pradávný lid nashromáždil.
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_02"); //Nêkteré magicky zvyšují bojové schopnosti a magii.
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_03"); //Pro toho, kdo je dokáže èíst, mohou pâedstavovat skuteèný poklad.


	Log_CreateTopic (TOPIC_Addon_Stoneplates, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_Stoneplates, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_Stoneplates,"Kamenné tabulky obsahují vêdêní dávného lidu stavitelù. Nêkteré z nich mi zvýší bojové nebo magické schopnosti, ale napâed se je musím nauèit èíst."); 
};
///////////////////////////////////////////////////////////////////////
//	Info WillYouTeachMe
///////////////////////////////////////////////////////////////////////
instance DIA_Addon_Myxir_WillYouTeachMe		(C_INFO)
{
	...
	description	 = 	"Mohl bys mê nauèit èíst v tom jazyce?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_WillYouTeachMe_15_00"); //Nauèíš mê ten jazyk?
	AI_Output	(self, other, "DIA_Addon_Myxir_WillYouTeachMe_12_01"); //No, proè ne? Rád se s tebou podêlím o své vêdomosti.
