...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_WasMachstDu_15_00"); //Co tu děláš?
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_WasMachstDu_12_03"); //Každý z nás se ho musí naučit, jinak tahle expedice skončí dřív, než vůbec něco zjistíme.
	AI_Output	(self, other, "DIA_Addon_Myxir_WasMachstDu_12_04"); //Stavitelé své vědomosti zaznamenávali na kamenné tabulky. Spousta z nich se bohužel rozbila nebo už je lidé dávno rozkradli.
};
///////////////////////////////////////////////////////////////////////
//	Info Steintafeln
///////////////////////////////////////////////////////////////////////
...
func void DIA_Addon_Myxir_Steintafeln_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_02"); //Některé magicky zvyšují bojové schopnosti a magii.
	AI_Output	(self, other, "DIA_Addon_Myxir_Steintafeln_12_03"); //Pro toho, kdo je dokáže číst, mohou představovat skutečný poklad.


	Log_CreateTopic (TOPIC_Addon_Stoneplates, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_Stoneplates, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_Stoneplates,"Kamenné tabulky obsahují vědění dávného lidu stavitelů. Některé z nich mi zvýší bojové nebo magické schopnosti, ale napřed se je musím naučit číst."); 
};
///////////////////////////////////////////////////////////////////////
//	Info WillYouTeachMe
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output	(other, self, "DIA_Addon_Myxir_WillYouTeachMe_15_00"); //Naučíš mě ten jazyk?
	AI_Output	(self, other, "DIA_Addon_Myxir_WillYouTeachMe_12_01"); //No, proč ne? Rád se s tebou podělím o své vědomosti.
