...
func void DIA_Coragon_HALLO_Info ()
{
	...
	AI_Output (self ,other, "DIA_ADDON_NEW_Coragon_Add_09_00"); //Jestli máš zlaăáky, klidnę se tu můžeš i najíst.
...
func void DIA_Coragon_WhatsUp_Info ()
{
	...
	AI_Output (self ,other, "DIA_ADDON_NEW_Coragon_Add_09_01"); //Ále, ani mi nepâipomínej. Lord Andre teë v šibeniční uličce servíruje pivo zdarma.
	AI_Output (self ,other, "DIA_ADDON_NEW_Coragon_Add_09_02"); //Takže sem nepâijde dohromady nikdo. Až na boháče z horní čtvrti.
	AI_Output (other, self, "DIA_Coragon_Add_15_03"); //A co je s nimi?
	AI_Output (self ,other, "DIA_ADDON_NEW_Coragon_Add_09_04"); //(smęje se) Nękteâí z tęch nabobů dokážou pęknę brnkat na nervy.
	AI_Output (self ,other, "DIA_ADDON_NEW_Coragon_Add_09_05"); //Napâíklad tuhleten Valentino - nemůžu ho už ani vidęt.
	AI_Output (self ,other, "DIA_ADDON_NEW_Coragon_Add_09_06"); //Ale zákazníky si nemůžu vybírat, protože se mi hodí každý zlaăák.
...
instance DIA_Addon_Coragon_MissingPeople		(C_INFO)
{
	...
	description	 = 	"Můžeš mi povędęt nęco o tęch pohâešovaných lidech?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Coragon_MissingPeople_15_00"); //Âekni mi o tęch pohâešovaných lidech.
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_01"); //Slyšel jsem, že dost lidí zmizelo dole v pâístavu. Ani se nedivím, tam dole se vždycky dęly divný vęci. 
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_02"); //Dokonce pâitom pâišel o učedníka i Thorben, tesaâ z dolní části męsta.  
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_03"); //Fakt divnou historku ti může vyprávęt i Hakon, jeden z obchodníků na tržišti. 
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_04"); //Prý den co den narážel na jednoho chlápka, co se ale najednou ztratil z povrchu zemského. Dokonce tu vęc ohlásil i domobranę. 
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_05"); //Lidi z męsta jsou z toho pęknę vyplašení. Nevím, co si o tom myslet, pâijde mi to všecko jako pękné nesmysly.  
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_06"); //Khorinis je drsné męsto, ale za jeho branami číhají ještę horší nebezpečí.   
	AI_Output	(self, other, "DIA_Addon_Coragon_MissingPeople_09_07"); //Ti, co se zdržují za hradbami, obvykle padnou za obęă banditům nebo je sežere dravá zvęâ. Je to jednoduché.  
	
	Log_CreateTopic (TOPIC_Addon_WhoStolePeople, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_WhoStolePeople, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_WhoStolePeople,"O pohâešovaných lidech by nęco mohl vędęt Hakon, obchodník na tržišti, a tesaâ Thorben."); 
};
...
func void DIA_Coragon_Bestohlen_Info ()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_09"); //Ano, nedávno. Bylo tu tehdá pęknę nabito a já musel roznášet pivo.
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_10"); //Nebyl jsem mimo bar dlouho, ale tęm šmejdům to stačilo.
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_11"); //Šel jsem kvůli tomu za domobranou, ale samozâejmę nenašli vůbec nic. Radši se budou nalejvat tím pivem zadarmo.
...
func void B_Coragon_Bier()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_14"); //Tumáš - za odmęnu si vezmi tohle.
...
func void DIA_Coragon_BringSilber_Info ()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_13"); //Vážnę!
...
func void DIA_Coragon_Schuldenbuch_Info ()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_16"); //Hmm? (pâekvapenę) Ale to je Lehmarova účetní kniha!
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_17"); //Co s ní chceš dęlat?
};
...
func void DIA_Coragon_GiveBook_Info ()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_19"); //Díky! Zachránils mi krk. Lehmar dokáže bejt pęknę hnusnej.
...
func void DIA_Coragon_ToOV_Info ()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_24"); //Musíš se stát občanem męsta. Najdi si nęjakou práci.
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_25"); //Nejlépe u nękoho z âemeslníků v dolní části męsta. Pak by ses męl stát občanem.
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_26"); //No, a kdyby ti to nestačilo, promluv si v kasárnách s lordem Andremm.
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_27"); //Možná tę pâijme k męstské stráži, a ta má pâístup i do horní části męsta.
};
...
func void DIA_Coragon_Valentino_Info ()
{
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_29"); //Je nechutnę bohatý, a tak nemusí makat. A každýmu se tím chlubí.
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_30"); //Aă už to chceš slyšet, nebo ne.
...
{
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_33"); //Včera večer ale nemęl na zaplacení.
	if (Valentino.aivar[AIV_DefeatedByPlayer] == TRUE)
	{
		AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_34"); //Blábolil nęco o tom, že ho okradli a že mi zaplatí pozdęji. Fakt!
	}
	else //Pickpocket OHNE Niederschlagen - AUSKOMMENTIERT
	{
		AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_35"); //A ještę chvilku pâedtím se chvástal, kolik má penęz.
	...
	AI_Output (self ,other,"DIA_ADDON_NEW_Coragon_Add_09_38"); //No, dal jsem mu poâádnę na frak, co jinýho?
};
