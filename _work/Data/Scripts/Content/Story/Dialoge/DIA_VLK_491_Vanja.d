...
{
	AI_Output			(self, other, "DIA_Vanja_STANDARD_17_00"); //Jestem zajęta.
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
//	Info DOPE
...
instance DIA_Vanja_DOPE		(C_INFO)
{
	...
	permanent	 =  FALSE;
	description	 = 	"Nie wiesz, gdzie mogę znaleźć trochę ziela?";
};
...
{
	AI_Output (other, self, "DIA_Vanja_DOPE_15_00"); //Nie wiesz, gdzie mogę znaleźć trochę ziela?
	AI_Output (self, other, "DIA_Vanja_DOPE_17_01"); //Nie mam pojęcia. Trzymaj się lepiej od tego z dala.
	AI_Output (self, other, "DIA_Vanja_DOPE_17_02"); //Jeśli tego nie zrobisz, gorzko pożałujesz...
};
