...
instance DIA_Vanja_DOPE		(C_INFO)
{
	...
	permanent	 =  FALSE;
	description	 = 	"Kde bych sehnal nìjakou trávu?";
};
...
{
	AI_Output (other, self, "DIA_Vanja_DOPE_15_00"); //Kde bych sehnal nìjakou trávu?
	AI_Output (self, other, "DIA_Vanja_DOPE_17_01"); //Nemám tušení. Radši dej od toho ruce pryè.
	AI_Output (self, other, "DIA_Vanja_DOPE_17_02"); //Protože jestli se na to nepøestaneš ptát, mùžeš si je spálit.
};
