...
FUNC VOID DIA_DJG_715_Ferros_OldCamp_Info()
{
	...
	B_LogEntry (TOPIC_FerrosSword,"Kdesi u skřetů ztratil Feros svůj meč - to bylo pořádně hloupé."); 
};
...
FUNC VOID DIA_DJG_715_Ferros_OldCamp_No ()
{
	...
	AI_Output (self ,other,"DIA_DJG_715_Ferros_OldCamp_No_01_01"); //Asi bych se měl sám sebe ptát, proč jsem vlastně tady.
...
FUNC VOID DIA_DJG_715_Ferros_OldCamp_Yes ()
{
	...
	B_LogEntry (TOPIC_FerrosSword,"Feros svůj meč nejspíš ztratil na vysokém útesu na jihu - tam, kde si skřeti rozbili své stany."); 
...
{
	AI_Output (self ,other,"DIA_DJG_715_Ferros_FerrosAnySword_Blade_Yes2_01_00"); //Díky, máš to u mě.
...
{	
	...
	{
	AI_Output (self ,other,"DIA_Ferros_Teach_01_02"); //Dobrý bojovník by se měl naučit, jak své schopnosti převést přímo na zbraň.
