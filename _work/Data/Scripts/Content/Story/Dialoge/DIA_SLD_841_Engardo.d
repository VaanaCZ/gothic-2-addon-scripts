...
func void DIA_Engardo_HALLO_Info ()
{
	...
	if (Chance == FALSE)
	{
		AI_Output (self, other, "DIA_Engardo_HALLO_13_00"); //Hej, burane, ztratil ses? Vraã se zpátky na pole a vytáhni tam nêjaký tuâíny.
		Chance = 1;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 1) 
	{	
		AI_Output (self, other, "DIA_Engardo_HALLO_13_01"); //Jsi ve špatný èas na špatnym místê...
		AI_Output (self, other, "DIA_Engardo_HALLO_13_02"); //...takže mám dojem, že jestli se chceš dožít rána, mêl bys teë hned odsud pêknê vysmahnout, jasný?
		Chance = 2;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 2)
	{
		AI_Output (self, other, "DIA_Engardo_HALLO_13_03"); //Máš snad nêco s ušima? Nebo se chceš pozdravit se zubatou? (cynicky) Fajn, teë už je pozdê.
