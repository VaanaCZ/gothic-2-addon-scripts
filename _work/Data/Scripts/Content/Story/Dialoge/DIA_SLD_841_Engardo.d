...
func void DIA_Engardo_HALLO_Info ()
{
	...
	if (Chance == FALSE)
	{
		AI_Output (self, other, "DIA_Engardo_HALLO_13_00"); //Ehi, bifolco, ti sei perso? Torna al tuo campo a coltivare le rape.
		Chance = 1;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 1) 
	{	
		AI_Output (self, other, "DIA_Engardo_HALLO_13_01"); //Sei nel posto sbagliato al momento sbagliato...
		AI_Output (self, other, "DIA_Engardo_HALLO_13_02"); //...quindi se vuoi vivere faresti meglio a sparire in fretta, mi hai capito?
		Chance = 2;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 2)
