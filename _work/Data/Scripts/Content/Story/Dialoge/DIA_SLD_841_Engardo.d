...
func void DIA_Engardo_HALLO_Info ()
{
	...
	if (Chance == FALSE)
	{
		AI_Output (self, other, "DIA_Engardo_HALLO_13_00"); //Hej, burane, ztratil ses? Vraù se zp·tky na pole a vyt·hni tam nÏjak˝ tu¯Ìny.
		Chance = 1;
		AI_StopProcessInfos (self);
	}
	else if (Chance == 1) 
	{	
		AI_Output (self, other, "DIA_Engardo_HALLO_13_01"); //Jsi ve öpatn˝ Ëas na öpatnym mÌstÏ...
