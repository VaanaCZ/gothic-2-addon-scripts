...
func void DIA_Nadja_STANDARD_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_ADDON_Nadja_STANDARD_16_00"); //Napâed si promluv s Bromorem, teprve pak se s tebou můžu bavit.
	}
	else
	{
	...
	{
		AI_Output (other, self, "DIA_ADDON_Nadja_STANDARD_15_01"); //Jen jsem ti chtęl položit pár otázek ohlednę tęch zmizelých lidí.
		AI_Output (self, other, "DIA_ADDON_Nadja_STANDARD_16_02"); //Nęco ti âíct můžu, ale tady ne, zlato.
...
instance DIA_Addon_Nadja_LuciaInfo		(C_INFO)
{
	...
	description	 = 	"Můžeme si teë pomluvit?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Nadja_LuciaInfo_15_00"); //Tak TEË už si můžeme promluvit?
	...
	AI_Output	(self, other, "DIA_Addon_Nadja_LuciaInfo_16_03"); //Tak ty by ses rád dozvędęl nęco o tęch lidech, co zmizeli tady v pâístavu?
	AI_Output	(self, other, "DIA_Addon_Nadja_LuciaInfo_16_04"); //Asi ti moc nepomůžu, ale aspoŕ ti můžu âíct, co se stalo s Lucií.
	...
	Info_AddChoice	(DIA_Addon_Nadja_LuciaInfo, "Vyprávęj mi o Lucii.", DIA_Addon_Nadja_LuciaInfo_lucia );
};
func void DIA_Addon_Nadja_LuciaInfo_lucia ()
{
	AI_Output	(other, self, "DIA_Addon_Nadja_LuciaInfo_lucia_15_00"); //Tak mi povęz nęco o Lucii.
...
func void DIA_Addon_Nadja_LuciaInfo_wo ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Nadja_LuciaInfo_wo_16_01"); //Často se scházela s Elvrichem, učnęm tesaâe Thorbena z dolní části męsta.
	AI_Output	(self, other, "DIA_Addon_Nadja_LuciaInfo_wo_16_02"); //Vsadím se, že utekla s tím mladíkem.

	Log_CreateTopic (TOPIC_Addon_Lucia, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_Lucia, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_Lucia,"Prostitutka Lucia jedné noci náhle zmizela. Všichni si myslí, že uprchla s Elvrichem, učedníkem tesaâe Thorbena."); 
...
func void DIA_Addon_Nadja_LuciaInfo_Elvrich ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_Elvrich_16_01"); //Jestli je nesežrali vlci, nejspíš zůstali u nęjakýho sedláka.
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_Elvrich_16_02"); //Kam jinam mohli jít?

	Info_AddChoice	(DIA_Addon_Nadja_LuciaInfo, "Víš ještę nęco dalšího?", DIA_Addon_Nadja_LuciaInfo_sonst );
};
func void DIA_Addon_Nadja_LuciaInfo_sonst ()
{
	AI_Output			(other, self, "DIA_Addon_Nadja_LuciaInfo_sonst_15_00"); //Víš ještę nęco dalšího?
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_sonst_16_01"); //Povídá se, že tady v pâístavu zmizela spousta lidí.
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_sonst_16_02"); //Ale nevím jistę, jestli jim vęâit.
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_sonst_16_03"); //Męl by sis promluvit s kupci tady dole.
	...
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_sonst_16_06"); //Nechceš se trochu pobavit, ještę než půjdeš?
...
func void DIA_Addon_Nadja_LuciaInfo_weiter ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Nadja_LuciaInfo_weiter_16_01"); //Škoda. Tak možná pâíštę.
...
func void DIA_Nadja_BUYHERB_Info ()
{
	...
	{	
		...
		{
			AI_Output (self, other, "DIA_Nadja_BUYHERB_16_02"); //Jestli ti vážnę mám nęco âíct, budeš se muset vytasit s ŕákou tou škvárou.
...
func void DIA_Nadja_WANT_HERB_Info ()
{
	...
	else
	{
		...
		AI_Output (self, other, "DIA_Nadja_WANT_HERB_16_02"); //Promluv si s Borkou, fešáku. Ten by pro tebe mohl nęco mít.
