...
instance DIA_CipherDJG_WHATNEXT		(C_INFO)
{
	...
	description	 = 	"Močálový drak je mrtvý! Co teë budeš dęlat?";
};
...
func void DIA_CipherDJG_WHATNEXT_Info ()
{
	...
	AI_Output	(self, other, "DIA_CipherDJG_WHATNEXT_07_01"); //Nemám tušení. Ještę jsem o tom nepâemýšlel, vážnę. Ale v každym pâípadę se teë můžeš vrátit do Khorinidu jako hrdina.
	AI_Output	(self, other, "DIA_CipherDJG_WHATNEXT_07_02"); //Vsadím se, že z toho jde docela dost vytęžit. Pâemýšlej o tom.

	B_LogEntry (TOPIC_Dragonhunter,"Když je močálový drak mrtvý, chce z toho Cipher vytâískat nęjaký prachy a stát se velkým 'hrdinou'. No, uvidíme."); 
