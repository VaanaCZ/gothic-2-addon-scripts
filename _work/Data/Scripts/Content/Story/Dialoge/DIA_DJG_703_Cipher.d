...
func void DIA_CipherDJG_HELLOAGAIN_Info ()
{
	...
	Info_AddChoice	(DIA_CipherDJG_HELLOAGAIN, "Radši zůstanu sám.", 	DIA_CipherDJG_HELLOAGAIN_GoAlone);
...
instance DIA_CipherDJG_GO		(C_INFO)
{
	...
	description	 = 	"Teď by mohla být ta správná chvíle, abysme vyrazili!";
};
...
{
	AI_Output			(other, self, "DIA_CipherDJG_GO_15_00"); //Teď by mohla být ta správná chvíle, abysme vyrazili!
...
func void DIA_CipherDJG_SWAMPDRAGONDEAD_Info ()
{
	...
	B_StartOtherRoutine	(DJG_Rod,"Začít");
};
...
instance DIA_CipherDJG_WHATNEXT		(C_INFO)
{
	...
	description	 = 	"Močálový drak je mrtvý! Co teď budeš dělat?";
};
...
{
	AI_Output	(other, self, "DIA_CipherDJG_WHATNEXT_15_00"); //Močálový drak je po smrti! Co budeš dělat teď?
	AI_Output	(self, other, "DIA_CipherDJG_WHATNEXT_07_01"); //Nemám tušení. Ještě jsem o tom nepřemýšlel, vážně. Ale v každym případě se teď můžeš vrátit do Khorinidu jako hrdina.
	AI_Output	(self, other, "DIA_CipherDJG_WHATNEXT_07_02"); //Vsadím se, že z toho jde docela dost vytěžit. Přemýšlej o tom.

	B_LogEntry (TOPIC_Dragonhunter,"Když je močálový drak mrtvý, chce z toho Cipher vytřískat nějaký prachy a stát se velkým 'hrdinou'. No, uvidíme."); 
