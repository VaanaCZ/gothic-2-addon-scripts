...
func void DIA_Lee_DI_Hallo_Info ()
{
	...
	AI_Output			(self, other, "DIA_Lee_DI_Hallo_04_01"); //Nękdo musí na loë dohlížet. Zůstanu tady a postarám se o to, aby tady byla, až se vrátíš.
...
instance DIA_Lee_DI_UndeadDragonDead		(C_INFO)
{
	...
	description = 	"Teë si půjdeme po svém.";
};
	...
	&& (hero.guild == GIL_DJG)
		{
			...
			AI_Output (self ,other, "DIA_Lee_Add_04_2&"); //Pak budu moct konečnę navštívit krále, což už dlouho odkládám.
