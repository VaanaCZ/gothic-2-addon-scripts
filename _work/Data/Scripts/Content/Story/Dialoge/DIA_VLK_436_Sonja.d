...
func void DIA_Sonja_STANDARD_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_00"); //Jeśli chcesz się zabawić, pogadaj z Bromorem.
	}
	else if (other.guild == GIL_DJG)
	&& (Sonja_Says == FALSE)
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_01"); //Problem z wami panowie jest taki, że miast uprawiać porządny seks, wolicie wytaczać krew z orków.
		Sonja_Says = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_02"); //Jeśli szukasz miłych słówek, znajdź sobie babę i się z nią ożeń.
	};
	AI_StopProcessInfos (self);
};
