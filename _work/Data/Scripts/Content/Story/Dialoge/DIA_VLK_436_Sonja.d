...
func void DIA_Sonja_STANDARD_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_00"); //Parla con Bromor se vuoi divertirti.
	}
	else if (other.guild == GIL_DJG)
	&& (Sonja_Says == FALSE)
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_01"); //Il problema con voi ragazzi è che preferite macellare orchi che andare a donne.
		Sonja_Says = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_02"); //Se hai bisogno di chiacchiere, cercati una donna e sposala.
	};
	AI_StopProcessInfos (self);
};
