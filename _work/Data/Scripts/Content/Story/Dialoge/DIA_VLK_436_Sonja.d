...
func void DIA_Sonja_STANDARD_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_00"); //Habla con Bromor si quieres divertirte.
	}
	else if (other.guild == GIL_DJG)
	&& (Sonja_Says == FALSE)
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_01"); //El problema con vosotros es que preferís matar orcos que fornicar.
		Sonja_Says = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_02"); //Si lo que buscas es conversación, échate una novia y cásate con ella.
	};
	AI_StopProcessInfos (self);
};
