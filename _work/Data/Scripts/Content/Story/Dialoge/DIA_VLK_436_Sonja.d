...
func void DIA_Sonja_STANDARD_Info ()
{
	...
	&& (Sonja_Says == FALSE)
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_01"); //To je problém vás chlapù - radši byste vraždili skâety, než zatloukli hâebík.
		Sonja_Says = TRUE;
	}
	else
	{
		AI_Output (self, other, "DIA_Sonja_STANDARD_16_02"); //Jestli se rád s nêkým vybavuješ, najdi si babu a ožeà se s ní.
	};
	AI_StopProcessInfos (self);
};
