...
INSTANCE DIA_Addon_BDT_10018_Torwache_EXIT (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Volveremos a hablar.";
};        
...
{
	AI_Output (other, self,"DIA_Addon_BDT_10018_Torwache_EXIT_15_00"); //Volveremos a hablar.
	
	if (BDT_100018_Einmal == FALSE)
	{
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_EXIT_04_01"); //Pues ya sabes lo que te dir
		BDT_100018_Einmal = TRUE;
	}
	else
	{
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_EXIT_04_02"); //Largo.
	};
...
func void DIA_Addon_BDT_10018_Torwache_FirstWarn_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_00"); //¡Eh, tranquilo! ¡No vas a entrar aquí, así que largo!
		AI_Output (other, self,"DIA_Addon_BDT_10018_Torwache_FirstWarn_15_01"); //Aparta de mi camino, tengo que ver a Raven.
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_02"); //Nadie entra en este lugar. Órdenes directas del propio Raven.
		BDT_100018_Tells = TRUE;
		
		Log_CreateTopic (Topic_Addon_Tempel,LOG_MISSION);
		Log_SetTopicStatus (Topic_Addon_Tempel,LOG_RUNNING);
		B_LogEntry (Topic_Addon_Tempel,"El centinela de la puerta del templo no me deja pasar. Tendré que encontrar el modo de entrar.");
	}
	else
	{	
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_03"); //¿Tú de nuevo? ¡Me vas a hacer perder la paciencia!
		//AI_StopProcessInfos(self);
	};			
...
{
	AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_SecondWarn_04_00"); //¡Un paso más y será el último que des!
...
func void DIA_Addon_BDT_10018_Torwache_Attack_Info()
{
	...
	AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_Attack_04_00"); //¡Por Raven!
...
INSTANCE DIA_Addon_BDT_10018_Torwache_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Es imprescindible que lo vea.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Hi_15_00");//Es imprescindible que lo vea.
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Hi_04_01");//No, no lo es. Sólo Bloodwyn tiene permiso para estar aquí.
	
	B_LogEntry (Topic_Addon_Tempel,"Sólo Bloodwyn puede quedarse en el templo. Quizá pueda pasar con su mediación.");
};
//----------------------------------------------------------------------
//	Info Bloodwyn
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Bloodwyn   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "¿Bloodwyn? ¿Pero no estaba muerto?";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Bloodwyn_15_00");//¿Bloodwyn? ¿Pero no estaba muerto?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Bloodwyn_04_01");//Está más fuerte que nunca. Y si se entera de que alguien anda causando problemas aquí fuera, te hará picadillo.
};
//----------------------------------------------------------------------
//	Info Bribe
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Bribe   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Te daré 1000 monedas de oro si me dejas pasar.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Bribe_15_00");//Te doy mil monedas de oro si me dejas pasar.
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Bribe_04_01");//Pierdes el tiempo, miserable.
};
//----------------------------------------------------------------------
//	Info Drin
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Drin   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "¿Bloodwyn está dentro? Que salga, entonces.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Drin_15_00");//¿Bloodwyn está dentro? Pues sácalo.
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_01");//¡Ja! ¿Crees de verdad que pienso hacerlo?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_02");//Puede que ahora seas alguien importante en el campamento, pero tu poder termina JUSTO AQUÍ. ¿Entendido?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_03");//Ve a la mina a extraer oro o lo que quieras, ¡pero largo de mi vista!
	
	MIS_BloodwynRaus = LOG_RUNNING;

	B_LogEntry (Topic_Addon_Tempel,"Bloodwyn está en el templo, pero yo no pienso seguir adelante. Quizá debería inspeccionar la mina.");
};
//----------------------------------------------------------------------
//	Info kopf
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_kopf   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "(enseña la cabeza de Bloodwyn)";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_kopf_15_00");//¡Toma! ¿¡Aún quieres detenerme!?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_kopf_04_01");//¿Es… es… Bloodwyn? Vaya, es
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_kopf_04_02");//Uh…sí, uh, no. Digooo... uh... Puedes entrar...
