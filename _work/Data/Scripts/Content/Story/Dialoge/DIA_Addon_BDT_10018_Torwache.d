...
INSTANCE DIA_Addon_BDT_10018_Torwache_EXIT (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Ještì si promluvíme.";
};        
...
{
	AI_Output (other, self,"DIA_Addon_BDT_10018_Torwache_EXIT_15_00"); //Ještì si promluvíme.
	
	if (BDT_100018_Einmal == FALSE)
	{
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_EXIT_04_01"); //Stejnì už víš, co ti teï povím.
...
func void DIA_Addon_BDT_10018_Torwache_FirstWarn_Info()
{
	...
	if ( BDT_100018_Tells == FALSE)
	{
		...
		AI_Output (other, self,"DIA_Addon_BDT_10018_Torwache_FirstWarn_15_01"); //Jdi mi z cesty - musím vidìt Havrana!
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_02"); //Sem nikdo nesmí. Pøímý rozkazy vod samotnýho Havrana.
		BDT_100018_Tells = TRUE;
		
		Log_CreateTopic (Topic_Addon_Tempel,LOG_MISSION);
		Log_SetTopicStatus (Topic_Addon_Tempel,LOG_RUNNING);
		B_LogEntry (Topic_Addon_Tempel,"Strážce brány mì do chrámu nepustí. Musím najít zpùsob, jak se dostat dovnitø.");
	}
	else
	{	
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_03"); //To seš zase ty? Zaèínáš mi jít pìknì na nervy.
		//AI_StopProcessInfos(self);
	};			
...
{
	AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_SecondWarn_04_00"); //Ještì krok a je po tobì.
...
INSTANCE DIA_Addon_BDT_10018_Torwache_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Zatracenì nutnì se k nìmu potøebuju dostat.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Hi_15_00");//Musím za ním! Je to zatracenì dùležitý!
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Hi_04_01");//Ne, není. Jedinej, kdo má povolení tu bejt, je Bloodwyn.
	
	B_LogEntry (Topic_Addon_Tempel,"V chrámu mùže zùstávat pouze Bloodwyn. Snad bych se pøes nìj mohl dostat dovnitø.");
};
//----------------------------------------------------------------------
//	Info Bloodwyn
//----------------------------------------------------------------------
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Bloodwyn_04_01");//Je silnìjší než kdy døív. A jestli zjistí, žes tu dìlal rotyku, nadìlá z tebe prejt.
};
//----------------------------------------------------------------------
//	Info Bribe
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Bribe   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Jestli mì pustíš dovnitø, dám ti tisíc zlaákù.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Bribe_15_00");//Když mì pustíš dovnitø, dám ti tisíc zlatých.
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Bribe_04_01");//Akorát mì zdržuješ, ubožáku.
};
//----------------------------------------------------------------------
//	Info Drin
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Drin   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Je tam Bloodwyn? Tak ho dostaò ven.";
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_01");//Ha! To si vážnì myslíš, že bych nìco takovýho udìlal?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_02");//Možná že teïka jsi v táboøe dùležitej, ale tvoje moc konèí PRÁVÌ TADY. Kapišto?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_03");//Tak si bìž do dolu a doluj si zlato nebo nìco jinýho, ale tady nepøekážej!
	
	MIS_BloodwynRaus = LOG_RUNNING;

	B_LogEntry (Topic_Addon_Tempel,"Bloodwyn je v chrámu, ale odsud se nedostanu nikam. Mìl bych to spíš obhlédnout kolem dolu.");
};
//----------------------------------------------------------------------
//	Info kopf
//----------------------------------------------------------------------
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_kopf_15_00");//Hele! Poøád si myslíš, že mì zastavíš?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_kopf_04_01");//To je... to je Bloodwyn? Fuj tajbl, to je...
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_kopf_04_02");//No jo, teda ne... Vlastnì... no, myslím, že mùžeš jít dál.
