...
INSTANCE DIA_Addon_BDT_10018_Torwache_EXIT (C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Ještê si promluvíme.";
};        
...
{
	AI_Output (other, self,"DIA_Addon_BDT_10018_Torwache_EXIT_15_00"); //Ještê si promluvíme.
	
	if (BDT_100018_Einmal == FALSE)
	{
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_EXIT_04_01"); //Stejnê už víš, co ti teë povím.
...
func void DIA_Addon_BDT_10018_Torwache_FirstWarn_Info()
{
	...
	if ( BDT_100018_Tells == FALSE)
	{
		...
		AI_Output (other, self,"DIA_Addon_BDT_10018_Torwache_FirstWarn_15_01"); //Jdi mi z cesty - musím vidêt Havrana!
		...
		B_LogEntry (Topic_Addon_Tempel,"Strážce brány mê do chrámu nepustí. Musím najít zpùsob, jak se dostat dovnitâ.");
	}
	else
	{	
		AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_FirstWarn_04_03"); //To seš zase ty? Zaèínáš mi jít pêknê na nervy.
		//AI_StopProcessInfos(self);
	};			
...
{
	AI_Output (self, other,"DIA_Addon_BDT_10018_Torwache_SecondWarn_04_00"); //Ještê krok a je po tobê.
...
INSTANCE DIA_Addon_BDT_10018_Torwache_Hi   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Zatracenê nutnê se k nêmu potâebuju dostat.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Hi_15_00");//Musím za ním! Je to zatracenê dùležitý!
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Hi_04_01");//Ne, není. Jedinej, kdo má povolení tu bejt, je Bloodwyn.
	
	B_LogEntry (Topic_Addon_Tempel,"V chrámu mùže zùstávat pouze Bloodwyn. Snad bych se pâes nêj mohl dostat dovnitâ.");
};
//----------------------------------------------------------------------
//	Info Bloodwyn
//----------------------------------------------------------------------
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Bloodwyn_04_01");//Je silnêjší než kdy dâív. A jestli zjistí, žes tu dêlal rotyku, nadêlá z tebe prejt.
};
//----------------------------------------------------------------------
//	Info Bribe
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Bribe   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Jestli mê pustíš dovnitâ, dám ti tisíc zlaãákù.";
};
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_Bribe_15_00");//Když mê pustíš dovnitâ, dám ti tisíc zlatých.
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Bribe_04_01");//Akorát mê zdržuješ, ubožáku.
};
//----------------------------------------------------------------------
//	Info Drin
//----------------------------------------------------------------------
INSTANCE DIA_Addon_BDT_10018_Torwache_Drin   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Je tam Bloodwyn? Tak ho dostaà ven.";
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_01");//Ha! To si vážnê myslíš, že bych nêco takovýho udêlal?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_02");//Možná že teëka jsi v táboâe dùležitej, ale tvoje moc konèí PRÁVÊ TADY. Kapišto?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_Drin_04_03");//Tak si bêž do dolu a doluj si zlato nebo nêco jinýho, ale tady nepâekážej!
	
	MIS_BloodwynRaus = LOG_RUNNING;

	B_LogEntry (Topic_Addon_Tempel,"Bloodwyn je v chrámu, ale odsud se nedostanu nikam. Mêl bych to spíš obhlédnout kolem dolu.");
};
//----------------------------------------------------------------------
//	Info kopf
//----------------------------------------------------------------------
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10018_Torwache_kopf_15_00");//Hele! Poâád si myslíš, že mê zastavíš?
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_kopf_04_01");//To je... to je Bloodwyn? Fuj tajbl, to je...
	AI_Output (self, other, "DIA_Addon_BDT_10018_Torwache_kopf_04_02");//No jo, teda ne... Vlastnê... no, myslím, že mùžeš jít dál.
