...
INSTANCE DIA_Grimes_Erz(C_INFO)
{
	...
	permanent	= FALSE;
	description	= "Kolik rudy už jsi vytêžil?";
};                       
...
{	
	AI_Output (other,self,"DIA_Grimes_Erz_15_00");//Kolik rudy už jsi vytêžil?
	AI_Output (self,other,"DIA_Grimes_Erz_05_01");//Nêkolik beden. Ale nic z toho tady nezùstalo.
...
{	
	...
	AI_Output (self,other,"DIA_Grimes_Weg_05_01");//Nešel pâímou cestou - místo toho chtêl pâejít âeku tam, kde byla zamrzlá.
	AI_Output (self,other,"DIA_Grimes_Weg_05_02");//Chtêl si to zkrátit a dostat se k hradu ze západu.
};
// ************************************************************
// 			  Grimes
// ************************************************************
...
{	
	...
	AI_Output (self,other,"DIA_Grimes_Grimes_05_01");//Ne, zùstanu a budu têžit rudu.
	AI_Output (self,other,"DIA_Grimes_Grimes_05_02");//Nenechám se zastavit nêkolika skâety - už jsem pâeèkal horší èasy.
	AI_Output (self,other,"DIA_Grimes_Grimes_05_03");//Pamatuješ, jak jsme têžili ve starém dole a najednou se dovnitâ provalila voda...
	AI_Output (self,other,"DIA_Grimes_Grimes_05_04");//Ale to jsou staré pâíbêhy.
};
// ************************************************************
// 			  Grimes
// ************************************************************
...
{	
	...
	AI_Output (self,other,"DIA_Grimes_PERM_05_01");//Tahle skála je zatracené nepoddajná - úplnê jako by se snažila nám zabránit v získávání rudy.
};
