...
INSTANCE DIA_Pal_213_Schiffswache_IAmPAL2   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Pak bys męl vędęt, kdo z nás má vyšší hodnost.";
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmPAL3   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Tímto ti dávám rozkaz, abys mę pustil na loë.";
};
...
INSTANCE DIA_Pal_213_Schiffswache_IAmDJG3   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Mám na to písemné zplnomocnęní.";
};
