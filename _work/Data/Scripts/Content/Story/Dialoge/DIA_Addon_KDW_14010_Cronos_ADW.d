...
{
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_00"); //Rád tì vidím. Už jsme se obávali nejhoršího.
	AI_Output	(other, self, "DIA_Addon_Cronos_ADWHello_15_01"); //Nebylo to tak zlé. Jak se vede?
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_02"); //Tady je to vážnì nebezpeèné.
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_03"); //Nìkterá zdejší zvíøata jsme ještì nikdy nevidìli.
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_04"); //Kousek odsud je velká bažina, která se rozšiøovala už nìkolik set let, aniž by si toho kdo všiml.
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_05"); //Není dne, aby na nás z tìch bažin nezaútoèily nìjaké bestie.
...
instance DIA_Addon_Cronos_WaechterADW		(C_INFO)
{
	...
	description	 = 	"Dozvìdìl ses o tìch kamenných strážcích nìco nového?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Cronos_WaechterADW_15_00"); //Víte nìco nového o tìch kamenných strážcích?
	...
	AI_Output	(self, other, "DIA_Addon_Cronos_WaechterADW_04_03"); //Ale zdání klame. Jakmile se k nim pøiblížíš, napadnou tì.
	AI_Output	(self, other, "DIA_Addon_Cronos_WaechterADW_04_04"); //Je jasné, že zdroj jejich moci musí být nìkde tady kolem.
};
