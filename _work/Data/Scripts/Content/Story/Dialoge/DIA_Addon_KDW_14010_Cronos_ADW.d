...
{
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_00"); //Rád tê vidím. Už jsme se obávali nejhoršího.
	AI_Output	(other, self, "DIA_Addon_Cronos_ADWHello_15_01"); //Nebylo to tak zlé. Jak se vede?
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_02"); //Tady je to vážnê nebezpeèné.
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_03"); //Nêkterá zdejší zvíâata jsme ještê nikdy nevidêli.
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_04"); //Kousek odsud je velká bažina, která se rozšiâovala už nêkolik set let, aniž by si toho kdo všiml.
	AI_Output	(self, other, "DIA_Addon_Cronos_ADWHello_04_05"); //Není dne, aby na nás z têch bažin nezaútoèily nêjaké bestie.
...
instance DIA_Addon_Cronos_WaechterADW		(C_INFO)
{
	...
	description	 = 	"Dozvêdêl ses o têch kamenných strážcích nêco nového?";
};
...
{
	AI_Output	(other, self, "DIA_Addon_Cronos_WaechterADW_15_00"); //Víte nêco nového o têch kamenných strážcích?
	...
	AI_Output	(self, other, "DIA_Addon_Cronos_WaechterADW_04_03"); //Ale zdání klame. Jakmile se k nim pâiblížíš, napadnou tê.
	AI_Output	(self, other, "DIA_Addon_Cronos_WaechterADW_04_04"); //Je jasné, že zdroj jejich moci musí být nêkde tady kolem.
};
