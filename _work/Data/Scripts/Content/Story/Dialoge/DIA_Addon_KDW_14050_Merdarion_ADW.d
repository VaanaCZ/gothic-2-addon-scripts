...
func void DIA_Addon_Merdarion_ADWHello_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_06_03"); //Tyhle teleportační kameny se tváâí, že nefungují. Není z nich slyšet žádný šum.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_06_04"); //Ale i když nejsou aktivní, stále v nich dâímá nęjaká energie.
...
func void DIA_Addon_Merdarion_ADWHello_was ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_was_06_01"); //Tak o tom mám jistou pâedstavu, ale potâebuji důkaz.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_was_06_02"); //Pâed pár dny jsem męl pocit, že jsem podobnou stavbu už nękde vidęl.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_was_06_03"); //Myslím, že jim budeme muset dát zatracenę hodnę energie, abychom je znovu uvedli do chodu.
	
	Info_AddChoice	(DIA_Addon_Merdarion_ADWHello, "Kde už jsi tyhle teleportační kameny vidęl?", DIA_Addon_Merdarion_ADWHello_wo );
...
func void DIA_Addon_Merdarion_ADWHello_focus ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focus_06_01"); //Napadá mę jen jedna vęc. Magické ohnisko.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focus_06_02"); //Myslím jeden z pęti ohniskových kamenů, které kdysi sloužily k vytvoâení magické bariéry kolem Hornického údolí.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focus_06_03"); //Pokud vím, pâed časem jsi nám je vrátil.
	AI_Output			(other, self, "DIA_Addon_Merdarion_ADWHello_focus_15_04"); //Ano, na to si vzpomínám.
	
	Info_AddChoice	(DIA_Addon_Merdarion_ADWHello, "Tvrdil jsi, že pro své podezâení potâebuješ důkaz.", DIA_Addon_Merdarion_ADWHello_focusProof );
...
func void DIA_Addon_Merdarion_ADWHello_focusWo ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focusWo_06_01"); //Byly svęâeny mnę. Mám je chovat v bezpečí, dokud se pro nę nenajde jiné využití.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focusWo_06_02"); //A jak to tak vypadá, tak právę nadešel ten správný čas.
...
{
	AI_Output			(other, self, "DIA_Addon_Merdarion_ADWHello_focusProof_15_00"); //Pravil jsi, že pro své teorie potâebuješ důkaz.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focusProof_06_01"); //Magické ohnisko by męlo být pâipojeno k tęmto kamenům.
...
{
	AI_Output	(other, self, "DIA_Addon_Merdarion_ADWHello_wo_15_00"); //Kde už jsi tyhle teleportační kameny vidęl?
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_wo_06_01"); //Byl jsi taky v trestanecké kolonii. Copak sis tęch kamenů vůbec nevšiml?
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_wo_06_02"); //Vím celkem jistę, že tam leží dodnes.
};
func void DIA_Addon_Merdarion_ADWHello_reaktor ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_reaktor_06_02"); //Používali takovou magii, jakou jsem nikdy nevidęl.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_reaktor_06_03"); //Vybudovali celou síă teleportačních kamenů, aby se ve męstę mohli rychle pâesouvat z místa na místo.
...
func void DIA_Addon_Merdarion_FokusGeben_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_FokusGeben_06_01"); //Dobâe, ale dávej na nęj pozor, slyšíš?
	...
	B_LogEntry (TOPIC_Addon_TeleportsADW,"Vodní mág Merdarion mi dal jeden ze starých ohniskových kamenů, s jejichž pomocí kdysi vznikla bariéra v Hornickém údolí. Zkusím s ním aktivovat nękterý z teleportačních kamenů."); 
};
...
func void DIA_Addon_Merdarion_FirstFocus_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_FirstFocus_06_01"); //Už jsem si toho všiml. Takže jsem męl pravdu.
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_FirstFocus_06_04"); //Velmi by nám pomohlo v pátrání, kdybychom se mohli rychle pâesouvat z jedné části męsta do druhé.
	...
	B_LogEntry (TOPIC_Addon_TeleportsADW,"Merdarion mi dal další ohniskový kámen. Mám zkusit oživit všechny teleportační kameny. Vždycky až nękterý z nich zprovozním, dá mi další ohniskový kámen."); 
};
...
func void DIA_Addon_Merdarion_ActivateTeleports_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_03"); //Bylo to tęžké?
		AI_Output	(other, self, "DIA_Addon_Merdarion_ActivateTeleports_15_04"); //To záleží na tom, jak se na to díváš. Nęjaká pomoc by se mi hodila.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_08"); //Vedl sis vážnę dobâe. Mohu ti za tvou práci jen blahopâát.
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_09"); //Teë už fungují všechny. Je to ale působivý pohled, co âíkáš?
	};
	
	AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_10"); //Tady máš pár zlaăáků.
	B_GivePlayerXP (XP_Addon_ActivatedTeleportStone);
	...
	&& (Ghost_SCKnowsHow2GetInAdanosTempel == FALSE)
 	...
 	{
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_11"); //Jo, abych nezapomnęl, chtęl s tebou mluvit Saturas.
...
FUNC VOID DIA_Addon_Merdarion_ADW_TEACH_MANA_BACK()
{
	if (other.attribute[ATR_MANA_MAX] >= T_HIGH)  
	{
		...
		AI_Output (self, other, "DIA_Addon_Merdarion_ADW_TEACH_MANA_06_01"); //Nic víc už tę naučit nemohu.
