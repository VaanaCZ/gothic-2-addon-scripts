...
func void DIA_Addon_Merdarion_ADWHello_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_06_03"); //Tyhle teleportaèní kameny se tváøí, že nefungují. Není z nich slyšet žádný šum.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_06_04"); //Ale i když nejsou aktivní, stále v nich døímá nìjaká energie.
...
func void DIA_Addon_Merdarion_ADWHello_was ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_was_06_01"); //Tak o tom mám jistou pøedstavu, ale potøebuji dùkaz.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_was_06_02"); //Pøed pár dny jsem mìl pocit, že jsem podobnou stavbu už nìkde vidìl.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_was_06_03"); //Myslím, že jim budeme muset dát zatracenì hodnì energie, abychom je znovu uvedli do chodu.
	
	Info_AddChoice	(DIA_Addon_Merdarion_ADWHello, "Kde už jsi tyhle teleportaèní kameny vidìl?", DIA_Addon_Merdarion_ADWHello_wo );
...
func void DIA_Addon_Merdarion_ADWHello_focus ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focus_06_01"); //Napadá mì jen jedna vìc. Magické ohnisko.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focus_06_02"); //Myslím jeden z pìti ohniskových kamenù, které kdysi sloužily k vytvoøení magické bariéry kolem Hornického údolí.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focus_06_03"); //Pokud vím, pøed èasem jsi nám je vrátil.
	AI_Output			(other, self, "DIA_Addon_Merdarion_ADWHello_focus_15_04"); //Ano, na to si vzpomínám.
	
	Info_AddChoice	(DIA_Addon_Merdarion_ADWHello, "Tvrdil jsi, že pro své podezøení potøebuješ dùkaz.", DIA_Addon_Merdarion_ADWHello_focusProof );
	Info_AddChoice	(DIA_Addon_Merdarion_ADWHello, "Kde jsou ty ohniskové kameny teï?", DIA_Addon_Merdarion_ADWHello_focusWo );
};
func void DIA_Addon_Merdarion_ADWHello_focusWo ()
{
	AI_Output			(other, self, "DIA_Addon_Merdarion_ADWHello_focusWo_15_00"); //Kde jsou ty ohniskové kameny teï?
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focusWo_06_01"); //Byly svìøeny mnì. Mám je chovat v bezpeèí, dokud se pro nì nenajde jiné využití.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focusWo_06_02"); //A jak to tak vypadá, tak právì nadešel ten správný èas.
...
{
	AI_Output			(other, self, "DIA_Addon_Merdarion_ADWHello_focusProof_15_00"); //Pravil jsi, že pro své teorie potøebuješ dùkaz.
	AI_Output			(self, other, "DIA_Addon_Merdarion_ADWHello_focusProof_06_01"); //Magické ohnisko by mìlo být pøipojeno k tìmto kamenùm.
...
{
	AI_Output	(other, self, "DIA_Addon_Merdarion_ADWHello_wo_15_00"); //Kde už jsi tyhle teleportaèní kameny vidìl?
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_wo_06_01"); //Byl jsi taky v trestanecké kolonii. Copak sis tìch kamenù vùbec nevšiml?
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_wo_06_02"); //Vím celkem jistì, že tam leží dodnes.
};
func void DIA_Addon_Merdarion_ADWHello_reaktor ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_reaktor_06_02"); //Používali takovou magii, jakou jsem nikdy nevidìl.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_reaktor_06_03"); //Vybudovali celou sí teleportaèních kamenù, aby se ve mìstì mohli rychle pøesouvat z místa na místo.
	AI_Output	(self, other, "DIA_Addon_Merdarion_ADWHello_reaktor_06_04"); //A TENTO kámen nejspíš pøedstavuje jisté centrum.
};
...
func void DIA_Addon_Merdarion_FokusGeben_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_FokusGeben_06_01"); //Dobøe, ale dávej na nìj pozor, slyšíš?
	...
	B_LogEntry (TOPIC_Addon_TeleportsADW,"Vodní mág Merdarion mi dal jeden ze starých ohniskových kamenù, s jejichž pomocí kdysi vznikla bariéra v Hornickém údolí. Zkusím s ním aktivovat nìkterý z teleportaèních kamenù."); 
};
...
func void DIA_Addon_Merdarion_FirstFocus_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_FirstFocus_06_01"); //Už jsem si toho všiml. Takže jsem mìl pravdu.
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_FirstFocus_06_04"); //Velmi by nám pomohlo v pátrání, kdybychom se mohli rychle pøesouvat z jedné èásti mìsta do druhé.
	...
	B_LogEntry (TOPIC_Addon_TeleportsADW,"Merdarion mi dal další ohniskový kámen. Mám zkusit oživit všechny teleportaèní kameny. Vždycky až nìkterý z nich zprovozním, dá mi další ohniskový kámen."); 
};
...
func void DIA_Addon_Merdarion_ActivateTeleports_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_03"); //Bylo to tìžké?
		AI_Output	(other, self, "DIA_Addon_Merdarion_ActivateTeleports_15_04"); //To záleží na tom, jak se na to díváš. Nìjaká pomoc by se mi hodila.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_08"); //Vedl sis vážnì dobøe. Mohu ti za tvou práci jen blahopøát.
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_09"); //Teï už fungují všechny. Je to ale pùsobivý pohled, co øíkáš?
	};
	
	AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_10"); //Tady máš pár zlaákù.
	B_GivePlayerXP (XP_Addon_ActivatedTeleportStone);
	...
	&& (Ghost_SCKnowsHow2GetInAdanosTempel == FALSE)
 	...
 	{
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_11"); //Jo, abych nezapomnìl, chtìl s tebou mluvit Saturas.
		AI_Output	(self, other, "DIA_Addon_Merdarion_ActivateTeleports_06_12"); //Máš za ním zajít co nejdøíve.
	};
};
...
FUNC VOID DIA_Addon_Merdarion_ADW_TEACH_MANA_BACK()
{
	if (other.attribute[ATR_MANA_MAX] >= T_HIGH)  
	{
		...
		AI_Output (self, other, "DIA_Addon_Merdarion_ADW_TEACH_MANA_06_01"); //Nic víc už tì nauèit nemohu.
