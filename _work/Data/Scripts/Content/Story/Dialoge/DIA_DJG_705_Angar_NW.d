...
{	
	...
	{
	AI_Output (self ,other,"DIA_Angar_NW_AllDragonsDead_04_02"); //Zùstanu tady. Takže kdybys mê potâeboval, víš, kde mê hledat.
	};
};
...
func void DIA_Angar_NW_KnowWhereEnemy_Info ()
{
	...
	AI_Output			(self, other, "DIA_Angar_NW_KnowWhereEnemy_04_01"); //Èím dál budu od Hornického údolí, tím líp. Kdy vyrazíme?
		
	Log_CreateTopic (TOPIC_Crew, LOG_MISSION);                                                                                        	
	Log_SetTopicStatus(TOPIC_Crew, LOG_RUNNING); 	                                                                                  	
	B_LogEntry (TOPIC_Crew,"Angar je rád za každou míli, o kterou se vzdálí od Hornického údolí. Nabídl mi, že mê na cestê doprovodí.");  
	
	if (crewmember_count >= Max_Crew)
	{
		AI_Output			(other,self , "DIA_Angar_NW_KnowWhereEnemy_15_02"); //Momentálnê mám dost lidí na to, aby mohli âídit loë. Možná se k tobê pozdêji ještê vrátím.
		AI_Output			(self, other, "DIA_Angar_NW_KnowWhereEnemy_04_03"); //Fajn. Budu tady, kdybys mê potâeboval.
	}
	else 
	{
		Info_ClearChoices (DIA_Angar_NW_KnowWhereEnemy);
		Info_AddChoice (DIA_Angar_NW_KnowWhereEnemy,"Dám ti vêdêt, až budeme vyplouvat.",DIA_Angar_NW_KnowWhereEnemy_No);
...
{
	AI_Output (other,self ,"DIA_Angar_NW_KnowWhereEnemy_No_15_00"); //Dám ti vêdêt, až budeme vyplouvat.
...
instance DIA_Angar_NW_LeaveMyShip		(C_INFO)
{
	...
	PERMANENT 	 =  TRUE;
	description	 = 	"Zùstaà tady a starej se o své problémy.";
};
...
{
	AI_Output			(other, self, "DIA_Angar_NW_LeaveMyShip_15_00"); //Zùstaà tady a starej se o své problémy.
...
{
	AI_Output	(other, self, "DIA_Angar_NW_StillNeedYou_15_00"); //Vraã se na palubu.
	AI_Output	(self, other, "DIA_Angar_NW_StillNeedYou_04_01"); //Jsi horší než já. Trochu víc rozhodnosti by ti jen prospêlo. Ještê se uvidíme.
