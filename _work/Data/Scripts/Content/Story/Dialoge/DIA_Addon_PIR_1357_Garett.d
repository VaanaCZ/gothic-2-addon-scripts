...
{	
	AI_Output (self,other,"DIA_Addon_Garett_Anheuern_09_00"); //Aă tę ani nenapadne, že by ses chtęl pâidat k našemu oddílu.
	AI_Output (self,other,"DIA_Addon_Garett_Anheuern_09_01"); //Co si myslíš, že budou ostatní dęlat, až budu pryč, co?
	AI_Output (self,other,"DIA_Addon_Garett_Anheuern_09_02"); //Až se vrátím, nezbude v mý chajdę ani jediná bedna!
...
{	
	AI_Output (self,other,"DIA_Addon_Garett_Hello_09_00"); //A hele, kohopak to tu máme? Nękdo novej, a doufám, že nepatâí k tęm zatrolenejm banditům.
	AI_Output (self,other,"DIA_Addon_Garett_Hello_09_01"); //Jsem Garett. Když budeš nęco potâebovat, jsem ten pravej.
	AI_Output (self,other,"DIA_Addon_Garett_Hello_09_02"); //Mám na skladę skoro všecko – víno, zbranę a spoustu dalších vęcí, který by se ti mohly hodit.
	AI_Output (self,other,"DIA_Addon_Garett_Hello_09_03"); //Kromę koâalky – pro pití musíš zajít za Samuelem.
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Garett_Samuel_09_03"); //Hlavnę by ses męl zásobit koâalkou.
	AI_Output (self,other,"DIA_Addon_Garett_Samuel_09_04"); //Jsou tu lidi, co si moc nepotrpí na zelenáče, abych tak âek.
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Garett_Warez_09_02"); //Donedávna část prodával pâímo banditům.
	AI_Output (self,other,"DIA_Addon_Garett_Warez_09_03"); //Ale od tý doby, co s nima válčíme, chodí všecko zboží mnę.
};
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Garett_Bandits_09_03"); //Greg nám nakázal, abysme oddęlali každýho banditu, kterej se ukáže poblíž tábora.
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Garett_Greg_09_03"); //Nutí svýho pokladníka Francise vybírat tolik, že ještę pár grošů navíc a męl by na krku vzpouru.
	AI_Output (self, other, "DIA_Addon_Garett_Greg_09_04"); //A když nękdo z nás narazí na nęco FAKT cennýho, nekompromisnę si to zabaví pro sebe.
	AI_Output (self, other, "DIA_Addon_Garett_Greg_09_05"); //Jednou jsem na jedný královský fregatę čmajznul kompas.
	AI_Output (self, other, "DIA_Addon_Garett_Greg_09_06"); //A ten šmejd Greg mę pochopitelnę donutil, abych mu ho dal.
	AI_Output (self, other, "DIA_Addon_Garett_Greg_09_07"); //Pche! Nejspíš ho nękde zakopal, i se svejma ostatníma pokladama.
};
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Garett_Tips_09_01"); //Jednou mi vyprávęl, že můj kompas hlídá samotná smrt. A pak sa smál.
	AI_Output (other,self,"DIA_Addon_Garett_Tips_15_02"); //Ještę nęco?
	AI_Output (self,other,"DIA_Addon_Garett_Tips_09_03"); //Na jižním pobâeží je pláž, kam se dá dostat jedinę z moâe.
	AI_Output (self,other,"DIA_Addon_Garett_Tips_09_04"); //Greg tam prý často pobývá. Možná tam nęco najdeš.
	AI_Output (self,other,"DIA_Addon_Garett_Tips_09_05"); //Jednou jsem se tam šel mrknout, jako že bych tâeba nęco našel sám. Jenže se to tem hemží všelijakejma potvorama.
	AI_Output (self,other,"DIA_Addon_Garett_Tips_09_06"); //Jestli to chceš vážnę zkusit, nezapomeŕ si vzít krumpáč.
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Garett_GiveKompass_09_01"); //(šăastnę) Jo, to je on! Už jsem nedoufal, že ho znova uvidím.
	...
	{ 
		...
		AI_Output (self,other,"DIA_Addon_Garett_GiveKompass_09_04"); //Tumáš, vem si na oplátku tenhle opasek. Je to nejcennęjší, co mám.
		B_GiveInvItems (self, other, ItBE_Addon_Prot_EdgPoi, 1);
	}
	else if (self.aivar[AIV_DefeatedByPlayer] == FALSE)
	{
		AI_Output (self,other,"DIA_Addon_Garett_GiveKompass_09_05"); //Tenhle pásek si ode mę koupil, pamatuješ?
		AI_Output (self,other,"DIA_Addon_Garett_GiveKompass_09_06"); //A zaplatils za nęj spoustu penęz – (rychle) víc, než za kolik stál. Tak si vem aspoŕ zpátky svý zlato.
		B_GiveInvItems (self, other, itmi_gold, Value_ItBE_Addon_Prot_EdgPoi);
	};
	
	B_LogEntry (TOPIC_Addon_Kompass,"Garret męl velkou radost, že jsem mu vrátil kompas.");
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Garett_Francis_09_01"); //Greg mu pâedal velení, dokud bude pryč.
	AI_Output (self,other,"DIA_Addon_Garett_Francis_09_02"); //Ale Francis je jako velitel totálnę neschopnej!
	AI_Output (self,other,"DIA_Addon_Garett_Francis_09_03"); //Nedonutí ani Morgana, aby zvednul ten svůj línej zadek z postele.
	AI_Output (self,other,"DIA_Addon_Garett_Francis_09_04"); //Henry a jeho chlapi jsou jediní, kteâí tu nęco dęlaj.
	...
	if (GregIsBack == FALSE)
	{
		...
		AI_Output (self,other,"DIA_Addon_Garett_Francis_09_07"); //A všecky je poâádnę nakope do prdele.
	};
};
...
FUNC VOID DIA_Addon_Garett_PERM_Info()
{
	...
	|| (Npc_IsDead(Greg))
	{
		AI_Output (self ,other,"DIA_Addon_Garett_PERM_09_02"); //Od Gregova odchodu se tu nic moc nedęlo.
	}
	else
	{
		AI_Output (self ,other,"DIA_Addon_Garett_PERM_09_01"); //Když se teë Greg vrátil, všecko už zase začíná jít tak, jak má.
	};
};
