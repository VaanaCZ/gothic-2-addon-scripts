...
{
	AI_Output			(other, self, "DIA_Mil_332_Stadtwache_PERM_15_00"); //Comment ça se passe ?
	AI_Output			(self, other, "DIA_Mil_332_Stadtwache_PERM_04_01"); //Dégagez, je suis de service !
	AI_StopProcessInfos (self);
};
