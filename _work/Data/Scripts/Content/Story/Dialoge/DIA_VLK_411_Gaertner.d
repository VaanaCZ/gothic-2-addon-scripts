...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Job_09_01"); //A jak sądzisz, hę? Jestem ogrodnikiem, zajmuję się ogrodem.
	...
	AI_Output (self ,other,"DIA_Gaertner_Job_09_04"); //Raz chcieli mnie wpakować do Kolonii za zabójstwo jednego gościa.
	AI_Output (self ,other,"DIA_Gaertner_Job_09_05"); //Ale ponieważ gubernator Larius potrzebował ogrodnika, pozwolili mi tu zostać.
	AI_Output (self ,other,"DIA_Gaertner_Job_09_06"); //Z czasem ten ogród stał się moim domem. Bardzo się cieszę, że tak się stało.
};
//*************************************************************
//		
//*************************************************************
INSTANCE DIA_Gaertner_Plants(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Czy hodujesz również jakieś zioła?";
};                       
...
{	
	AI_Output (other,self ,"DIA_Gaertner_Plants_15_00"); //Czy hodujesz również jakieś zioła?
	AI_Output (self ,other,"DIA_Gaertner_Plants_09_01"); //Nawet kilka. Mam tutaj ogniste ziele i ogniste pokrzywy. Próbowałem też hodować bagienne ziele, ale nie za bardzo chce rosnąć w tych warunkach.
	AI_Output (self ,other,"DIA_Gaertner_Plants_09_02"); //Mam trochę świeżo ściętych roślin, więc gdybyś chciał coś kupić...
	
	Log_CreateTopic (Topic_CityTrader,LOG_NOTE);
	B_LogEntry (Topic_CityTrader,"Ogrodnik gubernatora może mi sprzedać rośliny.");
};
//*************************************************************
//		Trade
//*************************************************************
...
{	
	B_GiveTradeInv (self);
	AI_Output (other,self ,"DIA_Gaertner_Trade_15_00"); //Pokaż mi swoje towary.
};
//*************************************************************
//		Krautabak
//*************************************************************
INSTANCE DIA_Gaertner_Krautabak(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Mam tu trochę ziela.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Gaertner_Krautabak_15_00"); //Mam tu trochę ziela. Chcesz sobie zapalić?
	AI_Output (self ,other,"DIA_Gaertner_Krautabak_09_01"); //Sam nie wiem... A zresztą, dawaj je tutaj. Skręcę sobie jednego.
	...
	AI_Output (self ,other,"DIA_Gaertner_Krautabak_09_03"); //Mocny towar. Chyba już mi wystarczy.
...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Sign_09_00"); //A więc jesteś jednym z nas. Mam dla ciebie pożyteczną wskazówkę.
	AI_Output (self ,other,"DIA_Gaertner_Sign_09_01"); //W okolicznych domach bardzo często znajdziesz skrytki, otwierane przez naciśnięcie ukrytego przycisku.
	AI_Output (self ,other,"DIA_Gaertner_Sign_09_02"); //Ludzie zwykle trzymają w nich kosztowności.
};
