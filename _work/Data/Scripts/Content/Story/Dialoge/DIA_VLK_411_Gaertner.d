...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Job_09_03"); //Ano, a mêlo by to tak zùstat. Jsem rád, že tady mám klid.
	AI_Output (self ,other,"DIA_Gaertner_Job_09_04"); //Jednou mê chtêli poslat do trestanecké kolonie, protože jsem oddêlal jednoho chlápka.
	AI_Output (self ,other,"DIA_Gaertner_Job_09_05"); //Ale správce Larius potâeboval dalšího zahradníka, takže jsem tady mohl zùstat.
...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Plants_09_01"); //Pár. Pêstuju vrbky úzkolisté a ohnivé kopâivy. Taky jsem zkoušel trávu z bažin, ale vùbec se jí tady nedaâilo.
	AI_Output (self ,other,"DIA_Gaertner_Plants_09_02"); //Mno, právê jsem sklidil. Takže jestli chceš nêco koupit...
	
	Log_CreateTopic (Topic_CityTrader,LOG_NOTE);
	B_LogEntry (Topic_CityTrader,"Zahradník místodržícího mi mùže prodat nêjaké rostliny.");
};
//*************************************************************
//		Trade
//*************************************************************
...
INSTANCE DIA_Gaertner_Krautabak(C_INFO)
{
	...
	permanent	= FALSE;
	description = "Obstaral jsem ti nêjaký rostlinný tabák.";
};                       
...
{	
	...
	AI_Output (self ,other,"DIA_Gaertner_Sign_09_00"); //Tak ty jsi jedním z nás. Mám pro tebe nêkolik užiteèných informací.
	AI_Output (self ,other,"DIA_Gaertner_Sign_09_01"); //Nêkolik domù tady nahoâe má tajné skrýše, které je možné otevâít jen pomocí nêjakého ukrytého spínaèe.
