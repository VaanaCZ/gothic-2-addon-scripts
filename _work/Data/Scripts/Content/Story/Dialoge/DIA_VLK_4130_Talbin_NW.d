...
instance DIA_Talbin_NW		(C_INFO)
{
	...
	description	 = 	"No proszę, przełęcz nie była chyba aż tak straszna?";
};
...
{
	AI_Output			(other, self, "DIA_Talbin_NW_15_00"); //No proszę, przełęcz nie była chyba aż tak straszna?
	AI_Output			(self, other, "DIA_Talbin_NW_07_01"); //Dzięki za ratunek.
	AI_Output			(self, other, "DIA_Talbin_NW_07_02"); //Proszę, znalazłem ten kamień na przełęczy. Myślę, że ci się przyda.

	if (hero.guild == GIL_KDF)
	{
	AI_Output			(self, other, "DIA_Talbin_NW_07_03"); //To chyba kamień runiczny.
	CreateInvItems (self, ItMi_RuneBlank, 1);									
	B_GiveInvItems (self, other, ItMi_RuneBlank, 1);					
	}
	else
	{
	AI_Output			(self, other, "DIA_Talbin_NW_07_04"); //To chyba kawałek rudy.
	CreateInvItems (self, ItMi_Nugget, 1);									
	B_GiveInvItems (self, other, ItMi_Nugget, 1);					
	};
	
	AI_Output			(self, other, "DIA_Talbin_NW_07_05"); //Niech Innos ma cię w swojej opiece.
...
{
	AI_Output			(other, self, "DIA_Talbin_NW_PERM_15_00"); //Wszystko w porządku?
	AI_Output			(self, other, "DIA_Talbin_NW_PERM_07_01"); //Tak, dziękuję. Idź już, poradzę sobie.
	AI_StopProcessInfos (self);
};
