...
func void DIA_Talbin_NW_Info ()
{
	...
	AI_Output			(self, other, "DIA_Talbin_NW_07_05"); //Nechť tě Innos ochraňuje.
...
{
	AI_Output			(other, self, "DIA_Talbin_NW_PERM_15_00"); //Je všechno v pořádku?
	AI_Output			(self, other, "DIA_Talbin_NW_PERM_07_01"); //Jo, díky tobě. A teď už běž, budu v pohodě.
	AI_StopProcessInfos (self);
};
