...
instance DIA_Talbin_NW		(C_INFO)
{
	...
	description	 = 	"V tom prùsmyku to nebylo tak hrozné, co?";
};
...
{
	AI_Output			(other, self, "DIA_Talbin_NW_15_00"); //V tom prùsmyku to nebylo tak hrozné, co?
	AI_Output			(self, other, "DIA_Talbin_NW_07_01"); //Díky za záchranu.
	AI_Output			(self, other, "DIA_Talbin_NW_07_02"); //Na, tenhle šutrák sem našel v prùsmyku. Myslím, že se ti bude hodit.

	if (hero.guild == GIL_KDF)
	{
	AI_Output			(self, other, "DIA_Talbin_NW_07_03"); //Poèítám, že je to runovej kámen.
	...
	AI_Output			(self, other, "DIA_Talbin_NW_07_05"); //Nechã tê Innos ochraàuje.
...
func void DIA_Talbin_NW_PERM_Info ()
{
	...
	AI_Output			(self, other, "DIA_Talbin_NW_PERM_07_01"); //Jo, díky tobê. A teë už bêž, budu v pohodê.
	AI_StopProcessInfos (self);
};
