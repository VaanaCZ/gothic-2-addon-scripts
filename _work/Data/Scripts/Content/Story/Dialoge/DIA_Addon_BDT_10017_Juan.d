...
{	
	...
	AI_Output (self,other,"DIA_Addon_Juan_HI_13_01");//Co chceš? Chceš mi âíct nęco důležitýho? Jestli ne, tak můžeš zase jít.
	
	if !Npc_IsDead (Freund)
	{
		AI_Output (self,other,"DIA_Addon_Juan_HI_13_02");//Jinak z tebe můj kámoš nadęlá sekanou. Tak co je?
...
INSTANCE DIA_Addon_Juan_Losung   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Prý máš nęco zajímavého na prodej...";
};
...
{	
	AI_Output (other,self,"DIA_Addon_Juan_Losung_15_00");//Prý máš na prodej nęco zajímavého.
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_01");//Takže Esteban mę chce vodit za nos? Už celý dny makám jak barevnej a musím se schovávat v týhle mizerný díâe.
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_02");//A on mi sem kliëánko pošle nękoho s dalšíma krámama? Já nejsem žádný skladištę!
	AI_Output (other,self,"DIA_Addon_Juan_Losung_15_03");//No a? To není můj problém.
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_04");//Ale to si piš, že jo, o to se postarám. Chceš zásilku? Dobâe, můžeš za ni zaplatit!
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_05");//Sežeŕ si zlato u Estebana, u Havrana nebo já nevím kde. Mnę je to fuk. Ale každej, kdo chce tohle zboží, za nęj musí zaplatit!
};
...
INSTANCE DIA_Addon_Juan_AufsMaul (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Mę neposlal Esteban!";
};
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Juan_AufsMaul_13_01"); //Fakt? No, tak to teda... Moment! Stůj, máš nęco na rameni.
