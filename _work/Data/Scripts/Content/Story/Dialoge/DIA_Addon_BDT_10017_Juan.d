...
{	
	...
	AI_Output (self,other,"DIA_Addon_Juan_HI_13_01");//Co chceš? Chceš mi øíct nìco dùležitýho? Jestli ne, tak mùžeš zase jít.
...
INSTANCE DIA_Addon_Juan_Losung   (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Prý máš nìco zajímavého na prodej...";
};
...
{	
	AI_Output (other,self,"DIA_Addon_Juan_Losung_15_00");//Prý máš na prodej nìco zajímavého.
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_01");//Takže Esteban mì chce vodit za nos? Už celý dny makám jak barevnej a musím se schovávat v týhle mizerný díøe.
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_02");//A on mi sem kliïánko pošle nìkoho s dalšíma krámama? Já nejsem žádný skladištì!
	AI_Output (other,self,"DIA_Addon_Juan_Losung_15_03");//No a? To není mùj problém.
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_04");//Ale to si piš, že jo, o to se postarám. Chceš zásilku? Dobøe, mùžeš za ni zaplatit!
	AI_Output (self,other,"DIA_Addon_Juan_Losung_13_05");//Sežeò si zlato u Estebana, u Havrana nebo já nevím kde. Mnì je to fuk. Ale každej, kdo chce tohle zboží, za nìj musí zaplatit!
};
