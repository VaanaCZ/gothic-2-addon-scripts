...
{	
	AI_Output (other, self, "DIA_Addon_HammerPirate_Hello_15_00"); //Všecko v pohodě?
	if (self.aivar[AIV_PARTYMEMBER] == TRUE)
	{
		if (C_TowerBanditsDead() == TRUE)
		{
			AI_Output (self, other, "DIA_Addon_HammerPirate_Hello_07_01"); //Jasně, už je to hotový. Ti šmejdi jsou teď na placičku!
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_HammerPirate_Hello_07_02"); //Tak pojďme na to!
		};
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_HammerPirate_Hello_07_03"); //Ne! Vůbec mě to tady nebaví.
	};
};
...
{	
	...
	AI_Output (other,self ,"DIA_Addon_PIR_6_JoinHenry_15_08"); //Přesně tak.
...
func void DIA_Addon_HammerPirate_ComeOn_Info ()
{
	...
	{
		AI_Output (self ,other,"DIA_Addon_HammerPirate_ComeOn_07_01"); //Henry potřebuje, aby jeden z nás zůstal TADY.
	}
	else if (Npc_GetDistToWP (self, "ADW_PIRATECAMP_WAY_08") > 6000)
	{	
		AI_Output (self ,other,"DIA_Addon_HammerPirate_ComeOn_07_02"); //Vraťme se kousek směrem k táboru.
		AI_StopProcessInfos (self);
	}
	else
	{
...
{	
	AI_Output (self ,other,"DIA_Addon_HammerPirate_TooFar_07_01"); //Jestli chceš jít dál tímhle směrem, tak teda ale beze mě.
	AI_Output (self ,other,"DIA_Addon_HammerPirate_GoHome_07_02"); //Myslím, že teď půjdu zpátky.
...
{	
	AI_Output (self ,other,"DIA_Addon_HammerPirate_Success_07_01"); //Víš ty co? Trochu jsem o tom přemejšlel. Ty nejseš tak špatnej!
	AI_Output (self ,other,"DIA_Addon_HammerPirate_Success_07_02"); //Tak já se teda vrátím do tábora. Měj se!
