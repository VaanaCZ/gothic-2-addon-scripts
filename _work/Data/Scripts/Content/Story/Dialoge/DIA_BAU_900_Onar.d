...
INSTANCE DIA_Onar_WegenPepe (C_INFO)
{
	...
	permanent   = FALSE;
	description = "Kvůli Bullcovi teë máte o pár ovcí míŕ.";
};
...
{
	AI_Output (other, self, "DIA_Onar_WegenPepe_15_00"); //Kvůli Bullcovi teë máte o pár ovcí míŕ.
...
FUNC VOID DIA_Onar_LeeSentMe_Info()
{
	...
	AI_Output (self, other, "DIA_Onar_LeeSentMe_14_06"); //S čímkoli dalším se obraă na Leeho.
...
func void DIA_Onar_WannaSheep_Info ()
{
	...
	if (Npc_IsDead (Pepe))
	{
		...
		AI_Output (self, other, "DIA_Onar_WannaSheep_14_06"); //Uf! V tom pâípadę... nech mi tu za ni 200 zlatých a vezmi si ji z pastviny sám.
...
{
	AI_Output (other, self, "DIA_Onar_BuyLiesel_15_00"); //Tady máš tęch 200 zlatých. Dej mi tu ovci.
