...
func void DIA_Rosi_WASMACHSTDU_Info ()
{
	...
	AI_Output			(self, other, "DIA_Rosi_WASMACHSTDU_17_03"); //A z té své podfukaâiny už nastâádal celé jmęní.
	AI_Output			(self, other, "DIA_Rosi_WASMACHSTDU_17_04"); //Dâe naše dęlníky, dokud jim nezničí záda. Jeho vlastní lidé mu už neâeknou jinak než otrokáâ.
	AI_Output			(self, other, "DIA_Rosi_WASMACHSTDU_17_05"); //Nejsem vůbec pyšná na to, že se můžu nazývat Sekobovou ženou, to mi vęâ. Občas si pâeju, aby bariéra byla zůstala na svém místę.
	};

	AI_Output			(self, other, "DIA_Rosi_WASMACHSTDU_17_06"); //Nemáš zájem o nęco k jídlu nebo nęco, co by se ti hodilo pro lov v lesích?
	Log_CreateTopic (Topic_OutTrader,LOG_NOTE);
	B_LogEntry (Topic_OutTrader,"Rosi prodává na Sekobovę statku různé vęci.");
};
...
func void DIA_Rosi_MinenAnteil_Info ()
{
	...
	AI_Output (self, other, "DIA_Rosi_Minenanteil_17_01"); //Ne. Z nęčeho žít musím. A taky nejsem jediný, kdo je pustil do obęhu.
	B_GivePlayerXP (XP_Ambient);
};
