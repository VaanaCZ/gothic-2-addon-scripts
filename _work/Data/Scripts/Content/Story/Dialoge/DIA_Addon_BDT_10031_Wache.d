...
{	
	AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Scatty_06_00");//Hele, chceš jít kopat? Tak nezapomeà zajít za Scattym a doplnit zásoby.
	AI_Output (other, self, "DIA_Addon_BDT_10031_Wache_Scatty_15_01");//Co tedy potâebuju?
	AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Scatty_06_02");//No, minimálnê krumpáè. A àáký zásoby taky neuškodí.
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10031_Wache_Hi_15_00");//Všecko v pohodê?
	
	if (Sklaven_Flucht == TRUE)
	&& (Wache_Joker == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Hi_06_01");//Páni, ti otroci mêli ale naspêch!
		AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Hi_06_02");//Jak se doslechli, že jsou volní, pelášili jak zajíci.
		Wache_Joker = TRUE;
	};
	AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Hi_06_03");//Jo. Takže sekej latinu a všecko bude v pohodê.
