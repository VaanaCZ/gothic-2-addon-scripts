...
{	
	AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Scatty_06_00");//Hele, chceš jít kopat? Tak nezapomeň zajít za Scattym a doplnit zásoby.
	AI_Output (other, self, "DIA_Addon_BDT_10031_Wache_Scatty_15_01");//Co tedy potřebuju?
	AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Scatty_06_02");//No, minimálně krumpáč. A ňáký zásoby taky neuškodí.
...
{	
	AI_Output (other, self, "DIA_Addon_BDT_10031_Wache_Hi_15_00");//Všecko v pohodě?
	
	if (Sklaven_Flucht == TRUE)
	&& (Wache_Joker == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Hi_06_01");//Páni, ti otroci měli ale naspěch!
		AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Hi_06_02");//Jak se doslechli, že jsou volní, pelášili jak zajíci.
		Wache_Joker = TRUE;
	};
	AI_Output (self, other, "DIA_Addon_BDT_10031_Wache_Hi_06_03");//Jo. Takže sekej latinu a všecko bude v pohodě.
