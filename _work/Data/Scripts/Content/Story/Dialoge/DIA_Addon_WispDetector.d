...
{
	AI_Output	(other, self, "DIA_Addon_WispDetector_DetectItems_15_00"); //Najdi mi nęco!
	...
	{	
		Info_AddChoice	(DIA_Addon_WispDetector_DetectItems, "Potâebuju, zlato, klíče a nádobí."		, DIA_Addon_WispDetector_DetectItems_NONE );
	};
	if (PLAYER_TALENT_WISPDETECTOR[WISPSKILL_FF] 	== TRUE)		
	{	
		Info_AddChoice	(DIA_Addon_WispDetector_DetectItems, "Potâebuji stâelné zbranę a stâelivo."				, DIA_Addon_WispDetector_DetectItems_FF );
	};
	if (PLAYER_TALENT_WISPDETECTOR[WISPSKILL_NF] 	== TRUE)		
	{	
		Info_AddChoice	(DIA_Addon_WispDetector_DetectItems, "Potâebuji zbranę nablízko."								, DIA_Addon_WispDetector_DetectItems_NF );
	};
...
{
	AI_Output			(other, self, "DIA_Addon_WispDetector_DetectItems_NF_15_00"); //Potâebuji zbranę na blízko.
...
{
	AI_Output			(other, self, "DIA_Addon_WispDetector_DetectItems_FF_15_00"); //Potâebuji zbranę na dálku a stâelivo.
...
{
	AI_Output			(other, self, "DIA_Addon_WispDetector_DetectItems_NONE_15_00"); //Potâebuji zlato, klíče a nádobí.
