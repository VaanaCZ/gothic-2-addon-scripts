...
func void DIA_Addon_Carlos_HI_Yes()
{
	...
	AI_Output (self,other,"DIA_Addon_Carlos_HI_Yes_12_01"); //(vztekle) Protože teï jsem jeho místo pøevzal já. Udìlals to dobøe, díky moc!
	Info_ClearChoices (DIA_Addon_Carlos_HI);
};
...
FUNC VOID DIA_Addon_Carlos_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_00");//Thorus mi nakázal, abych pro tábor našel nìkoho novýho místo toho útoèníka.
	...
	{
		AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_02");//A Franco poslal nìkoho novýho.
	};
	
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_03");//Hele, já jenom dìlám, co mi øekne Thorus. O samotným útoku nevím ani zbla.
};
