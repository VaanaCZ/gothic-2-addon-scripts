...
{	
	AI_Output (self,other,"DIA_Addon_Carlos_HI_12_00"); //Hej, to ty jesteś tym nowym, który pobił Franka?
...
func void DIA_Addon_Carlos_HI_Yes()
{
	...
	AI_Output (self,other,"DIA_Addon_Carlos_HI_Yes_12_01"); //Bo teraz ja muszę odwalać jego robotę. Wielkie dzięki!
	Info_ClearChoices (DIA_Addon_Carlos_HI);
};
...
func void DIA_Addon_Carlos_HI_No()
{
	...
	AI_Output (self,other,"DIA_Addon_Carlos_HI_No_12_01"); //Ach, rozumiem. Nie chciałem przeszkadzać.
	Info_ClearChoices (DIA_Addon_Carlos_HI);
};
...
FUNC VOID DIA_Addon_Carlos_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_00");//Thorus kazał mi wpuścić do obozu kogoś nowego, gdy zabójca będzie już gryzł ziemię.
	
	if (Logan_Inside == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_01");//A Franko przysłał Logana.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_02");//A Franko przysłał nowych kolesi.
	};
	
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_03");//Hej, ja tylko wykonuję rozkazy Thorusa. Nie wiem nic o samej próbie zabójstwa.
};
...
{
	AI_Output (other, self, "DIA_Addon_Carlos_PERM_15_00"); //Jak to jest być szefem myśliwych?
