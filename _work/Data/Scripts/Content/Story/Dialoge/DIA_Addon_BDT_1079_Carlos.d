...
func void DIA_Addon_Carlos_HI_Yes()
{
	...
	AI_Output (self,other,"DIA_Addon_Carlos_HI_Yes_12_01"); //(vztekle) Protože teë jsem jeho místo pâevzal já. Udęlals to dobâe, díky moc!
	Info_ClearChoices (DIA_Addon_Carlos_HI);
};
...
FUNC VOID DIA_Addon_Carlos_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_00");//Thorus mi nakázal, abych pro tábor našel nękoho novýho místo toho útočníka.
	...
	{
		AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_02");//A Franco poslal nękoho novýho.
	};
	
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_03");//Hele, já jenom dęlám, co mi âekne Thorus. O samotným útoku nevím ani zbla.
};
...
INSTANCE DIA_Addon_Carlos_PERM   (C_INFO)
{
	...
	permanent   = TRUE;
	description	= "A jak se ti velí lovcům?";
};
