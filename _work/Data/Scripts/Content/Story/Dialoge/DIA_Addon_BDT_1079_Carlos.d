...
func void DIA_Addon_Carlos_HI_Yes()
{
	...
	AI_Output (self,other,"DIA_Addon_Carlos_HI_Yes_12_01"); //(vztekle) Protože teď jsem jeho místo převzal já. Udělals to dobře, díky moc!
	Info_ClearChoices (DIA_Addon_Carlos_HI);
};
...
FUNC VOID DIA_Addon_Carlos_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_00");//Thorus mi nakázal, abych pro tábor našel někoho novýho místo toho útočníka.
	...
	{
		AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_02");//A Franco poslal někoho novýho.
	};
	
	AI_Output (self, other, "DIA_Addon_Carlos_Attentat_12_03");//Hele, já jenom dělám, co mi řekne Thorus. O samotným útoku nevím ani zbla.
};
