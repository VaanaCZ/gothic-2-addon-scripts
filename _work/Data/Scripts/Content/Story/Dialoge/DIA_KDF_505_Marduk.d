...
FUNC VOID DIA_Marduk_Kap3_Hello_NotYourConcern ()
{
	...
	if (hero.guild == GIL_DJG)
	{
		AI_Output (self ,other,"DIA_Marduk_Kap3_Hello_NotYourConcern_05_03"); //(rozzlobenę) Bývaly časy, kdy lůza nemęla povolen vstup do našeho svatého kláštera. Jsi smutným důkazem, že ty časy pominuly.
...
{
	AI_Output (other,self ,"DIA_Marduk_Kap3_PERM_15_00"); //Je nęco nového?
...
{
	AI_Output (other,self ,"DIA_Marduk_Kap4U5_PERM_15_00"); //Je nęco nového?
