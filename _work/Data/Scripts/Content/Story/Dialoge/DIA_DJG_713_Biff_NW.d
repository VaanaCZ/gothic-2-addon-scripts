...
instance DIA_Biff_NW_HAfen		(C_INFO)
{
	...
	description	 = 	"Dobra. Już niedługo.";
};
...
{
	AI_Output			(other, self, "DIA_Biff_NW_HAfen_15_00"); //Dobra. Już niedługo.
	AI_Output			(self, other, "DIA_Biff_NW_HAfen_07_01"); //Nie mogę się już doczekać.
