...
instance DIA_Biff_NW_HAfen		(C_INFO)
{
	...
	description	 = 	"Vale. Ya no queda mucho.";
};
...
{
	AI_Output			(other, self, "DIA_Biff_NW_HAfen_15_00"); //Vale. Ya no queda mucho.
	AI_Output			(self, other, "DIA_Biff_NW_HAfen_07_01"); //Estoy impaciente.
