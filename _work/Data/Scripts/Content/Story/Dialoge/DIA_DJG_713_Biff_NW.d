...
instance DIA_Biff_NW_HAfen		(C_INFO)
{
	...
	description	 = 	"Ok, non molto più a lungo.";
};
...
{
	AI_Output			(other, self, "DIA_Biff_NW_HAfen_15_00"); //Ok, non molto più a lungo.
	AI_Output			(self, other, "DIA_Biff_NW_HAfen_07_01"); //Non vedo l'ora.
