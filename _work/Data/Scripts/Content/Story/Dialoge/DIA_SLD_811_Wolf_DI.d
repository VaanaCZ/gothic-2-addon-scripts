...
{
	AI_Output			(other, self, "DIA_Wolf_DI_HALLO_15_00"); //Co słychać?

	if ( Bennet_IsOnBoard == LOG_SUCCESS)
	&& (Npc_IsDead(Bennet_DI)	==	FALSE)
		{
			AI_Output			(self, other, "DIA_Wolf_DI_HALLO_08_01"); //Cholera! Musiałeś brać ze sobą Benneta?
			AI_Output			(other, self, "DIA_Wolf_DI_HALLO_15_02"); //Jakiś problem?
			AI_Output			(self, other, "DIA_Wolf_DI_HALLO_08_03"); //Ech... nie, żaden. Rób, co masz do zrobienia i wynośmy się stąd, dobra?
		}
	else
		{
			if (DIA_Wolf_DI_HALLO_OneTime == FALSE)
				{
					AI_Output			(self, other, "DIA_Wolf_DI_HALLO_08_04"); //Kuźnia nie jest w najlepszym stanie, ale zrobię co w mojej mocy.
				...
				{
					AI_Output			(other, self, "DIA_Wolf_DI_HALLO_15_05"); //Mógłbyś sporządzić dla mnie nową zbroję?
					AI_Output			(self, other, "DIA_Wolf_DI_HALLO_08_06"); //Przykro mi, ale nie z tymi narzędziami. Musisz poczekać, aż wylądujemy na kontynencie.
				};
		};
};
...
INSTANCE DIA_Wolf_DI_Training (C_INFO)
{
	...
	description = "Naucz mnie czegoś o walce na dystans.";
};                       
...
{	
	AI_Output (other,self ,"DIA_Wolf_DI_Training_15_00"); //Naucz mnie czegoś o walce na dystans.
...
func void DIA_Wolf_DI_Training_BOW_1()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_BOW_1_08_00"); //W odróżnieniu od kuszy do posługiwania się łukiem potrzeba dużo miejsca. Pamiętaj, żeby w trakcie walki zachować odpowiednią odległość od przeciwnika.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_Training_BOW_5()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_BOW_5_08_00"); //Cięciwa musi się prześlizgnąć między twoimi palcami. Zaciskając kurczowo palce, wypaczysz kierunek lotu strzały.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_Training_CROSSBOW_1()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_CROSSBOW_1_08_00"); //Strzelając z kuszy, musisz pozostawać w całkowitym bezruchu. Dlatego zawsze staraj się powoli naciskać spust.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
func void DIA_Wolf_DI_Training_CROSSBOW_5()
{
	...
	{
		AI_Output (self ,other,"DIA_Wolf_DI_Training_CROSSBOW_5_08_00"); //Sprytny strzelec zawsze wykorzystuje powiewy powietrza i stara się nie strzelać pod wiatr.
	};
	Info_ClearChoices 	(DIA_Wolf_DI_Training);
	Info_AddChoice	  	(DIA_Wolf_DI_Training, DIALOG_BACK, DIA_Wolf_DI_Training_BACK);
	Info_AddChoice		(DIA_Wolf_DI_Training, B_BuildLearnString(PRINT_LearnBow1	, 			B_GetLearnCostTalent(other, NPC_TALENT_BOW, 1))			,DIA_Wolf_DI_Training_BOW_1);
...
{
	AI_Output			(other ,self, "DIA_Wolf_DI_UndeadDragonDead_15_00"); //Wszystko w porządku?
	AI_Output			(self ,other, "DIA_Wolf_DI_UndeadDragonDead_08_01"); //U mnie tak, a u ciebie? Nie było lekko, co?

	if (DIA_Wolf_DI_UndeadDragonDead_OneTime == FALSE)
		{
			AI_Output			(other ,self, "DIA_Wolf_DI_UndeadDragonDead_15_02"); //Dokąd zamierzasz się teraz udać?
			AI_Output			(self ,other, "DIA_Wolf_DI_UndeadDragonDead_08_03"); //Gdziekolwiek, byle nie z powrotem. Mam już serdecznie dość Khorinis.
			AI_Output			(self ,other, "DIA_Wolf_DI_UndeadDragonDead_08_04"); //Nie obchodzi mnie, dokąd popłyniemy, byle jak najdalej stąd.
