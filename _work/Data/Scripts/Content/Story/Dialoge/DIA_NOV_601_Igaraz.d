...
FUNC VOID DIA_Igaraz_METOO_TELL ()
{
	...
	AI_Output (self, other, "DIA_Igaraz_METOO_TELL_13_02"); //Nesnaž se hledat poblíž farem - není tam nic, co by tę k nęčemu dovedlo.
};
...
{
	AI_Output (other, self, "DIA_Igaraz_METOO_AGON_15_00"); //Vidęl jsi Agona nebo Ulfa?
...
FUNC VOID DIA_Igaraz_Price_Info()
{
	...
	AI_Output (self ,other,"DIA_Igaranz_Price_13_03"); //300 zlatých a můžeš si s tęmi papíry dęlat, co chceš.
};
