...
FUNC VOID DIA_Addon_Rhademes_First_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Rhademes_First_03_00"); //Můj duch byl navęky uvęznęn.
		AI_Output (self, other, "DIA_Addon_Rhademes_First_03_01"); //Konečnę jsem volný. Meč má NOVÉHO nositele.
		AI_Output (self, other, "DIA_Addon_Rhademes_First_03_02"); //Poslední komnata byla otevâena.
		AI_Output (other, self, "DIA_Addon_Rhademes_First_15_03"); //Avšak brána zůstává uzavâena.
	...
	{
		AI_Output (self, other, "DIA_Addon_Rhademes_First_03_07"); //(podráždęnę) Ghanima en Kandra Adanos?!
		B_Say (other, self, "$CANTUNDERSTANDTHIS");	
		AI_Output (self, other, "DIA_Addon_Rhademes_First_03_08"); //(zuâivę) Bengla anthani!
...
{
	AI_Output (other, self, "DIA_Addon_Rhademes_Hebel_15_00"); //Ale ne všechny spouštęjí past, že?
	AI_Output (self, other, "DIA_Addon_Rhademes_Hebel_03_01"); //Ano, pâesnę tak!
};
...
instance DIA_Addon_Rhademes_DeinVater (C_INFO)
{
	...
	permanent   = FALSE;
	description	= "Když tu past sestrojil tvůj otec, jak TY můžeš vędęt, jak funguje?!";
};
...
{
	AI_Output (other, self, "DIA_Addon_Rhademes_DeinVater_15_00"); //Tu past vytvoâil tvůj otec – jak TY můžeš vędęt, jak funguje?!
	AI_Output (self, other, "DIA_Addon_Rhademes_DeinVater_03_01"); //QUARHODRON! Ještę stále slyším rány kladiv... na druhé stranę brány... po tak dlouhé dobę...
	AI_Output (self, other, "DIA_Addon_Rhademes_DeinVater_03_02"); //Meč... mi ukázal... pomstu... za mé selhání.
	AI_Output (other, self, "DIA_Addon_Rhademes_DeinVater_15_03"); //Chceš âíct, že jsi vidęl, která páka je ta pravá?
	AI_Output (self, other, "DIA_Addon_Rhademes_DeinVater_03_04"); //Už jsem to dávno zapomnęl.
