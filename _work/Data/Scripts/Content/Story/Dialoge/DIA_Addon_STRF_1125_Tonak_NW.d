...
{
	AI_Output (other, self, "DIA_Addon_Tonak_NW_Hi_15_00");//¿Así que vuelves a trabajar en el campo?
	AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_01");//¡Eh, el tipo que me salvó la vida! Sí, ahora trabajo más duro.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_02");//Especialmente con esos hermanos chalados. Ni los bandidos eran TAN malos
	};
};
// ************************************************************
// 			  				PICK POCKET
