...
FUNC VOID DIA_Addon_Tonak_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_01");//Hele, ten chlap mi zachránil život! Jo, teë z toho pro mę kouká další práce.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_02");//Zvlášă s tęmahle dvęma trhlejma bráchama. Čoveče, ti banditi nebyli zas TAK špatný!
	};
};
// ************************************************************
// 			  				PICK POCKET
