...
FUNC VOID DIA_Addon_Tonak_NW_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_01");//Hele, ten chlap mi zachránil život! Jo, teď z toho pro mě kouká další práce.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_02");//Zvlášť s těmahle dvěma trhlejma bráchama. Čoveče, ti banditi nebyli zas TAK špatný!
	};
};
// ************************************************************
// 			  				PICK POCKET
