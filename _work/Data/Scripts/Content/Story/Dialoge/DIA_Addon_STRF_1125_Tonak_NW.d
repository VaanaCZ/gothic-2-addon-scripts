...
{
	AI_Output (other, self, "DIA_Addon_Tonak_NW_Hi_15_00");//Alors, le travail des champs va reprendre ?
	AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_01");//Hé, le type qui m'a sauvé la vie ! Et oui, le dur labeur continue pour moi.
	
	if !Npc_IsDead (Egill)
	&& !Npc_IsDead (Ehnim)
	{
		AI_Output (self, other, "DIA_Addon_Tonak_NW_Hi_03_02");//Surtout avec ces deux imbéciles de frères. Mon dieu, les bandits n'étaient pas aussi terribles...
	};
};
// ************************************************************
// 			  				PICK POCKET
