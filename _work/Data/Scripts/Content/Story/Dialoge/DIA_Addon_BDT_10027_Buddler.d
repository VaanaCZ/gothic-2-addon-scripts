...
{	
	...
	{	
		AI_Output (self, other, "DIA_Addon_BDT_10027_Buddler_Hi_11_01");//Už jsem pro rudobarony dřel dost dlouho. Teď se tu pro změnu může lopotit zase někdo jinej.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_BDT_10027_Buddler_Hi_11_02");//Sakra, to teď jako máme zase dolovat sami nebo co?
	};
};
//---------------------------------------------------------------------
//	Info Hacken
...
FUNC VOID DIA_Addon_10027_Buddler_Hacken_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_10027_Buddler_Hacken_11_00");//To chce makat hlavně hlavou, hochu. Dolování zlata je čistě mentální záležitost. Kámen k ničemu nepřinutíš – je tvrdší než ty.
	AI_Output (self, other, "DIA_Addon_10027_Buddler_Hacken_11_01");//Otevři svou mysl a splyň se silou zlata. Je to jako meditace, jako modlitba.
