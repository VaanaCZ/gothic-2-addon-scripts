...
instance DIA_Addon_Lares_Patch		(C_INFO)
{
	...
	description	= "(Ornament - žádat navrácení èásti)";
};
...
func void DIA_Lares_HALLO_Info ()
{
	...
	Info_AddChoice 		(DIA_Lares_HALLO,"Nevidêli jsme se už?",DIA_Lares_HALLO_NO);
	Info_AddChoice 		(DIA_Lares_HALLO,"Hej, Laresi, ty starej pardále!",DIA_Lares_HALLO_YES);
};
FUNC VOID DIA_Lares_HALLO_NO()
{
	AI_Output (other, self, "DIA_Lares_HALLO_NO_15_00"); //Nevidêli jsme se už?
	AI_Output (self, other, "DIA_Lares_HALLO_NO_09_01"); //Chlape, to si mê vážnê nepamatuješ? Poflakoval jsem se kolem Novýho tábora.
	...
	Info_AddChoice 		(DIA_Lares_HALLO,"Samozâejmê že si pamatuju na Leeho!",DIA_Lares_HALLO_LEE);
...
FUNC VOID DIA_Lares_HALLO_YES()
{
	...
	AI_Output (self, other, "DIA_Lares_HALLO_YES_09_01"); //Podaâilo se mi utýct z Hornickýho údolí právê vèas. Spolu s Leem a ještê nêkolika dalšíma chlapama.
...
{
	AI_Output (other, self, "DIA_Lares_HALLO_LEE_15_00"); //Samozâejmê že si pamatuju na Leeho!
	B_Lares_AboutLee();
...
FUNC VOID DIA_Lares_HALLO_NOIDEA()
{
	...
	AI_Output (self, other, "DIA_Lares_HALLO_NOIDEA_09_01"); //Tys asi dostal velkou ránu do hlavy, co? Lee byl velitelem žoldákù v Novém táboâe.
	B_Lares_AboutLee();
...
func void DIA_Addon_Lares_Vatras_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_Vatras_09_01"); //(udivenê) Tak ty už jsi byl za Vatrasem? To jsi na nêj musel udêlat poâádný dojem.
	AI_Output	(self, other, "DIA_Addon_Lares_Vatras_09_02"); //Jinak by ti urèitê jen tak neprozradil moje jméno. Zvlášã když tu teë máme tu nevyâešenou záležitost s pohâešovanými lidmi.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Lares_WhatAreYouGuys_09_03"); //Pracujeme pro nê a oni na oplátku dohlídnou, aby nám naše trestanecká minulost nebyla na pâítêž.
	AI_Output (other, self, "DIA_Addon_Lares_WhatAreYouGuys_15_04"); //Mluvíš o kruhu vody?
	AI_Output (self, other, "DIA_Addon_Lares_WhatAreYouGuys_09_05"); //Už jsi o nêm slyšel?
...
func void DIA_Addon_Lares_Ranger_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_Ranger_09_01"); //Kruh je pro vodní mágy totéž, co paladinové pro mágy ohnê.
	AI_Output	(self, other, "DIA_Addon_Lares_Ranger_09_02"); //Ale my na rozdíl od paladinù operujeme ve skrytu.
	AI_Output	(self, other, "DIA_Addon_Lares_Ranger_09_03"); //Kruh' je mocnou zbraní proti nebezpeèím, jež ohrožují obyvatelstvo Khorinidu.
	AI_Output	(self, other, "DIA_Addon_Lares_Ranger_09_04"); //Jenže to bude fungovat, jenom když totožnost èlenù kruhu vody udržíme v tajnosti.
	...
	B_LogEntry (TOPIC_Addon_RingOfWater,"'Kruh' je pro mágy vody totéž co paladinové pro mágy ohnê. 'Kruh' však dává pâednost nenápadnému jednání. Nikdo nesmí vêdêt, KDO všechno k nêmu patâí, neboã jeho síla spoèívá právê v utajení." ); 
};
// ------------------------------------------------------------
// Info WannaBeRanger
// ------------------------------------------------------------
...
func void DIA_Addon_Lares_WannaBeRanger_AboutYou ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_WannaBeRanger_AboutYou_09_01"); //Kdysi dávno jsem je ochránil, ještê když jsme žili za bariérou.
	AI_Output (self, other, "DIA_Addon_Lares_WannaBeRanger_AboutYou_09_02"); //(usmívá se) A mají spoustu dùvodù, proè mi být vdêèní.
};
func void DIA_Addon_Lares_WannaBeRanger_HowIsIt ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_WannaBeRanger_HowIsIt_09_01"); //Hodnê se lišíme od jiných komunit, ke kterým se tady v Khorinidu mùžeš pâipojit.
	AI_Output (self, other, "DIA_Addon_Lares_WannaBeRanger_HowIsIt_09_02"); //Když se staneš jedním z nás, nebudeme po tobê chtít nic, co bys nedokázal.
	AI_Output (self, other, "DIA_Addon_Lares_WannaBeRanger_HowIsIt_09_03"); //Jediné, co opravdu vyžadujeme, je mlèenlivost.
...
func void DIA_Addon_Lares_RingBack_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Lares_RingBack_09_01"); //Výbornê. Mùžeš mi tedy vrátit mùj akvamarínový prsten?
		...
		else
		{
			...
			AI_Output	(self, other, "DIA_Addon_Lares_RingBack_09_05"); //Jen žádné skopièiny! Já ho potâebuju!
		};
	};
...
{
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_09_00"); //Takže, mùj mladý pâíteli. Všichni jsme se tu dnes sešli, abychom oslavili tvé pâijetí do kruhu vody.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_09_01"); //Všichni chlapi, kteâí tu jsou, na tebe budou od nynêjška dávat dobrý pozor.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_09_02"); //Samozâejmê že kruh vody má i další èleny, takže buë opatrný.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_09_03"); //Když pro nás vykonáš nêjaký úkol nebo naopak vyvedeš nêjakou pitomost, dozvíš se to.
	...
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_09_05"); //Nos ji s hrdostí, ale nikdy ne ve mêstê ani v jiných obydlených oblastech.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_09_06"); //Nezapomeà, že musíme zùstat v utajení. Nikdo nesmí vêdêt, kdo ke kruhu vody patâí.
	...
	Info_AddChoice	(DIA_Addon_Lares_GetRangerArmor, "V èem mi mùžeš pomoci?", DIA_Addon_Lares_GetRangerArmor_Learn );
...
func void DIA_Addon_Lares_GetRangerArmor_weapons ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_weapons_09_01"); //Zbraní kruhu vody je ètvrteèní hùl, ale každý z nás radši bojuje s tím, naè je zvyklý.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_weapons_09_02"); //Tady je jedna z našich holí. Já se ji nikdy nenauèil používat, ale tobê možná postaèí.
...
func void DIA_Addon_Lares_GetRangerArmor_end ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_end_09_01"); //Tak to tê nebudeme zdržovat.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_end_09_02"); //Teë bêž pâímo za Vatrasem, aã ti zadá první úkol.
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_end_09_03"); //Bratâi z kruhu, nyní se vraãme ke svým povinnostem.
...
func void DIA_Addon_Lares_GetRangerArmor_weiter () 
{
	...
	B_LogEntry (TOPIC_Addon_RingOfWater,"Na tajném setkání kruhu, které probêhlo v Orlanovê hospodê, jsem dostal novou zbroj. Nyní mám zajít za Vatrasem, který mi zadá první úkol v âadách tohoto spoleèenství." ); 
};

func void DIA_Addon_Lares_GetRangerArmor_Learn ()
{
	AI_Output	(other, self, "DIA_Addon_Lares_GetRangerArmor_Learn_15_00"); //V èem mi mùžeš pomoci?
	AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_Learn_09_01"); //Mùžu ti ukázat, jak se stát obratnêjším.
	...
	{
		AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_Learn_09_05"); //Cavalorn ovládá plížení, jednoruèní boj a stâelbu.
	};
	if ((Npc_IsDead(BAU_970_Orlan))== FALSE)
	{
		AI_Output	(self, other, "DIA_Addon_Lares_GetRangerArmor_Learn_09_06"); //Orlan tu pro tebe vždycky bude mít pâipravený vytopený pokoj a èistou postel.
	};
...
{
	AI_Output	(other, self, "DIA_Addon_Lares_Teleportstation_15_00"); //Už jsi nêkdy používal teleportaèní kámen?
	AI_Output	(self, other, "DIA_Addon_Lares_Teleportstation_09_01"); //Ne, ale už jsem o takových vêcech slyšel. Jenže ani vodní mágové o nich zatím moc nevêdí.
	...
	AI_Output	(self, other, "DIA_Addon_Lares_Teleportstation_09_04"); //No, jestli chceš používat takový vêci, popros hospodskýho Orlana, aby tê pustil do tý svý zabednêný jeskynê.
	AI_Output	(self, other, "DIA_Addon_Lares_Teleportstation_09_05"); //Myslím, že nêkde u svý hospody ukryl jeden z teleportaèních kamenù vodních mágù.
	AI_Output	(self, other, "DIA_Addon_Lares_Teleportstation_09_06"); //Vyjdi z mêsta východní branou a prostê se drž na cestê. Nemùžeš to minout.
	
	B_LogEntry (TOPIC_Addon_TeleportsNW,"Lares mi prozradil, že Orlan schoval u svého hostince teleportaèní kámen."); 
...
{
	AI_Output (other, self, "DIA_Addon_Lares_Ornament_15_00"); //Vatras mi nakázal, abych ti zanesl tenhle ornament. Prý ho máš nêkomu vrátit.
	B_GiveInvItems (other, self, ItMi_Ornament_Addon_Vatras,1);
	AI_Output (self, other, "DIA_Addon_Lares_Ornament_09_01"); //(povzdech) Samozâejmê. Zase je to na mnê, jako vždycky. To jsem si mohl myslet.
...
instance DIA_Addon_Lares_OrnamentBringJob		(C_INFO)
{
	...
	description = "Mùžu tam ten ornament zanést za tebe!";
};
...
func void DIA_Addon_Lares_OrnamentBringJob_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_OrnamentBringJob_09_01"); //(zamyšlenê) Hmm. Myslím, že bych to mêl radši zaâídit sám, ale mùžeš jít se mnou.
	AI_Output	(self, other, "DIA_Addon_Lares_OrnamentBringJob_09_02"); //Akorát nemùžu odejít hned, musím dohlížet na pâístav.
...
func void DIA_Addon_Lares_YourMission_Info ()
{
	...
	if (!Npc_KnowsInfo (other, DIA_Addon_Lares_WhatAreYouGuys))
	{
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_01"); //O tom nemùžu mluvit.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_02"); //Vatras by mi utrhnul hlavu.
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_03"); //Dêlám to, co všichni. Dêlám, co mi nakážou vodní mágové.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_04"); //Nêkteâí z têch zmizelých lidí byli rybáâi. A zmizeli i se svými èluny.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_05"); //A proto tu stojím a hlídám celý pâístav. Snad se tu ještê nêco semele.
		...
		SC_GotLaresRing = TRUE;		
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_08"); //Když ho budeš mít na prstê, ostatní budou vêdêt, že jednáš mým jménem.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_09"); //Sežeà nêkoho, kdo to tu za mê vezme, aã mùžu jít vrátit ten ornament.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_10"); //Nêkdo z nás urèitê hlídá na tržišti, ale nevím, na kom je zrovna âada.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_11"); //Takže si radši promluv se všema, kteâí tam postávaj. Až narazíš na toho pravýho, všimne si mýho prstenu a dá ti vêdêt.
		AI_Output (self, other, "DIA_Addon_Lares_YourMission_09_12"); //Vyâië mu, že potâebuju, aby mê tady v pâístavu nêkdo vystâídal.

		B_LogEntry (TOPIC_Addon_RingOfWater,"Lares mi pâedal svùj akvamarínový prsten - tajné znamení našeho kruhu. Když jej budu nosit, ostatní èlenové poznají, že k nim patâím."); 

		Log_CreateTopic (TOPIC_Addon_BringRangerToLares, LOG_MISSION);
		Log_SetTopicStatus(TOPIC_Addon_BringRangerToLares, LOG_RUNNING);
		B_LogEntry (TOPIC_Addon_BringRangerToLares,"Lares nemùže opustit pâístav. Proto mám místo nêj zajít na tržištê, prokázat se jeho akvamarínovým prstenem a najít nêkoho, kdo by ho vystâídal."); 
...
{
	AI_Output (other, self, "DIA_Addon_Lares_BaltramAbloese_15_00"); //Mluvil jsem s Baltramem. Prý najde nêkoho, kdo tê pâijde nahradit.
	AI_Output (self, other, "DIA_Addon_Lares_BaltramAbloese_09_01"); //Á, tak to je fajn. Takže mùžeme koneènê vypadnout.
	if (SC_IsRanger == FALSE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_Lares_BaltramAbloese_09_03"); //(s úsmêvem) Myslím, že se ti ještê bude hodit.
		}
		else
		{
...
instance DIA_Addon_Lares_PeopleMissing		(C_INFO)
{
	...
	permanent 	= TRUE;
	description	= "Co se týèe têch pohâešovaných lidí...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Lares_PeopleMissing_15_00"); //Co se týèe têch pohâešovaných lidí...
	...
	{
		Info_AddChoice (DIA_Addon_Lares_PeopleMissing, "Nêkolik z têch pohâešovaných lidí jsem zachránil.", DIA_Addon_Lares_PeopleMissing_SAVED );
	}
	else if (MIS_Lares_BringRangerToMe != 0)
	&& (SCKnowsMissingPeopleAreInAddonWorld == TRUE)
	&& (MissingPeopleReturnedHome == FALSE)
	{
		Info_AddChoice (DIA_Addon_Lares_PeopleMissing, "Už vím, co se s têmi pohâešovanými lidmi stalo.", DIA_Addon_Lares_PeopleMissing_Success );
	}
	else
	{
...
func void DIA_Addon_Lares_PeopleMissing_TellMe()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_PeopleMissing_TellMe_09_02"); //Zpoèátku jsme si mysleli, že ho prostê schlamstla jedna z têch moâskejch pâíšer.
	AI_Output (self, other, "DIA_Addon_Lares_PeopleMissing_TellMe_09_03"); //Jenže zanedlouho zaèali mizet i další lidi z mêsta i okolí. To už by byly pêknê divný náhody.
	AI_Output (self, other, "DIA_Addon_Lares_PeopleMissing_TellMe_09_04"); //Nikdo z nich se zatím nevrátil. Zatím to vypadá, že budeme muset poèkat, dokud nenarazíme na nêjakou stopu.
...
{
	AI_Output	(other, self, "DIA_Addon_Lares_PeopleMissing_Success_15_00"); //Vím, co se stalo s têmi pohâešovanými lidmi!
	AI_Output	(self, other, "DIA_Addon_Lares_PeopleMissing_Success_09_01"); //(pâekvapenê) Vážnê?
	...
	AI_Output	(other, self, "DIA_Addon_Lares_PeopleMissing_Success_15_06"); //...vím, kde tê hledat. Je mi to jasný.
	Lares_CanBringScToPlaces = TRUE;
	Info_ClearChoices (DIA_Addon_Lares_PeopleMissing);
};
func void DIA_Addon_Lares_PeopleMissing_SAVED ()
{
	AI_Output	(other, self, "DIA_Addon_Lares_PeopleMissing_SAVED_15_00"); //Nêkteré z têch zmizelých lidí už jsem zachránil.
	AI_Output	(self, other, "DIA_Addon_Lares_PeopleMissing_SAVED_09_01"); //Já vêdêl, že to dokážeš. Takže už si mùžu koneènê jít po svém.
	B_GivePlayerXP (XP_Ambient);
...
func void DIA_Addon_Lares_RangerHelp_ruestung ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_ruestung_09_02"); //Ale dá se získat i levnêjc, když ti pâitom nebude vadit trochu napálit domobranu.
	AI_Output (other, self, "DIA_Addon_Lares_RangerHelp_ruestung_15_03"); //Co tím myslíš?
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_ruestung_09_04"); //Matteo má vedle svého domu skladištê, ale všechno zboží zabavila domobrana.
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_ruestung_09_05"); //Zajdi na tržištê za Zurisem, kup si u nêj uspávací kouzlo a tím pak pošli všechny strážce do âíše snù.
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_ruestung_09_06"); //Pak si mezi Matteovým zbožím urèitê vybereš nêco šikovnýho.
...
func void DIA_Addon_Lares_RangerHelp_waffe ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_waffe_09_01"); //Tak v tom ti, obávám se, nepomùžu. Zkusils to na tržišti?
...
func void DIA_Addon_Lares_RangerHelp_geld ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_geld_09_01"); //Tak to potâebujeme všichni. Je mi líto, nemám, co bych ti dal. Ale lichváâ Lehmar mi ještê dluží laskavost.
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_geld_09_02"); //Zajdi za ním a pùjè si, kolik potâebuješ. O zbytek se postarám. Najdeš ho v pâístavní ètvrti, tam, kde už skoro zaèíná dolní èást mêsta.
...
func void DIA_Lares_Paladine_Info ()
{
	...
	AI_Output (self, other, "DIA_Lares_Paladine_09_03"); //A to si myslíš, že ti ho dají? Nikdy se nedostaneš ani do horní èásti mêsta.
	if (!Npc_KnowsInfo (other, DIA_Addon_Lares_Vatras))
	{
		AI_Output (other, self, "DIA_Lares_Paladine_15_04"); //Nêjaký zpùsob se najde.
...
func void DIA_Lares_WhyPalHere_Info ()
{
	...
	AI_Output (self, other, "DIA_Lares_WhyPalHere_09_01"); //Nikdo to neví jistê. Hodnê lidí si myslí, že to je kvùli skâetùm, ale já si myslím, že tu je jinej dùvod.
...
instance DIA_Addon_Lares_Gilde (C_INFO)
{
	...
	permanent    =  TRUE;
	description	 = 	"Vatras tvrdil, že mi pomùžeš pâidat se k nêkteré z místních komunit.";
};
...
{
	AI_Output (other, self, "DIA_Addon_Lares_Gilde_15_00"); //Podle Vatrase mi prý mùžeš pomoct pâidat se k nêkteré z místních komunit.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_09_01"); //(smêje se) Už tê unavuje bejt nýmandem, co?
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_09_02"); //No dobâe, chápu tê.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_09_03"); //Jestli se chceš pâidat k Leemu, mùžu na žoldáky trochu zapùsobit.
...
{
	AI_Output (other, self, "DIA_Addon_Lares_Gilde_SLD_15_00"); //Žoldákùm.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_SLD_09_01"); //Jsem si jist, že tê Lee pâijme.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_SLD_Add_09_01"); //Ale napâed budeš muset projít zkouškou.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_SLD_09_02"); //Bêž na Onarùv statek a promluv si tam s Cordem. 
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_SLD_Add_09_02"); //Pomùže ti tu zkoušku splnit.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_SLD_09_03"); //Povêz mu, že nad tebou držím ochrannou ruku. Pochopí to.
	RangerHelp_gildeSLD = TRUE;
	
	Log_CreateTopic (TOPIC_Addon_RangerHelpSLD, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_RangerHelpSLD, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_RangerHelpSLD,"Podle Larese mi mùže život na statkáâovê farmê ulehèit žoldák Cord."); 
...
func void DIA_Addon_Lares_Gilde_MIL ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_MIL_09_01"); //(pobavenê) Je mi jasný, že by se ti to líbilo! Diktovat ostatním zákony a pâitom jim vybírat kapsy.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_MIL_09_02"); //Paladinové skladují své zásoby v pâístavu a jejich skladník je mùj dobrý pâítel.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_MIL_09_03"); //Možná by ti mohl nêjak pomoct. Jmenuje se Martin.

	Log_CreateTopic (TOPIC_Addon_RangerHelpMIL, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_RangerHelpMIL, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_RangerHelpMIL,"Lares mi poradil, že jestli se chci co nejdâíve stát èlenem domobrany, mêl bych zajít za skladníkem Martinem. Obvykle postává v pâístavu, kde paladinové uchovávají své zásoby."); 
...
{
	AI_Output (other, self, "DIA_Addon_Lares_Gilde_KDF_15_00"); //Ohnivým mágùm.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_KDF_09_01"); //(smêje se) Vsadím se, že tohle Vatras nepâedvídal, jinak by mê za tebou neposlal.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_KDF_09_02"); //Vstup do kláštera je drahý.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_KDF_09_03"); //Ti hoši tê nepustí dál, dokud jim nevênuješ pêknê tuèný milodar.
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_KDF_09_04"); //A jediný, kdo v téhle vêci mùže nêco udêlat, je sám Vatras. Zkus si s ním o tom promluvit.

	Log_CreateTopic (TOPIC_Addon_RangerHelpKDF, LOG_MISSION);
	Log_SetTopicStatus(TOPIC_Addon_RangerHelpKDF, LOG_RUNNING);
	B_LogEntry (TOPIC_Addon_RangerHelpKDF,"Lares tvrdil, že Vatras zná snadný zpùsob, jak se dostat do kláštera."); 
...
instance DIA_Lares_AboutSld (C_INFO)
{
	...
	permanent    =  TRUE;
	description	 = 	"Povêz mi o Leem a têch jeho žoldácích nêco bližšího.";
};
...
{
	AI_Output (other,self,  "DIA_ADDON_Lares_AboutSld_15_00"); //Povêz mi nêco víc o Leeovi a jeho žoldácích.
	...
	Info_AddChoice (DIA_Lares_AboutSld, "Chtêl bych vêdêt víc o têch žoldácích.", DIA_Lares_AboutSld_Sld);
...
{	
	...
	AI_Output (self, other, "DIA_Lares_AboutSld_09_01"); //Fajn, jestli seš poâád tak tvrdej, jako jsi bejval, nemêl bys s nima mít žádnej problém.
	...
	AI_Output (self, other, "DIA_Lares_AboutSld_09_03"); //(smích) Jestli seš krapet pâecitlivêlej, tak nemáš šanci s nima vydržet.
};	
func void DIA_Lares_AboutSld_WhyNotYou()
{
	...
	AI_Output (self, other, "DIA_Lares_WhyInCity_09_01"); //Ale vždyã jsem! Jenom ne na farmê.
	AI_Output (self, other, "DIA_Lares_WhyInCity_09_02"); //Dá se âíct, že ho tady ve mêstê zastupuju. Nechceme, aby ta loë odplula bez nás.
...
{	
	...
	AI_Output (self, other, "DIA_Lares_Schiff_09_01"); //Je na otevâené èásti pâístavu za útesem. Lee se chce se svejma pár lidma odsud vážnê dostat.
	AI_Output (self, other, "DIA_Lares_Schiff_09_02"); //Ale bude to chvíli trvat.
	AI_Output (other,self , "DIA_Lares_Schiff_15_03"); //Proè?
	AI_Output (self, other, "DIA_Lares_Schiff_09_04"); //Mêl by ses na to radêj zeptat Leeho, když ho potkáš... Má dobrej plán.
};
func void DIA_Lares_AboutSld_WayToOnar()
{
	AI_Output (other,self, "DIA_Lares_WegZumHof_15_00"); //Jak najdu farmu velkostatkáâe?
	AI_Output (self, other, "DIA_Addon_Lares_WegZumHof_09_00"); //Je to jednoduchý. Vyjdeš východní bránou z pâístavu a pak pùjdeš po cestê k východu.
	AI_Output (self, other, "DIA_Addon_Lares_WegZumHof_09_01"); //Jestli chceš, mùžu tê tam zavést.
...
func void DIA_Lares_GuildOfThieves_Info ()
{
	...
	AI_Output (self, other, "DIA_Lares_GuildOfThieves_09_02"); //Samozâejmê, máme tady zlodêjskej cech. Jako v každým vêtším mêstê.
	AI_Output (self, other, "DIA_Lares_GuildOfThieves_09_03"); //A každej malej zlodêjíèek nebo šmelináâ je s ní nêjak propojenej.
};	
// ------------------------------------------------------------
// Wo finden?
// ------------------------------------------------------------
...
func void DIA_Lares_WhereGuildOfThieves_Info ()
{
	...
	AI_Output (self, other, "DIA_Lares_WhereGuildOfThieves_09_03"); //Jestli se s nima chceš zaplést, mêl bys být hodnê opatrný.
};
// ------------------------------------------------------------
// Meersalz Schlüssel
// ------------------------------------------------------------
instance DIA_Lares_GotKey (C_INFO)
{
	...
	permanent    =  FALSE;
	description	 = 	"Mám tady tenhle klíè. Je celej zrezlej od moâský vody...";
};
...
{
	AI_Output (other, self, "DIA_Lares_GotKey_15_00"); //Mám tady tenhle klíè. Je celej zrezlej od moâský vody.
	AI_Output (self, other, "DIA_Lares_GotKey_09_01"); //Takže?
	AI_Output (other,self, "DIA_Lares_GotKey_15_02"); //Mám dojem, že by mê mohl dovést k úkrytu zlodêjskýho cechu.
...
func void DIA_Lares_OtherGuild_Info ()
{
	...
	|| (other.guild == GIL_PAL)
	{
		if (other.guild == GIL_MIL)
		{
			...
			AI_Output (self, other, "DIA_Lares_OtherGuild_09_01"); //(smích) To mê podrž - bejvalej trestanec v domobranê...
		}
		else //GIL_PAL
		{
			AI_Output (self, other, "DIA_Lares_OtherGuild_09_02"); //Tak ty seš teë jedním z královských paladinù!
		};
	
		AI_Output (self, other, "DIA_Lares_OtherGuild_09_03"); //(uliènicky) Nêco takovýho mùžeš províst jenom ty.
	...
	|| (other.guild == GIL_DJG)
	{
		...
		AI_Output (self, other, "DIA_Addon_Lares_OtherGuild_09_00"); //Prý tê pâijali k Leemu.
...
instance DIA_Addon_Lares_Forest (C_INFO)
{
	...
	description	 = 	"Pomohl bys mi projít têmi houštinami na východê?";
};
...
{
	AI_Output (other, self, "DIA_Addon_Lares_RangerHelp_Forest_15_00"); //Nepomohl bys mi projít pâes ty husté lesy na východê.
	...
	AI_Output (other, self, "DIA_Addon_Lares_RangerHelp_Forest_15_03"); //A jedno z míst, kde mám hledat, by mêlo být právê uprostâed têch hvozdù.
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_Forest_09_04"); //Chápu. A pro jednoho je taková cesta moc nebezpeèná, co?
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_Forest_09_05"); //Tak fajn, jen mi dej vêdêt, až budeš chtít vyrazit.
...
func void DIA_Lares_GoNow_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Lares_GoNow_09_03"); //Nemùžu odsud odejít, dokud nezjistíme víc o têch zmizelých lidech, nebo pokud mê tu nêkdo nevystâídá.
	}
	...
	else
	{
			...
			{
				Info_AddChoice	(DIA_Lares_GoNow, "Do hustého lesa na východê.", DIA_Lares_GoNow_Forest );
			};
	};		
};
...
{
	AI_Output			(other, self, "DIA_Addon_Lares_GoNow_Forest_15_00"); //Do hustého lesa na východê.
...
func void DIA_Lares_GUIDE_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Lares_GUIDE_09_01"); //Tak tady jsi. Už jsem si zaèínal myslet, že tê sežrali vlci.
	};
	AI_Output (self, other, "DIA_Lares_GUIDE_09_02"); //Takže dál už trefíš sám. Musím se vrátit do mêsta, mám tam ještê nêjaké vyâizování.
	AI_Output (self, other, "DIA_Lares_GUIDE_09_03"); //Prostê pokraèuj po téhle cestê dál a pamatuj - važ si sám sebe a nepodêlej se z každý blbosti, pak to pro tebe bude hraèka.
...
{
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortalInter1_09_00"); //Teë, když jsme venku z mêsta a nikdo nás nemùže slyšet, vysvêtlím ti to trochu blíž.
...
func void DIA_Addon_Lares_ArrivedPortalInter1_teil2 ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Lares_ArrivedPortalInter1_teil2_09_01"); //Dokonce i Lee se je doteëka snaží chránit, jak mùže, aby je nepotkalo nic zlýho.
	AI_Output			(self, other, "DIA_Addon_Lares_ArrivedPortalInter1_teil2_09_02"); //Já musím být s vodními mágy poâád v kontaktu, proto jsem taky vêtšinou ve mêstê a spolupracuju s Vatrasem.
	B_MakeRangerReadyForMeeting (self);
	AI_Output			(self, other, "DIA_Addon_Lares_ArrivedPortalInter1_teil2_09_03"); //A tohle je zbroj, kterou nám všem dali vodní mágové. Prý takový brnêní nosili èlenové kruhu vody ještê pâed válkama se skâety.
	...
	if (Cavalorn_RangerHint == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Lares_ArrivedPortalInter1_teil2_09_05"); //Máš pravdu, naše komunita se rozrostla. Dokonce ani já už nevím, kolik nás vlastnê je.
	};

	AI_Output			(self, other, "DIA_Addon_Lares_ArrivedPortalInter1_teil2_09_06"); //Ale teë se pohnême. Chci se dostat dál od mêsta a pak si mùžeme âíct víc.
	Info_ClearChoices	(DIA_Addon_Lares_ArrivedPortalInter1);
};
...
func void DIA_Addon_Lares_ArrivedPortalInter1_wer ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Lares_ArrivedPortalInter1_wer_09_01"); //V Novém táboâe býval hlavním mágem vody, ještê když Hornické údolí obklopovala bariéra.
...
{
	AI_Output			(other, self, "DIA_Addon_Lares_ArrivedPortalInter1_ja_15_00"); //Samozâejmê, býval hlavním vodním mágem v Novém táboâe.
	DIA_Addon_Lares_ArrivedPortalInter1_teil2 ();
};
...
{
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortalInter2_09_00"); //Mágové vody jsou celí bez sebe. Už pár týdnù makaj na vykopávkách na severovýchodê, ale nikdo netuší, co se tam vlastnê snaží najít.
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortalInter2_09_01"); //Všechno to zaèalo, když se zemê zaèala tâást, jako to bývalo v nejhorších dobách bariéry.
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortalInter2_09_02"); //Ze zemê vylízaj dêsný kamenný potvory a zabijou každýho, kdo se nachomýtne na 100 stop od nich.
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortalInter2_09_03"); //Vodní mágové se toho chopili a všecky ty nepâátelský útoèníky znièili. A teë tam kopou a hledají pro všechny ty podivnosti nêjaký vysvêtlení.
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortalInter2_09_04"); //Ale to brzo uvidíš sám.

	LaresGuide_ZumPortal = 5;
	B_LogEntry (TOPIC_Addon_KDW,"Lares mi vyprávêl o vykopávkách, které mají na svêdomí vodní mágové. Snaží se objasnit nêjaké podivné události - tajemná zemêtâesení a záhadné kamenné obludy, které povstávají pâímo ze zemê."); 
};
...
{
	AI_Output	(self, other, "DIA_Addon_Lares_ArrivedPortalInterWeiter3_09_00"); //Mùžeš ještê pokraèovat.
...
{
	AI_Output	(self, other, "DIA_Addon_Lares_ArrivedPortalInterWeiter4_09_00"); //Jo, tady už to mùže bejt nebezpeèný.
...
func void DIA_Addon_Lares_ArrivedPortal_Info ()
{
	...
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortal_09_00"); //Tak jsme tu.
 	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortal_09_01"); //Tumáš, vezmi si ten ornament. Vodní mágové musí být nêkde tady. Tak jim ho dej.
	B_GiveInvItems (self, other, ItMi_Ornament_Addon_Vatras, 1);					
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortal_09_02"); //Kdybys v tý díâe narazil na nêjaký potvory, na který bys nestaèil, utíkej smêrem k Saturasovi.
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortal_09_03"); //On je za tebe vyâídí. Já už se musím vrátit.
	AI_Output 	(self, other, "DIA_Addon_Lares_ArrivedPortal_09_04"); //Jo, ještê nêco: aã tê ani nenapadne, že by ses tu delší dobu promenádoval s tím ornamentem. Bêž PÂÍMO za Saturasem.
...
func void DIA_Addon_Lares_GOFORESTPRE_ja ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_GOFORESTPRE_ja_09_01"); //Tak fajn, kamaráde. Pojë za mnou, pùjde do tuhýho.
	AI_StopProcessInfos (self);
...
{
	AI_Output	(other, self, "DIA_Addon_Lares_GOFORESTPRE_nein_15_00"); //Ne. Mùžeš jít.
	AI_Output	(self, other, "DIA_Addon_Lares_GOFORESTPRE_nein_09_01"); //Myslíš, že se to všecko vyâeší samo? No tak dobrá, mêj se!
	AI_StopProcessInfos (self);
...
func void DIA_Addon_Lares_GOFORESTPRE_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Lares_GOFORESTPRE_09_01"); //Pâemýšlel jsi o tom, že vyrazíme do lesa? Opravdu to chceš udêlat?
 	};
	Info_ClearChoices	(DIA_Addon_Lares_GOFORESTPRE);
	Info_AddChoice	(DIA_Addon_Lares_GOFORESTPRE, "Ne. Mùžeš jít.", DIA_Addon_Lares_GOFORESTPRE_nein );
...
func void DIA_Addon_Lares_GOFOREST_Info ()
{
	...
	{	
		B_MakeRangerReadyToLeaveMeeting (self);
		AI_Output 	(self, other, "DIA_Addon_Lares_GOFOREST_09_00"); //Tak, zbytek už bys mêl zvládnout sám. Já jdu zpátky.
	 	AI_StopProcessInfos (self);
		self.aivar[AIV_PARTYMEMBER] = FALSE;
		Npc_ExchangeRoutine (self,"START");
 	...
 	{
		AI_Output 	(self, other, "DIA_Addon_Lares_GOFOREST_09_01"); //Pospêš si, nechci tu zùstávat ani o chvilku dýl, než musím.
	 	AI_StopProcessInfos (self);
 	};
};
...
{
	AI_Output (other, self, "DIA_Lares_DEX_15_00"); //Mùžeš mê nêèemu nauèit?
	AI_Output (self, other, "DIA_Addon_Lares_DEX_Add_09_01"); //Jasnê. Když budeš chtít, mùžu ti vysvêtlit, jak se stát silnêjším a obratnêjším.

	Lares_TeachDEX = TRUE;
	
	Log_CreateTopic (Topic_CityTeacher,LOG_NOTE);
	B_LogEntry (Topic_CityTeacher,"Lares mi pomùže zlepšit sílu a obratnost.");
};
// ------------------------------------------------------------
// 			  				   TEACH 
// ------------------------------------------------------------
...
{	
	...
	{
		AI_Output (self ,other,"DIA_Lares_AnyNews_09_01"); //Za ty nejlepší zprávy mùžeš ty sám. Nechali Benneta jít, je zpátky na farmê.
		AI_Output (self ,other,"DIA_Lares_AnyNews_09_02"); //Bêž za ním, mám dojem, že by ti chtêl podêkovat osobnê.
	}
	else
	{
		...
		else
		{
			...
			AI_Output (self ,other,"DIA_Lares_AnyNews_09_07"); //Bennet odjel do mêsta pro zásoby. No a už se nevrátil.
...
{	
	AI_Output (other,self ,"DIA_Lares_NewsAboutBennet_15_00"); //Nêjaký zprávy o Bennetovi?
	AI_Output (self ,other,"DIA_Lares_NewsAboutBennet_09_01"); //Vypadá to, že ho vzali do kasáren a strèili do žaláâe.
	AI_Output (other,self ,"DIA_Lares_NewsAboutBennet_15_02"); //Jak ho odtamtud mùžeme dostat?
	AI_Output (self ,other,"DIA_Lares_NewsAboutBennet_09_03"); //Tak to vùbec netuším. Nemùžu se dostat ani k nêmu do cely, abych si s ním promluvil.
	AI_Output (self ,other,"DIA_Lares_NewsAboutBennet_09_04"); //Všechno, co zmùžu, je mít oèi na stopkách. Ale asi toho stejnê moc nevykoukám.
};
...
{	
	...
	AI_Output (self ,other,"DIA_Lares_Kap4_PERM_09_02"); //Hmmm. Èerstvý moâský vzduch - to je pâesnê to, co jsem potâeboval.
};
...
func void DIA_Lares_KnowWhereEnemy_Info ()
{
	...
	AI_Output			(other, self, "DIA_Lares_KnowWhereEnemy_15_02"); //Zjistil jsem, kde se ukrývá vùdce drakù. Je na ostrovê, nedaleko odsud.
	...
	AI_Output			(self, other, "DIA_Lares_KnowWhereEnemy_09_05"); //Mùžeš na svých cestách potâebovat nêkoho, kde tê nauèí posilovat obratnost nebo boj jednoruèními zbranêmi?
	
	if (crewmember_count >= Max_Crew)
	{
		AI_Output			(other,self , "DIA_Lares_KnowWhereEnemy_15_06"); //Loë už je plná, ale kdyby se nêco zmênilo, dám vêdêt.
	}
	else 
	{
		...
		Info_AddChoice (DIA_Lares_KnowWhereEnemy,"Vêdêl jsem, že se na tebe mùžu spolehnout.",DIA_Lares_KnowWhereEnemy_Yes);
	};
};

FUNC VOID DIA_Lares_KnowWhereEnemy_Yes ()
{
	AI_Output (other,self ,"DIA_Lares_KnowWhereEnemy_Yes_15_00"); //Vêdêl jsem, že se na tebe mùžu spolehnout.
	AI_Output (other,self ,"DIA_Lares_KnowWhereEnemy_Yes_15_01"); //Všichni se sejdeme na lodi.
	AI_Output (self ,other,"DIA_Lares_KnowWhereEnemy_Yes_09_02"); //Muž èinu, tak to mám rád. Ještê se uvidíme.
...
{
	AI_Output (other,self ,"DIA_Lares_KnowWhereEnemy_No_15_00"); //Cením si tvé nabídky, ale nemám, jak bych tê využil.
...
instance DIA_Lares_LeaveMyShip		(C_INFO)
{
	...
	PERMANENT 	 =  TRUE;
	description	 = 	"Bude lepší, když zùstaneš tady.";
};
...
func void DIA_Lares_StillNeedYou_Info ()
{
	...
	if (Lares_IsOnBoard == LOG_OBSOLETE)
	{
		AI_Output	(self, other, "DIA_Lares_StillNeedYou_09_01"); //Normálnê nenechávám jen tak nêkoho, aby se mnou takhle jednal, ale jelikož jsi jedním z nás, nechám to protentokrát být.
