...
func void DIA_Valentino_WhoAgain_Info ()
{
	...
	AI_Output			(self, other, "DIA_Valentino_HALLO_wasmachstdu_03_03"); //Jestli máš problémy, nech si je pro sebe, já na ně zvědavý nejsem.
};
...
func void DIA_Valentino_Manieren_Info ()
{
	...
	AI_Output			(self, other, "DIA_Valentino_HALLO_klappe_03_01"); //Mně to nevadí. Jen si mě klidně zbij. Až se zítra ráno probudím, zase mi bude dobře.
...
instance DIA_Valentino_WASNUETZLICHES		(C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Chceš mi říct ještě něco jiného?";
};
