...
func void DIA_Valentino_WhoAgain_Info ()
{
	...
	AI_Output			(self, other, "DIA_Valentino_HALLO_wasmachstdu_03_03"); //Jestli máš problémy, nech si je pro sebe, já na nę zvędavý nejsem.
};
...
func void DIA_Valentino_Manieren_Info ()
{
	...
	AI_Output			(self, other, "DIA_Valentino_HALLO_klappe_03_01"); //Mnę to nevadí. Jen si mę klidnę zbij. Až se zítra ráno probudím, zase mi bude dobâe.
...
instance DIA_Valentino_WASNUETZLICHES		(C_INFO)
{
	...
	permanent	= TRUE;
	description	= "Chceš mi âíct ještę nęco jiného?";
};
