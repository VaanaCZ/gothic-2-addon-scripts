...
INSTANCE DIA_Udar_YouAreBest (C_INFO)
{
	...
	permanent	= FALSE;
	Description = "Slyšel jsem, že jsi ten NEJLEPŠÍ střelec z kuše...";
};                       
...
INSTANCE DIA_Udar_Teach (C_INFO)
{
	...
	permanent	= TRUE;
	Description = "Chtěl bych se od tebe něčemu přiučit.";
};                       
...
INSTANCE DIA_Udar_Ring (C_INFO)
{
	...
	permanent	= FALSE;
	Description = "Tady ti nesu ten Tengronův prsten...";
};                       
