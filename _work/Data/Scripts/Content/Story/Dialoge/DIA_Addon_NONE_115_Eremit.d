...
func void DIA_Addon_Eremit_Hello_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_00"); //Co tady dělám?! A co tu sakra děláš TY?
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_01"); //Šel jsem do nejodlehlejší části ostrova, protože jsem chtěl mít konečně klid!
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_02"); //Občanská válka, nájezdy banditů, tlupy skřetů, co ti pomalu tlučou na dveře...
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_03"); //To prostě nebylo pro mě. Tak jsem z toho šílenství odešel.
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_04"); //Možná že tu nějací skřeti jsou, ale moc jich nebude.
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_05"); //A žádní LIDÉ se tu – díky Innosovi – nikdy neukázali. (mrzutě) Až dodneška.
};
...
instance DIA_Addon_Eremit_SeekTafeln (C_INFO)
{
	...
	description	= "Hledám nějaké kamenné tabulky...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Eremit_Add_15_02"); //Hledám kamenné tabulky. Nemáš tu třeba nějaké?
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_06"); //(opatrně) Ano, ale nechávám si je!
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_07"); //Jsou to jediné, co se tu dá číst.
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_08"); //Sice jim ještě nerozumím, ale některé texty už se mi podařilo rozluštit.
};
...
{
	AI_Output (other, self, "DIA_Addon_Eremit_Add_15_03"); //Co se týče těch kamenných tabulek...
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_25"); //Mám tě naučit, jak je číst?
...
// ---------------------------------------------------------------
	...
	{	
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_27"); //No, je to poměrně jednoduché. G je O, T je H a I je C. 
...
func void DIA_Addon_Eremit_Teach_Yes()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_29"); //Myslím, že víc už tě v tomhle nenaučím.
		Eremit_Teach_Once = TRUE;
	}
...
instance DIA_Addon_Eremit_Klamotten (C_INFO)
{
	...
	permanent 	= TRUE;
	description = "Mám pro tebe nějaké ošacení...";
};
...
{
	AI_Output (other, self, "DIA_Addon_Eremit_Add_15_01"); //Mám pro tebe nějaké oblečení.
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_19"); //Vážně? Ukaž mi je, uvidíme, jestli mi sedne.
	...
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat lehkou pirátskou zbroj", DIA_Addon_Eremit_Klamotten_PIR_L);
	};
	if (Npc_HasItems (other, ITAR_PIR_M_Addon) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat středně těžkou pirátskou zbroj", DIA_Addon_Eremit_Klamotten_PIR_M);
	};
	if (Npc_HasItems (other, ITAR_PIR_H_Addon) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat zbroj pirátských kapitánů", DIA_Addon_Eremit_Klamotten_PIR_H);
	};
	...
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat zbroj kruhu vody", DIA_Addon_Eremit_Klamotten_Ranger);
	};
	if (Npc_HasItems (other, ITAR_KDW_L_Addon) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat lehké roucho kruhu vody", DIA_Addon_Eremit_Klamotten_KDW_L);
	};
	if (Npc_HasItems (other, ITAR_KDW_H) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat těžké roucho kruhu vody", DIA_Addon_Eremit_Klamotten_KDW_H);
	};
	if (Npc_HasItems (other, ITAR_Governor) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat velitelský kabátec", DIA_Addon_Eremit_Klamotten_Governor);
	};
	if (Npc_HasItems (other, ITAR_JUDGE) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat soudcovské roucho", DIA_Addon_Eremit_Klamotten_Judge);
	};
	if (Npc_HasItems (other, ITAR_SMITH) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat kovářskou zástěru", DIA_Addon_Eremit_Klamotten_Smith);
	};
	if (Npc_HasItems (other, ITAR_BARKEEPER) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat hostinskou zástěru", DIA_Addon_Eremit_Klamotten_Barkeeper);
	};
	if (Npc_HasItems (other, ITAR_VLK_L) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat měšťanský oděv I", DIA_Addon_Eremit_Klamotten_VLK_L);
	};
	if (Npc_HasItems (other, ITAR_VLK_M) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat měšťanský oděv II", DIA_Addon_Eremit_Klamotten_VLK_M);
	};
	if (Npc_HasItems (other, ITAR_VLK_H) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat měšťanský oděv III", DIA_Addon_Eremit_Klamotten_VLK_H);
	};
	if (Npc_HasItems (other, ITAR_VlkBabe_L) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat měšťanský šat I", DIA_Addon_Eremit_Klamotten_VlkBabe_L);
	};
	if (Npc_HasItems (other, ITAR_VlkBabe_M) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat měšťanský šat II", DIA_Addon_Eremit_Klamotten_VlkBabe_M);
	};
	if (Npc_HasItems (other, ITAR_VlkBabe_H) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat měšťanský šat III", DIA_Addon_Eremit_Klamotten_VlkBabe_H);
	};
	/*
	...
	*/
	...
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat starou paladinskou zbroj", DIA_Addon_Eremit_Klamotten_PAL_SKEL);
	};
	if (Npc_HasItems (other, ITAR_BAU_L) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat lehký selský oděv", DIA_Addon_Eremit_Klamotten_BAU_L);
	};
	if (Npc_HasItems (other, ITAR_BAU_M) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat středně těžký selský oděv", DIA_Addon_Eremit_Klamotten_BAU_M);
	};
	if (Npc_HasItems (other, ITAR_BauBabe_L) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat lehký selský šat", DIA_Addon_Eremit_Klamotten_BauBabe_L);
	};
	if (Npc_HasItems (other, ITAR_BauBabe_M) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat středně těžký selský šat", DIA_Addon_Eremit_Klamotten_BauBabe_M);
	};
	/*
	...
	*/
	...
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat zbroj z důlního červa", DIA_Addon_Eremit_Klamotten_DJG_Crawler);
	};
	/*
	...
	*/
	...
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat koženou zbroj", DIA_Addon_Eremit_Klamotten_Leather);
	};
	...
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat roucho temných umění", DIA_Addon_Eremit_Klamotten_Xardas);
	};
	if (Npc_HasItems (other, ITAR_Lester) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat Lesterovo roucho", DIA_Addon_Eremit_Klamotten_Lester);
	};
	if (Npc_HasItems (other, ITAR_Diego) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat Diegovu zbroj", DIA_Addon_Eremit_Klamotten_Diego);
	};
	if (Npc_HasItems (other, ITAR_CorAngar) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat Cor Angarovu zbroj", DIA_Addon_Eremit_Klamotten_CorAngar);
	};
	if (Npc_HasItems (other, ITAR_Prisoner) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat kopáčské kalhoty", DIA_Addon_Eremit_Klamotten_Prisoner);
	};
	if (Npc_HasItems (other, ITAR_Dementor) > 0)
	{
		Info_AddChoice (DIA_Addon_Eremit_Klamotten, "Předat roucho pátračů", DIA_Addon_Eremit_Klamotten_Dementor);
	};
};
// -------------------------------------------------------------
	func void B_Eremit_Tatsache()
	{
		...
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_21"); //Ale co teď budu dělat? Dal jsem všecko zlato pirátům za to, že mě sem zavezli.
...
{
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_24"); //Skvělý. Napřed mi tu všecko rozhodíš a pak... (povzdechne si)
	Info_ClearChoices (DIA_Addon_Eremit_Klamotten);
};
...
func void DIA_Addon_Eremit_PERM_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_09"); //(hrdě) Všecko jsem si udělal sám. Zbraně, nástroje, chatrč, prostě všecko.
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_10"); //Když jsem sem přišel, neměl jsem nic než dobrou náladu.
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_11"); //Jenže občas...
		AI_Output (other, self, "DIA_Addon_Eremit_Doppelt_15_01"); //Ano? 
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_12"); //Občas bych byl rád, kdybych si s sebou byl vzal aspoň nějaké oblečení.
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_13"); //Neumím tkát ani vydělávat kůže.
	...
	{
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_15"); //Zařídím to. 
		if (MIS_Eremit_Klamotten == LOG_SUCCESS)
		{
			AI_Output (self, other, "DIA_Addon_Eremit_Add_04_18"); //S oblečením v pohodě přežiju zimu! A potom... no, potom uvidíme...
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_Eremit_Add_04_16"); //Pořád lepší než v Khorinidu!
