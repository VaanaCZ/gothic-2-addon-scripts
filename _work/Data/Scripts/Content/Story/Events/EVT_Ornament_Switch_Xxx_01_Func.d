...
func void EVT_ORNAMENT_SWITCH_BIGFARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_BIGFARM == FALSE)
		{
			...
			B_LogEntry 			(TOPIC_Addon_Ornament,"J'ai activé le mécanisme du cercle de pierre près de la ferme de Sekob. Il y a eu une forte déflagration, et une sentinelle de pierre a essayé de me tuer."); 
...
func void EVT_ORNAMENT_SWITCH_FARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FARM == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"J'ai activé le mécanisme du cercle de pierre près de la ferme de Lobart. Un séisme s'est produit, sans autre conséquence."); 
...
func void EVT_ORNAMENT_SWITCH_FOREST_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FOREST == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"J'ai activé le mécanisme du cercle de pierre dans la forêt, au nord. Une puissante sentinelle de pierre est apparue - elle était assez peu coopérative, d'ailleurs."); 
