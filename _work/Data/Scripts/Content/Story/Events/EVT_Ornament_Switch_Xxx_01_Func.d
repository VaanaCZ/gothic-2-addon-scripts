...
func void EVT_ORNAMENT_SWITCH_BIGFARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_BIGFARM == FALSE)
		{
			...
			B_LogEntry 			(TOPIC_Addon_Ornament,"Ho attivato il meccanismo del cerchio di pietra vicino alla fattoria di Sekob. C'è stata una grande esplosione e una sentinella di pietra ha cercato di uccidermi."); 
...
func void EVT_ORNAMENT_SWITCH_FARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FARM == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"Ho attivato il meccanismo del cerchio di pietra vicino alla fattoria di Lobart. C'è stata solo una scossa."); 
...
func void EVT_ORNAMENT_SWITCH_FOREST_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FOREST == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"Ho attivato il meccanismo del cerchio di pietra nella foresta di nordest. È comparsa una grande sentinella di pietra: era di pessimo umore."); 
