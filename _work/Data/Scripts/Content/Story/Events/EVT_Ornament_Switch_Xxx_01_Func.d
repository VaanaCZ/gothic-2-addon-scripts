...
func void EVT_ORNAMENT_SWITCH_BIGFARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_BIGFARM == FALSE)
		{
			...
			B_LogEntry 			(TOPIC_Addon_Ornament,"He activado el mecanismo del círculo de piedra junto a la granja de Sekob. Ha habido una enorme explosión y un centinela de piedra ha tratado de matarme."); 
...
func void EVT_ORNAMENT_SWITCH_FARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FARM == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"He activado el mecanismo del círculo de piedra junto a la granja de Lobart. Ha habido un temblor, pero nada más."); 
...
func void EVT_ORNAMENT_SWITCH_FOREST_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FOREST == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"He activado el mecanismo del círculo de piedra del bosque del norte. Ha aparecido un gran centinela de piedra. Tenía malas pulgas."); 
