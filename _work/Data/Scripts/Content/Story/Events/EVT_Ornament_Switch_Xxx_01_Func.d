...
func void EVT_ORNAMENT_SWITCH_BIGFARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_BIGFARM == FALSE)
		{
			...
			B_LogEntry 			(TOPIC_Addon_Ornament,"Spustil jsem mechanismus kamenného kruhu u Sekobova statku. Byla to rána jak z dìla a vzápìtí se mì pokusila zabít nìjaká kamenná potvora."); 
...
func void EVT_ORNAMENT_SWITCH_FARM_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FARM == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"Aktivoval jsem mechanismus kamenného kruhu u Lobartova statku. Zemì se zatøásla, ale nic jiného se nestalo."); 
...
func void EVT_ORNAMENT_SWITCH_FOREST_01_FUNC ()
{
		if (ORNAMENT_SWITCHED_FOREST == FALSE)
		{
			...
			Log_CreateTopic 	(TOPIC_Addon_Ornament, LOG_MISSION);
			Log_SetTopicStatus	(TOPIC_Addon_Ornament, LOG_RUNNING);
			B_LogEntry 			(TOPIC_Addon_Ornament,"Aktivoval jsem mechanismus kamenného kruhu v lese na severu. Objevil se kamenný strážce a nebyl v nijak dobré náladì."); 
