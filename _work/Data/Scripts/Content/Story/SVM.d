...
CLASS C_SVM
{
	...
	var string Weather;						//Tempo schifoso!
	...
	// ------ GOLD ------
	var string GOLD_1000;					//1000 monete d'oro.
	var string GOLD_950;					//950 monete d'oro.
	var string GOLD_900;					//900 monete d'oro.
	var string GOLD_850;					//850 monete d'oro.
	var string GOLD_800;					//800 monete d'oro.
	var string GOLD_750;					//750 monete d'oro.
	var string GOLD_700;					//700 monete d'oro.
	var string GOLD_650;					//650 monete d'oro.
	var string GOLD_600;					//600 GOldstücke.
	var string GOLD_550;					//550 monete d'oro.
	var string GOLD_500;					//500 monete d'oro.
	var string GOLD_450;					//450 monete d'oro.
	var string GOLD_400;					//400 monete d'oro.
	var string GOLD_350;					//350 monete d'oro.
	var string GOLD_300;					//300 monete d'oro.
	var string GOLD_250;					//250 monete d'oro.
	var string GOLD_200;					//200 monete d'oro.
	var string GOLD_150;					//150 monete d'oro.
	var string GOLD_100;					//100 monete d'oro.
	var string GOLD_90;						//90 monete d'oro.
	var string GOLD_80;						//80 monete d'oro.
	var string GOLD_70;						//70 monete d'oro.
	var string GOLD_60;						//60 monete d'oro.
	var string GOLD_50;						//50 monete d'oro.
	var string GOLD_40;						//40 monete d'oro.
	var string GOLD_30;						//30 monete d'oro.
	var string GOLD_20;						//20 monete d'oro.
	var string GOLD_10;						//10 monete d'oro.
