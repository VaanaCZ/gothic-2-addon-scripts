...
CLASS C_SVM
{
	...
	var string Weather;						//Zatracená slota!
	...
	// ------ GOLD ------
	var string GOLD_1000;					//1000 zlatých.
	var string GOLD_950;					//950 zlatých.
	var string GOLD_900;					//900 zlatých.
	var string GOLD_850;					//850 zlatých.
	var string GOLD_800;					//800 zlatých.
	var string GOLD_750;					//750 zlatých.
	var string GOLD_700;					//700 zlatých.
	var string GOLD_650;					//650 zlatých.
	var string GOLD_600;					//600 GOldstücke.
	var string GOLD_550;					//550 zlatých.
	var string GOLD_500;					//500 zlatých.
	var string GOLD_450;					//450 zlatých.
	var string GOLD_400;					//400 zlatých.
	var string GOLD_350;					//350 zlatých.
	var string GOLD_300;					//300 zlatých.
	var string GOLD_250;					//250 zlatých.
	var string GOLD_200;					//200 zlatých.
	var string GOLD_150;					//150 zlatých.
	var string GOLD_100;					//100 zlatých.
	var string GOLD_90;						//90 zlatých.
	var string GOLD_80;						//80 zlatých.
	var string GOLD_70;						//70 zlatých.
	var string GOLD_60;						//60 zlatých.
	var string GOLD_50;						//50 zlatých.
	var string GOLD_40;						//40 zlatých.
	var string GOLD_30;						//30 zlatých.
	var string GOLD_20;						//20 zlatých.
	var string GOLD_10;						//10 zlatých.
