...
func void UseStandardBrief ()
{
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager
					...
					Doc_PrintLine	( nDocID,  0, "Carta normal"					);
...
{
	name 		= "Mapa de la ciudad de Khorinis";  // 
...
{
	name 		= "Mapa del Valle de las Minas";
...
INSTANCE ItWr_EinhandBuch (C_ITEM)
{
	...
	scemeName				=	"MAP";
	description				= 	"Arte de la defensa meridional";
	
	TEXT[2] 				=  "Un libro acerca del arte de";
	TEXT[3] 				=  "la lucha a una mano.";
	TEXT[5]					= 	NAME_Value;
	COUNT[5]				= 	value;
...
INSTANCE ItWr_ZweihandBuch (C_ITEM)
{
	...
	scemeName				=	"MAP";
	description				= 	"Paradas dobles";
	
	TEXT[2] 				=  "Un libro acerca del arte de";
	TEXT[3] 				=  "del combate con dos armas.";
	TEXT[5]					= 	NAME_Value;
	COUNT[5]				= 	value;
	...
	FUNC VOID UseZweihandBuch()
	{
		...
		nDocID = 	Doc_Create		()			  ;								// DocManager
					...
					Doc_SetFont 	( nDocID,  0, FONT_BookHeadline	   			); 	// -1 -> all pages
 					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Paradas dobles"	);
					Doc_SetFont 	( nDocID,  0, FONT_Book	   			); 	// -1 -> all pages
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLine	( nDocID,  0, ""					);
					...
					Doc_PrintLine	( nDocID,  1, ""					);
					Doc_PrintLine	( nDocID,  1, ""					);
					Doc_PrintLines	( nDocID,  1, "A consecuencia de esto, el rival se suele detener y eso presenta la oportunidad de tomar la iniciativa y derrotar al enemigo con ataques certeros.    "	);
