...
INSTANCE ItWr_EinhandBuch (C_ITEM)
{
	...
	FUNC VOID UseEinhandBuch()
	{
		...
		nDocID = 	Doc_Create		()			  ;								
					...
					Doc_SetFont 	( nDocID,  0, FONT_Book	   			); 	// -1 -> all pages
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Jižané na rozdíl od seveřanů spoléhají daleko méně na fyzickou sílu. V horkém podnebí své domoviny dávají přednost lehké zbroji, která jim nijak nebrání v pohybu. Proto se i jejich styl boje velmi liší od toho, na který jsme zvyklí u nás."					);
