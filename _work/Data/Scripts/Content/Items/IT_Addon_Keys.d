...
INSTANCE ITKE_Addon_Tavern_01 (C_Item)
{
	...
	description			= 	"Clef de Lou";
	
	TEXT[2]				=	"Ouvre la porte de la taverne";
	TEXT[3]				=   "dans le camp des bandits";
...
INSTANCE ITKE_ORLAN_TELEPORTSTATION (C_Item)
{
	...
	description			= 	"Clef d'Orlan";
	
	TEXT[2]				=	"Ouvre la porte de la grotte";
	TEXT[3]				=   "au sud de sa taverne";
...
INSTANCE ITKE_ADDON_BUDDLER_01 (C_Item)
{
	...
	description			= 	"Clef de coffre";
	
	TEXT[2]				=	"Provient du camp des bandits";
	TEXT[3]				=   "";
