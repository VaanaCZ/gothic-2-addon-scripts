...
INSTANCE ItMi_BaltramPaket(C_Item)
{
	...
	description			= 	name;
	TEXT[2]				= 	"Un lourd colis plein";
	TEXT[3]				=	"de bonnes choses.";
	TEXT[4]				=	"obtenue du fermier Akil";
...
INSTANCE ItMi_Addon_Lennar_Paket(C_Item)
{
	...
	description			= 	name;
	TEXT[2]				= 	"Il contient des crochets";
	TEXT[3]				=	"";
	TEXT[4]				=	"Plusieurs crochets";
