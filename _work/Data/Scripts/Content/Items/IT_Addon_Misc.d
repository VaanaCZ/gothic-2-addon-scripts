...
INSTANCE ItMi_Packet_Baltram4Skip_Addon (C_Item)
{
	...
	TEXT[3]				=	"dobrých vìcí.";
	TEXT[4]				=	"je urèen pirátu Skipovi";
...
FUNC VOID Use_CavalornsBeutel ()
{
		...
		B_LogEntry (TOPIC_Addon_CavalornTheHut,"U Cavalornovy chýše v Hornickém údolí jsem našel váèek s jedinou hrudkou rudy. Ten starý zlodìj Cavalorn jej tu musel zapomenout.");
};
...
INSTANCE ItMi_Addon_Lennar_Paket(C_Item)
{
	...
	description			= 	name;
	TEXT[2]				= 	"Uvnitø jsou paklíèe";
	TEXT[3]				=	"";
	TEXT[4]				=	"Spousta paklíèù";
