...
INSTANCE ItMi_BaltramPaket(C_Item)
{
	...
	description			= 	name;
	TEXT[2]				= 	"Un pesado fardo";
	TEXT[3]				=	"de bienes.";
	TEXT[4]				=	"del granjero Akil";
...
INSTANCE ItMi_Packet_Baltram4Skip_Addon (C_Item)
{
	...
	description			= 	name;
	TEXT[2]				= 	"Este paquete pesado";
	TEXT[3]				=	"de bienes";
	TEXT[4]				=	"es para el pirata Skip";
	
};
/******************************************************************************************/
INSTANCE ItMi_BromorsGeld_Addon (C_Item)
{
	name 				=	"Bol de oro de Bromor";
...
{
	name 				=	"Bolsa de cuero de Cavalorn";
	...
	TEXT[0]				= 	"";
	TEXT[1]				= 	"Lleva una etiqueta con";
	TEXT[2]				= 	"el nombre 'Cavalorn'";
	TEXT[3]				= 	"Hay un trozo de mineral dentro";
	TEXT[4]				= 	"";
