...
INSTANCE ItRu_PalLight (C_Item)
{
	...
	COUNT	[2]			=	SPL_Cost_PalLight;
	
	TEXT	[3]			=	NAME_Duration;		
	COUNT	[3]			=	SPL_Duration_PalLIGHT;
...
INSTANCE ItRu_PalLightHeal (C_Item)
{
	...
	TEXT	[2]			=	NAME_Manakosten;		
	COUNT	[2]			=	SPL_Cost_PalLightHeal;
	
	TEXT	[3]			=	NAME_HealingPerCast;		
	COUNT	[3]			=	SPL_Heal_PalLightHeal;
...
INSTANCE ItRu_PalMediumHeal (C_Item)
{
	...
	TEXT	[2]			=	NAME_Manakosten;		
	COUNT	[2]			=	SPL_Cost_PalMediumHeal;
	
	TEXT	[3]			=	NAME_HealingPerCast;		
	COUNT	[3]			=	SPL_Heal_PalMediumHeal;
...
INSTANCE ItRu_PalFullHeal (C_Item)
{
	...
	TEXT	[2]			=	NAME_Manakosten;		
	COUNT	[2]			=	SPL_Cost_PalFullHeal;
	
	TEXT	[3]			=	NAME_HealingPerCast;		
	COUNT	[3]			=	SPL_Heal_PalFullHeal;
...
INSTANCE ItRu_PalHolyBolt (C_Item)
{
	...
	TEXT	[2]			=	NAME_Manakosten;			
	COUNT	[2]			=	SPL_Cost_PalHolyBolt;
	
	TEXT	[3]			=	NAME_Dam_Magic;		
	COUNT	[3]			=	SPL_Damage_PalHolyBolt;
...
INSTANCE ItRu_PalRepelEvil (C_Item)
{
	...
	TEXT	[2]			=	NAME_Manakosten;				
	COUNT	[2]			=	SPL_Cost_PalRepelEvil;
	
	TEXT	[3]			=	NAME_Dam_Magic;		
	COUNT	[3]			=	SPL_Damage_PalRepelEvil;
...
INSTANCE ItRu_PalDestroyEvil (C_Item)
{
	...
	TEXT	[2]			=	NAME_Manakosten;				
	COUNT	[2]			=	SPL_Cost_PalDestroyEvil;
	
	TEXT	[3]			=	NAME_Dam_Magic;		
	COUNT	[3]			=	SPL_Damage_PalDestroyEvil;
...
INSTANCE ItRu_SumGobSkel (C_Item)
{
	...
	TEXT 	[2]			=   "Los huesos esparcidos";
	TEXT 	[3]			=   "de trasgos muertos.";
...
INSTANCE ItRu_Concussionbolt	(C_Item)
{
	...
	description			=	"Proyectil de impacto";
