...
INSTANCE ItFo_Addon_Shellflesh (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Chair de palourde juteuse";
	TEXT[1]				= 	NAME_Bonus_HP; COUNT[1] = HP_Shellflesh;
	TEXT[2]				= 	"Comestible crue";
	TEXT[3]				= 	"";
...
INSTANCE ItFo_Addon_Grog(C_Item)
{
	...
	description		= 	"Authentique tafia de marin ";
...
INSTANCE ItFo_Addon_SchlafHammer (C_Item)
{
	...
	description		= 	"Marteau double";
	
	TEXT[1]			= 	"Fera somnoler le plus redoutable soiffard...";				
