...
INSTANCE ItFo_Addon_SchnellerHering(C_Item)
{
	...
	description		= 	"Szybki śledź";
	
	TEXT[1]			= 	"Wygląda groźnie!";				
	TEXT[2]			=	"Efekty nieznane. Bardzo możliwe efekty uboczne!";
...
{	
	...
	FUNC VOID Use_FireStew()
	{
		...
		PrintScreen ("Siła i żywotność zwiększone!", -1, 34, FONT_ScreenSmall,2); 
	};
//-------------------------------------------------------
// Fleischsuppe
//-------------------------------------------------------
