...
INSTANCE ItFo_Addon_Grog(C_Item)
{
	...
	description		= 	"Koøalka pravého moøského vlka";
...
INSTANCE ItFo_Addon_SchnellerHering(C_Item)
{
	...
	description		= 	"Vypadá nebezpeènì!";
	
	TEXT[1]			= 	"Úèinky nejsou známy.";				
	TEXT[2]			=	"Možné vedlejší úèinky";
...
INSTANCE ItFo_Addon_Pfeffer_01	(C_Item)
{
	...
	description			= 	"Èervený pepø";
	
	TEXT[0]				= 	"Z jižních ostrovù";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"POZOR, OSTRÉ!";
	TEXT[4]				= 	"";
...
{	
	...
	description			= 	"Dušené maso, z nìhož se ještì kouøí";
