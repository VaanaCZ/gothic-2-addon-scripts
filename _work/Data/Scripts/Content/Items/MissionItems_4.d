	...
	INSTANCE  ItAm_Mana_Angar_MIS(C_Item)
{
	...
	description		= "Amuleto mágico de Angar";
...
{
	name 				=	"Bolsón de cuero de Kareloth";
...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"En el interior está grabado un nombre, Talbin.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	description				=	name;
	TEXT[0]					=	"El huevo está caliente y en su interior";
	TEXT[1]					=	"se escuchan arañazos.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
};
...
{
	name 					=	"Anillo de los señores de la guerra orcos";
...
INSTANCE ItPo_DragonEggDrinkNeoras_MIS (C_Item)
{
	...
	description		= 	"Poción de secreción de huevo de dragón";
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"He encontrado un extraño mapa que llevaba el coronel orco. Parece un mapa estratégico de los orcos."); 
