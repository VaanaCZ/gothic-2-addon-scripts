...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Na wewnętrznej stronie wygarbowano imię 'Talbin'.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	description				=	name;
	TEXT[0]					=	"Jajo jest ciepłe, a ze środka";
	TEXT[1]					=	"dochodzi słaby dźwięk, jakby drapanie.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
};
...
{
	name 					=	"Pierścień orkowych przywódców";
	...
	TEXT[0]					=	"Pierścień jest szorstki i";
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"Przy orkowym pułkowniku znalazłem dziwną mapę. Wygląda jak plan działań wojennych tych stworzeń."); 
