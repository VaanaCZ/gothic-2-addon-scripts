	...
	INSTANCE  ItAm_Mana_Angar_MIS(C_Item)
{
	...
	description		= "Angarùv magický amulet";
...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Na vnitøní stranì je vyvedeno jméno Talbin.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	TEXT[1]					=	"a zevnitø se ozývá podezøelé škrábání.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
};
...
{
	name 					=	"Prsten skøetích vojevùdcù";
	...
	TEXT[0]					=	"Neumìle vyrobený prsten,";
	TEXT[1]					=	"na dotyk podivnì chladný.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
...
INSTANCE ItPo_DragonEggDrinkNeoras_MIS (C_Item)
{
	...
	description		= 	"Lektvar z draèího vejce";
	
	TEXT[3]			= 	"Úèinky nejsou známy.";				
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"U skøetího dùstojníka jsem našel podivnou mapu, která se podezøele podobá strategickému váleènému plánu."); 
