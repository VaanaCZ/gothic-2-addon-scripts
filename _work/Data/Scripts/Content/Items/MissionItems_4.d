	...
	INSTANCE  ItAm_Mana_Angar_MIS(C_Item)
{
	...
	description		= "Amulette magique d'Angar";
...
{
	name 				=	"Sacoche de cuir de Kéroloth";
...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Le nom Talbin est marqué au fer à l'intérieur.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	description				=	name;
	TEXT[0]					=	"L'œuf est chaud et vous entendez";
	TEXT[1]					=	"un grattement à l'intérieur.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
};
...
INSTANCE ItPo_DragonEggDrinkNeoras_MIS (C_Item)
{
	...
	description		= 	"Potion de sécrétion d'œuf de dragon";
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"J'ai trouvé une étrange carte sur le colonel orque. Il semble que ce soit la carte stratégique des orques."); 
