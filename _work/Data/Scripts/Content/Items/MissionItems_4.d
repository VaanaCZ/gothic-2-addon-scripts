...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Na vnitřní straně je vyvedeno jméno Talbin.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	TEXT[1]					=	"a zevnitř se ozývá podezřelé škrábání.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
};
...
{
	name 					=	"Prsten skřetích vojevůdců";
	...
	TEXT[0]					=	"Neuměle vyrobený prsten,";
	TEXT[1]					=	"na dotyk podivně chladný.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"U skřetího důstojníka jsem našel podivnou mapu, která se podezřele podobá strategickému válečnému plánu."); 
