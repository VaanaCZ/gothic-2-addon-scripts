	...
	INSTANCE  ItAm_Mana_Angar_MIS(C_Item)
{
	...
	description		= "Amuleto magico di Angar";
...
{
	name 				=	"Borsa di cuoio di Keroloth";
...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Il nome Talbin è marchiato all'interno.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{	
	...
	description				=	name;
	TEXT[0]					=	"L'uovo è caldo e si sente";
...
INSTANCE ItRi_OrcEliteRing(C_Item)
{
	...
	TEXT[0]					=	"L'anello è grezzo e sembra";
...
INSTANCE ItPo_DragonEggDrinkNeoras_MIS (C_Item)
{
	...
	description		= 	"Pozione di secrezione di uovo di drago";
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"Ho trovato una stana mappa addosso al colonnello orchesco. Sembra che sia la mappa da guerra strategica degli orchi."); 
