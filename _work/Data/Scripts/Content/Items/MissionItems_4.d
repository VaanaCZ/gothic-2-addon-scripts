...
INSTANCE ItAt_TalbinsLurkerSkin (C_Item)
{
	...
	description			= 	name;
	TEXT[0]				= 	"Na vnitâní stranê je vyvedeno jméno Talbin.";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
...
{
	name 					=	"Prsten skâetích vojevùdcù";
	...
	TEXT[0]					=	"Neumêle vyrobený prsten,";
	TEXT[1]					=	"na dotyk podivnê chladný.";
	TEXT[2]					=	"";
	TEXT[3]					=	"";
	TEXT[5]					=	NAME_Value;					COUNT[5]	= value;
...
var int Use_Map_NewWorld_Orcelite_MIS_OneTime;
	func void Use_Map_NewWorld_Orcelite_MIS()
	{
		...
		&& (MIS_KillOrkOberst != 0)
		{
			B_LogEntry (TOPIC_OrcElite,"U skâetího dùstojníka jsem našel podivnou mapu, která se podezâele podobá strategickému váleènému plánu."); 
