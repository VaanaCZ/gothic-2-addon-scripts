...
{   
		...
		var int nDocID;
			...
			nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Expedice do Hornického údolí selhala. Utrpìli jsme tìžké ztráty a ti, kteøí pøežili, jsou nyní uvìznìni na hradì a obklíèeni skøety.");
					Doc_PrintLines	( nDocID,  0, "Také na nás mnohokrát zaútoèili draci. Znièili a spálili veškerou zem v okolí hradu. S Innosovou pomocí snad vytrváme, dokud nedorazí posily. Stejnì nám nic jiného nezbývá, nebo žádný výpad podniknout nemùžeme.");					
					Doc_PrintLine	( nDocID,  0, ""					);
...
{   
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLines	( nDocID,  0, "Takže jestli máš nìkde ulitý nìjaký zlato, bylo by naèase se s ním vytasit.");
					Doc_PrintLine	( nDocID,  0, " "					);
					Doc_PrintLine	( nDocID,  0, " "					);
...
{   
	...
	nDocID = 	Doc_Create		()			  ;							// DocManager 
				...
				Doc_PrintLines	( nDocID,  0, "Trápí mì ale jakési neblahé tušení, takže radši všechnu rudu nìkam schovám.");
...
{   
		...
		var int nDocID;
			...
			nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLine	( nDocID,  0, "");
					Doc_PrintLines	( nDocID,  0, "Opustili jsme tábor. Teï, když bariéra padla, hledáme místo, kde celá ta zkáza zaèala. Snad tam najdeme odpovìdi, po kterých se pídíme už po dlouhá léta. Jen Adanos ví, kam nás cesta zavede."					);
