...
{   
		...
		var int nDocID;
			...
			nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Expedice do Hornického údolí selhala. Utrpěli jsme těžké ztráty a ti, kteří přežili, jsou nyní uvězněni na hradě a obklíčeni skřety.");
					Doc_PrintLines	( nDocID,  0, "Také na nás mnohokrát zaútočili draci. Zničili a spálili veškerou zem v okolí hradu. S Innosovou pomocí snad vytrváme, dokud nedorazí posily. Stejně nám nic jiného nezbývá, neboť žádný výpad podniknout nemůžeme.");					
					Doc_PrintLine	( nDocID,  0, ""					);
...
{   
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLines	( nDocID,  0, "Takže jestli máš někde ulitý nějaký zlato, bylo by načase se s ním vytasit.");
					Doc_PrintLine	( nDocID,  0, " "					);
					Doc_PrintLine	( nDocID,  0, " "					);
...
{   
	...
	nDocID = 	Doc_Create		()			  ;							// DocManager 
				...
				Doc_PrintLines	( nDocID,  0, "Trápí mě ale jakési neblahé tušení, takže radši všechnu rudu někam schovám.");
...
{   
		...
		var int nDocID;
			...
			nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLine	( nDocID,  0, "");
					Doc_PrintLines	( nDocID,  0, "Opustili jsme tábor. Teď, když bariéra padla, hledáme místo, kde celá ta zkáza začala. Snad tam najdeme odpovědi, po kterých se pídíme už po dlouhá léta. Jen Adanos ví, kam nás cesta zavede."					);
