...
{   
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Můj mladý chráněnče, velmi jsi mne zklamal. Jak to, že jsi nasedl na loď a nevzal s sebou Innosovo oko?"					);
...
{   
		...
		nDocID = 	Doc_Create		()			  ;								// DocManager 
					...
					Doc_PrintLines	( nDocID,  0, "Nejdřív jsem myslel, že jsem mrtev, ale pak jsem se přesvědčil, že v mých starých kostech přece jen nějaká síla zůstala."					);
...
{   
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLines	( nDocID,  0, "Elixír užívej opatrně, neb má silné vedlejší účinky a může narušit všechnu tvou manu."					);
...
{	
	...
	B_LogEntry (TOPIC_HallenVonIrdorath,"Deník novice černých mágů hovoří o komnatách s pákami, o klíčnících, o kombinacích spínačů i o dalších věcech. Musím si to všecko zapamatovat, mohlo by se mi to později hodit."); 
};
...
{   
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager 
					...
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Je mi fuk, jestli ten most přejdete z druhé strany, nebo ne. Pro mě za mě si všichni klidně shnijte v pekle!"					);
