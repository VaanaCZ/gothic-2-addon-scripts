...
{
	name 				=	"Borsa di cuoio molto strana";
	...
	TEXT[0]				= 	"";
	TEXT[1]				= 	"La borsa sembra";
	TEXT[2]				= 	"contenere un oggetto";
	TEXT[3]				= 	"duro e un documento.";
	TEXT[4]				= 	"";
...
{
	name 				=	"Lettera di avvertimento di Xardas";
...
INSTANCE ItWr_Krypta_Garon		(C_Item)
{
	...
	TEXT[3]				= 	"scritta con calligrafia tremante.";
};
...
{
	name 				=	"Chiave del colonnello orchesco";
...
{
	name 				=	"Chiave del mastro di chiavi";
...
{
	name 				=	"Chiave della stanza del mago oscuro";
...
{
	name 				=	"Pergamena del mago oscuro";
...
{
	name 				=	"Chiave del forziere del mago oscuro";
