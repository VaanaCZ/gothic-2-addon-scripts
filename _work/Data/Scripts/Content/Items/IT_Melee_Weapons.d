...
{	
	name 				=	"Zardzewiały krótki miecz";  //STANDARDOBJEKTIERUNG
...
{	
	name 				=	"Zardzewiały topór";  //STANDARDOBJEKTIERUNG
...
{	
	name 				=	"Zardzewiały miecz dwuręczny"; //STANDARDOBJEKTIERUNG
...
{	
	name 				=	"Miecz dwuręczny paladyna";  //NUR PALADIN 
...
{	
	name 				=	"Kiepski miecz półtoraręczny";  
...
{	
	name 				=	"Dobry miecz półtoraręczny";  
...
{	
	name 				=	"Barbarzyński topór bojowy";  
...
{	
	name 				=	"Błogosławione ostrze magiczne";
