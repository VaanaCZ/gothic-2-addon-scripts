...
{
	name 				=	"Fiaschetta da laboratorio";
...
INSTANCE ItMi_Pocket(C_Item)//steht drin, weil auch in Welt verteilt!!
{
	...
	description			= 	name;
	TEXT[2]				= 	"Una borsa stretta,";
	TEXT[3]				=   "non troppo pesante.";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
...
INSTANCE ItMi_BloodCup_MIS (C_Item)
{
	...
	description			= 	"Un calice di sangue";
...
INSTANCE ItMi_ApfelTabak(C_Item)
{
	...
	TEXT[2]				=  "Un sacchetto di tabacco alla mela";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
//-------------------------------------------------------------
//			Pilztabak
...
INSTANCE ItMi_PilzTabak(C_Item)
{
	...
	TEXT[2]				=  "Tabacco oscuro alla mela-fungo";
...
INSTANCE ItMi_DoppelTabak(C_Item)
{
	...
	TEXT[2]				=  "Ha un buon gusto di mela…";
...
INSTANCE ItMi_Honigtabak(C_Item)
{
	...
	TEXT[2]				=  "Tabacco alla mela dolce";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
//-------------------------------------------------------------
//		SumpfKraut Tabak
...
INSTANCE ItMi_SumpfTabak(C_Item)
{
	...
	TEXT[2]				=  "Miscela di erba di palude";
