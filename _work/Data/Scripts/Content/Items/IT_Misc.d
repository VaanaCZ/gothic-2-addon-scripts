...
{
	name 				=	"Botella de agua de laboratorio";
...
{
	name 				=	"Tallo de hierba del pantano";
...
INSTANCE ItMi_Pocket(C_Item)//steht drin, weil auch in Welt verteilt!!
{
	...
	description			= 	name;
	TEXT[2]				= 	"Una bolsa estrecha,";
	TEXT[3]				=   "no muy pesada.";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
...
INSTANCE ItMi_ApfelTabak(C_Item)
{
	...
	TEXT[2]				=  "Una bolsa de tabaco de manzana.";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
//-------------------------------------------------------------
//			Pilztabak
...
INSTANCE ItMi_PilzTabak(C_Item)
{
	...
	TEXT[2]				=  "Tabaco de hongos y manzana oscura";
...
INSTANCE ItMi_Honigtabak(C_Item)
{
	...
	TEXT[2]				=  "Tabaco de manzana dulce";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
//-------------------------------------------------------------
//		SumpfKraut Tabak
...
INSTANCE ItMi_SumpfTabak(C_Item)
{
	...
	TEXT[2]				=  "Mezcla de hierbas del pantano";
