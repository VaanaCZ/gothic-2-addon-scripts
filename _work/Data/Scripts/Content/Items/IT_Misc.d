...
INSTANCE ItMi_Pocket(C_Item)//steht drin, weil auch in Welt verteilt!!
{
	...
	description			= 	name;
	TEXT[2]				= 	"Wąski, niezbyt";
	TEXT[3]				=   "ciężki woreczek.";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
...
INSTANCE ItMi_ApfelTabak(C_Item)
{
	...
	TEXT[2]				=  "Tytoń o smaku jabłkowym.";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
//-------------------------------------------------------------
//			Pilztabak
...
INSTANCE ItMi_PilzTabak(C_Item)
{
	...
	TEXT[2]				=  "Tytoń o smaku grzybowym.";
...
INSTANCE ItMi_DoppelTabak(C_Item)
{
	...
	TEXT[2]				=  "Smakuje podobnie do zwykłego.";
