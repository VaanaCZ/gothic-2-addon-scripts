...
INSTANCE ItAt_Addon_BCKopf (C_Item)
{
	...
	description			= 	"Głowa polnego pełzacza";
	TEXT[0]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
...
INSTANCE ItAt_CrawlerMandibles (C_Item)
{
	...
	TEXT[0]				= 	"Można je otworzyć w celu";
	TEXT[1]				= 	"wypicia zawartej w nich wydzieliny,";
	TEXT[2]				= 	"która pozwala zregenerować manę.";
...
{
	name 				=	"Język ognistego jaszczura";
...
{
	name 				=	"Kamień duszy smoka-ożywieńca";
