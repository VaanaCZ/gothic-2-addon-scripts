...
{
	name 				=	"Mandíbulas de incursor de campo";
...
INSTANCE ItAt_CrawlerMandibles (C_Item)
{
	...
	TEXT[0]				= 	"Las mandíbulas se pueden abrir";
	TEXT[1]				= 	"para beber la secreción de su interior.";
	TEXT[2]				= 	"Regenera poder mágico.";
...
INSTANCE ItAt_Sting (C_Item)
{
	...
	TEXT[0]				= 	"";
	TEXT[1]				= 	"El aguijón";
	TEXT[2]				= 	"contiene una secreción venenosa.";
	TEXT[3]				= 	"";
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
FUNC VOID Use_Sting()
...
INSTANCE itat_LurkerSkin (C_Item) //REPTILE Skin
{
	...
	description			= 	"La piel de un reptil";
	TEXT[0]				= 	"";
	TEXT[1]				= 	"";
	TEXT[2]				= 	"";
	TEXT[3]				= 	"";
...
{
	name 				=	"Cuerno de un dragón chasqueador";
...
{
	name 				=	"Piel de una bestia de sombra";
...
{
	name 				=	"Piel de tiburón de la ciénaga";
...
{
	name 				=	"Cuerno de una bestia de sombra";
...
{
	name 				=	"Dientes de tiburón de la ciénaga";
...
{
	name 				=	"Corazón de gólem de piedra";
...
{
	name 				=	"Corazón de gólem de fuego";
...
{
	name 				=	"Corazón de gólem de hielo";
...
{
	name 				=	"Piedra del alma de dragón muerto viviente";
...
{
	name 				=	"Corazón de un dragón de hielo";
...
{
	name 				=	"Corazón de un dragón de roca";
...
{
	name 				=	"Corazón de un dragón de la ciénaga";
...
{
	name 				=	"Corazón de un dragón de fuego";
