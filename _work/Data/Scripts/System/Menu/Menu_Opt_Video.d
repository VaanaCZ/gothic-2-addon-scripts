...
INSTANCE MENUITEM_VID_DEVICE_CHOICE(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension	
	posx		= 4000;		posy		=	MENU_START_Y + MENU_DY*0 +  MENU_CHOICE_YPLUS;
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Rozdzielczość";
	text[1]		= "Wybierz pożądaną rozdzielczość i wciśnij klawisz [Enter]"; // Kommentar
...
INSTANCE MENUITEM_VID_RESOLUTION_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	= MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 4000;		posy		=	MENU_START_Y + MENU_DY*1 + MENU_CHOICE_YPLUS;
	dimx 		= 3700;		dimy		= 	MENU_CHOICE_DY;		
	// Aktionen
...
INSTANCE MENUITEM_VID_BRIGHTNESS_SLIDER(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension	
	posx		=	4000;	posy		= MENU_START_Y + MENU_DY*3 + MENU_SLIDER_YPLUS;
...
INSTANCE MENUITEM_VID_CONTRAST_SLIDER(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_SLIDER;	
	// Position und Dimension	
	posx		=	4000;	posy		= MENU_START_Y + MENU_DY*4 + MENU_SLIDER_YPLUS;
	dimx = MENU_SLIDER_DX; 	dimy		= MENU_SLIDER_DY;
	// Aktionen	
...
INSTANCE MENUITEM_VID_GAMMA_SLIDER(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_SLIDER;	
	// Position und Dimension	
	posx		=	4000;	posy		= MENU_START_Y + MENU_DY*5 + MENU_SLIDER_YPLUS;
	dimx = MENU_SLIDER_DX; 	dimy		= MENU_SLIDER_DY;
	// Aktionen	
