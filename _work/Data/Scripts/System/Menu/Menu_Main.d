...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Wczytaj";
	text[1]		=	"Kontynuuj zapisaną grę";  // Kommentar
...
instance MENUITEM_MAIN_SAVEGAME_SAVE(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Zapisz";
	text[1]		= "Zapisz obecny stan rozgrywki";  // Kommentar
...
INSTANCE MENUITEM_MAIN_RESUME(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Wznów";
	text[1]		=   "Wznów trwającą rozgrywkę";  // Kommentar
...
instance MENUITEM_MAIN_OPTIONS(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Opcje";
	text[1]		= "Ustawienia rozgrywki, dźwięku i grafiki.";  // Kommentar
...
instance MENUITEM_MAIN_INTRO(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Wprowadzenie";
	text[1]		= "Odtwórz film wprowadzający";
