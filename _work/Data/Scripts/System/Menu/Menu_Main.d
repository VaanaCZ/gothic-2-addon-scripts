...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Naèíst hru";
	text[1]		=	"Pokraèovat v uložené hâe";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Pâehrát intro";
	text[1]		= "Pâehrát úvodní animaci";
...
INSTANCE MENUITEM_MAIN_EXIT(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ukonèit hru";
	text[1]		= "Opustit svêt Gothic II";  // Kommentar
