...
instance MENUITEM_MAIN_SAVEGAME_SAVE(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Sauvegarder";
	text[1]		= "Sauvegarder partie actuelle";  // Kommentar
...
INSTANCE MENUITEM_MAIN_RESUME(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Reprendre";
	text[1]		=   "Reprendre la partie actuelle";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Quitter partie";
	text[1]		= "Quitter l'univers de Gothic II";  // Kommentar
