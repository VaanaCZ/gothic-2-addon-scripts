...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Continuar una partida guardada";  // Kommentar
...
instance MENUITEM_MAIN_OPTIONS(C_MENU_ITEM_DEF) 
{
	...
	text[1]		= "Opciones de gráficos, sonido y juego";  // Kommentar
...
instance MENUITEM_MAIN_INTRO(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Introducción";
	text[1]		= "Reproducir la secuencia de introducción";
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Salir del juego";
	text[1]		= "Salir del mundo de Gothic II";  // Kommentar
