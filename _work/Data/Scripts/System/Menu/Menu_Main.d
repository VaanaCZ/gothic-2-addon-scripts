...
instance MENUITEM_MAIN_NEWGAME(C_MENU_ITEM_DEF) 
{
	...
	text[1]		= "Comincia una nuova avventura";  // Kommentar
...
INSTANCE MENUITEM_MAIN_SAVEGAME_LOAD(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Continua una partita salvata";  // Kommentar
...
instance MENUITEM_MAIN_OPTIONS(C_MENU_ITEM_DEF) 
{
	...
	text[1]		= "Impostazioni di gioco, audio, video";  // Kommentar
...
instance MENUITEM_MAIN_INTRO(C_MENU_ITEM_DEF) 
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Introduzione";
	text[1]		= "Esegui la sequenza introduttiva";
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ringraziamenti";
	text[1]		= "Ringraziamenti";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Esci dal gioco";
	text[1]		= "Abbandona il mondo di Gothic II";  // Kommentar
