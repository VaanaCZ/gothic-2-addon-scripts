...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Hlasitost efektù";
	text[1]		= "Hlasitost zvukových efektù a øeèi"; // Kommentar
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Zapíná a vypíná hudbu na pozadí"; // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ovladaè zvuku";
	text[1]		= "Úèinky se projeví až po restartování"; // Kommentar
...
instance MENUITEM_AUDIO_SPEEKER_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "2 reproduktory|sluchátka|surround|4 reproduktory|reproduktory 5.1|reproduktory 7.1";
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ozvìna";
	text[1]		= "Efekty ozvìny v jeskyních apod."; // Kommentar
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ozvìny øeèi";
	text[1]		= "Efekty ozvìny mluveného slova.";
...
instance MENUITEM_AUDIO_SAMPLERATE(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Zmìny se projeví až po restartování."; // Kommentar
