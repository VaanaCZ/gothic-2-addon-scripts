...
INSTANCE MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Volume FX";
	text[1]		= "Volume del parlato e degli effetti sonori"; // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Volume musica";
	text[1]		= "Volume della musica di sottofondo"; // Kommentar
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Musica";
	text[1]		= "Attiva/disattiva la musica di sottofondo"; // Kommentar
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Fonte audio";
	text[1]		= "Devi riavviare perché alcuni cambiamenti abbiano effetto"; // Kommentar
...
instance MENUITEM_AUDIO_SPEEKER_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "2 altoparlanti|cuffie|surround|4 altoparlanti|5.1 altoparlanti|7.1 altoparlanti";
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "vuoi sentire l'eco in grotte e così via?"; // Kommentar
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Riv. parlato";
	text[1]		= "Effetti di riverbero nel parlato";
