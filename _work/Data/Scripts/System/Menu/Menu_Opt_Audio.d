...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Głośność efektów";
	text[1]		= "Głośność efektów dźwiękowych i partii mówionych"; // Kommentar
...
INSTANCE MENUITEM_AUDIO_SFXVOL_SLIDER(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension
	posx		= 4700;		posy		= MENU_START_SOUND_Y + MENU_SOUND_DY*0;
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Głośność muzyki";
	text[1]		= "Głośność podkładu muzycznego"; // Kommentar
...
INSTANCE MENUITEM_AUDIO_MUSICVOL_SLIDER(C_MENU_ITEM_DEF)
{
	...
	type		= MENU_ITEM_SLIDER;
	// Position und Dimension
	posx		= 4700;		posy		= 	MENU_START_SOUND_Y + MENU_SOUND_DY*1;
	dimx = MENU_SLIDER_DX; dimy	= MENU_SLIDER_DY;
	// Aktionen
...
instance MENUITEM_AUDIO_MUSIC(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Muzyka";
	text[1]		= "Włączenie/wyłączenie muzyki w tle"; // Kommentar
...
INSTANCE MENUITEM_AUDIO_MUSIC_CHOICE(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension
	posx		= 4700;		posy		=	MENU_START_SOUND_Y + MENU_SOUND_DY*2 + MENU_CHOICE_YPLUS;
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Sterownik dźwięku";
	text[1]		= "Wymaga ponownego uruchomienia gry"; // Kommentar

	// Position und Dimension
	posx		=	700;	posy		=	MENU_START_SOUND_Y + MENU_SOUND_DY*3;
	dimx		=	3800;	dimy		=	750;
	// Aktionen
	onSelAction[0]  = SEL_ACTION_UNDEF;
	// Weitere Einstellungen
...
instance MENUITEM_AUDIO_PROVIDER_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
	posx		= 4700;		posy		=	MENU_START_SOUND_Y + MENU_SOUND_DY*3 + MENU_CHOICE_YPLUS;
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ust. głośników";
	text[1]		= "Wybierz odpowiednią konfigurację głośników"; // Kommentar
...
instance MENUITEM_AUDIO_SPEEKER_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "2 głośniki|Słuchawki|Surround|4 głośniki|Głośniki 5.1|Głośniki 7.1";
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Pogłos otoczenia";
	text[1]		= "Specjalne efekty dźwiękowe otoczenia"; // Kommentar
...
instance MENUITEM_AUDIO_REVERB_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
	posx		= 4700;		posy		=	MENU_START_SOUND_Y + MENU_SOUND_DY*5 + MENU_CHOICE_YPLUS;
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Pogłos mowy";
	text[1]		= "Czy pogłos ma wpływać na partie mówione?";
...
instance MENUITEM_AUDIO_SAMPLERATE(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension
	posx		=	700;	posy		=	MENU_START_SOUND_Y + MENU_SOUND_DY*7;
	dimx		=	3700;	dimy		=	750;
	// Aktionen
	onSelAction[0]  = SEL_ACTION_UNDEF;
	// Weitere Einstellungen
...
instance MENUITEM_AUDIO_SAMPLERATE_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	= 	MENU_FONT_SMALL;
	// Position und Dimension
	posx		= 4700;		posy		=	MENU_START_SOUND_Y + MENU_SOUND_DY*7 + MENU_CHOICE_YPLUS;
	dimx = MENU_CHOICE_DX;dimy = MENU_CHOICE_DY;
	// Aktionen
