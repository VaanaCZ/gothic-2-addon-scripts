...
INSTANCE MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Hlasitost zvukových efektù a âeèi"; // Kommentar
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ozvêna";
	text[1]		= "Efekty ozvêny v jeskyních apod."; // Kommentar
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ozvêny âeèi";
	text[1]		= "Efekty ozvêny mluveného slova.";
...
instance MENUITEM_AUDIO_SAMPLERATE(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Zmêny se projeví až po restartování."; // Kommentar
