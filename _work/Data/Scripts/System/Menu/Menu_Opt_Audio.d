...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Hlasitost efektů";
	text[1]		= "Hlasitost zvukových efektů a řeči"; // Kommentar
...
instance MENUITEM_AUDIO_PROVIDER(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Účinky se projeví až po restartování"; // Kommentar
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ozvěna";
	text[1]		= "Efekty ozvěny v jeskyních apod."; // Kommentar
...
instance MENUITEM_AUDIO_REVERB_SPEECH(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Ozvěny řeči";
	text[1]		= "Efekty ozvěny mluveného slova.";
...
instance MENUITEM_AUDIO_SAMPLERATE(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Změny se projeví až po restartování."; // Kommentar
