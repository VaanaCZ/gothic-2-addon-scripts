...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 1 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 2 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 3 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 4 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 5 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 6 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 7 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 8 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF)
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 9 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 10 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 11 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 12 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 13 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 14 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 15 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT16(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 16 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT17(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 17 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT18(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 18 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT19(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 19 -  ENTREE et indiquez un nom"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT20(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 20 -  ENTREE et indiquez un nom"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 1 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 2 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 3 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 4 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 5 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 6 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "Inconnu";
	text[1]		=   "Emplacement 7 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 8 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 9 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 10 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 11 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 12 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 13 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 14 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 15 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 16 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 17 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 18 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 19 - ENTREE pour charger la partie"; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Emplacement 20 - ENTREE pour charger la partie"; // Kommentar
