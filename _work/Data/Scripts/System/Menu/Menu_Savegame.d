...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "neznámé";
	text[1]		=   "pozice 1 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 2 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 3 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 4 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 5 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 6 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 7 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 8 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF)
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 9 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 10 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 11 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 12 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 13 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 14 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 15 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT16(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 16 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT17(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 17 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT18(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 18 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT19(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 19 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT20(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "neznámé";
	text[1]		=   "pozice 20 - chceš-li použít tuto pozici, stiskni ENTER a zadej její název"; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 1 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 2 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 3 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 4 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 5 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 6 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "neznámé";
	text[1]		=   "Pozice 7 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 8 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 9 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 10 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 11 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 12 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 13 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 14 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 15 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 16 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 17 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 18 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 19 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Pozice 20 - hru naèteš stiskem klávesy ENTER."; // Kommentar
...
{
	text[0]		=   "    - Rychlé uložení -    ";
	text[1]		=   "stiskem klávesy ENTER tuto hru naèteš"; // Kommentar
	posx		=	SAVEGAME_X1;
