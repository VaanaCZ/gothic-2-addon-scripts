...
INSTANCE MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF)
{
	...
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 1: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 2: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 3: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 4: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 5: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 6: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 7: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 8: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF)
{
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 9: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 10: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 11: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 12: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 13: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 14: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 15: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT16(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 16: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT17(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 17: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT18(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 18: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT19(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 19: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
INSTANCE MENUITEM_SAVE_SLOT20(C_MENU_ITEM_DEF)
{
	...
	type		=	MENU_ITEM_INPUT;
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 20: para usar este espacio, pulsa INTRO y escribe el nombre"; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 1: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 2: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 3: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 4: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 5: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 6: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "desconocido";
	text[1]		=   "Espacio 7: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 8: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 9: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 10: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 11: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 12: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 13: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 14: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 15: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 16: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 17: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 18: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 19: ATRÁS para cargar la partida."; // Kommentar
...
{
	text[0]		=   "---";
	text[1]		=   "Espacio 20: ATRÁS para cargar la partida."; // Kommentar
