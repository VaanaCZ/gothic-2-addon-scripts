...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zaměření v boji";
	text[1]		= 	"Zvýraznění stávajícího cíle útoku"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_SOUND_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zaměření na objekt";
	text[1]		= 	"Zvýraznění zaměřeného objektu"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_OLDCONTROLS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Použít ovládání boje jako ve hře Gothic I"; // Kommentar
	// Position und Dimension	
