...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Titulky";
	text[1]		= 	"Zapnout èi vypnout titulky u rozhovorù"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zamìøení v boji";
	text[1]		= 	"Zvýraznìní stávajícího cíle útoku"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_SOUND_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
instance MENUITEM_GAME_FIGHTFOCUS_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		= 	"žádné|okno|zjasnìní|obojí";
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5000;		posy		= MENU_START_Y + MENU_SOUND_DY*1 + MENU_CHOICE_YPLUS;
	dimx 		= 2000;		dimy 		= MENU_CHOICE_DY;
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zamìøení na objekt";
	text[1]		= 	"Zvýraznìní zamìøeného objektu"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Inverze kamery";
	text[1]		= 	"Zapnout èi vypnout inverzi kamery"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_M(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Myš vyp./zap.";
	text[1]		= 	"Umožnit ovládání myší"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Ovládání Gothic I";
	text[1]		= 	"Použít ovládání boje jako ve høe Gothic I"; // Kommentar
	// Position und Dimension	
