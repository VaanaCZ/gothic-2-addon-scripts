...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Sottotitoli";
	text[1]		= 	"Attiva/disattiva i sottotitoli durante i dialoghi"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Evidenzia nemico";
	text[1]		= 	"Configura l'evidenziazione del bersaglio in combattimento"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_SOUND_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
instance MENUITEM_GAME_FIGHTFOCUS_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		= 	"nessuno|riquadro|illumina|entrambi";
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5000;		posy		= MENU_START_Y + MENU_SOUND_DY*1 + MENU_CHOICE_YPLUS;
	dimx 		= 2000;		dimy 		= MENU_CHOICE_DY;
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Evidenzia oggetto";
	text[1]		= 	"Attiva/disattiva l'evidenziazione dell'oggetto puntato"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Inverti telecamera";
	text[1]		= 	"Attiva/disattiva i movimenti invertiti della telecamera"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_M(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"mouse";
	text[1]		= 	"Attiva/distattiva i controlli del mouse"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Cont. Gothic 1";
	text[1]		= 	"usa i controlli di comb. di Gothic 1"; // Kommentar
	// Position und Dimension	
