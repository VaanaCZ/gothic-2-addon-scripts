...
INSTANCE MENUITEM_GAME_SUB_TITLES(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Titulky";
	text[1]		= 	"Zapnout či vypnout titulky u rozhovorů"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zamęâení v boji";
	text[1]		= 	"Zvýraznęní stávajícího cíle útoku"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_SOUND_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
instance MENUITEM_GAME_FIGHTFOCUS_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		= 	"žádné|okno|zjasnęní|obojí";
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5000;		posy		= MENU_START_Y + MENU_SOUND_DY*1 + MENU_CHOICE_YPLUS;
	dimx 		= 2000;		dimy 		= MENU_CHOICE_DY;
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zamęâení na objekt";
	text[1]		= 	"Zvýraznęní zamęâeného objektu"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_LOOKAROUND_INVERSE(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Zapnout či vypnout inverzi kamery"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GAME_OLDCONTROLS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Použít ovládání boje jako ve hâe Gothic I"; // Kommentar
	// Position und Dimension	
