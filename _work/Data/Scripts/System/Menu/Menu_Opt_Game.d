...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Foco de combate";
	text[1]		= 	"Configurar el resaltado del objetivo actual de combate"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_SOUND_DY*1;
	dimx		=	4000;	dimy		=	750;
	// Aktionen
...
instance MENUITEM_GAME_FIGHTFOCUS_CHOICE(C_MENU_ITEM_DEF)
{
	backPic		=	MENU_CHOICE_BACK_PIC;
	type		=	MENU_ITEM_CHOICEBOX;	
	text[0]		= 	"ninguno|caja|iluminar|ambos";
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5000;		posy		= MENU_START_Y + MENU_SOUND_DY*1 + MENU_CHOICE_YPLUS;
	dimx 		= 2000;		dimy 		= MENU_CHOICE_DY;
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Foco de objeto";
	text[1]		= 	"Activar y desactivar el resalto del objeto enfocado"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Controles Gothic 1";
	text[1]		= 	"usar controles habituales de combate de Gothic I"; // Kommentar
	// Position und Dimension	
