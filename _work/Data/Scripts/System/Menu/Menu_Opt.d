...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Zmiana ustawień rozgrywki";  // Kommentar
...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Pole widzenia, ilość szczegółów i efekty specjalne";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Karta graficzna, rozdzielczość, jasność i kontrast";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Muzyka, efekty dźwiękowe i sekwencje mówione";  // Kommentar
...
INSTANCE MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Sterowanie";
	text[1]		= "Konfiguracja klawiatury i myszy";  // Kommentar
...
INSTANCE MENUITEM_OPT_EXT(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Dalsze ustawienia";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Wydajność/Jakość";
	text[1]		= "Optymalizacja działania gry";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Ust. własne#Duża wydajność|Średnia jakość|Wysoka jakość";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
