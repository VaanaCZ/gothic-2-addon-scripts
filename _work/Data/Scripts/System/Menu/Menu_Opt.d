...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Impostazioni di gioco";
	text[1]		= "Configura il gioco";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Visualizzazione";
	text[1]		= "Distanza della visuale, dettagli ed effetti";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		=	"Impostazioni video";
	text[1]		=	"Adattatore grafico, risoluzione, luminosità e contrasto";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Audio";
	text[1]		= "Musica, parlato ed effetti sonori";  // Kommentar
...
INSTANCE MENUITEM_OPT_CONTROLS(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Comandi";
	text[1]		= "Configura la tastiera e il mouse";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Configurazione estesa";
	text[1]		= "Altre impostazioni";  // Kommentar
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Prestazioni/Qualità";
	text[1]		= "Ottimizza le prestazioni e la qualità";  // Kommentar
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Personalizzato#Prestazioni alte|Qualità media|Alta qualità";	// # trennt die UnDef-Option von der auswaehlbaren Optionen
