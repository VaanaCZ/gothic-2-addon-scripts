...
INSTANCE MENU_ITEM_INP_WEAPON_LEFT(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Wciśnij klawisz mający odpowiadać za daną czynność.";
...
{
	text[0]		=	"Ustawienia domyślne";
	text[1]		=	"Przywrócenie ustawień domyślnych"; // Kommentar
...
INSTANCE MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Wybór alternatywnych ustawień sterowania"; // Kommentar
