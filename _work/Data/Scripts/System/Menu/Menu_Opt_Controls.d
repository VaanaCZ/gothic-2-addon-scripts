...
instance MENU_ITEM_NEXTMENU(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Más teclas...";
	text[1]		= "Configurar más teclas de control";  // Kommentar
...
INSTANCE MENU_ITEM_INP_WEAPON_LEFT(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Pulsa la tecla deseada para esta acción.";
...
{
	text[0]		=	"CONFIGURACIÓN DE CONTROLES";
	type		=	MENU_ITEM_TEXT;
...
{
	text[0]		=	"Estadísticas del personaje";
	text[1]			=   "pulsa la tecla SUPR para vaciar el espacio y INTRO para definir"; // Kommentar
...
{
	text[0]		=	"Configuración predeterminada";
	text[1]		=	"Establecer la configuración de control predeterminada"; // Kommentar
...
INSTANCE MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Establecer una configuración alternativa de controles"; // Kommentar
