...
{
	text[0]			=	"Attacco a sinistra";
	text[1]			=   "Premi il tasto CANC per eliminare e INVIO per definire"; // Kommentar
...
INSTANCE MENU_ITEM_INP_WEAPON_LEFT(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Premi il tasto desiderato per questa azione";
...
{
	text[0]		=	"Impostazioni predefinite";
	text[1]		=	"Torna alla configurazione predefinita"; // Kommentar
...
{
	text[0]		=	"Impostazioni alternative";
	text[1]		=	"Utilizza una configurazione alternativa"; // Kommentar
