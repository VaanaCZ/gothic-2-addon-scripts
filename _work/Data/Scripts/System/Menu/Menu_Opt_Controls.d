...
instance MENU_ITEM_NEXTMENU(C_MENU_ITEM_DEF)
{
	...
	text[0]		= "Další klávesy...";
	text[1]		= "Konfigurace dalších kláves";  // Kommentar
...
{
	text[0]			=	"Levý útok";
	text[1]			=   "kláv. DEL nastavení zruší, kláv. ENTER zadá nové"; // Kommentar
...
{
	text[0]			=	"Pravý útok";
	text[1]			=   "kláv. DEL uvolníš a pomocí ENTER znovu nadefinuješ"; // Kommentar
...
INSTANCE MENU_ITEM_INP_WEAPON_LEFT(C_MENU_ITEM_DEF)
{
	...
	text[1] 	=   "Stiskni klávesu, kterou chceš této akci pøiøadit";
...
{
	text[0]		=	"Implicitní nastavení";
	text[1]		=	"Vrátit nastavení ovládání na implicitní"; // Kommentar
...
INSTANCE MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Nastavit ovládání na alternativní"; // Kommentar
