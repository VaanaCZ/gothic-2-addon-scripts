...
INSTANCE MENUITEM_EXT_FFT(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"movimiento de agua";
	text[1]		= 	"Activar y desactivar el movimiento de agua"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_WATERFADE(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Decolorar";
	text[1]		= 	"Activar y desactivar el decoloramiento de agua"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"movimiento de viento";
	text[1]		= 	"Activar y desactivar el movimiento de objeto por viento"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Sombra de nubes";
	text[1]		= 	"Activar y desactivar las sombras de nubes"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_DY*3;
	dimx		=	3500;	dimy		=	750;
	// Aktionen
...
INSTANCE MENUITEM_EXT_AMBIENTPFX(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"FX ambiente";
	text[1]		= 	"Activar y desactivar efectos de partículas innecesarios"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_ENVMAP(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Reflejos";
	text[1]		= 	"Activar y desactivar los reflejos"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zonas de niebla";
	text[1]		= 	"Activar/desactivar niebla"; // Kommentar
	// Position und Dimension	
