...
INSTANCE MENUITEM_EXT_FFT(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"movimento onde";
	text[1]		= 	"Attiva/disattiva il movimento dell'acqua"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_WATERFADE(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Trasp. acqua";
	text[1]		= 	"Attiva/disattiva la trasparenza dell'acqua"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"movimento vento";
	text[1]		= 	"Attiva/disattiva il movimento vento degli oggetti con il vento"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_CLOUDSHADOW(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Ombre nuvole";
	text[1]		= 	"Attiva/disattiva le ombre delle nuvole"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_DY*3;
	dimx		=	3500;	dimy		=	750;
	// Aktionen
...
INSTANCE MENUITEM_EXT_AMBIENTPFX(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Effetti amb.";
	text[1]		= 	"Attiva/disattiva gli effetti sulle particelle non necessarie"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_ENVMAP(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Riflessi";
	text[1]		= 	"Attiva/disattiva i riflessi"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"zone di nebbia";
	text[1]		= 	"attiva/disattiva zone di nebbia"; // Kommentar
	// Position und Dimension	
