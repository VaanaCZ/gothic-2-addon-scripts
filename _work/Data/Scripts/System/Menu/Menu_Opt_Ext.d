...
INSTANCE MENUITEM_EXT_FFT(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Vlny na vodě";
	text[1]		= 	"Zapnout či vypnout vlnění vody"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_WATERFADE(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Mizení vody";
	text[1]		= 	"Zapnout či vypnout mizení vody"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_OBJWIND(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Vítr";
	text[1]		= 	"Zapíná pohyb předmětů ve větru"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_CLOUDSHADOW(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Stíny mraků";
	text[1]		= 	"Zapnout či vypnout stíny mraků"; // Kommentar
	// Position und Dimension	
	posx		=	1000;	posy		=	MENU_START_Y + MENU_DY*3;
	dimx		=	3500;	dimy		=	750;
	// Aktionen
...
INSTANCE MENUITEM_EXT_AMBIENTPFX(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zvuky okolí";
	text[1]		= 	"Zapnout či vypnout zvuky prostředí"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_ENVMAP(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Zrcadlení";
	text[1]		= 	"Zapnout či vypnout zrcadlení a odrazy"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_RADIALFOG(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Zapnout či vypnout radiální mlhu"; // Kommentar
	// Position und Dimension	
