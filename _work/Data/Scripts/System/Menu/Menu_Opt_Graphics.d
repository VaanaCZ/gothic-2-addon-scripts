...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Úroveà detailù textur"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Detaily modelù";
	text[1]		= 	"Úroveà detailù modelù"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Dohled";
	text[1]		= "Urèi míru dohledu (v procentech)"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Zvýr. objektù";
	text[1]		= "Vzdálenost zobrazovaných objektù"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Ef. na obloze";
	text[1]		= 	"Zapnout èi vypnout efekty na obloze"; // Kommentar
	// Position und Dimension	
