...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Úroveŕ detailů textur"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Detaily modelů";
	text[1]		= 	"Úroveŕ detailů modelů"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Dohled";
	text[1]		= "Urči míru dohledu (v procentech)"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Zvýr. objektů";
	text[1]		= "Vzdálenost zobrazovaných objektů"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Ef. na obloze";
	text[1]		= 	"Zapnout či vypnout efekty na obloze"; // Kommentar
	// Position und Dimension	
