...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"Tekstury";
	text[1]		= 	"Wybór ilości detali na teksturach"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_MODEL_DETAIL(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Modele";
	text[1]		= 	"Wybór ilości detali na modelach"; // Kommentar
	// Position und Dimension	
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Zasięg widzenia";
	text[1]		= "Wybór zasięgu widzenia, w procentach"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Wybór zasięgu, z jakiego widoczne będą obiekty"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Niebo";
	text[1]		= 	"Włączenie/wyłączenie dodatkowych efektów nieba"; // Kommentar
	// Position und Dimension	
