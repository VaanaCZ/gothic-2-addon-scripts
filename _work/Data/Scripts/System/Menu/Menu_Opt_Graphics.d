...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"detalle de texturas";
	text[1]		= 	"Seleccionar el nivel de detalle de las texturas"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"detalle de modelos";
	text[1]		= 	"Seleccionar el nivel de detalle de los modelos"; // Kommentar
	// Position und Dimension	
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Alcance visual";
	text[1]		= "Selecciona el porcentaje de alcance visual"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Fund. objetos";
	text[1]		= "Selecciona el alcance visual de los objetos"; // Kommentar
	// Position und Dimension	
...
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Efectos cielo";
	text[1]		= 	"Activa y desactiva los efectos de cielo"; // Kommentar
	// Position und Dimension	
