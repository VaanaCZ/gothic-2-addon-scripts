...
INSTANCE MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0]		=	"det. texture";
	text[1]		= 	"Seleziona il livello di dettaglio delle texture"; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_GRA_MODEL_DETAIL(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"det. modello";
	text[1]		= 	"Seleziona il livello di dettaglio dei modelli"; // Kommentar
	// Position und Dimension	
...
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Raggio visuale";
	text[1]		= "Seleziona il raggio visuale in percentuale"; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	backpic		= MENU_ITEM_BACK_PIC;
	text[0]		= "Diss. oggetti";
	text[1]		= "Seleziona il raggio visuale per gli oggetti"; // Kommentar
	// Position und Dimension	
