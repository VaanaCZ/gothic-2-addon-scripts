...
//------------------------------------------------------------------------------------------------
// Hier mьssen die einzelnen Sounds eingetragen werden
//------------------------------------------------------------------------------------------------
...
/* Special	 */
				...
				INSTANCE FoundRiddlersBook				(C_SFX_DEF) {file= "Info_CorKalom_BringBook_Success_15_01.wav";	vol = 80;		};//Bjцrn
				INSTANCE FoundRiddler					(C_SFX_DEF) {file= "theriddle_tot_15_01.wav";					vol = 80;		};//Bjцrn
				INSTANCE LastDoorEvent					(C_SFX_DEF) {file= "LastDoorEvent.wav";							vol = 100;		};//Bjцrn
...
/* (A)mbientsounds fьr die Addon-(ST)einmonster added by Patrick */
...
// -------------  Damage ---------------		                                          
// sollte ьber das Kollisionssoundsystem         geregelt werden. IAM_ME_FL   etc.        
...
// [EDENFELD] In Gothic 2 wird das System drastisch verkьrzt, da die Programmlogik fьr obige Tabelle buggy ist.
...
/* IAI */	//											schwert trifft auf schwert
				...
				// [EDENFELD] neu, die machen vielleicht auch Sinn (Paladin Rьstung)
				// gibts noch mehr Rьstungmaterialien als Leather und Metal ? Nein ? Dann ist hiermit genug!
...
/* MAM */	//											faust trifft auf monster/human	        		                		
				...
				// [EDENFELD] neu
				// Menschenfaust trifft auf Rьstung
