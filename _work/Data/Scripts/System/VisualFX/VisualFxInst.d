...
// WICHTIG:
// die Parameter der Keys verдndern die effekte/visuals nur wenn ein Wert ungleich NULL angegeben wird,
// ausser bei INTEGER Variablen. Das heisst wenn ein KEY benutzt wird und ein Parameter den FX/das Visual дndern
...
// gehдngt werden, und darf erst beim Casten ein Visual bekommen.
// nur so kann getestet werden, ob ein etwaiges gecastetes Licht noch aktiv ist. Vorher wurde die spellFX_Light_ACTIVE
// Instanz ьber die emCreateFXID Variable getriggert. Die so erzeugten Effekte haben dann aber keinen Bezug mehr zum Licht Spell.
...
instance spellFX_InstantFireball_FIRECLOUD		(CFx_Base_Proto)
{
		...
		emtrjmode_s 	= "TARGET";
     	...
     	emtrjeasefunc_s 		= "LINEAR";
		emTrjDynUpdateDelay	= 20000;
     	emCheckCollision 		= 2;					// [EDENFELD, neu] 2: Coll, aber keinen Schaden abziehen (nцtig, da dieser FX nicht als Child eingefьgt wurde, sondern komplett
     													// unabhдngig mit Coll in die Welt gesetzt wurde. Der Schaden wird aber schon von spellFX_InstantFireball berechnet.)
...
INSTANCE spellFX_FireRain_SUB(CFx_Base_Proto)		// vorrьbergehend, bis er hardcodiert nicht mehr gesucht wird
{
     	visname_S 				= "";
     	emtrjmode_s 			= "FIXED";
		emTrjOriginNode 		= "BIP01 HEAD";
...
instance spellFX_PalHeal_START		(CFx_Base_Proto)			// HEAL START wird im 1. Invest-Key getriggert. Sдule aus dem Boden.
{
...
instance spellFX_PalHeal_ORIGIN	(CFx_Base_Proto)		// HEAL ORIGIN wird automatisch ьber emFXInvestOrigin_S getriggert. Aura um den Spieler
{
...
INSTANCE spellFX_Icewave_SUB(CFx_Base_Proto)		// vorrьbergehend, bis er hardcodiert nicht mehr gesucht wird
{
     	visname_S 				= "";
     	emtrjmode_s 			= "FIXED";
		emTrjOriginNode 		= "BIP01 HEAD";
...
INSTANCE spellFX_MassDeath_SUB			(CFx_Base_Proto)		// vorrьbergehend, bis er hardcodiert nicht mehr gesucht wird
{
     	visname_S 				= "";
     	emtrjmode_s 			= "FIXED";
		emTrjOriginNode 		= "BIP01 HEAD";
...
instance spellFX_Thunderspell_SENDPERCEPTION			(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 Head";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_SENDPERCEPTION_CHILD1		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 R UPPERARM";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD2		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 L UPPERARM";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD3		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 L HAND";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD4		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 R HAND";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD5		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 L FOOT";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD6		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01 R FOOT";
		visAlpha		= 1;
...
instance spellFX_Thunderspell_TARGET_CHILD7		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
...
instance spellFX_Thunderspell_TARGET_CHILD8		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
...
instance spellFX_Thunderspell_TARGET_CHILD9		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
...
instance spellFX_Thunderspell_TARGET_CHILD10		(CFx_Base_Proto)			// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
...
instance spellFX_Thunderspell_TARGET_CHILD11		(CFx_Base_Proto)		// gehцrt zu FX-Kette. DO NOT DELETE
{
		visname_S 		= "MFX_Thunderball_Target";
		emTrjOriginNode = "BIP01";
		visAlpha		= 1;
...
INSTANCE BLACK_SCREEN(CFx_Base_Proto)
{
 	...
 	userString[2]     	= "0";
 	visAlphaBlendFunc_S = "BLEND";
	emFXLifeSpan    	= 2;						// Dauer is Sekunden (ьber timer skaliert)
};
